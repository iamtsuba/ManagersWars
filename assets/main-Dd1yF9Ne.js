import{s as v}from"./supabase-BOyPgsCC.js";function Q(t,{navigate:e,toast:i}){t.innerHTML=`
  ...
  </div>`}async function Se(t,e){const{state:i,navigate:o,toast:a,openModal:n,closeModal:s}=e;t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:d}=await v.from("cards").select(`id, card_type, current_note, gc_type, formation, is_for_sale, sale_price,
  ...
  <div class="page">
  ...
  </div>`;function w(){const m=x(),g=document.getElementById("col-grid");if(!g)return;if(!m.length){g.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const y={},$=[];m.forEach(k=>{const h=k.player.id;y[h]||(y[h]=!0,$.push(k))}),g.innerHTML=$.map(k=>{const h=u[k.player.id]||1,_=h>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${h}</div>`:"",L=r.filter(C=>C.player.id===k.player.id&&C.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return ze(k,_+L)}).join(""),g.querySelectorAll("[data-card-id]").forEach(k=>{k.addEventListener("click",()=>{const h=r.find(_=>_.id===k.dataset.cardId);h&&qe(h,r,u,e)})})}w(),t.querySelectorAll(".filter-btn").forEach(m=>{m.addEventListener("click",()=>{p=m.dataset.job,t.querySelectorAll(".filter-btn").forEach(g=>{const y=g.dataset.job===p;g.style.background=y?"var(--green)":"#fff",g.style.color=y?"#fff":"var(--gray-600)",g.style.borderColor=y?"var(--green)":"var(--gray-200)"}),w()})}),document.getElementById("col-search").addEventListener("input",m=>{f=m.target.value.toLowerCase(),w()}),t.querySelectorAll("[data-gc-id]").forEach(m=>{m.addEventListener("click",()=>De(m.dataset.gcType,n))}),t.querySelectorAll("[data-form-id]").forEach(m=>{m.addEventListener("click",()=>Ge(m.dataset.formation,n))})}function De(t,e){const i=U[t]||{icon:"⚡",desc:"Effet spécial."};e("Game Changer",`<div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}function Ge(t,e){const i={"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2}},o={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},a=i[t]||i["4-4-2"],n=["ATT","MIL","DEF","GK"];function s(l){return l===1?[1]:l===2?[0,2]:l===3?[0,1,2]:l===4?[0,1,1,2]:l===5?[0,1,1,1,2]:[1]}const d={};n.forEach(l=>{const c=a[l],u=s(c);u.map((p,f)=>({role:l,col:p,slotIdx:f})),u.forEach((p,f)=>{const b=l+"-"+p;d[b]||(d[b]=l)})});function r(){const b=n.length*70+40,x=[30,110,30+80*2],w=n.map((g,y)=>20+y*70+70/2);let m=`<svg width="280" height="${b}" viewBox="0 0 280 ${b}" xmlns="http://www.w3.org/2000/svg">`;n.forEach((g,y)=>{const $=a[g],k=s($),h=[...new Set(k)].sort();for(let _=0;_<h.length-1;_++){const T=h[_],L=h[_+1];L-T===1&&(m+=`<line x1="${x[T]+18}" y1="${w[y]}" x2="${x[L]-18}" y2="${w[y]}"
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}function qe(t,e,i,o){var h,_,T,L,C,j;const{state:a,toast:n,openModal:s,closeModal:d,navigate:r,refreshProfile:l}=o,c=t.player,u=e.filter(I=>I.player.id===c.id),p=u.length,f=Be[c.rarity]||1e3,b=c.rarity!=="legende",x=ge(c),w=O(c,c.job),m=c.job2?O(c,c.job2):null,g=F[c.job]||"#1A6B3C",y=c.job2?F[c.job2]:null,$=me[c.rarity]||"#ccc",k=ve[c.country_code]||c.country_code||"";s(`${c.firstname} ${c.surname_encoded}`,`<div style="display:flex;gap:16px;flex-wrap:wrap;justify-content:center">
  ...
  <div class="page">
    ...
    </div>`,'<button class="btn btn-ghost" id="close-selector">Fermer</button>'),(c=document.getElementById("close-selector"))==null||c.addEventListener("click",n),(u=document.getElementById("remove-player"))==null||u.addEventListener("click",()=>{delete e.slots[t],n(),z(i,e,o)}),document.querySelectorAll(".player-option").forEach(p=>{p.addEventListener("click",()=>{e.slots[t]=p.dataset.cardId,n(),z(i,e,o)})})}function Oe(t,e,i){var d;const{openModal:o,closeModal:a}=i,n=[...Object.values(t.slots).filter(Boolean),...t.subs],s=t.playerCards.filter(r=>!n.includes(r.id));o("Ajouter un remplaçant",`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
  ...
  </div>`,t.querySelectorAll(".booster-card:not(.disabled)").forEach(s=>{s.addEventListener("click",async()=>{const d=ae.find(r=>r.id===s.dataset.booster);if(d){s.style.opacity="0.5",s.style.pointerEvents="none";try{await Ve(d,{state:e,toast:o,navigate:i,container:t})}catch(r){o(r.message,"error"),s.style.opacity="",s.style.pointerEvents=""}}})})}async function Ve(t,{state:e,toast:i,navigate:o,container:a}){if(t.cost>0&&e.profile.credits<t.cost){i("Crédits insuffisants","error");return}t.id==="players_pub"&&await Ze();let n=[];t.type==="player"?n=await We(e.profile,t.cardCount,t.cost):t.type==="game_changer"?n=await Ye(e.profile,t.cardCount,t.cost):t.type==="formation"&&(n=await Je(e.profile,t.cost));const{data:s}=await v.from("users").select("*").eq("id",e.profile.id).single();s&&(e.profile=s),Xe(n,t,o)}async function We(t,e,i){if(i>0){const{error:r}=await v.from("users").update({credits:t.credits-i}).eq("id",t.id);if(r)throw r}const{data:o}=await v.from("players").select("id,job,firstname,surname_encoded,country_code,club_id,rarity,note_g,note_d,note_m,note_a,note_min,note_max,skin,hair,hair_length,sell_price,clubs(encoded_name,logo_url)").eq("is_active",!0);if(!(o!=null&&o.length))throw new Error("Pas de joueurs en BDD — ajoutes-en via le panel admin !");const a=o.filter(r=>r.job==="GK"),n=o.filter(r=>r.job!=="GK");let s=[];!t.first_booster_opened&&a.length>0?(s.push(a[Math.floor(Math.random()*a.length)]),s.push(...re([...n]).slice(0,e-1)),await v.from("users").update({first_booster_opened:!0}).eq("id",t.id)):s=re([...o]).slice(0,e);const{data:d}=await v.from("cards").insert(s.map(r=>({owner_id:t.id,player_id:r.id,card_type:"player"}))).select();return s.map((r,l)=>({...d[l],player:r}))}async function Ye(t,e,i){const{error:o}=await v.from("users").update({credits:t.credits-i}).eq("id",t.id);if(o)throw o;const a=Object.keys(he),n=Array.from({length:e},()=>a[Math.floor(Math.random()*a.length)]),{data:s}=await v.from("cards").insert(n.map(d=>({owner_id:t.id,card_type:"game_changer",gc_type:d}))).select();return s}async function Je(t,e){const{error:i}=await v.from("users").update({credits:t.credits-e}).eq("id",t.id);if(i)throw i;const o=["4-4-2","4-3-3","3-4-3","3-5-2","5-3-2"],a=o[Math.floor(Math.random()*o.length)],{data:n}=await v.from("cards").insert({owner_id:t.id,card_type:"formation",formation:a}).select();return n}function Xe(t,e,i){var s,d;const o=document.createElement("div");o.id="booster-anim-overlay",o.innerHTML=`
    <style>
  ...
  `,document.body.appendChild(o);let a=!1;const n=document.getElementById("pack-visual");n.addEventListener("click",()=>{a||(a=!0,n.classList.add("shaking"),setTimeout(()=>{n.classList.remove("shaking"),n.classList.add("pack-open"),setTimeout(()=>{document.getElementById("pack-phase").style.display="none";const r=document.getElementById("cards-phase");r.style.display="flex",r.innerHTML=t.map((l,c)=>`
          ...
          </div>`).join(""),t.forEach((l,c)=>{setTimeout(()=>{var u;(u=document.getElementById(`card-flip-${c}`))==null||u.classList.add("revealed")},c*350+300)}),setTimeout(()=>{document.getElementById("reveal-btns").style.display="flex"},t.length*350+800),r.querySelectorAll(".card-flip-wrapper").forEach(l=>{l.addEventListener("click",()=>{var c;(c=document.getElementById(`card-flip-${l.dataset.cardIdx}`))==null||c.classList.add("revealed")})})},600)},500))}),(s=document.getElementById("reveal-collection"))==null||s.addEventListener("click",()=>{o.remove(),i("collection")}),(d=document.getElementById("reveal-more"))==null||d.addEventListener("click",()=>{o.remove(),i("boosters")})}function Qe(t){var e,i;if(t.card_type==="player"&&t.player){const o=t.player,a=o.job||"ATT",n=Pe[a]||"#1A6B3C",s=He[o.rarity]||"#ccc",d=a==="GK"?o.note_g:a==="DEF"?o.note_d:a==="MIL"?o.note_m:o.note_a,r=Ke(o),l={MA:"MAROC",FR:"FRANCE",AR:"ARGENTINE",PT:"PORTUGAL",BR:"BRESIL",ES:"ESPAGNE",DE:"ALLEMAGNE",GB:"ANGLETERRE",IT:"ITALIE",CM:"CAMEROUN",SN:"SENEGAL"}[o.country_code]||o.country_code;return`<div style="width:140px;height:200px;background:#f2e8d2;border-radius:12px;border:3px solid ${s};overflow:hidden;display:flex;flex-direction:column">
      <!-- Nom -->
  ...
  <div class="match-screen">
  ...
  </div>`,(n=document.getElementById("match-quit"))==null||n.addEventListener("click",()=>{confirm("Abandonner le match ?")&&i.navigate("home")}),(s=document.getElementById("view-ai"))==null||s.addEventListener("click",()=>ut(e,i)),xe(t,e,i),_e(t,e,i),t.querySelectorAll(".gc-mini").forEach(d=>{d.addEventListener("click",()=>ct(d.dataset.gcId,d.dataset.gcType,t,e,i))});const a=document.getElementById("match-log");a&&(a.scrollTop=a.scrollHeight)}function xe(t,e,i){const o=document.getElementById("match-field");if(!o)return;const a=e.phase==="attack"||e.phase==="defense",n=e.phase==="attack"?["MIL","ATT"]:["GK","DEF","MIL"];e.phase==="attack"||e.phase;const s=["ATT","MIL","DEF","GK"];o.innerHTML=`<div class="match-grid">
    ${s.map(d=>{const r=e.homeTeam[d]||[];return r.length?`<div class="match-row">
      ...
      <button class="btn btn-primary" id="confirm-attack" style="width:100%" ${r?"":"disabled"}>
        Attaquer →
      </button>`,(a=document.getElementById("confirm-attack"))==null||a.addEventListener("click",()=>rt(t,e,i))}else if(e.phase==="defense"){const r=e.selected.length>0?Y(e.selected.map(c=>({...c,_line:c._role})),e.modifiers.home):null,l=((n=e.pendingAttack)==null?void 0:n.total)||0;o.innerHTML=`
      <div style="text-align:center;color:#fff;margin-bottom:6px;font-size:13px">
      ...
      <button class="btn btn-primary" id="confirm-defense" style="width:100%" ${r?"":"disabled"}>
        Défendre →
      </button>`,(s=document.getElementById("confirm-defense"))==null||s.addEventListener("click",()=>dt(t,e,i))}else e.phase==="finished"?(o.innerHTML='<button class="btn btn-primary" id="end-match" style="width:100%">Voir les résultats</button>',(d=document.getElementById("end-match"))==null||d.addEventListener("click",()=>i.navigate("home"))):o.innerHTML=`<div style="text-align:center;color:rgba(255,255,255,.5);padding:8px;font-size:13px">⏳ Tour de l'IA...</div>`}function rt(t,e,i){const o=W(e.selected,e.modifiers.home);e.pendingAttack={...o,players:[...e.selected],side:"home"},e.selected.forEach(a=>{const n=(e.homeTeam[a._role]||[]).find(s=>s.cardId===a.cardId);n&&(n.used=!0)}),e.log.push({text:`Vous attaquez : ${o.total} (${e.selected.map(a=>a.name).join(", ")})`,type:"info"}),e.selected=[],e.modifiers.home={},e.phase="ai-defense",M(t,e,i),setTimeout(()=>lt(t,e,i),1200)}function dt(t,e,i){const o=e.selected.map(s=>({...s,_line:s._role})),a=Y(o,e.modifiers.home);e.selected.forEach(s=>{const d=(e.homeTeam[s._role]||[]).find(r=>r.cardId===s.cardId);d&&(d.used=!0)});const n=ue(e.pendingAttack.total,a.total,e.modifiers.home);n.shielded?e.log.push({text:"🛡️ Bouclier ! But annulé.",type:"info"}):n.goal?(e.aiScore++,e.log.push({text:`⚽ BUT IA ! (${e.pendingAttack.total} > ${a.total})`,type:"goal"})):e.log.push({text:`🧤 Défense ! (${a.total} ≥ ${e.pendingAttack.total})`,type:"info"}),e.selected=[],e.modifiers.home={},e.pendingAttack=null,ke(t,e,i,"home-attack")}function K(t,e,i){const o=[...e.aiTeam.MIL||[],...e.aiTeam.ATT||[]],a=fe(o,"attack",e.difficulty);if(!a.length){$e(t,e,i);return}const n=W(a,e.modifiers.ai);e.pendingAttack={...n,players:a,side:"ai"},a.forEach(s=>{s.used=!0}),e.log.push({text:`IA attaque : ${n.total}`,type:"info"}),e.modifiers.ai={},e.phase="defense",M(t,e,i)}function lt(t,e,i){const o=[...e.aiTeam.GK||[],...e.aiTeam.DEF||[],...e.aiTeam.MIL||[]],a=fe(o,"defense",e.difficulty),n=a.length>0?Y(a,e.modifiers.ai).total:0;a.forEach(d=>{d.used=!0});const s=ue(e.pendingAttack.total,n,e.modifiers.ai);s.shielded?e.log.push({text:"🛡️ Bouclier IA ! But annulé.",type:"info"}):s.goal?(e.homeScore++,e.log.push({text:`⚽ BUT VOUS ! (${e.pendingAttack.total} > ${n})`,type:"goal"})):e.log.push({text:`🧤 IA défend ! (${n} ≥ ${e.pendingAttack.total})`,type:"info"}),e.modifiers.ai={},e.pendingAttack=null,ke(t,e,i,"ai-attack")}function ke(t,e,i,o){if(e.round++,we(e)){P(t,e,i);return}if(o==="home-attack"){if(![...e.homeTeam.MIL||[],...e.homeTeam.ATT||[]].filter(n=>!n.used).length){if(![...e.homeTeam.GK||[],...e.homeTeam.DEF||[],...e.homeTeam.MIL||[]].filter(s=>!s.used).length){P(t,e,i);return}e.phase="ai-attack",M(t,e,i),setTimeout(()=>K(t,e,i),800);return}e.phase="attack",M(t,e,i)}else{if(![...e.aiTeam.MIL||[],...e.aiTeam.ATT||[]].filter(n=>!n.used).length){$e(t,e,i);return}e.phase="ai-attack",M(t,e,i),setTimeout(()=>K(t,e,i),800)}}function we(t){const e=["MIL","ATT","GK","DEF"].some(o=>(t.homeTeam[o]||[]).some(a=>!a.used)),i=["MIL","ATT","GK","DEF"].some(o=>(t.aiTeam[o]||[]).some(a=>!a.used));return!e&&!i}function $e(t,e,i){we(e)?P(t,e,i):(e.phase="attack",M(t,e,i))}function ct(t,e,i,o,a){if(!o.usedGc.includes(t)){switch(o.usedGc.push(t),e){case"Double attaque":o.modifiers.home.doubleAttack=!0,o.log.push({text:"⚡ Double attaque !",type:"info"});break;case"Bouclier":o.modifiers.home.shield=!0,o.log.push({text:"🛡️ Bouclier actif !",type:"info"});break;case"Ressusciter":{let n=!1;for(const s of["ATT","MIL","DEF","GK"]){const d=(o.homeTeam[s]||[]).find(r=>r.used);if(d){d.used=!1,n=!0;break}}o.log.push({text:n?"💫 Joueur ressuscité !":"💫 Aucun joueur à ressusciter",type:"info"});break}case"Vol de note":o.modifiers.ai.stolenNote=(o.modifiers.ai.stolenNote||0)+1,o.log.push({text:"🎯 -1 à la prochaine action IA",type:"info"});break;case"Gel":{const n=[...o.aiTeam.ATT||[],...o.aiTeam.MIL||[]].filter(s=>!s.used);if(n.length){const s=n.sort((d,r)=>A(r,"ATT")-A(d,"ATT"))[0];s.used=!0,o.log.push({text:`❄️ ${s.name} (IA) gelé !`,type:"info"})}break}case"Remplacement+":o.maxSubs++,o.log.push({text:"🔄 +1 remplacement",type:"info"});break}v.from("cards").delete().eq("id",t).then(()=>{}),M(i,o,a)}}async function P(t,e,i){e.phase="finished";const{state:o}=i,a=e.homeScore>e.aiScore,n=e.homeScore===e.aiScore,s=a?"victoire":n?"nul":"defaite",d=Me(e.mode,s);e.log.push({text:a?`🏆 Victoire ! +${d} cr.`:n?`🤝 Nul. +${d} cr.`:`❌ Défaite. +${d} cr.`,type:"goal"}),e.matchId&&await v.from("matches").update({status:"finished",home_score:e.homeScore,away_score:e.aiScore,winner_id:a?o.profile.id:null,home_credits_reward:d,played_at:new Date().toISOString()}).eq("id",e.matchId);const r={credits:(o.profile.credits||0)+d,matches_played:(o.profile.matches_played||0)+1};a?r.wins=(o.profile.wins||0)+1:n?r.draws=(o.profile.draws||0)+1:r.losses=(o.profile.losses||0)+1,await v.from("users").update(r).eq("id",o.profile.id),await i.refreshProfile(),M(t,e,i),pt(t,e,{isWin:a,isDraw:n,rewards:d},i)}function pt(t,e,{isWin:i,isDraw:o,rewards:a},n){var d,r;const s=document.createElement("div");s.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.85);display:flex;align-items:center;justify-content:center;z-index:2000",s.innerHTML=`
  ...
  `;function d(r){const l=document.getElementById("mkt-content"),c=r==="buy"?s:n;if(c.length===0){l.innerHTML=`<div style="text-align:center;color:var(--gray-600);padding:40px">
      ...
      ${c.map(u=>{var w,m,g;const p=(w=u.card)==null?void 0:w.player;if(!p)return"";const f=p.job==="GK"?p.note_g:p.job==="DEF"?p.note_d:p.job==="MIL"?p.note_m:p.note_a,b=ft[p.rarity],x=(i.profile.credits||0)>=u.price;return`<div class="card-panel" style="display:flex;align-items:center;gap:12px;padding:12px">
          <div style="width:44px;height:44px;border-radius:8px;background:${yt(p.job)};color:#fff;display:flex;align-items:center;justify-content:center;font-weight:900;font-size:18px;border:2px solid ${b};flex-shrink:0">${f}</div>
          <div style="flex:1;min-width:0">
