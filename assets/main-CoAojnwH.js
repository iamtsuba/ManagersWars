import{s as _}from"./supabase-z_u0vv5N.js";function se(t,{navigate:e,toast:i}){t.innerHTML=`
    ...
    <div class="page-body">
      ...
      <div>
        ...
        <div class="card-panel" style="padding:0">
          ${n.map(s=>{const d=s.winner_id===r.id,c=s.home_score===s.away_score,y=c?"N":d?"V":"D",p=c?"#888":d?"#1A6B3C":"#c0392b",f={vs_ai_easy:"IA Facile",vs_ai_medium:"IA Moyen",vs_ai_hard:"IA Difficile",vs_ai_club:"IA Club",friend_challenge:"Défi ami",championship:"Championnat"}[s.mode]||s.mode,v=new Date(s.created_at).toLocaleDateString("fr",{month:"short",day:"numeric"});return`<div style="display:flex;justify-content:space-between;align-items:center;padding:10px 14px;border-bottom:1px solid var(--gray-200)">
              <div>
  ...
  </div>`}async function be(t,e){const{state:i,navigate:o,toast:r,openModal:n,closeModal:a}=e;t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:l}=await _.from("cards").select(`id, card_type, current_note, gc_type, formation, is_for_sale, sale_price,
      player:players(id, firstname, surname_encoded, country_code, club_id, job, job2,
        note_g, note_d, note_m, note_a, rarity, note_min, note_max, skin, hair, hair_length, sell_price,
        clubs(encoded_name, logo_url))`).eq("owner_id",i.profile.id),s=(l||[]).filter(u=>u.card_type==="player"&&u.player),d=(l||[]).filter(u=>u.card_type==="game_changer"),c=(l||[]).filter(u=>u.card_type==="formation"),y={};s.forEach(u=>{const x=u.player.id;y[x]=(y[x]||0)+1});let p="Tous",f="";function h(){return[...s].sort((u,x)=>{const b=de.indexOf(u.player.job),m=de.indexOf(x.player.job);return b!==m?b-m:(u.player.surname_encoded||"").localeCompare(x.player.surname_encoded||"")})}function v(){return h().filter(u=>{const x=u.player,b=p==="Tous"||x.job===p,m=!f||`${x.firstname} ${x.surname_encoded}`.toLowerCase().includes(f);return b&&m})}t.innerHTML=`
  <div class="page">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}function Pe(t,e){const i={"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2}},o={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},r=i[t]||i["4-4-2"],n=["ATT","MIL","DEF","GK"];function a(d,c){const h=(d-1)*54,v=(c-h)/2;return Array.from({length:d},(g,u)=>v+u*54)}function l(d){return d===1?[1]:d===2?[0,2]:d===3?[0,1,2]:d===4?[0,1,1,2]:d===5?[0,1,1,1,2]:[1]}function s(){const p=n.length*72+48,f=n.map((u,x)=>24+x*72+72/2),h={};n.forEach(u=>{h[u]=a(r[u],290)});function v(u,x){const b=r[u],m=l(b),$=h[u],E=m.indexOf(x);return E>=0?$[E]:null}let g=`<svg width="290" height="${p}" viewBox="0 0 290 ${p}" xmlns="http://www.w3.org/2000/svg">`;n.forEach((u,x)=>{const b=h[u];for(let m=0;m<b.length-1;m++){const $=b[m]+20,E=b[m+1]-20,w=f[x];g+=`<line x1="${$}" y1="${w}" x2="${E}" y2="${w}"
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}function Ke(t,e,i,o){var E,w,A,L,I,M;const{state:r,toast:n,openModal:a,closeModal:l,navigate:s,refreshProfile:d}=o,c=t.player,y=e.filter(T=>T.player.id===c.id),p=y.length,f=Ne[c.rarity]||1e3,h=c.rarity!=="legende",v=he(c),g=U(c,c.job),u=c.job2?U(c,c.job2):null,x=H[c.job]||"#1A6B3C",b=c.job2?H[c.job2]:null,m=me[c.rarity]||"#ccc",$=xe[c.country_code]||c.country_code||"";a(`${c.firstname} ${c.surname_encoded}`,`<div style="display:flex;gap:16px;flex-wrap:wrap;justify-content:center">
  ...
  <div class="page">
  ...
  </div>`,He(t,e,r,i),document.getElementById("builder-back").addEventListener("click",()=>o("decks")),document.getElementById("formation-select").addEventListener("change",d=>{e.formation=d.target.value;const c=ce(e.formation),y={};c.forEach(p=>{e.slots[p]&&(y[p]=e.slots[p])}),e.slots=y,S(t,e,i)}),document.getElementById("save-deck").addEventListener("click",()=>Ve(e,i)),t.querySelectorAll("[data-remove-sub]").forEach(d=>{d.addEventListener("click",()=>{e.subs=e.subs.filter(c=>c!==d.dataset.removeSub),S(t,e,i)})}),(s=document.getElementById("add-sub-btn"))==null||s.addEventListener("click",()=>{We(e,t,i)})}function He(t,e,i,o){const r=document.getElementById("deck-field");if(!r)return;const n=e.formation,a=Ee[n]||{},l=$e[n]||[],s={};i.forEach(b=>{const m=e.slots[b],$=m?e.playerCards.find(E=>E.id===m):null;s[b]=($==null?void 0:$.player)||null});const d=i.filter(b=>b.startsWith("MIL"));let c=0,y=0;d.forEach(b=>{const m=s[b];m&&(c+=Number(m.note_m)||0)}),l.forEach(([b,m])=>{if(!b.startsWith("MIL")||!m.startsWith("MIL"))return;N(s[b],s[m])!=="#ff3333"&&y++});const p=320,f=320,h=28,v=4;function g(b){const m=a[b];return m?{x:m.x*p,y:m.y*f}:null}let u="";for(const[b,m]of l){const $=g(b),E=g(m);if(!$||!E)continue;const w=s[b],A=s[m],L=N(w,A),I=L==="#ff3333"?.3:.9,M=L!=="#ff3333"?`filter="url(#glow-${L.replace("#","")})"`:"";u+=`<line x1="${$.x}" y1="${$.y}" x2="${E.x}" y2="${E.y}"
      stroke="${L}" stroke-width="${v}" stroke-linecap="round"
      opacity="${I}" ${M}/>`}for(const b of i){const m=g(b);if(!m)continue;const $=s[b],E=b.replace(/\d+/,""),A={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[E]||"#555",L=$?Number(E==="GK"?$.note_g:E==="DEF"?$.note_d:E==="MIL"?$.note_m:$.note_a)||0:null,I=$?($.surname_encoded||"").slice(0,8).toUpperCase():"";if($){const M=te($);M&&(u+=`
          <defs>
            <clipPath id="clip-${b}">
    ...
    <svg viewBox="0 0 ${p} ${f}" width="100%" style="display:block;max-width:380px;margin:0 auto">
      ${x}
      ${u}
    </svg>`,r.querySelectorAll(".deck-slot-hit").forEach(b=>{b.addEventListener("click",()=>Ue(b.dataset.pos,e,t,o))})}function Ue(t,e,i,o){var p,f,h;const{openModal:r,closeModal:n}=o,a=t.replace(/\d+/,""),l=e.slots[t],s=l?e.playerCards.find(v=>v.id===l):null;(p=s==null?void 0:s.player)==null||p.id;const d=new Set;Object.entries(e.slots).forEach(([v,g])=>{var x;if(v===t||!g)return;const u=e.playerCards.find(b=>b.id===g);(x=u==null?void 0:u.player)!=null&&x.id&&d.add(u.player.id)}),e.subs.forEach(v=>{var u;const g=e.playerCards.find(x=>x.id===v);(u=g==null?void 0:g.player)!=null&&u.id&&d.add(g.player.id)});const c=new Set,y=e.playerCards.filter(v=>{const g=v.player;return!(g.job===a||g.job2===a)||d.has(g.id)||c.has(g.id)?!1:(c.add(g.id),!0)});y.sort((v,g)=>{const u=a==="GK"?v.player.note_g:a==="DEF"?v.player.note_d:a==="MIL"?v.player.note_m:v.player.note_a;return(a==="GK"?g.player.note_g:a==="DEF"?g.player.note_d:a==="MIL"?g.player.note_m:g.player.note_a)-u}),r(`Choisir ${a} — ${t}`,`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
      ${e.slots[t]?`
        <button class="btn btn-danger btn-sm" id="remove-player" style="width:100%;margin-bottom:4px">
          ✕ Retirer le joueur actuel
        </button>`:""}
      ${y.length>0?y.map(v=>{var m,$;const g=v.player,u=a==="GK"?g.note_g:a==="DEF"?g.note_d:a==="MIL"?g.note_m:g.note_a,x=te(g),b={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"}[g.rarity];return`<div class="player-option" data-card-id="${v.id}"
    ...
    </div>`,'<button class="btn btn-ghost" id="close-selector">Fermer</button>'),(f=document.getElementById("close-selector"))==null||f.addEventListener("click",n),(h=document.getElementById("remove-player"))==null||h.addEventListener("click",()=>{delete e.slots[t],n(),S(i,e,o)}),document.querySelectorAll(".player-option").forEach(v=>{v.addEventListener("click",()=>{e.slots[t]=v.dataset.cardId,n(),S(i,e,o)})})}function We(t,e,i){var s;const{openModal:o,closeModal:r}=i,n=new Set;Object.values(t.slots).filter(Boolean).forEach(d=>{var y;const c=t.playerCards.find(p=>p.id===d);(y=c==null?void 0:c.player)!=null&&y.id&&n.add(c.player.id)}),t.subs.forEach(d=>{var y;const c=t.playerCards.find(p=>p.id===d);(y=c==null?void 0:c.player)!=null&&y.id&&n.add(c.player.id)});const a=new Set,l=t.playerCards.filter(d=>{var c,y,p;return n.has((c=d.player)==null?void 0:c.id)||a.has((y=d.player)==null?void 0:y.id)?!1:(a.add((p=d.player)==null?void 0:p.id),!0)});o("Ajouter un remplaçant",`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
  ...
  <div class="page">
    ...
    <div class="page-body">
      <div class="booster-grid">
        ${pe.map(a=>{const l=r>=a.cost||a.cost===0,s=a.id==="players_std"||a.id==="players_pub";return`<div class="booster-card ${l?"":"disabled"}" data-booster="${a.id}" style="position:relative">
  ...
  </div>`,t.querySelectorAll(".booster-card:not(.disabled)").forEach(a=>{a.addEventListener("click",async()=>{const l=pe.find(s=>s.id===a.dataset.booster);if(l){a.style.opacity="0.5",a.style.pointerEvents="none";try{await Qe(l,{state:e,toast:o,navigate:i,container:t})}catch(s){o(s.message,"error"),a.style.opacity="",a.style.pointerEvents=""}}})}),t.querySelectorAll(".booster-info-btn").forEach(a=>{a.addEventListener("click",l=>{l.stopPropagation(),st()})})}async function Qe(t,{state:e,toast:i,navigate:o,container:r}){if(t.cost>0&&e.profile.credits<t.cost){i("Crédits insuffisants","error");return}t.id==="players_pub"&&await rt();let n=[];t.type==="player"?n=await tt(e.profile,t.cardCount,t.cost):t.type==="game_changer"?n=await it(e.profile,t.cardCount,t.cost):t.type==="formation"&&(n=await ot(e.profile,t.cost));const{data:a}=await _.from("users").select("*").eq("id",e.profile.id).single();a&&(e.profile=a),nt(n,t,o)}function Ze(){const t=Math.random()*100;return t<.5?"legende":t<2?"special":t<10?"normal_high":"normal_low"}function z(t){return Math.max(Number(t.note_g)||0,Number(t.note_d)||0,Number(t.note_m)||0,Number(t.note_a)||0)}function et(t,e){let i;switch(e){case"legende":i=t.filter(o=>o.rarity==="legende"),i.length||(i=t.filter(o=>o.rarity==="pepite"||o.rarity==="papyte")),i.length||(i=t.filter(o=>z(o)>=6));break;case"special":i=t.filter(o=>o.rarity==="pepite"||o.rarity==="papyte"),i.length||(i=t.filter(o=>z(o)>=6));break;case"normal_high":i=t.filter(o=>o.rarity==="normal"&&z(o)>=6),i.length||(i=t.filter(o=>z(o)>=6));break;default:i=t.filter(o=>o.rarity==="normal"&&z(o)>=1&&z(o)<=5),i.length||(i=t.filter(o=>o.rarity==="normal"));break}return i.length||(i=t),i[Math.floor(Math.random()*i.length)]}async function tt(t,e,i){if(i>0){const{error:d}=await _.from("users").update({credits:t.credits-i}).eq("id",t.id);if(d)throw d}const{data:o}=await _.from("players").select("id,job,firstname,surname_encoded,country_code,club_id,rarity,note_g,note_d,note_m,note_a,note_min,note_max,skin,hair,hair_length,sell_price,clubs(encoded_name,logo_url)").eq("is_active",!0);if(!(o!=null&&o.length))throw new Error("Pas de joueurs en BDD — ajoutes-en via le panel admin !");const r=o.filter(d=>d.job==="GK"),n=o.filter(d=>d.job!=="GK"),a=!t.first_booster_opened&&r.length>0,l=[];for(let d=0;d<e;d++){const c=d===0&&a?r:d===0?n:o,y=Ze(),p=et(c,y);p&&l.push(p)}a&&await _.from("users").update({first_booster_opened:!0}).eq("id",t.id);const{data:s}=await _.from("cards").insert(l.map(d=>({owner_id:t.id,player_id:d.id,card_type:"player"}))).select();return l.map((d,c)=>({...s[c],player:d}))}async function it(t,e,i){const{error:o}=await _.from("users").update({credits:t.credits-i}).eq("id",t.id);if(o)throw o;const r=Object.keys(_e),n=Array.from({length:e},()=>r[Math.floor(Math.random()*r.length)]),{data:a}=await _.from("cards").insert(n.map(l=>({owner_id:t.id,card_type:"game_changer",gc_type:l}))).select();return a}async function ot(t,e){const{error:i}=await _.from("users").update({credits:t.credits-e}).eq("id",t.id);if(i)throw i;const o=["4-4-2","4-3-3","3-4-3","3-5-2","5-3-2"],r=o[Math.floor(Math.random()*o.length)],{data:n}=await _.from("cards").insert({owner_id:t.id,card_type:"formation",formation:r}).select();return n}function nt(t,e,i){const o=document.createElement("div");o.id="booster-anim-overlay",o.innerHTML=`
    <style>
  ...
  </div>`,(n=document.getElementById("msg-btn"))==null||n.addEventListener("click",r)}function Ie(t){const e=typeof import.meta<"u"?"https://fcnwclxlkytdfjotqkta.supabase.co":"";if(!e||!(t!=null&&t.skin)||!(t!=null&&t.hair))return null;const i=t.hair==="chauve"?`${t.skin}-chauve-rase`:`${t.skin}-${t.hair}-${t.hair_length}`;return`${e}/storage/v1/object/public/assets/tetes/${i}.png`}function ue(t){const e=t.player;return{cardId:t.id,id:e.id,firstname:e.firstname,name:e.surname_encoded,country_code:e.country_code,club_id:e.club_id,job:e.job,job2:e.job2,note_g:Number(e.note_g)||0,note_d:Number(e.note_d)||0,note_m:Number(e.note_m)||0,note_a:Number(e.note_a)||0,rarity:e.rarity,skin:e.skin,hair:e.hair,hair_length:e.hair_length,boost:0,used:!1,_line:null,_col:null}}function oe(t){return t===1?[1]:t===2?[0,2]:t===3?[0,1,2]:t===4?[0,1,1,2]:t===5?[0,1,1,1,2]:[1]}function at(){const t=Math.random()*100;return t<.1?4:t<5?3:t<20?2:1}function dt(t,e){const i=G[e]||G["4-4-2"],o={GK:[],DEF:[],MIL:[],ATT:[]},r=[...t];for(const n of["GK","DEF","MIL","ATT"]){const a=[];for(let s=0;s<i[n];s++){let d=r.findIndex(c=>c.job===n);if(d===-1&&(d=r.findIndex(c=>c.job2===n)),d===-1&&(d=0),r[d]){const c={...r[d],_line:n};a.push(c),r.splice(d,1)}}const l=oe(a.length);a.forEach((s,d)=>{s._col=l[d]}),o[n]=a}return o}async function lt(t,e){const{data:i}=await _.from("players").select("id,firstname,surname_encoded,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length").eq("is_active",!0).limit(60);if(!i||i.length<11)return ct(t);const o=G[t]||G["4-4-2"],r={GK:[],DEF:[],MIL:[],ATT:[]},n=[...i];for(const a of["GK","DEF","MIL","ATT"]){const l=n.filter(p=>p.job===a),s=n.filter(p=>p.job!==a),d=[...l,...s],c=[];for(let p=0;p<o[a];p++){const f=d[p]||n[p];f&&c.push({cardId:"ai-"+f.id+"-"+p,id:f.id,firstname:f.firstname,name:f.surname_encoded,country_code:f.country_code,club_id:f.club_id,job:f.job,job2:f.job2,note_g:Number(f.note_g)||0,note_d:Number(f.note_d)||0,note_m:Number(f.note_m)||0,note_a:Number(f.note_a)||0,rarity:f.rarity,skin:f.skin,hair:f.hair,hair_length:f.hair_length,boost:0,used:!1,_line:a})}const y=oe(c.length);c.forEach((p,f)=>{p._col=y[f]}),r[a]=c}return r}function ct(t){const e=G[t]||G["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},o=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let r=0;for(const n of["GK","DEF","MIL","ATT"]){const a=[];for(let s=0;s<e[n];s++){const d=3+Math.floor(Math.random()*5);a.push({cardId:"fake-"+r,id:"fake-"+r,firstname:"IA",name:o[r%o.length],country_code:"XX",club_id:null,job:n,job2:null,note_g:n==="GK"?d:2,note_d:n==="DEF"?d:2,note_m:n==="MIL"?d:2,note_a:n==="ATT"?d:2,rarity:"normal",boost:0,used:!1,_line:n}),r++}const l=oe(a.length);a.forEach((s,d)=>{s._col=l[d]}),i[n]=a}return i}async function Le(t,e){var m;const{state:i,navigate:o,toast:r}=e,n=i.params||{};t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const a=n.matchMode||"vs_ai_easy",l=a.replace("vs_ai_",""),s=a;if(!n.deckId)return pt(t,e,a);const d=n.deckId,{data:c}=await _.from("deck_cards").select(`position, is_starter, slot_order,
      card:cards(id, card_type, formation,
        player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
          clubs(encoded_name,logo_url)))`).eq("deck_id",d).order("slot_order"),y=(c||[]).filter($=>{var E;return $.is_starter&&((E=$.card)==null?void 0:E.player)}).map($=>ue($.card)),p=(c||[]).filter($=>{var E;return!$.is_starter&&((E=$.card)==null?void 0:E.player)}).map($=>ue($.card));if(y.length<11){ke(t,"⚠️",`Deck incomplet (${y.length}/11).`,"Compléter",()=>o("decks"));return}const f=(c||[]).find($=>{var E;return((E=$.card)==null?void 0:E.card_type)==="formation"}),h=((m=f==null?void 0:f.card)==null?void 0:m.formation)||"4-4-2",{data:v}=await _.from("cards").select("id,gc_type").eq("owner_id",i.profile.id).eq("card_type","game_changer"),g=dt(y,h),u=await lt(h),{data:x}=await _.from("matches").insert({home_id:i.profile.id,away_id:null,mode:s,home_deck_id:d,status:"in_progress"}).select().single(),b={matchId:x==null?void 0:x.id,mode:s,difficulty:l,formation:h,homeTeam:g,aiTeam:u,homeSubs:p,subsUsed:0,maxSubs:Math.min(p.length,3),homeScore:0,aiScore:0,gcCards:v||[],usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};ft(t,b,e)}async function pt(t,e,i){var a;const{state:o,navigate:r}=e,{data:n}=await _.from("decks").select("id,name,is_active,formation_card_id").eq("owner_id",o.profile.id).order("created_at",{ascending:!1});if(!n||n.length===0){ke(t,"📋","Aucun deck. Crée un deck avant de jouer !","Créer un deck",()=>r("decks"));return}t.innerHTML=`
  ...
  <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;gap:20px;padding:20px">
    ...
    <div id="midfield-result" style="opacity:0;text-align:center;transition:opacity 0.5s;color:#fff">
      ...
      `,d&&(e.boostCard={value:h})}e.attacker=d?"home":"ai",e.log.push({text:`Duel milieu : ${e.clubName} ${l} – ${s} IA → ${d?e.clubName:"IA"} attaque en premier`,type:"info"}),setTimeout(()=>{e.phase=e.attacker==="home"?"attack":"ai-attack",D(t,e,i),e.attacker==="ai"&&setTimeout(()=>J(t,e,i),1e3)},2800)},1200)}function Ae(t,e,i,o,r=310,n=310){const a=Ee[e]||{},l=$e[e]||[],s=26,d={},c=["ATT","MIL","DEF","GK"];for(const h of c)(t[h]||[]).forEach((g,u)=>{d[`${h}${u+1}`]=g});function y(h){const v=a[h];return v?{x:v.x*r,y:v.y*n}:null}let p="";for(const[h,v]of l){const g=y(h),u=y(v);if(!g||!u)continue;const x=d[h],b=d[v],m=N(x,b),$=m==="#ff3333"?.25:.9,E=m!=="#ff3333"?`filter="url(#glow${m.replace("#","").slice(0,6)})"`:"";p+=`<line x1="${g.x.toFixed(1)}" y1="${g.y.toFixed(1)}" x2="${u.x.toFixed(1)}" y2="${u.y.toFixed(1)}"
      stroke="${m}" stroke-width="3.5" stroke-linecap="round" opacity="${$}" ${E}/>`}for(const[h,v]of Object.entries(d)){const g=y(h);if(!g)continue;const u=h.replace(/[0-9]/g,""),b={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[u]||"#555",m=i==="attack"&&["MIL","ATT"].includes(u)&&!v.used||i==="defense"&&["GK","DEF","MIL"].includes(u)&&!v.used,$=o.includes(v.cardId);let E;i==="attack"?E=u==="MIL"?Number(v.note_m)||0:Number(v.note_a)||0:i==="defense"?E=u==="GK"?Number(v.note_g)||0:u==="MIL"?Number(v.note_m)||0:Number(v.note_d)||0:E=Number(u==="GK"?v.note_g:u==="DEF"?v.note_d:u==="MIL"?v.note_m:v.note_a)||0,E=E+(v.boost||0);const w=$?"#FFD700":m?"rgba(255,255,255,0.7)":"rgba(255,255,255,0.25)",A=$?3:2,L=v.used?.25:1,I=Ie(v);I&&(p+=`<defs><clipPath id="mc-${h}"><circle cx="${g.x}" cy="${g.y}" r="${s}"/></clipPath></defs>`),p+=`<circle cx="${g.x}" cy="${g.y}" r="${s}" fill="${b}" opacity="${L}"
      stroke="${w}" stroke-width="${A}"/>`,I&&!v.used&&(p+=`<image href="${I}" x="${g.x-s}" y="${g.y-s}" width="${s*2}" height="${s*2}"
        clip-path="url(#mc-${h})" preserveAspectRatio="xMidYMid slice" opacity="0.8"/>`,p+=`<circle cx="${g.x}" cy="${g.y}" r="${s}" fill="${b}" opacity="0.35"
        stroke="${w}" stroke-width="${A}"/>`),v.boost&&(p+=`<rect x="${g.x+s-10}" y="${g.y-s}" width="14" height="10" rx="3" fill="#87CEEB"/>
        <text x="${g.x+s-3}" y="${g.y-s+8}" text-anchor="middle" font-size="7" fill="#000" font-weight="900">+${v.boost}</text>`),p+=`<text x="${g.x}" y="${g.y-1}" text-anchor="middle" font-size="12" font-weight="900"
    ...
    <text x="${g.x}" y="${g.y+11}" text-anchor="middle" font-size="6" fill="rgba(255,255,255,${v.used?.3:.8})"
      font-family="Arial">${(v.name||"").slice(0,8)}</text>`,m&&(p+=`<circle cx="${g.x}" cy="${g.y}" r="${s}" fill="rgba(255,255,255,0.08)"
  ...
  <div class="match-screen">
    ...
    <div class="match-log" id="match-log">
      ...
      <button class="btn btn-primary" id="confirm-attack" style="width:100%" ${s?"":"disabled"}>Attaquer →</button>`,(r=document.getElementById("confirm-attack"))==null||r.addEventListener("click",()=>vt(t,e,i))}else if(e.phase==="defense"){const s=e.selected.length>0?ee(e.selected.map(d=>({...d,_line:d._role})),e.modifiers.home):null;o.innerHTML=`
      <div style="text-align:center;color:#fff;margin-bottom:6px;font-size:13px">
      ...
      <button class="btn btn-primary" id="confirm-defense" style="width:100%" ${s?"":"disabled"}>Défendre →</button>`,(a=document.getElementById("confirm-defense"))==null||a.addEventListener("click",()=>mt(t,e,i))}else e.phase==="finished"?(o.innerHTML='<button class="btn btn-primary" id="end-match" style="width:100%">Voir les résultats</button>',(l=document.getElementById("end-match"))==null||l.addEventListener("click",()=>i.navigate("home"))):o.innerHTML=`<div style="text-align:center;color:rgba(255,255,255,.4);padding:8px;font-size:12px">⏳ Tour de l'IA...</div>`}function gt(t,e,i,o){const r=t.dataset.cardId,n=t.dataset.role,a=e.selected.findIndex(l=>l.cardId===r);if(a!==-1)e.selected.splice(a,1);else{if(e.selected.length>=3){o.toast("Maximum 3 joueurs","error");return}const l=(e.homeTeam[n]||[]).find(s=>s.cardId===r);l&&e.selected.push({...l,_role:n,_line:n})}D(i,e,o)}function vt(t,e,i){const o=e.selected.map(n=>({...n,_line:n._role})),r=Z(o,e.modifiers.home);e.pendingAttack={...r,players:[...e.selected],side:"home"},e.selected.forEach(n=>{const a=(e.homeTeam[n._role]||[]).find(l=>l.cardId===n.cardId);a&&(a.used=!0)}),e.log.push({text:`Vous attaquez : ${r.total} (${e.selected.map(n=>n.name).join(", ")})`,type:"info"}),e.selected=[],e.modifiers.home={},e.phase="ai-defense",D(t,e,i),setTimeout(()=>xt(t,e,i),1200)}function mt(t,e,i){const o=e.selected.map(a=>({...a,_line:a._role})),r=ee(o,e.modifiers.home);e.selected.forEach(a=>{const l=(e.homeTeam[a._role]||[]).find(s=>s.cardId===a.cardId);l&&(l.used=!0)});const n=ge(e.pendingAttack.total,r.total,e.modifiers.home);n.shielded?e.log.push({text:"🛡️ Bouclier ! But annulé.",type:"info"}):n.goal?(e.aiScore++,e.log.push({text:`⚽ BUT IA ! (${e.pendingAttack.total} > ${r.total})`,type:"goal"})):e.log.push({text:`🧤 Défense ! (${r.total} ≥ ${e.pendingAttack.total})`,type:"info"}),e.selected=[],e.modifiers.home={},e.pendingAttack=null,Te(t,e,i,"home-attack")}function J(t,e,i){const o=[...e.aiTeam.MIL||[],...e.aiTeam.ATT||[]],r=ve(o,"attack",e.difficulty);if(!r.length){Ce(t,e,i);return}const n=Z(r,e.modifiers.ai);e.pendingAttack={...n,players:r,side:"ai"},r.forEach(a=>{a.used=!0}),e.log.push({text:`IA attaque : ${n.total}`,type:"info"}),e.modifiers.ai={},e.phase="defense",D(t,e,i)}function xt(t,e,i){const o=[...e.aiTeam.GK||[],...e.aiTeam.DEF||[],...e.aiTeam.MIL||[]],r=ve(o,"defense",e.difficulty),n=r.length>0?ee(r,e.modifiers.ai).total:0;r.forEach(l=>{l.used=!0});const a=ge(e.pendingAttack.total,n,e.modifiers.ai);a.shielded?e.log.push({text:"🛡️ Bouclier IA !",type:"info"}):a.goal?(e.homeScore++,e.log.push({text:`⚽ BUT ! (${e.pendingAttack.total} > ${n})`,type:"goal"})):e.log.push({text:`🧤 IA défend (${n} ≥ ${e.pendingAttack.total})`,type:"info"}),e.modifiers.ai={},e.pendingAttack=null,Te(t,e,i,"ai-attack")}function Te(t,e,i,o){if(e.round++,Me(e)){X(t,e,i);return}if(o==="home-attack"){if(![...e.homeTeam.MIL||[],...e.homeTeam.ATT||[]].filter(n=>!n.used).length){if(![...e.homeTeam.GK||[],...e.homeTeam.DEF||[],...e.homeTeam.MIL||[]].filter(a=>!a.used).length){X(t,e,i);return}e.phase="ai-attack",D(t,e,i),setTimeout(()=>J(t,e,i),800);return}e.phase="attack",D(t,e,i)}else{if(![...e.aiTeam.MIL||[],...e.aiTeam.ATT||[]].filter(n=>!n.used).length){Ce(t,e,i);return}e.phase="ai-attack",D(t,e,i),setTimeout(()=>J(t,e,i),800)}}function Me(t){const e=["MIL","ATT","GK","DEF"].some(o=>(t.homeTeam[o]||[]).some(r=>!r.used)),i=["MIL","ATT","GK","DEF"].some(o=>(t.aiTeam[o]||[]).some(r=>!r.used));return!e&&!i}function Ce(t,e,i){Me(e)?X(t,e,i):(e.phase="attack",D(t,e,i))}function ht(t,e,i){const o=Object.values(e.homeTeam).flat().filter(r=>!r.used);if(!o.length){i.toast("Aucun joueur actif à booster","error");return}i.openModal("⚡ Utiliser le Boost",`<div style="margin-bottom:12px;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border-radius:10px;padding:12px;text-align:center;color:#000">
    ...
    <div style="display:flex;flex-direction:column;gap:6px">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Annuler</button>`),document.querySelectorAll(".player-boost-opt").forEach(r=>{r.addEventListener("click",()=>{const n=r.dataset.cardId;for(const a of["GK","DEF","MIL","ATT"]){const l=(e.homeTeam[a]||[]).find(s=>s.cardId===n);if(l){l.boost=(l.boost||0)+e.boostCard.value,e.log.push({text:`⚡ Boost +${e.boostCard.value} appliqué à ${l.name}`,type:"info"});break}}e.boostUsed=!0,i.closeModal(),D(t,e,i)})})}function bt(t,e,i){e.usedSubIds||(e.usedSubIds=[]);const o=Object.values(e.homeTeam).flat().filter(s=>s.used),r=e.homeSubs.filter(s=>!e.usedSubIds.includes(s.cardId));if(!o.length){i.toast("Aucun joueur grisé","info");return}if(!r.length){i.toast("Aucun remplaçant disponible","info");return}if(e.subsUsed>=e.maxSubs){i.toast(`Maximum ${e.maxSubs} remplacements`,"error");return}i.openModal("🔄 Remplacement",`<div style="margin-bottom:12px">
      ...
      ${o.map(s=>`
        <div class="grayed-opt" data-card-id="${s.cardId}" data-role="${s._line}"
          ...
          <div style="width:28px;height:28px;background:${Y[s.job]||"#888"};border-radius:5px;display:flex;align-items:center;justify-content:center;color:#fff;font-size:10px;font-weight:900">${s._line}</div>
