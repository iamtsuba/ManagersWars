import{s as _}from"./supabase-CO2r08Ga.js";function se(t,{navigate:e,toast:i}){t.innerHTML=`
    ...
    <div class="page-body">
      ...
      <div>
        ...
        <div class="card-panel" style="padding:0">
          ${n.map(r=>{const d=r.winner_id===a.id,c=r.home_score===r.away_score,y=c?"N":d?"V":"D",p=c?"#888":d?"#1A6B3C":"#c0392b",f={vs_ai_easy:"IA Facile",vs_ai_medium:"IA Moyen",vs_ai_hard:"IA Difficile",vs_ai_club:"IA Club",friend_challenge:"Défi ami",championship:"Championnat"}[r.mode]||r.mode,m=new Date(r.created_at).toLocaleDateString("fr",{month:"short",day:"numeric"});return`<div style="display:flex;justify-content:space-between;align-items:center;padding:10px 14px;border-bottom:1px solid var(--gray-200)">
              <div>
  ...
  `,document.body.appendChild(i);const o=()=>i.remove();document.getElementById("diff-cancel").addEventListener("click",o),i.addEventListener("click",a=>{a.target===i&&o()}),i.querySelectorAll("[data-mode]").forEach(a=>{a.addEventListener("click",()=>{o(),t("match",{matchMode:a.dataset.mode})})})}const Q={Ressusciter:{icon:"💫",desc:"Réactive un joueur grisé pour ce match."},"Double attaque":{icon:"⚡",desc:"La note d'attaque compte double."},Bouclier:{icon:"🛡️",desc:"Annule le prochain but adverse."},"Vol de note":{icon:"🎯",desc:"-1 à la note d'un joueur adverse."},Gel:{icon:"❄️",desc:"Bloque le meilleur attaquant IA."},"Remplacement+":{icon:"🔄",desc:"+1 remplacement pour ce match."}};function C(t,e){if(!t)return 0;switch(e){case"GK":return Number(t.note_g)||0;case"DEF":return Number(t.note_d)||0;case"MIL":return Number(t.note_m)||0;case"ATT":return Number(t.note_a)||0;default:return 0}}const de=["ATT","MIL","DEF","GK"];function he(t){let e=0;const i=t.length;for(let o=0;o<i;o++)for(let a=o+1;a<i;a++){const n=t[o],s=t[a];if(!n||!s)continue;const l=n._col!==void 0&&s._col!==void 0&&n._col===s._col,r=n._col!==void 0&&s._col!==void 0&&Math.abs(n._col-s._col)===1,d=de.indexOf(n._line),c=de.indexOf(s._line),y=Math.abs(d-c)===1;(n._line===s._line&&r||l&&y)&&(n.country_code&&s.country_code&&n.country_code===s.country_code&&e++,n.club_id&&s.club_id&&n.club_id===s.club_id&&e++)}return e}function Z(t,e={}){const i=t.reduce((n,s)=>{const l=s._line||s.job;return n+Number(l==="MIL"?s.note_m:s.note_a)||0},0),o=he(t);let a=i+o;return e.doubleAttack&&(a*=2),e.stolenNote&&(a-=e.stolenNote),{base:i,links:o,total:Math.max(0,a)}}function ee(t,e={}){const i=t.reduce((n,s)=>{const l=s._line||s.job;let r=0;return l==="GK"?r=Number(s.note_g)||0:l==="MIL"?r=Number(s.note_m)||0:r=Number(s.note_d)||0,n+r},0),o=he(t);let a=i+o;return e.stolenNote&&(a-=e.stolenNote),{base:i,links:o,total:Math.max(0,a)}}function xe(t,e,i={}){return i.shield?{goal:!1,shielded:!0}:{goal:t>e,shielded:!1}}function be(t,e,i="easy"){const o=t.filter(s=>!s.used);if(!o.length)return[];const a=[...o].sort((s,l)=>{const r=e==="attack"?C(s,"ATT"):s._line==="GK"?C(s,"GK"):C(s,"DEF");return(e==="attack"?C(l,"ATT"):l._line==="GK"?C(l,"GK"):C(l,"DEF"))-r});let n=i==="easy"?1+Math.floor(Math.random()*2):i==="medium"?2+Math.floor(Math.random()*2):3;return a.slice(0,Math.min(n,a.length,3))}function Ge(t,e){const i={vs_ai_easy:{victoire:500,nul:250,defaite:50},vs_ai_medium:{victoire:1e3,nul:500,defaite:50},vs_ai_hard:{victoire:1500,nul:750,defaite:100},vs_ai_club:{victoire:2500,nul:1250,defaite:100}};return(i[t]||i.vs_ai_easy)[e]||0}const $e={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"},O={GK:"#111111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},le=["GK","DEF","MIL","ATT"],Re=["Tous","GK","DEF","MIL","ATT"],Ne={normal:1e3,pepite:5e3,papyte:5e3,legende:1e4},Ee={MA:"MAROC",FR:"FRANCE",AR:"ARGENTINE",PT:"PORTUGAL",BR:"BRESIL",ES:"ESPAGNE",DE:"ALLEMAGNE",GB:"ANGLETERRE",IT:"ITALIE",CM:"CAMEROUN",SN:"SENEGAL",NG:"NIGERIA",DK:"DANEMARK",NL:"PAYS-BAS",BE:"BELGIQUE",CI:"CÔTE D'IVOIRE",AL:"ALBANIE",HR:"CROATIE",RS:"SERBIE",TR:"TURQUIE"};function _e(t){const e="https://fcnwclxlkytdfjotqkta.supabase.co";if(!(t!=null&&t.skin)||!(t!=null&&t.hair))return null;const i=t.hair==="chauve"?`${t.skin}-chauve-rase`:`${t.skin}-${t.hair}-${t.hair_length}`;return`${e}/storage/v1/object/public/assets/tetes/${i}.png`}function P(t,e){return t&&Number(e==="GK"?t.note_g:e==="DEF"?t.note_d:e==="MIL"?t.note_m:t.note_a)||0}function qe(t,e=""){var y,p;const i=t.player;if(!i)return"";const o=i.job||"ATT",a=O[o],n=$e[i.rarity]||"#ccc",s=P(i,o),l=i.job2?P(i,i.job2):null,r=i.job2?O[i.job2]:null,d=_e(i),c=Ee[i.country_code]||i.country_code||"";return`
  <div style="
  ...
  </div>`}async function Oe(t,e){const{state:i,navigate:o,toast:a,openModal:n,closeModal:s}=e;t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:l}=await _.from("cards").select(`id, card_type, current_note, gc_type, formation, is_for_sale, sale_price,
      player:players(id, firstname, surname_encoded, country_code, club_id, job, job2,
        note_g, note_d, note_m, note_a, rarity, note_min, note_max, skin, hair, hair_length, sell_price,
        clubs(encoded_name, logo_url))`).eq("owner_id",i.profile.id),r=(l||[]).filter(u=>u.card_type==="player"&&u.player),d=(l||[]).filter(u=>u.card_type==="game_changer"),c=(l||[]).filter(u=>u.card_type==="formation"),y={};r.forEach(u=>{const h=u.player.id;y[h]=(y[h]||0)+1});let p="Tous",f="";function x(){return[...r].sort((u,h)=>{const b=le.indexOf(u.player.job),v=le.indexOf(h.player.job);return b!==v?b-v:(u.player.surname_encoded||"").localeCompare(h.player.surname_encoded||"")})}function m(){return x().filter(u=>{const h=u.player,b=p==="Tous"||h.job===p,v=!f||`${h.firstname} ${h.surname_encoded}`.toLowerCase().includes(f);return b&&v})}t.innerHTML=`
  <div class="page">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}function Ke(t,e){const i={"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2}},o={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},a=i[t]||i["4-4-2"],n=["ATT","MIL","DEF","GK"];function s(d,c){const x=(d-1)*54,m=(c-x)/2;return Array.from({length:d},(g,u)=>m+u*54)}function l(d){return d===1?[1]:d===2?[0,2]:d===3?[0,1,2]:d===4?[0,1,1,2]:d===5?[0,1,1,1,2]:[1]}function r(){const p=n.length*72+48,f=n.map((u,h)=>24+h*72+72/2),x={};n.forEach(u=>{x[u]=s(a[u],290)});function m(u,h){const b=a[u],v=l(b),$=x[u],E=v.indexOf(h);return E>=0?$[E]:null}let g=`<svg width="290" height="${p}" viewBox="0 0 290 ${p}" xmlns="http://www.w3.org/2000/svg">`;n.forEach((u,h)=>{const b=x[u];for(let v=0;v<b.length-1;v++){const $=b[v]+20,E=b[v+1]-20,w=f[h];g+=`<line x1="${$}" y1="${w}" x2="${E}" y2="${w}"
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}function He(t,e,i,o){var E,w,T,L,I,M;const{state:a,toast:n,openModal:s,closeModal:l,navigate:r,refreshProfile:d}=o,c=t.player,y=e.filter(A=>A.player.id===c.id),p=y.length,f=Ne[c.rarity]||1e3,x=c.rarity!=="legende",m=_e(c),g=P(c,c.job),u=c.job2?P(c,c.job2):null,h=O[c.job]||"#1A6B3C",b=c.job2?O[c.job2]:null,v=$e[c.rarity]||"#ccc",$=Ee[c.country_code]||c.country_code||"";s(`${c.firstname} ${c.surname_encoded}`,`<div style="display:flex;gap:16px;flex-wrap:wrap;justify-content:center">
  ...
  </div>`,document.getElementById("new-deck-btn").addEventListener("click",async()=>{const s=prompt("Nom du deck :",`Deck ${((n==null?void 0:n.length)||0)+1}`);if(!s)return;const{data:l,error:r}=await _.from("decks").insert({owner_id:i.profile.id,name:s,is_active:!(n!=null&&n.length)}).select().single();if(r){a(r.message,"error");return}a("Deck créé !","success"),ce(l.id,t,e)}),t.querySelectorAll("[data-edit]").forEach(s=>{s.addEventListener("click",()=>ce(s.dataset.edit,t,e))}),t.querySelectorAll("[data-activate]").forEach(s=>{s.addEventListener("click",async()=>{await _.from("decks").update({is_active:!1}).eq("owner_id",i.profile.id),await _.from("decks").update({is_active:!0}).eq("id",s.dataset.activate),a("Deck activé !","success"),Ie(t,e)})})}async function ce(t,e,i){const{state:o,toast:a}=i;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:n}=await _.from("decks").select("*").eq("id",t).single(),{data:s}=await _.from("cards").select(`id, card_type, formation,
      player:players(id, firstname, surname_encoded, country_code, club_id, job, job2,
        note_g, note_d, note_m, note_a, rarity, skin, hair, hair_length,
        clubs(encoded_name, logo_url))`).eq("owner_id",o.profile.id),l=(s||[]).filter(f=>f.card_type==="player"&&f.player),r=(s||[]).filter(f=>f.card_type==="formation"),d=r.map(f=>f.formation).filter(Boolean),{data:c}=await _.from("deck_cards").select("card_id, position, is_starter, slot_order").eq("deck_id",t);let y=n.formation||"4-4-2";d.length>0&&!d.includes(y)&&(y=d[0]);const p={deckId:t,name:n.name,formation:y,formationCardId:n.formation_card_id,slots:{},subs:[],playerCards:l,formationCards:r,availableFormations:d};(c||[]).forEach(f=>{f.is_starter?p.slots[f.position]=f.card_id:p.subs.includes(f.card_id)||p.subs.push(f.card_id)}),z(e,p,i)}function z(t,e,i){var r;const{navigate:o}=i;K[e.formation];const a=pe(e.formation),n=a.filter(d=>e.slots[d]).length,s=e.availableFormations.length>0?e.availableFormations:Object.keys(K),l=e.subs.map(d=>e.playerCards.find(c=>c.id===d)).filter(Boolean);[...Object.values(e.slots),...e.subs],t.innerHTML=`
  <div class="page">
  ...
  </div>`,Ue(t,e,a,i),document.getElementById("builder-back").addEventListener("click",()=>o("decks")),document.getElementById("formation-select").addEventListener("change",d=>{e.formation=d.target.value;const c=pe(e.formation),y={};c.forEach(p=>{e.slots[p]&&(y[p]=e.slots[p])}),e.slots=y,z(t,e,i)}),document.getElementById("save-deck").addEventListener("click",()=>Ye(e,i)),t.querySelectorAll("[data-remove-sub]").forEach(d=>{d.addEventListener("click",()=>{e.subs=e.subs.filter(c=>c!==d.dataset.removeSub),z(t,e,i)})}),(r=document.getElementById("add-sub-btn"))==null||r.addEventListener("click",()=>{Ve(e,t,i)})}function Ue(t,e,i,o){const a=document.getElementById("deck-field");if(!a)return;const n=e.formation,s=ke[n]||{},l=we[n]||[],r={};i.forEach(b=>{const v=e.slots[b],$=v?e.playerCards.find(E=>E.id===v):null;r[b]=($==null?void 0:$.player)||null});const d=i.filter(b=>b.startsWith("MIL"));let c=0,y=0;d.forEach(b=>{const v=r[b];v&&(c+=Number(v.note_m)||0)}),l.forEach(([b,v])=>{if(!b.startsWith("MIL")||!v.startsWith("MIL"))return;G(r[b],r[v])!=="#ff3333"&&y++});const p=320,f=320,x=28,m=4;function g(b){const v=s[b];return v?{x:v.x*p,y:v.y*f}:null}let u="";for(const[b,v]of l){const $=g(b),E=g(v);if(!$||!E)continue;const w=r[b],T=r[v],L=G(w,T),I=L==="#ff3333"?.3:.9,M=L!=="#ff3333"?`filter="url(#glow-${L.replace("#","")})"`:"";u+=`<line x1="${$.x}" y1="${$.y}" x2="${E.x}" y2="${E.y}"
      stroke="${L}" stroke-width="${m}" stroke-linecap="round"
      opacity="${I}" ${M}/>`}for(const b of i){const v=g(b);if(!v)continue;const $=r[b],E=b.replace(/\d+/,""),T={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[E]||"#555",L=$?Number(E==="GK"?$.note_g:E==="DEF"?$.note_d:E==="MIL"?$.note_m:$.note_a)||0:null,I=$?($.surname_encoded||"").slice(0,8).toUpperCase():"";if($){const M=te($);M&&(u+=`
          <defs>
            <clipPath id="clip-${b}">
    ...
    <svg viewBox="0 0 ${p} ${f}" width="100%" style="display:block;max-width:380px;margin:0 auto">
      ${h}
      ${u}
    </svg>`,a.querySelectorAll(".deck-slot-hit").forEach(b=>{b.addEventListener("click",()=>We(b.dataset.pos,e,t,o))})}function We(t,e,i,o){var p,f,x;const{openModal:a,closeModal:n}=o,s=t.replace(/\d+/,""),l=e.slots[t],r=l?e.playerCards.find(m=>m.id===l):null;(p=r==null?void 0:r.player)==null||p.id;const d=new Set;Object.entries(e.slots).forEach(([m,g])=>{var h;if(m===t||!g)return;const u=e.playerCards.find(b=>b.id===g);(h=u==null?void 0:u.player)!=null&&h.id&&d.add(u.player.id)}),e.subs.forEach(m=>{var u;const g=e.playerCards.find(h=>h.id===m);(u=g==null?void 0:g.player)!=null&&u.id&&d.add(g.player.id)});const c=new Set,y=e.playerCards.filter(m=>{const g=m.player;return!(g.job===s||g.job2===s)||d.has(g.id)||c.has(g.id)?!1:(c.add(g.id),!0)});y.sort((m,g)=>{const u=s==="GK"?m.player.note_g:s==="DEF"?m.player.note_d:s==="MIL"?m.player.note_m:m.player.note_a;return(s==="GK"?g.player.note_g:s==="DEF"?g.player.note_d:s==="MIL"?g.player.note_m:g.player.note_a)-u}),a(`Choisir ${s} — ${t}`,`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
      ${e.slots[t]?`
        <button class="btn btn-danger btn-sm" id="remove-player" style="width:100%;margin-bottom:4px">
          ✕ Retirer le joueur actuel
        </button>`:""}
      ${y.length>0?y.map(m=>{var v,$;const g=m.player,u=s==="GK"?g.note_g:s==="DEF"?g.note_d:s==="MIL"?g.note_m:g.note_a,h=te(g),b={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"}[g.rarity];return`<div class="player-option" data-card-id="${m.id}"
          style="display:flex;align-items:center;gap:10px;padding:8px;border:1.5px solid var(--gray-200);border-radius:10px;cursor:pointer">
          <!-- Portrait -->
          <div style="width:44px;height:44px;border-radius:8px;overflow:hidden;flex-shrink:0;background:#dde;border:2px solid ${F[s]}">
            ${h?`<img src="${h}" style="width:100%;height:100%;object-fit:cover">`:`<div style="width:100%;height:100%;background:${F[s]};display:flex;align-items:center;justify-content:center;color:#fff;font-size:10px;font-weight:700">${s}</div>`}
          </div>
          <!-- Infos -->
  ...
  <div class="page">
    ...
    <div class="page-body">
      <div class="booster-grid">
        ${fe.map(s=>{const l=a>=s.cost||s.cost===0,r=s.id==="players_std"||s.id==="players_pub";return`<div class="booster-card ${l?"":"disabled"}" data-booster="${s.id}" style="position:relative">
  ...
  `,document.body.appendChild(t),t.addEventListener("click",e=>{e.target===t&&t.remove()}),document.getElementById("odds-close").addEventListener("click",()=>t.remove())}function dt(){return new Promise(t=>{const e=document.createElement("div");e.style.cssText="position:fixed;inset:0;background:#000;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:4000;color:#fff;gap:16px";let i=5;e.innerHTML=`<div style="font-size:48px">📺</div>
      ...
      <div style="font-size:36px;font-weight:900" id="ad-cd">5</div>`,document.body.appendChild(e);const o=setInterval(()=>{i--;const a=document.getElementById("ad-cd");a&&(a.textContent=i),i<=0&&(clearInterval(o),e.remove(),t(!0))},1e3)})}const S={"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2}},W={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function Te(t,e,i,o,a){var n;t.innerHTML=`<div class="match-screen" style="display:flex;align-items:center;justify-content:center;min-height:100vh">
    <div style="text-align:center;padding:40px;color:#fff">
      <div style="font-size:48px;margin-bottom:16px">${e}</div>
      <p style="margin-bottom:16px">${i}</p>
      <button class="btn btn-primary" id="msg-btn">${o}</button>
    </div>
  </div>`,(n=document.getElementById("msg-btn"))==null||n.addEventListener("click",a)}function Ae(t){const e=typeof import.meta<"u"?"https://fcnwclxlkytdfjotqkta.supabase.co":"";if(!e||!(t!=null&&t.skin)||!(t!=null&&t.hair))return null;const i=t.hair==="chauve"?`${t.skin}-chauve-rase`:`${t.skin}-${t.hair}-${t.hair_length}`;return`${e}/storage/v1/object/public/assets/tetes/${i}.png`}function ye(t){const e=t.player;return{cardId:t.id,id:e.id,firstname:e.firstname,name:e.surname_encoded,country_code:e.country_code,club_id:e.club_id,job:e.job,job2:e.job2,note_g:Number(e.note_g)||0,note_d:Number(e.note_d)||0,note_m:Number(e.note_m)||0,note_a:Number(e.note_a)||0,rarity:e.rarity,skin:e.skin,hair:e.hair,hair_length:e.hair_length,boost:0,used:!1,_line:null,_col:null}}function ie(t){return t===1?[1]:t===2?[0,2]:t===3?[0,1,2]:t===4?[0,1,1,2]:t===5?[0,1,1,1,2]:[1]}function lt(){const t=Math.random()*100;return t<.1?4:t<5?3:t<20?2:1}function ct(t,e){const i=S[e]||S["4-4-2"],o={GK:[],DEF:[],MIL:[],ATT:[]},a=[...t];for(const n of["GK","DEF","MIL","ATT"]){const s=[];for(let r=0;r<i[n];r++){let d=a.findIndex(c=>c.job===n);if(d===-1&&(d=a.findIndex(c=>c.job2===n)),d===-1&&(d=0),a[d]){const c={...a[d],_line:n};s.push(c),a.splice(d,1)}}const l=ie(s.length);s.forEach((r,d)=>{r._col=l[d]}),o[n]=s}return o}async function pt(t,e){const{data:i}=await _.from("players").select("id,firstname,surname_encoded,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length").eq("is_active",!0).limit(60);if(!i||i.length<11)return ft(t);const o=S[t]||S["4-4-2"],a={GK:[],DEF:[],MIL:[],ATT:[]},n=[...i];for(const s of["GK","DEF","MIL","ATT"]){const l=n.filter(p=>p.job===s),r=n.filter(p=>p.job!==s),d=[...l,...r],c=[];for(let p=0;p<o[s];p++){const f=d[p]||n[p];f&&c.push({cardId:"ai-"+f.id+"-"+p,id:f.id,firstname:f.firstname,name:f.surname_encoded,country_code:f.country_code,club_id:f.club_id,job:f.job,job2:f.job2,note_g:Number(f.note_g)||0,note_d:Number(f.note_d)||0,note_m:Number(f.note_m)||0,note_a:Number(f.note_a)||0,rarity:f.rarity,skin:f.skin,hair:f.hair,hair_length:f.hair_length,boost:0,used:!1,_line:s})}const y=ie(c.length);c.forEach((p,f)=>{p._col=y[f]}),a[s]=c}return a}function ft(t){const e=S[t]||S["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},o=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let a=0;for(const n of["GK","DEF","MIL","ATT"]){const s=[];for(let r=0;r<e[n];r++){const d=3+Math.floor(Math.random()*5);s.push({cardId:"fake-"+a,id:"fake-"+a,firstname:"IA",name:o[a%o.length],country_code:"XX",club_id:null,job:n,job2:null,note_g:n==="GK"?d:2,note_d:n==="DEF"?d:2,note_m:n==="MIL"?d:2,note_a:n==="ATT"?d:2,rarity:"normal",boost:0,used:!1,_line:n}),a++}const l=ie(s.length);s.forEach((r,d)=>{r._col=l[d]}),i[n]=s}return i}async function ut(t,e){var v;const{state:i,navigate:o,toast:a}=e,n=i.params||{};t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const s=n.matchMode||"vs_ai_easy",l=s.replace("vs_ai_",""),r=s;if(!n.deckId)return yt(t,e,s);const d=n.deckId,{data:c}=await _.from("deck_cards").select(`position, is_starter, slot_order,
      card:cards(id, card_type, formation,
        player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
          clubs(encoded_name,logo_url)))`).eq("deck_id",d).order("slot_order"),y=(c||[]).filter($=>{var E;return $.is_starter&&((E=$.card)==null?void 0:E.player)}).map($=>ye($.card)),p=(c||[]).filter($=>{var E;return!$.is_starter&&((E=$.card)==null?void 0:E.player)}).map($=>ye($.card));if(y.length<11){Te(t,"⚠️",`Deck incomplet (${y.length}/11).`,"Compléter",()=>o("decks"));return}const f=(c||[]).find($=>{var E;return((E=$.card)==null?void 0:E.card_type)==="formation"}),x=((v=f==null?void 0:f.card)==null?void 0:v.formation)||"4-4-2",{data:m}=await _.from("cards").select("id,gc_type").eq("owner_id",i.profile.id).eq("card_type","game_changer"),g=ct(y,x),u=await pt(x),{data:h}=await _.from("matches").insert({home_id:i.profile.id,away_id:null,mode:r,home_deck_id:d,status:"in_progress"}).select().single(),b={matchId:h==null?void 0:h.id,mode:r,difficulty:l,formation:x,homeTeam:g,aiTeam:u,homeSubs:p,subsUsed:0,maxSubs:Math.min(p.length,3),homeScore:0,aiScore:0,gcCards:m||[],usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};gt(t,b,e)}async function yt(t,e,i){var s;const{state:o,navigate:a}=e,{data:n}=await _.from("decks").select("id,name,is_active,formation_card_id").eq("owner_id",o.profile.id).order("created_at",{ascending:!1});if(!n||n.length===0){Te(t,"📋","Aucun deck. Crée un deck avant de jouer !","Créer un deck",()=>a("decks"));return}t.innerHTML=`
  ...
  </div>`,t.querySelectorAll(".deck-select-card").forEach(l=>{l.addEventListener("mouseenter",()=>l.style.background="rgba(255,255,255,0.14)"),l.addEventListener("mouseleave",()=>l.style.background="rgba(255,255,255,0.08)"),l.addEventListener("click",()=>{e.navigate("match",{matchMode:i,deckId:l.dataset.deckId})})}),(s=document.getElementById("cancel-deck-select"))==null||s.addEventListener("click",()=>a("home"))}function gt(t,e,i){const o=e.homeTeam.MIL||[],a=e.aiTeam.MIL||[];function n(y){return y.reduce((p,f)=>p+C(f,"MIL"),0)}function s(y){let p=0;for(let f=0;f<y.length-1;f++)G(y[f],y[f+1])!=="#333"&&p++;return p}const l=n(o)+s(o),r=n(a)+s(a),d=l>=r;function c(y,p,f){return`<div style="text-align:center">
  ...
  <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;gap:20px;padding:20px">
    ...
    <div id="midfield-result" style="opacity:0;text-align:center;transition:opacity 0.5s;color:#fff">
      ...
      `,d&&(e.boostCard={value:x})}e.attacker=d?"home":"ai",e.log.push({text:`Duel milieu : ${e.clubName} ${l} – ${r} IA → ${d?e.clubName:"IA"} attaque en premier`,type:"info"}),setTimeout(()=>{e.phase=e.attacker==="home"?"attack":"ai-attack",D(t,e,i),e.attacker==="ai"&&setTimeout(()=>V(t,e,i),1e3)},2800)},1200)}function Me(t,e,i,o,a=310,n=310){const s=ke[e]||{},l=we[e]||[],r=26,d={},c=["ATT","MIL","DEF","GK"];for(const x of c)(t[x]||[]).forEach((g,u)=>{d[`${x}${u+1}`]=g});function y(x){const m=s[x];return m?{x:m.x*a,y:m.y*n}:null}let p="";for(const[x,m]of l){const g=y(x),u=y(m);if(!g||!u)continue;const h=d[x],b=d[m],v=G(h,b),$=v==="#ff3333"?.25:.9,E=v!=="#ff3333"?`filter="url(#glow${v.replace("#","").slice(0,6)})"`:"";p+=`<line x1="${g.x.toFixed(1)}" y1="${g.y.toFixed(1)}" x2="${u.x.toFixed(1)}" y2="${u.y.toFixed(1)}"
      stroke="${v}" stroke-width="3.5" stroke-linecap="round" opacity="${$}" ${E}/>`}for(const[x,m]of Object.entries(d)){const g=y(x);if(!g)continue;const u=x.replace(/[0-9]/g,""),b={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[u]||"#555",v=i==="attack"&&["MIL","ATT"].includes(u)&&!m.used||i==="defense"&&["GK","DEF","MIL"].includes(u)&&!m.used,$=o.includes(m.cardId);let E;i==="attack"?E=u==="MIL"?Number(m.note_m)||0:Number(m.note_a)||0:i==="defense"?E=u==="GK"?Number(m.note_g)||0:u==="MIL"?Number(m.note_m)||0:Number(m.note_d)||0:E=Number(u==="GK"?m.note_g:u==="DEF"?m.note_d:u==="MIL"?m.note_m:m.note_a)||0,E=E+(m.boost||0);const w=$?"#FFD700":v?"rgba(255,255,255,0.7)":"rgba(255,255,255,0.25)",T=$?3:2,L=m.used?.25:1,I=Ae(m);I&&(p+=`<defs><clipPath id="mc-${x}"><circle cx="${g.x}" cy="${g.y}" r="${r}"/></clipPath></defs>`),p+=`<circle cx="${g.x}" cy="${g.y}" r="${r}" fill="${b}" opacity="${L}"
      stroke="${w}" stroke-width="${T}"/>`,I&&!m.used&&(p+=`<image href="${I}" x="${g.x-r}" y="${g.y-r}" width="${r*2}" height="${r*2}"
        clip-path="url(#mc-${x})" preserveAspectRatio="xMidYMid slice" opacity="0.8"/>`,p+=`<circle cx="${g.x}" cy="${g.y}" r="${r}" fill="${b}" opacity="0.35"
        stroke="${w}" stroke-width="${T}"/>`),m.boost&&(p+=`<rect x="${g.x+r-10}" y="${g.y-r}" width="14" height="10" rx="3" fill="#87CEEB"/>
        <text x="${g.x+r-3}" y="${g.y-r+8}" text-anchor="middle" font-size="7" fill="#000" font-weight="900">+${m.boost}</text>`),p+=`<text x="${g.x}" y="${g.y-1}" text-anchor="middle" font-size="12" font-weight="900"
    ...
    <text x="${g.x}" y="${g.y+11}" text-anchor="middle" font-size="6" fill="rgba(255,255,255,${m.used?.3:.8})"
      font-family="Arial">${(m.name||"").slice(0,8)}</text>`,v&&(p+=`<circle cx="${g.x}" cy="${g.y}" r="${r}" fill="rgba(255,255,255,0.08)"
    ...
    ${Me(t,e,i,o)}
  </div>`}function D(t,e,i){var d,c,y,p;const o={attack:"⚔️ Choisissez vos attaquants",defense:"🛡️ Choisissez vos défenseurs","ai-attack":"🤖 L'IA attaque...","ai-defense":"🤖 L'IA défend...",finished:"🏁 Match terminé"}[e.phase]||"",a=e.selected.map(f=>f.cardId),n=e.usedSubIds||[],s=e.homeSubs.filter(f=>!n.includes(f.cardId)),l=Object.values(e.homeTeam).flat().filter(f=>f.used);t.innerHTML=`
  <div class="match-screen">
    ...
    <div class="match-log" id="match-log">
      ...
      <button class="btn btn-primary" id="confirm-attack" style="width:100%" ${r?"":"disabled"}>Attaquer →</button>`,(a=document.getElementById("confirm-attack"))==null||a.addEventListener("click",()=>xt(t,e,i))}else if(e.phase==="defense"){const r=e.selected.length>0?ee(e.selected.map(d=>({...d,_line:d._role})),e.modifiers.home):null;o.innerHTML=`
      <div style="text-align:center;color:#fff;margin-bottom:6px;font-size:13px">
      ...
      <button class="btn btn-primary" id="confirm-defense" style="width:100%" ${r?"":"disabled"}>Défendre →</button>`,(s=document.getElementById("confirm-defense"))==null||s.addEventListener("click",()=>bt(t,e,i))}else e.phase==="finished"?(o.innerHTML='<button class="btn btn-primary" id="end-match" style="width:100%">Voir les résultats</button>',(l=document.getElementById("end-match"))==null||l.addEventListener("click",()=>i.navigate("home"))):o.innerHTML=`<div style="text-align:center;color:rgba(255,255,255,.4);padding:8px;font-size:12px">⏳ Tour de l'IA...</div>`}function ht(t,e,i,o){const a=t.dataset.cardId,n=t.dataset.role,s=e.selected.findIndex(l=>l.cardId===a);if(s!==-1)e.selected.splice(s,1);else{if(e.selected.length>=3){o.toast("Maximum 3 joueurs","error");return}const l=(e.homeTeam[n]||[]).find(r=>r.cardId===a);l&&e.selected.push({...l,_role:n,_line:n})}D(i,e,o)}function xt(t,e,i){const o=e.selected.map(n=>({...n,_line:n._role})),a=Z(o,e.modifiers.home);e.pendingAttack={...a,players:[...e.selected],side:"home"},e.selected.forEach(n=>{const s=(e.homeTeam[n._role]||[]).find(l=>l.cardId===n.cardId);s&&(s.used=!0)}),e.log.push({text:`Vous attaquez : ${a.total} (${e.selected.map(n=>n.name).join(", ")})`,type:"info"}),e.selected=[],e.modifiers.home={},e.phase="ai-defense",D(t,e,i),setTimeout(()=>$t(t,e,i),1200)}function bt(t,e,i){const o=e.selected.map(s=>({...s,_line:s._role})),a=ee(o,e.modifiers.home);e.selected.forEach(s=>{const l=(e.homeTeam[s._role]||[]).find(r=>r.cardId===s.cardId);l&&(l.used=!0)});const n=xe(e.pendingAttack.total,a.total,e.modifiers.home);n.shielded?e.log.push({text:"🛡️ Bouclier ! But annulé.",type:"info"}):n.goal?(e.aiScore++,e.log.push({text:`⚽ BUT IA ! (${e.pendingAttack.total} > ${a.total})`,type:"goal"})):e.log.push({text:`🧤 Défense ! (${a.total} ≥ ${e.pendingAttack.total})`,type:"info"}),e.selected=[],e.modifiers.home={},e.pendingAttack=null,Ce(t,e,i,"home-attack")}function V(t,e,i){const o=[...e.aiTeam.MIL||[],...e.aiTeam.ATT||[]],a=be(o,"attack",e.difficulty);if(!a.length){Be(t,e,i);return}const n=Z(a,e.modifiers.ai);e.pendingAttack={...n,players:a,side:"ai"},a.forEach(s=>{s.used=!0}),e.log.push({text:`IA attaque : ${n.total}`,type:"info"}),e.modifiers.ai={},e.phase="defense",D(t,e,i)}function $t(t,e,i){const o=[...e.aiTeam.GK||[],...e.aiTeam.DEF||[],...e.aiTeam.MIL||[]],a=be(o,"defense",e.difficulty),n=a.length>0?ee(a,e.modifiers.ai).total:0;a.forEach(l=>{l.used=!0});const s=xe(e.pendingAttack.total,n,e.modifiers.ai);s.shielded?e.log.push({text:"🛡️ Bouclier IA !",type:"info"}):s.goal?(e.homeScore++,e.log.push({text:`⚽ BUT ! (${e.pendingAttack.total} > ${n})`,type:"goal"})):e.log.push({text:`🧤 IA défend (${n} ≥ ${e.pendingAttack.total})`,type:"info"}),e.modifiers.ai={},e.pendingAttack=null,Ce(t,e,i,"ai-attack")}function Ce(t,e,i,o){if(e.round++,De(e)){Y(t,e,i);return}if(o==="home-attack"){if(![...e.homeTeam.MIL||[],...e.homeTeam.ATT||[]].filter(n=>!n.used).length){if(![...e.homeTeam.GK||[],...e.homeTeam.DEF||[],...e.homeTeam.MIL||[]].filter(s=>!s.used).length){Y(t,e,i);return}e.phase="ai-attack",D(t,e,i),setTimeout(()=>V(t,e,i),800);return}e.phase="attack",D(t,e,i)}else{if(![...e.aiTeam.MIL||[],...e.aiTeam.ATT||[]].filter(n=>!n.used).length){Be(t,e,i);return}e.phase="ai-attack",D(t,e,i),setTimeout(()=>V(t,e,i),800)}}function De(t){const e=["MIL","ATT","GK","DEF"].some(o=>(t.homeTeam[o]||[]).some(a=>!a.used)),i=["MIL","ATT","GK","DEF"].some(o=>(t.aiTeam[o]||[]).some(a=>!a.used));return!e&&!i}function Be(t,e,i){De(e)?Y(t,e,i):(e.phase="attack",D(t,e,i))}function Et(t,e,i){const o=Object.values(e.homeTeam).flat().filter(a=>!a.used);if(!o.length){i.toast("Aucun joueur actif à booster","error");return}i.openModal("⚡ Utiliser le Boost",`<div style="margin-bottom:12px;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border-radius:10px;padding:12px;text-align:center;color:#000">
    ...
    <div style="display:flex;flex-direction:column;gap:6px">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Annuler</button>`),document.querySelectorAll(".player-boost-opt").forEach(a=>{a.addEventListener("click",()=>{const n=a.dataset.cardId;for(const s of["GK","DEF","MIL","ATT"]){const l=(e.homeTeam[s]||[]).find(r=>r.cardId===n);if(l){l.boost=(l.boost||0)+e.boostCard.value,e.log.push({text:`⚡ Boost +${e.boostCard.value} appliqué à ${l.name}`,type:"info"});break}}e.boostUsed=!0,i.closeModal(),D(t,e,i)})})}function _t(t,e,i){e.usedSubIds||(e.usedSubIds=[]);const o=Object.values(e.homeTeam).flat().filter(r=>r.used),a=e.homeSubs.filter(r=>!e.usedSubIds.includes(r.cardId));if(!o.length){i.toast("Aucun joueur grisé","info");return}if(!a.length){i.toast("Aucun remplaçant disponible","info");return}if(e.subsUsed>=e.maxSubs){i.toast(`Maximum ${e.maxSubs} remplacements`,"error");return}i.openModal("🔄 Remplacement",`<div style="margin-bottom:12px">
      ...
      ${o.map(r=>`
        <div class="grayed-opt" data-card-id="${r.cardId}" data-role="${r._line}"
          ...
          <div style="width:28px;height:28px;background:${W[r.job]||"#888"};border-radius:5px;display:flex;align-items:center;justify-content:center;color:#fff;font-size:10px;font-weight:900">${r._line}</div>
    ...
    <div>
      ...
      ${a.map(r=>`
        <div class="sub-opt" data-card-id="${r.cardId}"
          ...
          <div style="width:28px;height:28px;background:${W[r.job]||"#888"};border-radius:5px;display:flex;align-items:center;justify-content:center;color:#fff;font-size:10px;font-weight:900">${r.job}</div>
          <div><b>${r.firstname} ${r.name}</b></div>
        </div>`).join("")}
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Annuler</button>`);let n=null,s=null;document.querySelectorAll(".grayed-opt").forEach(r=>{r.addEventListener("click",()=>{document.querySelectorAll(".grayed-opt").forEach(d=>d.style.borderColor="#eee"),r.style.borderColor="#c0392b",n={cardId:r.dataset.cardId,role:r.dataset.role},l()})}),document.querySelectorAll(".sub-opt").forEach(r=>{r.addEventListener("click",()=>{document.querySelectorAll(".sub-opt").forEach(d=>d.style.borderColor="var(--green)"),r.style.borderColor="#D4A017",s=r.dataset.cardId,l()})});function l(){if(!n||!s)return;const r=n.role,d=e.homeTeam[r]||[],c=d.findIndex(p=>p.cardId===n.cardId),y=e.homeSubs.find(p=>p.cardId===s);c!==-1&&y&&(y._line=r,y._col=d[c]._col,y.used=!1,d.splice(c,1,y),e.usedSubIds=[...e.usedSubIds||[],s],e.subsUsed++,e.log.push({text:`🔄 Remplacement : ${y.firstname} ${y.name} entre`,type:"info"})),i.closeModal(),D(t,e,i)}}function wt(t,e,i,o,a){if(!o.usedGc.includes(t)){switch(o.usedGc.push(t),e){case"Double attaque":o.modifiers.home.doubleAttack=!0,o.log.push({text:"⚡ Double attaque !",type:"info"});break;case"Bouclier":o.modifiers.home.shield=!0,o.log.push({text:"🛡️ Bouclier !",type:"info"});break;case"Ressusciter":{let n=!1;for(const s of["ATT","MIL","DEF","GK"]){const l=(o.homeTeam[s]||[]).find(r=>r.used);if(l){l.used=!1,n=!0;break}}o.log.push({text:n?"💫 Joueur ressuscité !":"💫 Aucun joueur à ressusciter",type:"info"});break}case"Vol de note":o.modifiers.ai.stolenNote=(o.modifiers.ai.stolenNote||0)+1,o.log.push({text:"🎯 -1 à la prochaine IA",type:"info"});break;case"Gel":{const n=[...o.aiTeam.ATT||[],...o.aiTeam.MIL||[]].filter(s=>!s.used);if(n.length){const s=n.sort((l,r)=>C(r,"ATT")-C(l,"ATT"))[0];s.used=!0,o.log.push({text:`❄️ ${s.name} (IA) gelé !`,type:"info"})}break}case"Remplacement+":o.maxSubs++,o.log.push({text:"🔄 +1 remplacement",type:"info"});break}_.from("cards").delete().eq("id",t).then(()=>{}),D(i,o,a)}}async function Y(t,e,i){var c,y;e.phase="finished";const{state:o}=i,a=e.homeScore>e.aiScore,n=e.homeScore===e.aiScore,s=a?"victoire":n?"nul":"defaite",l=Ge(e.mode,s);e.matchId&&await _.from("matches").update({status:"finished",home_score:e.homeScore,away_score:e.aiScore,winner_id:a?o.profile.id:null,home_credits_reward:l,played_at:new Date().toISOString()}).eq("id",e.matchId);const r={credits:(o.profile.credits||0)+l,matches_played:(o.profile.matches_played||0)+1};a?r.wins=(o.profile.wins||0)+1:n?r.draws=(o.profile.draws||0)+1:r.losses=(o.profile.losses||0)+1,await _.from("users").update(r).eq("id",o.profile.id),await i.refreshProfile();const d=document.createElement("div");d.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.85);display:flex;align-items:center;justify-content:center;z-index:2000",d.innerHTML=`
    ...
    </div>`,`<button class="btn btn-primary" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const It={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"};async function Lt(t,e){const{state:i,toast:o}=e;t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement du marché...</div>',await oe(t,e)}async function oe(t,e){const{state:i,toast:o}=e,{data:a}=await _.from("market_listings").select(`id, price, status, listed_at, seller_id,
  ...
  `;function l(r){const d=document.getElementById("mkt-content"),c=r==="buy"?s:n;if(c.length===0){d.innerHTML=`<div style="text-align:center;color:var(--gray-600);padding:40px">
      ...
      ${c.map(y=>{var g,u,h;const p=(g=y.card)==null?void 0:g.player;if(!p)return"";const f=p.job==="GK"?p.note_g:p.job==="DEF"?p.note_d:p.job==="MIL"?p.note_m:p.note_a,x=It[p.rarity],m=(i.profile.credits||0)>=y.price;return`<div class="card-panel" style="display:flex;align-items:center;gap:12px;padding:12px">
          ...
          <div style="text-align:right;flex-shrink:0">
            ...
            ${r==="buy"?`<button class="btn btn-primary btn-sm" data-buy="${y.id}" ${m?"":"disabled"} style="margin-top:4px">${m?"Acheter":"Trop cher"}</button>`:`<button class="btn btn-danger btn-sm" data-cancel="${y.id}" style="margin-top:4px">Retirer</button>`}
          </div>
        </div>`}).join("")}
    </div>`,d.querySelectorAll("[data-buy]").forEach(y=>{y.addEventListener("click",()=>Tt(y.dataset.buy,c,t,e))}),d.querySelectorAll("[data-cancel]").forEach(y=>{y.addEventListener("click",()=>At(y.dataset.cancel,t,e))})}l("buy"),t.querySelectorAll(".mkt-tab").forEach(r=>{r.addEventListener("click",()=>{t.querySelectorAll(".mkt-tab").forEach(d=>{const c=d===r;d.style.background=c?"var(--green)":"#fff",d.style.color=c?"#fff":"var(--gray-600)",d.style.borderColor=c?"var(--green)":"var(--gray-200)"}),l(r.dataset.tab)})})}async function Tt(t,e,i,o){const{state:a,toast:n,refreshProfile:s}=o,l=e.find(r=>r.id===t);if(l){if((a.profile.credits||0)<l.price){n("Crédits insuffisants","error");return}if(confirm(`Acheter ${l.card.player.firstname} ${l.card.player.surname_encoded} pour ${l.price.toLocaleString("fr")} crédits ?`))try{const{error:r}=await _.from("cards").update({owner_id:a.profile.id,is_for_sale:!1,sale_price:null}).eq("id",l.card.id);if(r)throw r;await _.from("market_listings").update({status:"sold",buyer_id:a.profile.id,sold_at:new Date().toISOString()}).eq("id",t),await _.from("users").update({credits:(a.profile.credits||0)-l.price}).eq("id",a.profile.id);const{data:d}=await _.from("users").select("credits").eq("id",l.seller_id).single();d&&await _.from("users").update({credits:(d.credits||0)+l.price}).eq("id",l.seller_id),await _.from("notifications").insert({user_id:l.seller_id,type:"card_sold",message:`Ta carte ${l.card.player.surname_encoded} a été vendue pour ${l.price} crédits !`,data:{card_id:l.card.id,price:l.price}}),await s(),n("Carte achetée ! ✅","success"),oe(i,o)}catch(r){n("Erreur : "+r.message,"error")}}}async function At(t,e,i){const{toast:o}=i,{data:a}=await _.from("market_listings").select("card_id").eq("id",t).single();await _.from("market_listings").update({status:"cancelled"}).eq("id",t),a&&await _.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",a.card_id),o("Annonce retirée","success"),oe(e,i)}function Mt(t){return{GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[t]||"#888"}async function Ct(t,{state:e,navigate:i,toast:o}){t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:a}=await _.from("users").select("id,pseudo,club_name,trophies_top1,trophies_top2,trophies_top3,wins,level").order("trophies_top1",{ascending:!1}).limit(100);t.innerHTML=`
  <div class="page">
    <div class="page-header">
  ...
  `}const k={user:null,profile:null,page:"home",params:{}};function R(t,e="info",i=3e3){const o=document.getElementById("toast");o&&(o.textContent=t,o.className=`show ${e}`,clearTimeout(o._t),o._t=setTimeout(()=>{o.className=""},i))}function Dt(t,e,i=""){document.getElementById("modal-title").textContent=t,document.getElementById("modal-body").innerHTML=e,document.getElementById("modal-footer").innerHTML=i,document.getElementById("modal-overlay").classList.remove("hidden")}function J(){document.getElementById("modal-overlay").classList.add("hidden")}async function N(){if(!k.user)return;const{data:t}=await _.from("users").select("*").eq("id",k.user.id).single();t&&(k.profile=t)}const ne="mw_theme";function H(){return localStorage.getItem(ne)||"dark"}function Bt(t){var e;localStorage.setItem(ne,t),X(t),(e=k.profile)!=null&&e.id&&_.from("users").update({theme:t}).eq("id",k.profile.id).then(()=>{})}function X(t){document.documentElement.setAttribute("data-theme",t)}function q(t,e={}){k.page=t,k.params=e,je()}async function je(){const t=document.getElementById("page-content");if(!t)return;document.querySelectorAll(".bottom-nav a").forEach(o=>{o.classList.toggle("active",o.dataset.page===k.page)});const e=document.getElementById("nav-credits");e&&k.profile&&(e.textContent=`💰 ${(k.profile.credits||0).toLocaleString("fr")}`);const i={state:k,navigate:q,toast:R,openModal:Dt,closeModal:J,refreshProfile:N};switch(t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',k.page){case"home":await ae(t,i);break;case"collection":await Oe(t,i);break;case"decks":await Ie(t,i);break;case"boosters":await Ze(t,i);break;case"match":await ut(t,i);break;case"market":await Lt(t,i);break;case"rankings":await Ct(t,i);break;default:await ae(t,i)}}function jt(){const t=document.getElementById("app"),e=k.profile;if(!e)return;const i="/manager-wars/icons/";t.innerHTML=`
    <nav class="top-nav">
      <div class="logo" id="nav-logo">
        <img src="${i}logo.png" alt="Manager Wars" style="height:36px;width:auto;display:block">
    ...
    <nav class="bottom-nav">
      <a href="#" data-page="home" class="active">
        <span class="icon"><img src="${i}nav-home.png" alt="Accueil" style="height:26px;width:auto;display:block"></span>
        <span>Accueil</span>
      </a>
      <a href="#" data-page="collection">
        <span class="icon"><img src="${i}nav-collection.png" alt="Cartes" style="height:26px;width:auto;display:block"></span>
        <span>Cartes</span>
      </a>
      <a href="#" data-page="decks">
        <span class="icon"><img src="${i}nav-decks.png" alt="Decks" style="height:26px;width:auto;display:block"></span>
        <span>Decks</span>
      </a>
      <a href="#" data-page="boosters">
        <span class="icon"><img src="${i}nav-boosters.png" alt="Boosters" style="height:26px;width:auto;display:block"></span>
        <span>Boosters</span>
      </a>
      <a href="#" data-page="market">
        <span class="icon"><img src="${i}nav-market.png" alt="Marché" style="height:26px;width:auto;display:block"></span>
        <span>Marché</span>
      </a>
    </nav>
