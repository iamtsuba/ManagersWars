import{s as w}from"./supabase-B22JUf_T.js";function re(t,{navigate:e,toast:i}){t.innerHTML=`
    ...
    <div class="page-body">
      ...
      <div>
        ...
        <div class="card-panel" style="padding:0">
          ${n.map(l=>{const s=l.winner_id===a.id,d=l.home_score===l.away_score,c=d?"N":s?"V":"D",y=d?"#888":s?"#1A6B3C":"#c0392b",p={vs_ai_easy:"IA Facile",vs_ai_medium:"IA Moyen",vs_ai_hard:"IA Difficile",vs_ai_club:"IA Club",friend_challenge:"Défi ami",championship:"Championnat"}[l.mode]||l.mode,m=new Date(l.created_at).toLocaleDateString("fr",{month:"short",day:"numeric"});return`<div style="display:flex;justify-content:space-between;align-items:center;padding:10px 14px;border-bottom:1px solid var(--gray-200)">
              <div>
  ...
  `,document.body.appendChild(i);const o=()=>i.remove();document.getElementById("diff-cancel").addEventListener("click",o),i.addEventListener("click",a=>{a.target===i&&o()}),i.querySelectorAll("[data-mode]").forEach(a=>{a.addEventListener("click",()=>{o(),t("match",{matchMode:a.dataset.mode})})})}const Q={Ressusciter:{icon:"💫",desc:"Réactive un joueur grisé pour ce match."},"Double attaque":{icon:"⚡",desc:"La note d'attaque compte double."},Bouclier:{icon:"🛡️",desc:"Annule le prochain but adverse."},"Vol de note":{icon:"🎯",desc:"-1 à la note d'un joueur adverse."},Gel:{icon:"❄️",desc:"Bloque le meilleur attaquant IA."},"Remplacement+":{icon:"🔄",desc:"+1 remplacement pour ce match."}};function D(t,e){if(!t)return 0;switch(e){case"GK":return Number(t.note_g)||0;case"DEF":return Number(t.note_d)||0;case"MIL":return Number(t.note_m)||0;case"ATT":return Number(t.note_a)||0;default:return 0}}const de=["ATT","MIL","DEF","GK"];function xe(t){let e=0;const i=t.length;for(let o=0;o<i;o++)for(let a=o+1;a<i;a++){const n=t[o],r=t[a];if(!n||!r)continue;const l=n._col!==void 0&&r._col!==void 0&&n._col===r._col,s=n._col!==void 0&&r._col!==void 0&&Math.abs(n._col-r._col)===1,d=de.indexOf(n._line),c=de.indexOf(r._line),y=Math.abs(d-c)===1;(n._line===r._line&&s||l&&y)&&(n.country_code&&r.country_code&&n.country_code===r.country_code&&e++,n.club_id&&r.club_id&&n.club_id===r.club_id&&e++)}return e}function Z(t,e={}){const i=t.reduce((n,r)=>{const l=r._line||r.job;return n+Number(l==="MIL"?r.note_m:r.note_a)||0},0),o=xe(t);let a=i+o;return e.doubleAttack&&(a*=2),e.stolenNote&&(a-=e.stolenNote),{base:i,links:o,total:Math.max(0,a)}}function ee(t,e={}){const i=t.reduce((n,r)=>{const l=r._line||r.job;let s=0;return l==="GK"?s=Number(r.note_g)||0:l==="MIL"?s=Number(r.note_m)||0:s=Number(r.note_d)||0,n+s},0),o=xe(t);let a=i+o;return e.stolenNote&&(a-=e.stolenNote),{base:i,links:o,total:Math.max(0,a)}}function he(t,e,i={}){return i.shield?{goal:!1,shielded:!0}:{goal:t>e,shielded:!1}}function be(t,e,i="easy"){const o=t.filter(r=>!r.used);if(!o.length)return[];const a=[...o].sort((r,l)=>{const s=e==="attack"?D(r,"ATT"):r._line==="GK"?D(r,"GK"):D(r,"DEF");return(e==="attack"?D(l,"ATT"):l._line==="GK"?D(l,"GK"):D(l,"DEF"))-s});let n=i==="easy"?1+Math.floor(Math.random()*2):i==="medium"?2+Math.floor(Math.random()*2):3;return a.slice(0,Math.min(n,a.length,3))}function Ge(t,e){const i={vs_ai_easy:{victoire:500,nul:250,defaite:50},vs_ai_medium:{victoire:1e3,nul:500,defaite:50},vs_ai_hard:{victoire:1500,nul:750,defaite:100},vs_ai_club:{victoire:2500,nul:1250,defaite:100}};return(i[t]||i.vs_ai_easy)[e]||0}const Ee={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"},K={GK:"#111111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},le=["GK","DEF","MIL","ATT"],Re=["Tous","GK","DEF","MIL","ATT"],Ne={normal:1e3,pepite:5e3,papyte:5e3,legende:1e4},$e={MA:"MAROC",FR:"FRANCE",AR:"ARGENTINE",PT:"PORTUGAL",BR:"BRESIL",ES:"ESPAGNE",DE:"ALLEMAGNE",GB:"ANGLETERRE",IT:"ITALIE",CM:"CAMEROUN",SN:"SENEGAL",NG:"NIGERIA",DK:"DANEMARK",NL:"PAYS-BAS",BE:"BELGIQUE",CI:"CÔTE D'IVOIRE",AL:"ALBANIE",HR:"CROATIE",RS:"SERBIE",TR:"TURQUIE"};function we(t){const e="https://fcnwclxlkytdfjotqkta.supabase.co";if(!(t!=null&&t.skin)||!(t!=null&&t.hair))return null;const i=t.hair==="chauve"?`${t.skin}-chauve-rase`:`${t.skin}-${t.hair}-${t.hair_length}`;return`${e}/storage/v1/object/public/assets/tetes/${i}.png`}function O(t,e){return t&&Number(e==="GK"?t.note_g:e==="DEF"?t.note_d:e==="MIL"?t.note_m:t.note_a)||0}function qe(t,e=""){var y,p;const i=t.player;if(!i)return"";const o=i.job||"ATT",a=K[o],n=Ee[i.rarity]||"#ccc",r=O(i,o),l=i.job2?O(i,i.job2):null,s=i.job2?K[i.job2]:null,d=we(i),c=$e[i.country_code]||i.country_code||"";return`
  <div style="
  ...
  </div>`}async function Ke(t,e){const{state:i,navigate:o,toast:a,openModal:n,closeModal:r}=e;t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:l}=await w.from("cards").select(`id, card_type, current_note, gc_type, formation, is_for_sale, sale_price,
      player:players(id, firstname, surname_encoded, country_code, club_id, job, job2,
        note_g, note_d, note_m, note_a, rarity, note_min, note_max, skin, hair, hair_length, sell_price,
        clubs(encoded_name, logo_url))`).eq("owner_id",i.profile.id),s=(l||[]).filter(u=>u.card_type==="player"&&u.player),d=(l||[]).filter(u=>u.card_type==="game_changer"),c=(l||[]).filter(u=>u.card_type==="formation"),y={};s.forEach(u=>{const v=u.player.id;y[v]=(y[v]||0)+1});let p="Tous",f="";function m(){return[...s].sort((u,v)=>{const b=le.indexOf(u.player.job),h=le.indexOf(v.player.job);return b!==h?b-h:(u.player.surname_encoded||"").localeCompare(v.player.surname_encoded||"")})}function x(){return m().filter(u=>{const v=u.player,b=p==="Tous"||v.job===p,h=!f||`${v.firstname} ${v.surname_encoded}`.toLowerCase().includes(f);return b&&h})}t.innerHTML=`
  <div class="page">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}function Pe(t,e){const i={"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2}},o={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},a=i[t]||i["4-4-2"],n=["ATT","MIL","DEF","GK"];function r(d,c){const m=(d-1)*54,x=(c-m)/2;return Array.from({length:d},(g,u)=>x+u*54)}function l(d){return d===1?[1]:d===2?[0,2]:d===3?[0,1,2]:d===4?[0,1,1,2]:d===5?[0,1,1,1,2]:[1]}function s(){const p=n.length*72+48,f=n.map((u,v)=>24+v*72+72/2),m={};n.forEach(u=>{m[u]=r(a[u],290)});function x(u,v){const b=a[u],h=l(b),E=m[u],$=h.indexOf(v);return $>=0?E[$]:null}let g=`<svg width="290" height="${p}" viewBox="0 0 290 ${p}" xmlns="http://www.w3.org/2000/svg">`;n.forEach((u,v)=>{const b=m[u];for(let h=0;h<b.length-1;h++){const E=b[h]+20,$=b[h+1]-20,_=f[v];g+=`<line x1="${E}" y1="${_}" x2="${$}" y2="${_}"
          stroke="rgba(255,255,255,0.35)" stroke-width="2" stroke-dasharray="4,3"/>`,g+=`<text x="${(E+$)/2}" y="${_-6}" text-anchor="middle"
          font-size="8" fill="rgba(255,255,255,0.45)">↔</text>`}});for(let u=0;u<3;u++)for(let v=0;v<n.length-1;v++){const b=n[v],h=n[v+1],E=x(b,u),$=x(h,u);if(E!==null&&$!==null){const _=(E+$)/2;g+=`<line x1="${E}" y1="${f[v]+20}" x2="${$}" y2="${f[v+1]-20}"
            stroke="rgba(255,255,255,0.35)" stroke-width="2" stroke-dasharray="4,3"/>`,g+=`<text x="${_+6}" y="${(f[v]+f[v+1])/2+3}"
            font-size="8" fill="rgba(255,255,255,0.45)">↕</text>`}}return n.forEach((u,v)=>{const b=a[u],h=m[u],E=l(b),$=o[u],_=f[v],T={};E.forEach((L,I)=>{T[L]||(T[L]={xs:[],indices:[]}),T[L].xs.push(h[I]),T[L].indices.push(I)}),Object.entries(T).forEach(([L,I])=>{const M=I.xs.length;if(M>1){const A=I.xs.reduce((B,U)=>B+U,0)/M;g+=`<circle cx="${A}" cy="${_}" r="20" fill="${$}" stroke="rgba(255,255,255,0.6)" stroke-width="2"/>`,g+=`<text x="${A}" y="${_-4}" text-anchor="middle" font-size="9" font-weight="900" fill="white" font-family="Arial Black,Arial">${u}</text>`,g+=`<text x="${A}" y="${_+9}" text-anchor="middle" font-size="8" font-weight="700" fill="rgba(255,255,255,0.85)">×${M}</text>`}else{const A=I.xs[0],B=I.indices[0]+1;g+=`<circle cx="${A}" cy="${_}" r="20" fill="${$}" stroke="rgba(255,255,255,0.6)" stroke-width="2"/>`,g+=`<text x="${A}" y="${_+4}" text-anchor="middle" font-size="9" font-weight="900" fill="white" font-family="Arial Black,Arial">${u}</text>`,g+=`<text x="${A}" y="${_+30}" text-anchor="middle" font-size="7" fill="rgba(255,255,255,0.4)">${u}${B}</text>`}})}),g+="</svg>",g}e(`Formation ${t}`,`<div style="background:linear-gradient(180deg,#1a6b3c,#0a3d1e);border-radius:12px;padding:16px;margin-bottom:14px;overflow-x:auto;text-align:center">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}function He(t,e,i,o){var $,_,T,L,I,M;const{state:a,toast:n,openModal:r,closeModal:l,navigate:s,refreshProfile:d}=o,c=t.player,y=e.filter(A=>A.player.id===c.id),p=y.length,f=Ne[c.rarity]||1e3,m=c.rarity!=="legende",x=we(c),g=O(c,c.job),u=c.job2?O(c,c.job2):null,v=K[c.job]||"#1A6B3C",b=c.job2?K[c.job2]:null,h=Ee[c.rarity]||"#ccc",E=$e[c.country_code]||c.country_code||"";r(`${c.firstname} ${c.surname_encoded}`,`<div style="display:flex;gap:16px;flex-wrap:wrap;justify-content:center">
      ...
      <div style="width:140px;border-radius:12px;padding:6px;background:${h};flex-shrink:0">
        <div style="background:#f2e8d2;border-radius:8px;overflow:hidden;display:flex;flex-direction:column">
          ...
          <div style="background:#f2e8d2;padding:3px 6px;display:flex;align-items:center;justify-content:space-between;min-height:24px">
            ...
            ${($=c.clubs)!=null&&$.logo_url?`<img src="${c.clubs.logo_url}" style="width:22px;height:16px;object-fit:contain">`:`<div style="background:#1a3a7a;color:#fff;border-radius:2px;padding:1px 3px;font-size:6px;font-weight:800">${(((_=c.clubs)==null?void 0:_.encoded_name)||"").slice(0,6)}</div>`}
          </div>
        </div>
      </div>
    ...
    </div>`:""}`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(T=document.getElementById("close-detail"))==null||T.addEventListener("click",l),(L=document.getElementById("direct-sell-btn"))==null||L.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte ${c.surname_encoded} pour ${f.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const A=y.find(U=>!U.is_for_sale)||y[0];if(!A){n("Aucune carte à vendre","error");return}const{error:B}=await w.from("cards").delete().eq("id",A.id);if(B){n(B.message,"error");return}await w.from("users").update({credits:(a.profile.credits||0)+f}).eq("id",a.profile.id),await d(),n(`+${f.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),l(),s("collection")}),(I=document.getElementById("market-sell-btn"))==null||I.addEventListener("click",async()=>{const A=parseInt(document.getElementById("sell-price").value);if(!A||A<1){n("Prix invalide","error");return}await w.from("cards").update({is_for_sale:!0,sale_price:A}).eq("id",t.id),await w.from("market_listings").insert({seller_id:a.profile.id,card_id:t.id,price:A}),n("Carte mise en vente sur le marché !","success"),l(),s("collection")}),(M=document.getElementById("cancel-sell-btn"))==null||M.addEventListener("click",async()=>{await w.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",t.id),await w.from("market_listings").update({status:"cancelled"}).eq("card_id",t.id).eq("status","active"),n("Annonce retirée","success"),l(),s("collection")})}const _e={"4-4-2":[["ATT1","ATT2"],["MIL1","MIL2"],["MIL2","MIL3"],["MIL3","MIL4"],["DEF1","DEF2"],["DEF2","DEF3"],["DEF3","DEF4"],["ATT1","MIL1"],["ATT1","MIL2"],["ATT2","MIL3"],["ATT2","MIL4"],["MIL1","DEF1"],["MIL1","DEF2"],["MIL2","DEF2"],["MIL3","DEF3"],["MIL4","DEF3"],["MIL4","DEF4"],["DEF1","GK1"],["DEF2","GK1"],["DEF3","GK1"],["DEF4","GK1"]],"4-3-3":[["ATT1","ATT2"],["ATT2","ATT3"],["MIL1","MIL2"],["MIL2","MIL3"],["DEF1","DEF2"],["DEF2","DEF3"],["DEF3","DEF4"],["ATT1","MIL1"],["ATT2","MIL2"],["ATT3","MIL3"],["MIL1","DEF1"],["MIL1","DEF2"],["MIL2","DEF2"],["MIL2","DEF3"],["MIL3","DEF3"],["MIL3","DEF4"],["DEF1","GK1"],["DEF2","GK1"],["DEF3","GK1"],["DEF4","GK1"]],"3-4-3":[["ATT1","ATT2"],["ATT2","ATT3"],["MIL1","MIL2"],["MIL2","MIL3"],["MIL3","MIL4"],["DEF1","DEF2"],["DEF2","DEF3"],["ATT1","MIL1"],["ATT2","MIL2"],["ATT2","MIL3"],["ATT3","MIL4"],["MIL1","DEF1"],["MIL2","DEF1"],["MIL2","DEF2"],["MIL3","DEF2"],["MIL3","DEF3"],["MIL4","DEF3"],["DEF1","GK1"],["DEF2","GK1"],["DEF3","GK1"]],"3-5-2":[["ATT1","ATT2"],["MIL1","MIL2"],["MIL2","MIL3"],["MIL3","MIL4"],["MIL4","MIL5"],["DEF1","DEF2"],["DEF2","DEF3"],["ATT1","MIL1"],["ATT1","MIL2"],["ATT2","MIL4"],["ATT2","MIL5"],["MIL1","DEF1"],["MIL2","DEF1"],["MIL2","DEF2"],["MIL3","DEF2"],["MIL4","DEF2"],["MIL4","DEF3"],["MIL5","DEF3"],["DEF1","GK1"],["DEF2","GK1"],["DEF3","GK1"]],"5-3-2":[["ATT1","ATT2"],["MIL1","MIL2"],["MIL2","MIL3"],["DEF1","DEF2"],["DEF2","DEF3"],["DEF3","DEF4"],["DEF4","DEF5"],["ATT1","MIL1"],["ATT2","MIL3"],["MIL1","DEF1"],["MIL1","DEF2"],["MIL2","DEF2"],["MIL2","DEF3"],["MIL2","DEF4"],["MIL3","DEF4"],["MIL3","DEF5"],["DEF1","GK1"],["DEF2","GK1"],["DEF3","GK1"],["DEF4","GK1"],["DEF5","GK1"]]};function G(t,e){if(!t||!e)return"#cc2222";const i=t.country_code&&e.country_code&&t.country_code===e.country_code,o=t.club_id&&e.club_id&&t.club_id===e.club_id;return i&&o?"#00ff88":i||o?"#FFD700":"#ff3333"}const ke={"4-4-2":{ATT1:{x:.3,y:.04},ATT2:{x:.7,y:.04},MIL1:{x:.1,y:.3},MIL2:{x:.37,y:.3},MIL3:{x:.63,y:.3},MIL4:{x:.9,y:.3},DEF1:{x:.1,y:.6},DEF2:{x:.37,y:.6},DEF3:{x:.63,y:.6},DEF4:{x:.9,y:.6},GK1:{x:.5,y:.88}},"4-3-3":{ATT1:{x:.2,y:.04},ATT2:{x:.5,y:.04},ATT3:{x:.8,y:.04},MIL1:{x:.2,y:.33},MIL2:{x:.5,y:.33},MIL3:{x:.8,y:.33},DEF1:{x:.1,y:.62},DEF2:{x:.37,y:.62},DEF3:{x:.63,y:.62},DEF4:{x:.9,y:.62},GK1:{x:.5,y:.88}},"3-4-3":{ATT1:{x:.2,y:.04},ATT2:{x:.5,y:.04},ATT3:{x:.8,y:.04},MIL1:{x:.1,y:.33},MIL2:{x:.37,y:.33},MIL3:{x:.63,y:.33},MIL4:{x:.9,y:.33},DEF1:{x:.2,y:.62},DEF2:{x:.5,y:.62},DEF3:{x:.8,y:.62},GK1:{x:.5,y:.88}},"3-5-2":{ATT1:{x:.3,y:.04},ATT2:{x:.7,y:.04},MIL1:{x:.05,y:.33},MIL2:{x:.28,y:.33},MIL3:{x:.5,y:.33},MIL4:{x:.72,y:.33},MIL5:{x:.95,y:.33},DEF1:{x:.2,y:.62},DEF2:{x:.5,y:.62},DEF3:{x:.8,y:.62},GK1:{x:.5,y:.88}},"5-3-2":{ATT1:{x:.3,y:.04},ATT2:{x:.7,y:.04},MIL1:{x:.2,y:.33},MIL2:{x:.5,y:.33},MIL3:{x:.8,y:.33},DEF1:{x:.05,y:.62},DEF2:{x:.28,y:.62},DEF3:{x:.5,y:.62},DEF4:{x:.72,y:.62},DEF5:{x:.95,y:.62},GK1:{x:.5,y:.88}}},P={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}},j={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function te(t){const e=typeof import.meta<"u"?"https://fcnwclxlkytdfjotqkta.supabase.co":"";if(!e||!(t!=null&&t.skin)||!(t!=null&&t.hair))return null;const i=t.hair==="chauve"?`${t.skin}-chauve-rase`:`${t.skin}-${t.hair}-${t.hair_length}`;return`${e}/storage/v1/object/public/assets/tetes/${i}.png`}async function Ie(t,e){const{state:i,navigate:o,toast:a}=e;t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:n}=await w.from("decks").select("id,name,formation_card_id,is_active").eq("owner_id",i.profile.id).order("created_at",{ascending:!1});t.innerHTML=`
  <div class="page">
    <div class="page-header">
      <h2>Mes decks</h2>
  ...
  </div>`,document.getElementById("new-deck-btn").addEventListener("click",async()=>{const r=prompt("Nom du deck :",`Deck ${((n==null?void 0:n.length)||0)+1}`);if(!r)return;const{data:l,error:s}=await w.from("decks").insert({owner_id:i.profile.id,name:r,is_active:!(n!=null&&n.length)}).select().single();if(s){a(s.message,"error");return}a("Deck créé !","success"),ce(l.id,t,e)}),t.querySelectorAll("[data-edit]").forEach(r=>{r.addEventListener("click",()=>ce(r.dataset.edit,t,e))}),t.querySelectorAll("[data-activate]").forEach(r=>{r.addEventListener("click",async()=>{await w.from("decks").update({is_active:!1}).eq("owner_id",i.profile.id),await w.from("decks").update({is_active:!0}).eq("id",r.dataset.activate),a("Deck activé !","success"),Ie(t,e)})})}async function ce(t,e,i){const{state:o,toast:a}=i;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:n}=await w.from("decks").select("*").eq("id",t).single(),{data:r}=await w.from("cards").select(`id, card_type, formation,
      player:players(id, firstname, surname_encoded, country_code, club_id, job, job2,
        note_g, note_d, note_m, note_a, rarity, skin, hair, hair_length,
        clubs(encoded_name, logo_url))`).eq("owner_id",o.profile.id),l=(r||[]).filter(f=>f.card_type==="player"&&f.player),s=(r||[]).filter(f=>f.card_type==="formation"),d=s.map(f=>f.formation).filter(Boolean),{data:c}=await w.from("deck_cards").select("card_id, position, is_starter, slot_order").eq("deck_id",t);let y=n.formation||"4-4-2";d.length>0&&!d.includes(y)&&(y=d[0]);const p={deckId:t,name:n.name,formation:y,formationCardId:n.formation_card_id,slots:{},subs:[],playerCards:l,formationCards:s,availableFormations:d};(c||[]).forEach(f=>{f.is_starter?p.slots[f.position]=f.card_id:p.subs.includes(f.card_id)||p.subs.push(f.card_id)}),z(e,p,i)}function z(t,e,i){var s;const{navigate:o}=i;P[e.formation];const a=pe(e.formation),n=a.filter(d=>e.slots[d]).length,r=e.availableFormations.length>0?e.availableFormations:Object.keys(P),l=e.subs.map(d=>e.playerCards.find(c=>c.id===d)).filter(Boolean);[...Object.values(e.slots),...e.subs],t.innerHTML=`
  <div class="page">
    ...
    <div style="padding:12px 16px;background:#fff;border-top:1px solid var(--gray-200)">
      ...
      <div style="display:flex;gap:8px;flex-wrap:wrap" id="subs-list">
        ${l.map(d=>{const c=d.player;return`<div style="display:flex;align-items:center;gap:6px;background:#f5f5f5;border-radius:8px;padding:4px 8px;font-size:12px">
            <span style="background:${j[c.job]};color:#fff;border-radius:4px;padding:1px 5px;font-size:10px;font-weight:700">${c.job}</span>
  ...
  </div>`,Ue(t,e,a,i),document.getElementById("builder-back").addEventListener("click",()=>o("decks")),document.getElementById("formation-select").addEventListener("change",d=>{e.formation=d.target.value;const c=pe(e.formation),y={};c.forEach(p=>{e.slots[p]&&(y[p]=e.slots[p])}),e.slots=y,z(t,e,i)}),document.getElementById("save-deck").addEventListener("click",()=>Ye(e,i)),t.querySelectorAll("[data-remove-sub]").forEach(d=>{d.addEventListener("click",()=>{e.subs=e.subs.filter(c=>c!==d.dataset.removeSub),z(t,e,i)})}),(s=document.getElementById("add-sub-btn"))==null||s.addEventListener("click",()=>{Ve(e,t,i)})}function Ue(t,e,i,o){const a=document.getElementById("deck-field");if(!a)return;const n=e.formation,r=ke[n]||{},l=_e[n]||[],s={};i.forEach(b=>{const h=e.slots[b],E=h?e.playerCards.find($=>$.id===h):null;s[b]=(E==null?void 0:E.player)||null});const d=i.filter(b=>b.startsWith("MIL"));let c=0,y=0;d.forEach(b=>{const h=s[b];h&&(c+=Number(h.note_m)||0)}),l.forEach(([b,h])=>{if(!b.startsWith("MIL")||!h.startsWith("MIL"))return;G(s[b],s[h])!=="#ff3333"&&y++});const p=320,f=320,m=28,x=4;function g(b){const h=r[b];return h?{x:h.x*p,y:h.y*f}:null}let u="";for(const[b,h]of l){const E=g(b),$=g(h);if(!E||!$)continue;const _=s[b],T=s[h],L=G(_,T),I=L==="#ff3333"?.3:.9,M=L!=="#ff3333"?`filter="url(#glow-${L.replace("#","")})"`:"";u+=`<line x1="${E.x}" y1="${E.y}" x2="${$.x}" y2="${$.y}"
      stroke="${L}" stroke-width="${x}" stroke-linecap="round"
      opacity="${I}" ${M}/>`}for(const b of i){const h=g(b);if(!h)continue;const E=s[b],$=b.replace(/\d+/,""),T={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[$]||"#555",L=E?Number($==="GK"?E.note_g:$==="DEF"?E.note_d:$==="MIL"?E.note_m:E.note_a)||0:null,I=E?(E.surname_encoded||"").slice(0,8).toUpperCase():"";if(E){const M=te(E);M&&(u+=`
          <defs>
            <clipPath id="clip-${b}">
              <circle cx="${h.x}" cy="${h.y}" r="${m}"/>
            </clipPath>
          </defs>
          <image href="${M}" x="${h.x-m}" y="${h.y-m}" width="${m*2}" height="${m*2}"
            clip-path="url(#clip-${b})" preserveAspectRatio="xMidYMid slice" opacity="0.85"/>`),u+=`
        <circle cx="${h.x}" cy="${h.y}" r="${m}" fill="${M?"transparent":T}"
          stroke="${T}" stroke-width="2" />
        <circle cx="${h.x}" cy="${h.y}" r="${m}" fill="${T}" opacity="${M?"0.5":"1"}"
          stroke="rgba(255,255,255,0.6)" stroke-width="2"/>
        ${M?`<image href="${M}" x="${h.x-m}" y="${h.y-m}" width="${m*2}" height="${m*2}"
        ...
        <rect x="${h.x-m}" y="${h.y-m}" width="${m*2}" height="${m*2}"
          fill="transparent" class="deck-slot-hit" data-pos="${b}" style="cursor:pointer"/>`}else u+=`
        <circle cx="${h.x}" cy="${h.y}" r="${m}" fill="rgba(255,255,255,0.08)"
    ...
    <svg viewBox="0 0 ${p} ${f}" width="100%" style="display:block;max-width:380px;margin:0 auto">
      ${v}
      ${u}
    </svg>`,a.querySelectorAll(".deck-slot-hit").forEach(b=>{b.addEventListener("click",()=>We(b.dataset.pos,e,t,o))})}function We(t,e,i,o){var p,f,m;const{openModal:a,closeModal:n}=o,r=t.replace(/\d+/,""),l=e.slots[t],s=l?e.playerCards.find(x=>x.id===l):null;(p=s==null?void 0:s.player)==null||p.id;const d=new Set;Object.entries(e.slots).forEach(([x,g])=>{var v;if(x===t||!g)return;const u=e.playerCards.find(b=>b.id===g);(v=u==null?void 0:u.player)!=null&&v.id&&d.add(u.player.id)}),e.subs.forEach(x=>{var u;const g=e.playerCards.find(v=>v.id===x);(u=g==null?void 0:g.player)!=null&&u.id&&d.add(g.player.id)});const c=new Set,y=e.playerCards.filter(x=>{const g=x.player;return!(g.job===r||g.job2===r)||d.has(g.id)||c.has(g.id)?!1:(c.add(g.id),!0)});y.sort((x,g)=>{const u=r==="GK"?x.player.note_g:r==="DEF"?x.player.note_d:r==="MIL"?x.player.note_m:x.player.note_a;return(r==="GK"?g.player.note_g:r==="DEF"?g.player.note_d:r==="MIL"?g.player.note_m:g.player.note_a)-u}),a(`Choisir ${r} — ${t}`,`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
      ${e.slots[t]?`
        <button class="btn btn-danger btn-sm" id="remove-player" style="width:100%;margin-bottom:4px">
          ✕ Retirer le joueur actuel
        </button>`:""}
      ${y.length>0?y.map(x=>{var h,E;const g=x.player,u=r==="GK"?g.note_g:r==="DEF"?g.note_d:r==="MIL"?g.note_m:g.note_a,v=te(g),b={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"}[g.rarity];return`<div class="player-option" data-card-id="${x.id}"
          style="display:flex;align-items:center;gap:10px;padding:8px;border:1.5px solid var(--gray-200);border-radius:10px;cursor:pointer">
          <!-- Portrait -->
          <div style="width:44px;height:44px;border-radius:8px;overflow:hidden;flex-shrink:0;background:#dde;border:2px solid ${j[r]}">
            ${v?`<img src="${v}" style="width:100%;height:100%;object-fit:cover">`:`<div style="width:100%;height:100%;background:${j[r]};display:flex;align-items:center;justify-content:center;color:#fff;font-size:10px;font-weight:700">${r}</div>`}
          </div>
          <!-- Infos -->
          <div style="flex:1;min-width:0">
            ...
            <div style="display:flex;align-items:center;gap:6px;margin-top:3px">
              ...
              ${(h=g.clubs)!=null&&h.logo_url?`<img src="${g.clubs.logo_url}" style="width:18px;height:18px;object-fit:contain">`:`<span style="font-size:10px;color:var(--gray-600)">${((E=g.clubs)==null?void 0:E.encoded_name)||"—"}</span>`}
              <span style="font-size:10px;color:var(--gray-600)">${g.country_code}</span>
            </div>
          </div>
          <!-- Note -->
          <div style="width:36px;height:36px;border-radius:8px;background:${j[r]};color:#fff;display:flex;align-items:center;justify-content:center;font-weight:900;font-size:16px;border:2px solid ${b};flex-shrink:0">
            ${u}
          </div>
        </div>`}).join(""):'<div style="text-align:center;color:var(--gray-600);padding:20px">Aucun joueur pour ce poste.<br><small>Ouvre des boosters !</small></div>'}
    </div>`,'<button class="btn btn-ghost" id="close-selector">Fermer</button>'),(f=document.getElementById("close-selector"))==null||f.addEventListener("click",n),(m=document.getElementById("remove-player"))==null||m.addEventListener("click",()=>{delete e.slots[t],n(),z(i,e,o)}),document.querySelectorAll(".player-option").forEach(x=>{x.addEventListener("click",()=>{e.slots[t]=x.dataset.cardId,n(),z(i,e,o)})})}function Ve(t,e,i){var s;const{openModal:o,closeModal:a}=i,n=new Set;Object.values(t.slots).filter(Boolean).forEach(d=>{var y;const c=t.playerCards.find(p=>p.id===d);(y=c==null?void 0:c.player)!=null&&y.id&&n.add(c.player.id)}),t.subs.forEach(d=>{var y;const c=t.playerCards.find(p=>p.id===d);(y=c==null?void 0:c.player)!=null&&y.id&&n.add(c.player.id)});const r=new Set,l=t.playerCards.filter(d=>{var c,y,p;return n.has((c=d.player)==null?void 0:c.id)||r.has((y=d.player)==null?void 0:y.id)?!1:(r.add((p=d.player)==null?void 0:p.id),!0)});o("Ajouter un remplaçant",`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
      ${l.length>0?l.map(d=>{var f;const c=d.player,y=te(c),p=c.job==="GK"?c.note_g:c.job==="DEF"?c.note_d:c.job==="MIL"?c.note_m:c.note_a;return`<div class="player-option" data-card-id="${d.id}"
          style="display:flex;align-items:center;gap:10px;padding:8px;border:1.5px solid var(--gray-200);border-radius:10px;cursor:pointer">
          <div style="width:40px;height:40px;border-radius:8px;overflow:hidden;flex-shrink:0;background:#dde;border:2px solid ${j[c.job]}">
  ...
  <div class="page">
    ...
    <div class="page-body">
      <div class="booster-grid">
        ${fe.map(r=>{const l=a>=r.cost||r.cost===0,s=r.id==="players_std"||r.id==="players_pub";return`<div class="booster-card ${l?"":"disabled"}" data-booster="${r.id}" style="position:relative">
  ...
  `,document.body.appendChild(o);let a=!1;document.getElementById("pack-visual").addEventListener("click",()=>{if(a)return;a=!0;const p=document.getElementById("pack-visual");p.classList.add("shaking"),setTimeout(()=>{p.classList.add("pack-open"),setTimeout(()=>{document.getElementById("pack-phase").style.display="none",r(0)},600)},500)});let n=0;function r(p){n=p;const f=document.getElementById("reveal-phase");f.style.display="flex",l(p)}function l(p){var E;const f=t[p],m=document.getElementById("card-counter"),x=document.getElementById("single-card-slot"),g=document.getElementById("card-tap-hint");m&&(m.textContent=`Carte ${p+1} / ${t.length}`),g&&(g.textContent=p<t.length-1?"Appuie pour continuer →":"Appuie pour voir toutes tes cartes");const u=ue(f),v=f.card_type==="player"&&((E=f.player)==null?void 0:E.rarity)==="legende";x.innerHTML=`
      <div id="current-card-wrap" class="single-card-reveal" style="cursor:pointer;${v?"filter:drop-shadow(0 0 20px #7a28b8)":""}">
        ${u}
      </div>`,v&&c();const b=document.getElementById("current-card-wrap");let h=!1;b.addEventListener("click",()=>{if(h)return;h=!0;const $=p+1;$<t.length?(b.style.transition="all 0.25s ease",b.style.transform="translateX(-120%) rotate(-15deg)",b.style.opacity="0",setTimeout(()=>l($),250)):s()})}function s(){y(),document.getElementById("reveal-phase").style.display="none";const p=document.getElementById("recap-phase");p.style.display="flex";const f=document.getElementById("recap-grid");f.innerHTML=t.map((m,x)=>`
      <div class="recap-card" style="--i:${x};animation-delay:${x*.07}s">
        ${ue(m)}
      </div>`).join("")}let d=null;function c(){const p=document.getElementById("fireworks-canvas");if(!p)return;p.width=window.innerWidth,p.height=window.innerHeight;const f=p.getContext("2d"),m=[];function x(){const u=Math.random()*p.width,v=Math.random()*p.height*.6,b=["#7a28b8","#ff4081","#D4A017","#00e676","#fff","#e040fb","#40c4ff"],h=b[Math.floor(Math.random()*b.length)];for(let E=0;E<60;E++){const $=Math.PI*2/60*E,_=2+Math.random()*5;m.push({x:u,y:v,vx:Math.cos($)*_,vy:Math.sin($)*_,alpha:1,color:h,size:2+Math.random()*3})}}x(),d=setInterval(x,600);function g(){if(document.getElementById("fireworks-canvas")){f.clearRect(0,0,p.width,p.height);for(let u=m.length-1;u>=0;u--){const v=m[u];if(v.x+=v.vx,v.y+=v.vy+.08,v.vy*=.98,v.alpha-=.018,v.alpha<=0){m.splice(u,1);continue}f.globalAlpha=v.alpha,f.fillStyle=v.color,f.beginPath(),f.arc(v.x,v.y,v.size,0,Math.PI*2),f.fill()}f.globalAlpha=1,(d!==null||m.length>0)&&requestAnimationFrame(g)}}g()}function y(){d!==null&&(clearInterval(d),d=null);const p=document.getElementById("fireworks-canvas");p&&p.getContext("2d").clearRect(0,0,p.width,p.height)}document.getElementById("reveal-collection").addEventListener("click",()=>{y(),o.remove(),i("collection")}),document.getElementById("reveal-more").addEventListener("click",()=>{y(),o.remove(),i("boosters")})}function ue(t){var e,i;if(t.card_type==="player"&&t.player){const o=t.player,a=o.job||"ATT",n=Xe[a]||"#1A6B3C",r=Qe[o.rarity]||"#ccc",l=a==="GK"?o.note_g:a==="DEF"?o.note_d:a==="MIL"?o.note_m:o.note_a,s=Je(o),d={MA:"MAROC",FR:"FRANCE",AR:"ARGENTINE",PT:"PORTUGAL",BR:"BRESIL",ES:"ESPAGNE",DE:"ALLEMAGNE",GB:"ANGLETERRE",IT:"ITALIE",CM:"CAMEROUN",SN:"SENEGAL"}[o.country_code]||o.country_code;return`<div style="width:140px;height:200px;background:#f2e8d2;border-radius:12px;border:3px solid ${r};overflow:hidden;display:flex;flex-direction:column">
      <!-- Nom -->
  ...
  </div>`,(n=document.getElementById("msg-btn"))==null||n.addEventListener("click",a)}function Ae(t){const e=typeof import.meta<"u"?"https://fcnwclxlkytdfjotqkta.supabase.co":"";if(!e||!(t!=null&&t.skin)||!(t!=null&&t.hair))return null;const i=t.hair==="chauve"?`${t.skin}-chauve-rase`:`${t.skin}-${t.hair}-${t.hair_length}`;return`${e}/storage/v1/object/public/assets/tetes/${i}.png`}function ye(t){const e=t.player;return{cardId:t.id,id:e.id,firstname:e.firstname,name:e.surname_encoded,country_code:e.country_code,club_id:e.club_id,job:e.job,job2:e.job2,note_g:Number(e.note_g)||0,note_d:Number(e.note_d)||0,note_m:Number(e.note_m)||0,note_a:Number(e.note_a)||0,rarity:e.rarity,skin:e.skin,hair:e.hair,hair_length:e.hair_length,boost:0,used:!1,_line:null,_col:null}}function ie(t){return t===1?[1]:t===2?[0,2]:t===3?[0,1,2]:t===4?[0,1,1,2]:t===5?[0,1,1,1,2]:[1]}function lt(){const t=Math.random()*100;return t<.1?4:t<5?3:t<20?2:1}function ct(t,e){const i=S[e]||S["4-4-2"],o={GK:[],DEF:[],MIL:[],ATT:[]},a=[...t];for(const n of["GK","DEF","MIL","ATT"]){const r=[];for(let s=0;s<i[n];s++){let d=a.findIndex(c=>c.job===n);if(d===-1&&(d=a.findIndex(c=>c.job2===n)),d===-1&&(d=0),a[d]){const c={...a[d],_line:n};r.push(c),a.splice(d,1)}}const l=ie(r.length);r.forEach((s,d)=>{s._col=l[d]}),o[n]=r}return o}async function pt(t,e){const{data:i}=await w.from("players").select("id,firstname,surname_encoded,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length").eq("is_active",!0).limit(60);if(!i||i.length<11)return ft(t);const o=S[t]||S["4-4-2"],a={GK:[],DEF:[],MIL:[],ATT:[]},n=[...i];for(const r of["GK","DEF","MIL","ATT"]){const l=n.filter(p=>p.job===r),s=n.filter(p=>p.job!==r),d=[...l,...s],c=[];for(let p=0;p<o[r];p++){const f=d[p]||n[p];f&&c.push({cardId:"ai-"+f.id+"-"+p,id:f.id,firstname:f.firstname,name:f.surname_encoded,country_code:f.country_code,club_id:f.club_id,job:f.job,job2:f.job2,note_g:Number(f.note_g)||0,note_d:Number(f.note_d)||0,note_m:Number(f.note_m)||0,note_a:Number(f.note_a)||0,rarity:f.rarity,skin:f.skin,hair:f.hair,hair_length:f.hair_length,boost:0,used:!1,_line:r})}const y=ie(c.length);c.forEach((p,f)=>{p._col=y[f]}),a[r]=c}return a}function ft(t){const e=S[t]||S["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},o=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let a=0;for(const n of["GK","DEF","MIL","ATT"]){const r=[];for(let s=0;s<e[n];s++){const d=3+Math.floor(Math.random()*5);r.push({cardId:"fake-"+a,id:"fake-"+a,firstname:"IA",name:o[a%o.length],country_code:"XX",club_id:null,job:n,job2:null,note_g:n==="GK"?d:2,note_d:n==="DEF"?d:2,note_m:n==="MIL"?d:2,note_a:n==="ATT"?d:2,rarity:"normal",boost:0,used:!1,_line:n}),a++}const l=ie(r.length);r.forEach((s,d)=>{s._col=l[d]}),i[n]=r}return i}async function ut(t,e){var h;const{state:i,navigate:o,toast:a}=e,n=i.params||{};t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const r=n.matchMode||"vs_ai_easy",l=r.replace("vs_ai_",""),s=r;if(!n.deckId)return yt(t,e,r);const d=n.deckId,{data:c}=await w.from("deck_cards").select(`position, is_starter, slot_order,
      card:cards(id, card_type, formation,
        player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
          clubs(encoded_name,logo_url)))`).eq("deck_id",d).order("slot_order"),y=(c||[]).filter(E=>{var $;return E.is_starter&&(($=E.card)==null?void 0:$.player)}).map(E=>ye(E.card)),p=(c||[]).filter(E=>{var $;return!E.is_starter&&(($=E.card)==null?void 0:$.player)}).map(E=>ye(E.card));if(y.length<11){Te(t,"⚠️",`Deck incomplet (${y.length}/11).`,"Compléter",()=>o("decks"));return}const f=(c||[]).find(E=>{var $;return(($=E.card)==null?void 0:$.card_type)==="formation"}),m=((h=f==null?void 0:f.card)==null?void 0:h.formation)||"4-4-2",{data:x}=await w.from("cards").select("id,gc_type").eq("owner_id",i.profile.id).eq("card_type","game_changer"),g=ct(y,m),u=await pt(m),{data:v}=await w.from("matches").insert({home_id:i.profile.id,away_id:null,mode:s,home_deck_id:d,status:"in_progress"}).select().single(),b={matchId:v==null?void 0:v.id,mode:s,difficulty:l,formation:m,homeTeam:g,aiTeam:u,homeSubs:p,subsUsed:0,maxSubs:Math.min(p.length,3),homeScore:0,aiScore:0,gcCards:x||[],usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};gt(t,b,e)}async function yt(t,e,i){var r;const{state:o,navigate:a}=e,{data:n}=await w.from("decks").select("id,name,is_active,formation_card_id").eq("owner_id",o.profile.id).order("created_at",{ascending:!1});if(!n||n.length===0){Te(t,"📋","Aucun deck. Crée un deck avant de jouer !","Créer un deck",()=>a("decks"));return}t.innerHTML=`
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${y.map((m,x)=>{const g=Ae(m),u=x<y.length-1?G(m,y[x+1]):null;return`
          <div style="width:52px;height:52px;border-radius:8px;background:${f};position:relative;flex-shrink:0;overflow:hidden;border:2px solid rgba(255,255,255,0.3)">
            ...
            <div style="position:relative;z-index:1;font-size:15px;font-weight:900;color:#fff;text-shadow:0 1px 3px #000">${D(m,"MIL")}</div>
  ...
  <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;gap:20px;padding:20px">
    ...
    <div id="midfield-result" style="opacity:0;text-align:center;transition:opacity 0.5s;color:#fff">
      ...
      `,d&&(e.boostCard={value:m})}e.attacker=d?"home":"ai",e.log.push({text:`Duel milieu : ${e.clubName} ${l} – ${s} IA → ${d?e.clubName:"IA"} attaque en premier`,type:"info"}),setTimeout(()=>{e.phase=e.attacker==="home"?"attack":"ai-attack",C(t,e,i),e.attacker==="ai"&&setTimeout(()=>V(t,e,i),1e3)},2800)},1200)}function Me(t,e,i,o,a=310,n=310){const r=ke[e]||{},l=_e[e]||[],s=26,d={},c=["ATT","MIL","DEF","GK"];for(const m of c)(t[m]||[]).forEach((g,u)=>{d[`${m}${u+1}`]=g});function y(m){const x=r[m];return x?{x:x.x*a,y:x.y*n}:null}let p="";for(const[m,x]of l){const g=y(m),u=y(x);if(!g||!u)continue;const v=d[m],b=d[x],h=G(v,b),E=h==="#ff3333"?.25:.9,$=h!=="#ff3333"?`filter="url(#glow${h.replace("#","").slice(0,6)})"`:"";p+=`<line x1="${g.x.toFixed(1)}" y1="${g.y.toFixed(1)}" x2="${u.x.toFixed(1)}" y2="${u.y.toFixed(1)}"
      stroke="${h}" stroke-width="3.5" stroke-linecap="round" opacity="${E}" ${$}/>`}for(const[m,x]of Object.entries(d)){const g=y(m);if(!g)continue;const u=m.replace(/[0-9]/g,""),b={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[u]||"#555",h=i==="attack"&&["MIL","ATT"].includes(u)&&!x.used||i==="defense"&&["GK","DEF","MIL"].includes(u)&&!x.used,E=o.includes(x.cardId);let $;i==="attack"?$=u==="MIL"?Number(x.note_m)||0:Number(x.note_a)||0:i==="defense"?$=u==="GK"?Number(x.note_g)||0:u==="MIL"?Number(x.note_m)||0:Number(x.note_d)||0:$=Number(u==="GK"?x.note_g:u==="DEF"?x.note_d:u==="MIL"?x.note_m:x.note_a)||0,$=$+(x.boost||0);const _=E?"#FFD700":h?"rgba(255,255,255,0.7)":"rgba(255,255,255,0.25)",T=E?3:2,L=x.used?.25:1,I=Ae(x);I&&(p+=`<defs><clipPath id="mc-${m}"><circle cx="${g.x}" cy="${g.y}" r="${s}"/></clipPath></defs>`),p+=`<circle cx="${g.x}" cy="${g.y}" r="${s}" fill="${b}" opacity="${L}"
      stroke="${_}" stroke-width="${T}"/>`,I&&!x.used&&(p+=`<image href="${I}" x="${g.x-s}" y="${g.y-s}" width="${s*2}" height="${s*2}"
        clip-path="url(#mc-${m})" preserveAspectRatio="xMidYMid slice" opacity="0.8"/>`,p+=`<circle cx="${g.x}" cy="${g.y}" r="${s}" fill="${b}" opacity="0.35"
      ...
      fill="${x.used?"#555":"white"}" font-family="Arial Black,Arial">${x.used?"–":$}</text>
    <text x="${g.x}" y="${g.y+11}" text-anchor="middle" font-size="6" fill="rgba(255,255,255,${x.used?.3:.8})"
      font-family="Arial">${(x.name||"").slice(0,8)}</text>`,h&&(p+=`<circle cx="${g.x}" cy="${g.y}" r="${s}" fill="rgba(255,255,255,0.08)"
        class="match-slot-hit ${E?"selected":""}" data-card-id="${x.cardId}" data-role="${u}"
  ...
  <div class="match-screen">
    ...
    <div style="padding:6px 12px;display:flex;gap:6px;overflow-x:auto;align-items:center;background:rgba(0,0,0,0.2)">
      ...
      ${e.gcCards.filter(f=>!e.usedGc.includes(f.id)).map(f=>{var m;return`
        <div class="gc-mini" data-gc-id="${f.id}" data-gc-type="${f.gc_type}"
          ...
          <div style="font-size:14px">${((m=Q[f.gc_type])==null?void 0:m.icon)||"⚡"}</div>
    ...
    <div class="match-log" id="match-log">
      ...
      <button class="btn btn-primary" id="confirm-defense" style="width:100%" ${s?"":"disabled"}>Défendre →</button>`,(r=document.getElementById("confirm-defense"))==null||r.addEventListener("click",()=>bt(t,e,i))}else e.phase==="finished"?(o.innerHTML='<button class="btn btn-primary" id="end-match" style="width:100%">Voir les résultats</button>',(l=document.getElementById("end-match"))==null||l.addEventListener("click",()=>i.navigate("home"))):o.innerHTML=`<div style="text-align:center;color:rgba(255,255,255,.4);padding:8px;font-size:12px">⏳ Tour de l'IA...</div>`}function xt(t,e,i,o){const a=t.dataset.cardId,n=t.dataset.role,r=e.selected.findIndex(l=>l.cardId===a);if(r!==-1)e.selected.splice(r,1);else{if(e.selected.length>=3){o.toast("Maximum 3 joueurs","error");return}const l=(e.homeTeam[n]||[]).find(s=>s.cardId===a);l&&e.selected.push({...l,_role:n,_line:n})}C(i,e,o)}function ht(t,e,i){const o=e.selected.map(n=>({...n,_line:n._role})),a=Z(o,e.modifiers.home);e.pendingAttack={...a,players:[...e.selected],side:"home"},e.selected.forEach(n=>{const r=(e.homeTeam[n._role]||[]).find(l=>l.cardId===n.cardId);r&&(r.used=!0)}),e.log.push({text:`Vous attaquez : ${a.total} (${e.selected.map(n=>n.name).join(", ")})`,type:"info"}),e.selected=[],e.modifiers.home={},e.phase="ai-defense",C(t,e,i),setTimeout(()=>Et(t,e,i),1200)}function bt(t,e,i){const o=e.selected.map(r=>({...r,_line:r._role})),a=ee(o,e.modifiers.home);e.selected.forEach(r=>{const l=(e.homeTeam[r._role]||[]).find(s=>s.cardId===r.cardId);l&&(l.used=!0)});const n=he(e.pendingAttack.total,a.total,e.modifiers.home);n.shielded?e.log.push({text:"🛡️ Bouclier ! But annulé.",type:"info"}):n.goal?(e.aiScore++,e.log.push({text:`⚽ BUT IA ! (${e.pendingAttack.total} > ${a.total})`,type:"goal"})):e.log.push({text:`🧤 Défense ! (${a.total} ≥ ${e.pendingAttack.total})`,type:"info"}),e.selected=[],e.modifiers.home={},e.pendingAttack=null,De(t,e,i,"home-attack")}function V(t,e,i){const o=[...e.aiTeam.MIL||[],...e.aiTeam.ATT||[]],a=be(o,"attack",e.difficulty);if(!a.length){Be(t,e,i);return}const n=Z(a,e.modifiers.ai);e.pendingAttack={...n,players:a,side:"ai"},a.forEach(r=>{r.used=!0}),e.log.push({text:`IA attaque : ${n.total}`,type:"info"}),e.modifiers.ai={},e.phase="defense",C(t,e,i)}function Et(t,e,i){const o=[...e.aiTeam.GK||[],...e.aiTeam.DEF||[],...e.aiTeam.MIL||[]],a=be(o,"defense",e.difficulty),n=a.length>0?ee(a,e.modifiers.ai).total:0;a.forEach(l=>{l.used=!0});const r=he(e.pendingAttack.total,n,e.modifiers.ai);r.shielded?e.log.push({text:"🛡️ Bouclier IA !",type:"info"}):r.goal?(e.homeScore++,e.log.push({text:`⚽ BUT ! (${e.pendingAttack.total} > ${n})`,type:"goal"})):e.log.push({text:`🧤 IA défend (${n} ≥ ${e.pendingAttack.total})`,type:"info"}),e.modifiers.ai={},e.pendingAttack=null,De(t,e,i,"ai-attack")}function De(t,e,i,o){if(e.round++,Ce(e)){Y(t,e,i);return}if(o==="home-attack"){if(![...e.homeTeam.MIL||[],...e.homeTeam.ATT||[]].filter(n=>!n.used).length){if(![...e.homeTeam.GK||[],...e.homeTeam.DEF||[],...e.homeTeam.MIL||[]].filter(r=>!r.used).length){Y(t,e,i);return}e.phase="ai-attack",C(t,e,i),setTimeout(()=>V(t,e,i),800);return}e.phase="attack",C(t,e,i)}else{if(![...e.aiTeam.MIL||[],...e.aiTeam.ATT||[]].filter(n=>!n.used).length){Be(t,e,i);return}e.phase="ai-attack",C(t,e,i),setTimeout(()=>V(t,e,i),800)}}function Ce(t){const e=["MIL","ATT","GK","DEF"].some(o=>(t.homeTeam[o]||[]).some(a=>!a.used)),i=["MIL","ATT","GK","DEF"].some(o=>(t.aiTeam[o]||[]).some(a=>!a.used));return!e&&!i}function Be(t,e,i){Ce(e)?Y(t,e,i):(e.phase="attack",C(t,e,i))}function $t(t,e,i){const o=Object.values(e.homeTeam).flat().filter(a=>!a.used);if(!o.length){i.toast("Aucun joueur actif à booster","error");return}i.openModal("⚡ Utiliser le Boost",`<div style="margin-bottom:12px;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border-radius:10px;padding:12px;text-align:center;color:#000">
    ...
    <div style="display:flex;flex-direction:column;gap:6px">
      ${o.map(a=>`
        <div class="player-boost-opt" data-card-id="${a.cardId}"
          ...
          <div style="width:32px;height:32px;background:${W[a.job]||"#888"};border-radius:6px;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:900;font-size:13px">${D(a,a._line||a.job)}</div>
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Annuler</button>`),document.querySelectorAll(".player-boost-opt").forEach(a=>{a.addEventListener("click",()=>{const n=a.dataset.cardId;for(const r of["GK","DEF","MIL","ATT"]){const l=(e.homeTeam[r]||[]).find(s=>s.cardId===n);if(l){l.boost=(l.boost||0)+e.boostCard.value,e.log.push({text:`⚡ Boost +${e.boostCard.value} appliqué à ${l.name}`,type:"info"});break}}e.boostUsed=!0,i.closeModal(),C(t,e,i)})})}function wt(t,e,i){e.usedSubIds||(e.usedSubIds=[]);const o=Object.values(e.homeTeam).flat().filter(s=>s.used),a=e.homeSubs.filter(s=>!e.usedSubIds.includes(s.cardId));if(!o.length){i.toast("Aucun joueur grisé","info");return}if(!a.length){i.toast("Aucun remplaçant disponible","info");return}if(e.subsUsed>=e.maxSubs){i.toast(`Maximum ${e.maxSubs} remplacements`,"error");return}i.openModal("🔄 Remplacement",`<div style="margin-bottom:12px">
  ...
  `;function l(s){const d=document.getElementById("mkt-content"),c=s==="buy"?r:n;if(c.length===0){d.innerHTML=`<div style="text-align:center;color:var(--gray-600);padding:40px">
      ...
      ${c.map(y=>{var g,u,v;const p=(g=y.card)==null?void 0:g.player;if(!p)return"";const f=p.job==="GK"?p.note_g:p.job==="DEF"?p.note_d:p.job==="MIL"?p.note_m:p.note_a,m=It[p.rarity],x=(i.profile.credits||0)>=y.price;return`<div class="card-panel" style="display:flex;align-items:center;gap:12px;padding:12px">
          <div style="width:44px;height:44px;border-radius:8px;background:${Mt(p.job)};color:#fff;display:flex;align-items:center;justify-content:center;font-weight:900;font-size:18px;border:2px solid ${m};flex-shrink:0">${f}</div>
          <div style="flex:1;min-width:0">
  ...
  `}const k={user:null,profile:null,page:"home",params:{}};function R(t,e="info",i=3e3){const o=document.getElementById("toast");o&&(o.textContent=t,o.className=`show ${e}`,clearTimeout(o._t),o._t=setTimeout(()=>{o.className=""},i))}function Ct(t,e,i=""){document.getElementById("modal-title").textContent=t,document.getElementById("modal-body").innerHTML=e,document.getElementById("modal-footer").innerHTML=i,document.getElementById("modal-overlay").classList.remove("hidden")}function J(){document.getElementById("modal-overlay").classList.add("hidden")}async function N(){if(!k.user)return;const{data:t}=await w.from("users").select("*").eq("id",k.user.id).single();t&&(k.profile=t)}const ne="mw_theme";function H(){return localStorage.getItem(ne)||"light"}function Bt(t){var e;localStorage.setItem(ne,t),X(t),(e=k.profile)!=null&&e.id&&w.from("users").update({theme:t}).eq("id",k.profile.id).then(()=>{})}function X(t){document.documentElement.setAttribute("data-theme",t)}function q(t,e={}){k.page=t,k.params=e,Fe()}async function Fe(){const t=document.getElementById("page-content");if(!t)return;document.querySelectorAll(".bottom-nav a").forEach(o=>{o.classList.toggle("active",o.dataset.page===k.page)});const e=document.getElementById("nav-credits");e&&k.profile&&(e.textContent=`💰 ${(k.profile.credits||0).toLocaleString("fr")}`);const i={state:k,navigate:q,toast:R,openModal:Ct,closeModal:J,refreshProfile:N};switch(t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',k.page){case"home":await se(t,i);break;case"collection":await Ke(t,i);break;case"decks":await Ie(t,i);break;case"boosters":await Ze(t,i);break;case"match":await ut(t,i);break;case"market":await Lt(t,i);break;case"rankings":await Dt(t,i);break;default:await se(t,i)}}function Ft(){const t=document.getElementById("app"),e=k.profile;if(!e)return;const i="/manager-wars/icons/";t.innerHTML=`
    <nav class="top-nav">
  ...
  `,document.querySelectorAll(".bottom-nav a").forEach(o=>{o.addEventListener("click",a=>{a.preventDefault(),q(o.dataset.page)})}),document.getElementById("nav-logo").addEventListener("click",()=>q("home")),document.getElementById("nav-credits").addEventListener("click",()=>q("boosters")),document.getElementById("theme-toggle").addEventListener("click",()=>{const a=H()==="dark"?"light":"dark";Bt(a),ge(a)}),ge(H())}function ge(t){const e=document.getElementById("theme-icon");e&&(e.textContent=t==="dark"?"☀️":"🌙")}async function jt(){X(H()),document.getElementById("modal-overlay").addEventListener("click",e=>{e.target===e.currentTarget&&J()}),document.getElementById("modal-close").addEventListener("click",J);const{data:{session:t}}=await w.auth.getSession();if(!t){ve(),re(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:R});return}if(k.user=t.user,await N(),ve(),!k.profile){je(document.getElementById("app"),{state:k,navigate:async()=>{await N(),me()},toast:R,refreshProfile:N});return}k.profile.theme&&k.profile.theme!==H()&&(localStorage.setItem(ne,k.profile.theme),X(k.profile.theme)),me(),w.auth.onAuthStateChange(async(e,i)=>{e==="SIGNED_OUT"&&(k.user=null,k.profile=null,document.getElementById("app").innerHTML="",re(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:R}))})}function me(){const t=document.getElementById("app");t.style.display="flex",t.style.flexDirection="column",Ft(),Fe()}function ve(){const t=document.getElementById("app-loader");t&&(t.classList.add("zoom-out"),setTimeout(()=>t.style.display="none",500))}jt();
