import{s as _}from"./supabase-3x2kAdST.js";function se(t,{navigate:e,toast:i}){t.innerHTML=`
  ...
  <div class="page">
    <div class="page-body">
      ...
      <div class="ranked-banner">
        <img src="/manager-wars/icons/badge-legendary.png" alt="" class="ranked-icon">
        <img src="/manager-wars/icons/badge-ranked.png" alt="Ranked" class="ranked-text">
      </div>
      ...
      <div>
        ...
        <div class="play-grid">
          <div class="play-card" data-action="match-ai">
            ...
            <img src="/manager-wars/icons/badge-matchia-txt.png" alt="Match IA" class="play-text" onerror="this.style.display='none'">
          </div>
          <div class="play-card" data-action="match-random">
            <img src="/manager-wars/icons/badge-vs.png" alt="" class="play-icon">
            <img src="/manager-wars/icons/badge-random.png" alt="Match Random" class="play-text">
          </div>
          <div class="play-card" data-action="match-friend">
            <img src="/manager-wars/icons/badge-championship.png" alt="" class="play-icon">
            <img src="/manager-wars/icons/badge-matchfriend.png" alt="Match Friend" class="play-text">
          </div>
          <div class="play-card" data-action="championship">
            <img src="/manager-wars/icons/badge-trophy.png" alt="" class="play-icon">
            <img src="/manager-wars/icons/badge-minileague-txt.png" alt="Mini League" class="play-text" onerror="this.style.display='none'">
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        <div class="card-panel" style="padding:0">
          ${n.map(s=>{const d=s.winner_id===r.id,c=s.home_score===s.away_score,y=c?"N":d?"V":"D",p=c?"#888":d?"#1A6B3C":"#c0392b",f={vs_ai_easy:"IA Facile",vs_ai_medium:"IA Moyen",vs_ai_hard:"IA Difficile",vs_ai_club:"IA Club",friend_challenge:"Défi ami",championship:"Championnat"}[s.mode]||s.mode,m=new Date(s.created_at).toLocaleDateString("fr",{month:"short",day:"numeric"});return`<div style="display:flex;justify-content:space-between;align-items:center;padding:10px 14px;border-bottom:1px solid var(--gray-200)">
              <div>
  ...
  `,document.body.appendChild(i);const o=()=>i.remove();document.getElementById("diff-cancel").addEventListener("click",o),i.addEventListener("click",r=>{r.target===i&&o()}),i.querySelectorAll("[data-mode]").forEach(r=>{r.addEventListener("click",()=>{o(),t("match",{matchMode:r.dataset.mode})})})}const Q={Ressusciter:{icon:"💫",desc:"Réactive un joueur grisé pour ce match."},"Double attaque":{icon:"⚡",desc:"La note d'attaque compte double."},Bouclier:{icon:"🛡️",desc:"Annule le prochain but adverse."},"Vol de note":{icon:"🎯",desc:"-1 à la note d'un joueur adverse."},Gel:{icon:"❄️",desc:"Bloque le meilleur attaquant IA."},"Remplacement+":{icon:"🔄",desc:"+1 remplacement pour ce match."}};function C(t,e){if(!t)return 0;switch(e){case"GK":return Number(t.note_g)||0;case"DEF":return Number(t.note_d)||0;case"MIL":return Number(t.note_m)||0;case"ATT":return Number(t.note_a)||0;default:return 0}}const de=["ATT","MIL","DEF","GK"];function he(t){let e=0;const i=t.length;for(let o=0;o<i;o++)for(let r=o+1;r<i;r++){const n=t[o],a=t[r];if(!n||!a)continue;const l=n._col!==void 0&&a._col!==void 0&&n._col===a._col,s=n._col!==void 0&&a._col!==void 0&&Math.abs(n._col-a._col)===1,d=de.indexOf(n._line),c=de.indexOf(a._line),y=Math.abs(d-c)===1;(n._line===a._line&&s||l&&y)&&(n.country_code&&a.country_code&&n.country_code===a.country_code&&e++,n.club_id&&a.club_id&&n.club_id===a.club_id&&e++)}return e}function Z(t,e={}){const i=t.reduce((n,a)=>{const l=a._line||a.job;return n+Number(l==="MIL"?a.note_m:a.note_a)||0},0),o=he(t);let r=i+o;return e.doubleAttack&&(r*=2),e.stolenNote&&(r-=e.stolenNote),{base:i,links:o,total:Math.max(0,r)}}function ee(t,e={}){const i=t.reduce((n,a)=>{const l=a._line||a.job;let s=0;return l==="GK"?s=Number(a.note_g)||0:l==="MIL"?s=Number(a.note_m)||0:s=Number(a.note_d)||0,n+s},0),o=he(t);let r=i+o;return e.stolenNote&&(r-=e.stolenNote),{base:i,links:o,total:Math.max(0,r)}}function xe(t,e,i={}){return i.shield?{goal:!1,shielded:!0}:{goal:t>e,shielded:!1}}function be(t,e,i="easy"){const o=t.filter(a=>!a.used);if(!o.length)return[];const r=[...o].sort((a,l)=>{const s=e==="attack"?C(a,"ATT"):a._line==="GK"?C(a,"GK"):C(a,"DEF");return(e==="attack"?C(l,"ATT"):l._line==="GK"?C(l,"GK"):C(l,"DEF"))-s});let n=i==="easy"?1+Math.floor(Math.random()*2):i==="medium"?2+Math.floor(Math.random()*2):3;return r.slice(0,Math.min(n,r.length,3))}function Ge(t,e){const i={vs_ai_easy:{victoire:500,nul:250,defaite:50},vs_ai_medium:{victoire:1e3,nul:500,defaite:50},vs_ai_hard:{victoire:1500,nul:750,defaite:100},vs_ai_club:{victoire:2500,nul:1250,defaite:100}};return(i[t]||i.vs_ai_easy)[e]||0}const $e={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"},O={GK:"#111111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},le=["GK","DEF","MIL","ATT"],Re=["Tous","GK","DEF","MIL","ATT"],Ne={normal:1e3,pepite:5e3,papyte:5e3,legende:1e4},Ee={MA:"MAROC",FR:"FRANCE",AR:"ARGENTINE",PT:"PORTUGAL",BR:"BRESIL",ES:"ESPAGNE",DE:"ALLEMAGNE",GB:"ANGLETERRE",IT:"ITALIE",CM:"CAMEROUN",SN:"SENEGAL",NG:"NIGERIA",DK:"DANEMARK",NL:"PAYS-BAS",BE:"BELGIQUE",CI:"CÔTE D'IVOIRE",AL:"ALBANIE",HR:"CROATIE",RS:"SERBIE",TR:"TURQUIE"};function _e(t){const e="https://fcnwclxlkytdfjotqkta.supabase.co";if(!(t!=null&&t.skin)||!(t!=null&&t.hair))return null;const i=t.hair==="chauve"?`${t.skin}-chauve-rase`:`${t.skin}-${t.hair}-${t.hair_length}`;return`${e}/storage/v1/object/public/assets/tetes/${i}.png`}function P(t,e){return t&&Number(e==="GK"?t.note_g:e==="DEF"?t.note_d:e==="MIL"?t.note_m:t.note_a)||0}function qe(t,e=""){var y,p;const i=t.player;if(!i)return"";const o=i.job||"ATT",r=O[o],n=$e[i.rarity]||"#ccc",a=P(i,o),l=i.job2?P(i,i.job2):null,s=i.job2?O[i.job2]:null,d=_e(i),c=Ee[i.country_code]||i.country_code||"";return`
  <div style="
  ...
  </div>`}async function Oe(t,e){const{state:i,navigate:o,toast:r,openModal:n,closeModal:a}=e;t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:l}=await _.from("cards").select(`id, card_type, current_note, gc_type, formation, is_for_sale, sale_price,
      player:players(id, firstname, surname_encoded, country_code, club_id, job, job2,
        note_g, note_d, note_m, note_a, rarity, note_min, note_max, skin, hair, hair_length, sell_price,
        clubs(encoded_name, logo_url))`).eq("owner_id",i.profile.id),s=(l||[]).filter(u=>u.card_type==="player"&&u.player),d=(l||[]).filter(u=>u.card_type==="game_changer"),c=(l||[]).filter(u=>u.card_type==="formation"),y={};s.forEach(u=>{const h=u.player.id;y[h]=(y[h]||0)+1});let p="Tous",f="";function x(){return[...s].sort((u,h)=>{const b=le.indexOf(u.player.job),v=le.indexOf(h.player.job);return b!==v?b-v:(u.player.surname_encoded||"").localeCompare(h.player.surname_encoded||"")})}function m(){return x().filter(u=>{const h=u.player,b=p==="Tous"||h.job===p,v=!f||`${h.firstname} ${h.surname_encoded}`.toLowerCase().includes(f);return b&&v})}t.innerHTML=`
  <div class="page">
      ...
      <div style="display:flex;gap:8px;overflow-x:auto;padding-bottom:4px">
        ...
        ${d.map(u=>{var h;return`
          <div data-gc-id="${u.id}" data-gc-type="${u.gc_type}" style="
            ...
            <div style="font-size:28px">${((h=Q[u.gc_type])==null?void 0:h.icon)||"⚡"}</div>
  ...
  </div>`;function g(){const u=m(),h=document.getElementById("col-grid");if(!h)return;if(!u.length){h.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const b={},v=[];u.forEach($=>{const E=$.player.id;b[E]||(b[E]=!0,v.push($))}),h.innerHTML=v.map($=>{const E=y[$.player.id]||1,w=E>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${E}</div>`:"",L=s.filter(I=>I.player.id===$.player.id&&I.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return qe($,w+L)}).join(""),h.querySelectorAll("[data-card-id]").forEach($=>{$.addEventListener("click",()=>{const E=s.find(w=>w.id===$.dataset.cardId);E&&He(E,s,y,e)})})}g(),t.querySelectorAll(".filter-btn").forEach(u=>{u.addEventListener("click",()=>{p=u.dataset.job,t.querySelectorAll(".filter-btn").forEach(h=>{const b=h.dataset.job===p;h.style.background=b?"var(--green)":"#fff",h.style.color=b?"#fff":"var(--gray-600)",h.style.borderColor=b?"var(--green)":"var(--gray-200)"}),g()})}),document.getElementById("col-search").addEventListener("input",u=>{f=u.target.value.toLowerCase(),g()}),t.querySelectorAll("[data-gc-id]").forEach(u=>{u.addEventListener("click",()=>Pe(u.dataset.gcType,n))}),t.querySelectorAll("[data-form-id]").forEach(u=>{u.addEventListener("click",()=>Ke(u.dataset.formation,n))})}function Pe(t,e){const i=Q[t]||{icon:"⚡",desc:"Effet spécial."};e("Game Changer",`<div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}function Ke(t,e){const i={"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2}},o={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},r=i[t]||i["4-4-2"],n=["ATT","MIL","DEF","GK"];function a(d,c){const x=(d-1)*54,m=(c-x)/2;return Array.from({length:d},(g,u)=>m+u*54)}function l(d){return d===1?[1]:d===2?[0,2]:d===3?[0,1,2]:d===4?[0,1,1,2]:d===5?[0,1,1,1,2]:[1]}function s(){const p=n.length*72+48,f=n.map((u,h)=>24+h*72+72/2),x={};n.forEach(u=>{x[u]=a(r[u],290)});function m(u,h){const b=r[u],v=l(b),$=x[u],E=v.indexOf(h);return E>=0?$[E]:null}let g=`<svg width="290" height="${p}" viewBox="0 0 290 ${p}" xmlns="http://www.w3.org/2000/svg">`;n.forEach((u,h)=>{const b=x[u];for(let v=0;v<b.length-1;v++){const $=b[v]+20,E=b[v+1]-20,w=f[h];g+=`<line x1="${$}" y1="${w}" x2="${E}" y2="${w}"
          stroke="rgba(255,255,255,0.35)" stroke-width="2" stroke-dasharray="4,3"/>`,g+=`<text x="${($+E)/2}" y="${w-6}" text-anchor="middle"
          font-size="8" fill="rgba(255,255,255,0.45)">↔</text>`}});for(let u=0;u<3;u++)for(let h=0;h<n.length-1;h++){const b=n[h],v=n[h+1],$=m(b,u),E=m(v,u);if($!==null&&E!==null){const w=($+E)/2;g+=`<line x1="${$}" y1="${f[h]+20}" x2="${E}" y2="${f[h+1]-20}"
            stroke="rgba(255,255,255,0.35)" stroke-width="2" stroke-dasharray="4,3"/>`,g+=`<text x="${w+6}" y="${(f[h]+f[h+1])/2+3}"
            font-size="8" fill="rgba(255,255,255,0.45)">↕</text>`}}return n.forEach((u,h)=>{const b=r[u],v=x[u],$=l(b),E=o[u],w=f[h],T={};$.forEach((L,I)=>{T[L]||(T[L]={xs:[],indices:[]}),T[L].xs.push(v[I]),T[L].indices.push(I)}),Object.entries(T).forEach(([L,I])=>{const M=I.xs.length;if(M>1){const A=I.xs.reduce((B,U)=>B+U,0)/M;g+=`<circle cx="${A}" cy="${w}" r="20" fill="${E}" stroke="rgba(255,255,255,0.6)" stroke-width="2"/>`,g+=`<text x="${A}" y="${w-4}" text-anchor="middle" font-size="9" font-weight="900" fill="white" font-family="Arial Black,Arial">${u}</text>`,g+=`<text x="${A}" y="${w+9}" text-anchor="middle" font-size="8" font-weight="700" fill="rgba(255,255,255,0.85)">×${M}</text>`}else{const A=I.xs[0],B=I.indices[0]+1;g+=`<circle cx="${A}" cy="${w}" r="20" fill="${E}" stroke="rgba(255,255,255,0.6)" stroke-width="2"/>`,g+=`<text x="${A}" y="${w+4}" text-anchor="middle" font-size="9" font-weight="900" fill="white" font-family="Arial Black,Arial">${u}</text>`,g+=`<text x="${A}" y="${w+30}" text-anchor="middle" font-size="7" fill="rgba(255,255,255,0.4)">${u}${B}</text>`}})}),g+="</svg>",g}e(`Formation ${t}`,`<div style="background:linear-gradient(180deg,#1a6b3c,#0a3d1e);border-radius:12px;padding:16px;margin-bottom:14px;overflow-x:auto;text-align:center">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}function He(t,e,i,o){var E,w,T,L,I,M;const{state:r,toast:n,openModal:a,closeModal:l,navigate:s,refreshProfile:d}=o,c=t.player,y=e.filter(A=>A.player.id===c.id),p=y.length,f=Ne[c.rarity]||1e3,x=c.rarity!=="legende",m=_e(c),g=P(c,c.job),u=c.job2?P(c,c.job2):null,h=O[c.job]||"#1A6B3C",b=c.job2?O[c.job2]:null,v=$e[c.rarity]||"#ccc",$=Ee[c.country_code]||c.country_code||"";a(`${c.firstname} ${c.surname_encoded}`,`<div style="display:flex;gap:16px;flex-wrap:wrap;justify-content:center">
    ...
    </div>`:""}`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(T=document.getElementById("close-detail"))==null||T.addEventListener("click",l),(L=document.getElementById("direct-sell-btn"))==null||L.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte ${c.surname_encoded} pour ${f.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const A=y.find(U=>!U.is_for_sale)||y[0];if(!A){n("Aucune carte à vendre","error");return}const{error:B}=await _.from("cards").delete().eq("id",A.id);if(B){n(B.message,"error");return}await _.from("users").update({credits:(r.profile.credits||0)+f}).eq("id",r.profile.id),await d(),n(`+${f.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),l(),s("collection")}),(I=document.getElementById("market-sell-btn"))==null||I.addEventListener("click",async()=>{const A=parseInt(document.getElementById("sell-price").value);if(!A||A<1){n("Prix invalide","error");return}await _.from("cards").update({is_for_sale:!0,sale_price:A}).eq("id",t.id),await _.from("market_listings").insert({seller_id:r.profile.id,card_id:t.id,price:A}),n("Carte mise en vente sur le marché !","success"),l(),s("collection")}),(M=document.getElementById("cancel-sell-btn"))==null||M.addEventListener("click",async()=>{await _.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",t.id),await _.from("market_listings").update({status:"cancelled"}).eq("card_id",t.id).eq("status","active"),n("Annonce retirée","success"),l(),s("collection")})}const we={"4-4-2":[["ATT1","ATT2"],["MIL1","MIL2"],["MIL2","MIL3"],["MIL3","MIL4"],["DEF1","DEF2"],["DEF2","DEF3"],["DEF3","DEF4"],["ATT1","MIL1"],["ATT1","MIL2"],["ATT2","MIL3"],["ATT2","MIL4"],["MIL1","DEF1"],["MIL1","DEF2"],["MIL2","DEF2"],["MIL3","DEF3"],["MIL4","DEF3"],["MIL4","DEF4"],["DEF1","GK1"],["DEF2","GK1"],["DEF3","GK1"],["DEF4","GK1"]],"4-3-3":[["ATT1","ATT2"],["ATT2","ATT3"],["MIL1","MIL2"],["MIL2","MIL3"],["DEF1","DEF2"],["DEF2","DEF3"],["DEF3","DEF4"],["ATT1","MIL1"],["ATT2","MIL2"],["ATT3","MIL3"],["MIL1","DEF1"],["MIL1","DEF2"],["MIL2","DEF2"],["MIL2","DEF3"],["MIL3","DEF3"],["MIL3","DEF4"],["DEF1","GK1"],["DEF2","GK1"],["DEF3","GK1"],["DEF4","GK1"]],"3-4-3":[["ATT1","ATT2"],["ATT2","ATT3"],["MIL1","MIL2"],["MIL2","MIL3"],["MIL3","MIL4"],["DEF1","DEF2"],["DEF2","DEF3"],["ATT1","MIL1"],["ATT2","MIL2"],["ATT2","MIL3"],["ATT3","MIL4"],["MIL1","DEF1"],["MIL2","DEF1"],["MIL2","DEF2"],["MIL3","DEF2"],["MIL3","DEF3"],["MIL4","DEF3"],["DEF1","GK1"],["DEF2","GK1"],["DEF3","GK1"]],"3-5-2":[["ATT1","ATT2"],["MIL1","MIL2"],["MIL2","MIL3"],["MIL3","MIL4"],["MIL4","MIL5"],["DEF1","DEF2"],["DEF2","DEF3"],["ATT1","MIL1"],["ATT1","MIL2"],["ATT2","MIL4"],["ATT2","MIL5"],["MIL1","DEF1"],["MIL2","DEF1"],["MIL2","DEF2"],["MIL3","DEF2"],["MIL4","DEF2"],["MIL4","DEF3"],["MIL5","DEF3"],["DEF1","GK1"],["DEF2","GK1"],["DEF3","GK1"]],"5-3-2":[["ATT1","ATT2"],["MIL1","MIL2"],["MIL2","MIL3"],["DEF1","DEF2"],["DEF2","DEF3"],["DEF3","DEF4"],["DEF4","DEF5"],["ATT1","MIL1"],["ATT2","MIL3"],["MIL1","DEF1"],["MIL1","DEF2"],["MIL2","DEF2"],["MIL2","DEF3"],["MIL2","DEF4"],["MIL3","DEF4"],["MIL3","DEF5"],["DEF1","GK1"],["DEF2","GK1"],["DEF3","GK1"],["DEF4","GK1"],["DEF5","GK1"]]};function G(t,e){if(!t||!e)return"#cc2222";const i=t.country_code&&e.country_code&&t.country_code===e.country_code,o=t.club_id&&e.club_id&&t.club_id===e.club_id;return i&&o?"#00ff88":i||o?"#FFD700":"#ff3333"}const ke={"4-4-2":{ATT1:{x:.3,y:.04},ATT2:{x:.7,y:.04},MIL1:{x:.1,y:.3},MIL2:{x:.37,y:.3},MIL3:{x:.63,y:.3},MIL4:{x:.9,y:.3},DEF1:{x:.1,y:.6},DEF2:{x:.37,y:.6},DEF3:{x:.63,y:.6},DEF4:{x:.9,y:.6},GK1:{x:.5,y:.88}},"4-3-3":{ATT1:{x:.2,y:.04},ATT2:{x:.5,y:.04},ATT3:{x:.8,y:.04},MIL1:{x:.2,y:.33},MIL2:{x:.5,y:.33},MIL3:{x:.8,y:.33},DEF1:{x:.1,y:.62},DEF2:{x:.37,y:.62},DEF3:{x:.63,y:.62},DEF4:{x:.9,y:.62},GK1:{x:.5,y:.88}},"3-4-3":{ATT1:{x:.2,y:.04},ATT2:{x:.5,y:.04},ATT3:{x:.8,y:.04},MIL1:{x:.1,y:.33},MIL2:{x:.37,y:.33},MIL3:{x:.63,y:.33},MIL4:{x:.9,y:.33},DEF1:{x:.2,y:.62},DEF2:{x:.5,y:.62},DEF3:{x:.8,y:.62},GK1:{x:.5,y:.88}},"3-5-2":{ATT1:{x:.3,y:.04},ATT2:{x:.7,y:.04},MIL1:{x:.05,y:.33},MIL2:{x:.28,y:.33},MIL3:{x:.5,y:.33},MIL4:{x:.72,y:.33},MIL5:{x:.95,y:.33},DEF1:{x:.2,y:.62},DEF2:{x:.5,y:.62},DEF3:{x:.8,y:.62},GK1:{x:.5,y:.88}},"5-3-2":{ATT1:{x:.3,y:.04},ATT2:{x:.7,y:.04},MIL1:{x:.2,y:.33},MIL2:{x:.5,y:.33},MIL3:{x:.8,y:.33},DEF1:{x:.05,y:.62},DEF2:{x:.28,y:.62},DEF3:{x:.5,y:.62},DEF4:{x:.72,y:.62},DEF5:{x:.95,y:.62},GK1:{x:.5,y:.88}}},K={"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2}},F={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function te(t){const e=typeof import.meta<"u"?"https://fcnwclxlkytdfjotqkta.supabase.co":"";if(!e||!(t!=null&&t.skin)||!(t!=null&&t.hair))return null;const i=t.hair==="chauve"?`${t.skin}-chauve-rase`:`${t.skin}-${t.hair}-${t.hair_length}`;return`${e}/storage/v1/object/public/assets/tetes/${i}.png`}async function Ie(t,e){const{state:i,navigate:o,toast:r}=e;t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:n}=await _.from("decks").select("id,name,formation_card_id,is_active").eq("owner_id",i.profile.id).order("created_at",{ascending:!1});t.innerHTML=`
  <div class="page">
    <div class="page-header">
      <h2>Mes decks</h2>
  ...
  </div>`,document.getElementById("new-deck-btn").addEventListener("click",async()=>{const a=prompt("Nom du deck :",`Deck ${((n==null?void 0:n.length)||0)+1}`);if(!a)return;const{data:l,error:s}=await _.from("decks").insert({owner_id:i.profile.id,name:a,is_active:!(n!=null&&n.length)}).select().single();if(s){r(s.message,"error");return}r("Deck créé !","success"),ce(l.id,t,e)}),t.querySelectorAll("[data-edit]").forEach(a=>{a.addEventListener("click",()=>ce(a.dataset.edit,t,e))}),t.querySelectorAll("[data-activate]").forEach(a=>{a.addEventListener("click",async()=>{await _.from("decks").update({is_active:!1}).eq("owner_id",i.profile.id),await _.from("decks").update({is_active:!0}).eq("id",a.dataset.activate),r("Deck activé !","success"),Ie(t,e)})})}async function ce(t,e,i){const{state:o,toast:r}=i;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:n}=await _.from("decks").select("*").eq("id",t).single(),{data:a}=await _.from("cards").select(`id, card_type, formation,
      player:players(id, firstname, surname_encoded, country_code, club_id, job, job2,
        note_g, note_d, note_m, note_a, rarity, skin, hair, hair_length,
        clubs(encoded_name, logo_url))`).eq("owner_id",o.profile.id),l=(a||[]).filter(f=>f.card_type==="player"&&f.player),s=(a||[]).filter(f=>f.card_type==="formation"),d=s.map(f=>f.formation).filter(Boolean),{data:c}=await _.from("deck_cards").select("card_id, position, is_starter, slot_order").eq("deck_id",t);let y=n.formation||"4-4-2";d.length>0&&!d.includes(y)&&(y=d[0]);const p={deckId:t,name:n.name,formation:y,formationCardId:n.formation_card_id,slots:{},subs:[],playerCards:l,formationCards:s,availableFormations:d};(c||[]).forEach(f=>{f.is_starter?p.slots[f.position]=f.card_id:p.subs.includes(f.card_id)||p.subs.push(f.card_id)}),z(e,p,i)}function z(t,e,i){var s;const{navigate:o}=i;K[e.formation];const r=pe(e.formation),n=r.filter(d=>e.slots[d]).length,a=e.availableFormations.length>0?e.availableFormations:Object.keys(K),l=e.subs.map(d=>e.playerCards.find(c=>c.id===d)).filter(Boolean);[...Object.values(e.slots),...e.subs],t.innerHTML=`
  <div class="page">
  ...
  </div>`,Ue(t,e,r,i),document.getElementById("builder-back").addEventListener("click",()=>o("decks")),document.getElementById("formation-select").addEventListener("change",d=>{e.formation=d.target.value;const c=pe(e.formation),y={};c.forEach(p=>{e.slots[p]&&(y[p]=e.slots[p])}),e.slots=y,z(t,e,i)}),document.getElementById("save-deck").addEventListener("click",()=>Ye(e,i)),t.querySelectorAll("[data-remove-sub]").forEach(d=>{d.addEventListener("click",()=>{e.subs=e.subs.filter(c=>c!==d.dataset.removeSub),z(t,e,i)})}),(s=document.getElementById("add-sub-btn"))==null||s.addEventListener("click",()=>{Ve(e,t,i)})}function Ue(t,e,i,o){const r=document.getElementById("deck-field");if(!r)return;const n=e.formation,a=ke[n]||{},l=we[n]||[],s={};i.forEach(b=>{const v=e.slots[b],$=v?e.playerCards.find(E=>E.id===v):null;s[b]=($==null?void 0:$.player)||null});const d=i.filter(b=>b.startsWith("MIL"));let c=0,y=0;d.forEach(b=>{const v=s[b];v&&(c+=Number(v.note_m)||0)}),l.forEach(([b,v])=>{if(!b.startsWith("MIL")||!v.startsWith("MIL"))return;G(s[b],s[v])!=="#ff3333"&&y++});const p=320,f=320,x=28,m=4;function g(b){const v=a[b];return v?{x:v.x*p,y:v.y*f}:null}let u="";for(const[b,v]of l){const $=g(b),E=g(v);if(!$||!E)continue;const w=s[b],T=s[v],L=G(w,T),I=L==="#ff3333"?.3:.9,M=L!=="#ff3333"?`filter="url(#glow-${L.replace("#","")})"`:"";u+=`<line x1="${$.x}" y1="${$.y}" x2="${E.x}" y2="${E.y}"
      stroke="${L}" stroke-width="${m}" stroke-linecap="round"
      opacity="${I}" ${M}/>`}for(const b of i){const v=g(b);if(!v)continue;const $=s[b],E=b.replace(/\d+/,""),T={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[E]||"#555",L=$?Number(E==="GK"?$.note_g:E==="DEF"?$.note_d:E==="MIL"?$.note_m:$.note_a)||0:null,I=$?($.surname_encoded||"").slice(0,8).toUpperCase():"";if($){const M=te($);M&&(u+=`
          <defs>
            <clipPath id="clip-${b}">
              <circle cx="${v.x}" cy="${v.y}" r="${x}"/>
            </clipPath>
          </defs>
          <image href="${M}" x="${v.x-x}" y="${v.y-x}" width="${x*2}" height="${x*2}"
            clip-path="url(#clip-${b})" preserveAspectRatio="xMidYMid slice" opacity="0.85"/>`),u+=`
        <circle cx="${v.x}" cy="${v.y}" r="${x}" fill="${M?"transparent":T}"
          stroke="${T}" stroke-width="2" />
        <circle cx="${v.x}" cy="${v.y}" r="${x}" fill="${T}" opacity="${M?"0.5":"1"}"
          stroke="rgba(255,255,255,0.6)" stroke-width="2"/>
        ${M?`<image href="${M}" x="${v.x-x}" y="${v.y-x}" width="${x*2}" height="${x*2}"
        ...
        <text x="${v.x}" y="${v.y-3}" text-anchor="middle" font-size="9" fill="rgba(255,255,255,0.5)"
          font-family="Arial">${E}</text>
        <text x="${v.x}" y="${v.y+10}" text-anchor="middle" font-size="14" fill="rgba(255,255,255,0.4)"
          font-family="Arial">+</text>
        <rect x="${v.x-x}" y="${v.y-x}" width="${x*2}" height="${x*2}"
          fill="transparent" class="deck-slot-hit" data-pos="${b}" style="cursor:pointer"/>`}const h=`
    <defs>
    ...
    <svg viewBox="0 0 ${p} ${f}" width="100%" style="display:block;max-width:380px;margin:0 auto">
      ${h}
      ${u}
    </svg>`,r.querySelectorAll(".deck-slot-hit").forEach(b=>{b.addEventListener("click",()=>We(b.dataset.pos,e,t,o))})}function We(t,e,i,o){var p,f,x;const{openModal:r,closeModal:n}=o,a=t.replace(/\d+/,""),l=e.slots[t],s=l?e.playerCards.find(m=>m.id===l):null;(p=s==null?void 0:s.player)==null||p.id;const d=new Set;Object.entries(e.slots).forEach(([m,g])=>{var h;if(m===t||!g)return;const u=e.playerCards.find(b=>b.id===g);(h=u==null?void 0:u.player)!=null&&h.id&&d.add(u.player.id)}),e.subs.forEach(m=>{var u;const g=e.playerCards.find(h=>h.id===m);(u=g==null?void 0:g.player)!=null&&u.id&&d.add(g.player.id)});const c=new Set,y=e.playerCards.filter(m=>{const g=m.player;return!(g.job===a||g.job2===a)||d.has(g.id)||c.has(g.id)?!1:(c.add(g.id),!0)});y.sort((m,g)=>{const u=a==="GK"?m.player.note_g:a==="DEF"?m.player.note_d:a==="MIL"?m.player.note_m:m.player.note_a;return(a==="GK"?g.player.note_g:a==="DEF"?g.player.note_d:a==="MIL"?g.player.note_m:g.player.note_a)-u}),r(`Choisir ${a} — ${t}`,`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
      ${e.slots[t]?`
        <button class="btn btn-danger btn-sm" id="remove-player" style="width:100%;margin-bottom:4px">
          ✕ Retirer le joueur actuel
        </button>`:""}
      ${y.length>0?y.map(m=>{var v,$;const g=m.player,u=a==="GK"?g.note_g:a==="DEF"?g.note_d:a==="MIL"?g.note_m:g.note_a,h=te(g),b={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"}[g.rarity];return`<div class="player-option" data-card-id="${m.id}"
          style="display:flex;align-items:center;gap:10px;padding:8px;border:1.5px solid var(--gray-200);border-radius:10px;cursor:pointer">
          <!-- Portrait -->
          <div style="width:44px;height:44px;border-radius:8px;overflow:hidden;flex-shrink:0;background:#dde;border:2px solid ${F[a]}">
            ${h?`<img src="${h}" style="width:100%;height:100%;object-fit:cover">`:`<div style="width:100%;height:100%;background:${F[a]};display:flex;align-items:center;justify-content:center;color:#fff;font-size:10px;font-weight:700">${a}</div>`}
          </div>
          <!-- Infos -->
          <div style="flex:1;min-width:0">
            ...
            <div style="display:flex;align-items:center;gap:6px;margin-top:3px">
              ...
              ${(v=g.clubs)!=null&&v.logo_url?`<img src="${g.clubs.logo_url}" style="width:18px;height:18px;object-fit:contain">`:`<span style="font-size:10px;color:var(--gray-600)">${(($=g.clubs)==null?void 0:$.encoded_name)||"—"}</span>`}
              <span style="font-size:10px;color:var(--gray-600)">${g.country_code}</span>
            </div>
          </div>
          <!-- Note -->
          <div style="width:36px;height:36px;border-radius:8px;background:${F[a]};color:#fff;display:flex;align-items:center;justify-content:center;font-weight:900;font-size:16px;border:2px solid ${b};flex-shrink:0">
            ${u}
          </div>
        </div>`}).join(""):'<div style="text-align:center;color:var(--gray-600);padding:20px">Aucun joueur pour ce poste.<br><small>Ouvre des boosters !</small></div>'}
    </div>`,'<button class="btn btn-ghost" id="close-selector">Fermer</button>'),(f=document.getElementById("close-selector"))==null||f.addEventListener("click",n),(x=document.getElementById("remove-player"))==null||x.addEventListener("click",()=>{delete e.slots[t],n(),z(i,e,o)}),document.querySelectorAll(".player-option").forEach(m=>{m.addEventListener("click",()=>{e.slots[t]=m.dataset.cardId,n(),z(i,e,o)})})}function Ve(t,e,i){var s;const{openModal:o,closeModal:r}=i,n=new Set;Object.values(t.slots).filter(Boolean).forEach(d=>{var y;const c=t.playerCards.find(p=>p.id===d);(y=c==null?void 0:c.player)!=null&&y.id&&n.add(c.player.id)}),t.subs.forEach(d=>{var y;const c=t.playerCards.find(p=>p.id===d);(y=c==null?void 0:c.player)!=null&&y.id&&n.add(c.player.id)});const a=new Set,l=t.playerCards.filter(d=>{var c,y,p;return n.has((c=d.player)==null?void 0:c.id)||a.has((y=d.player)==null?void 0:y.id)?!1:(a.add((p=d.player)==null?void 0:p.id),!0)});o("Ajouter un remplaçant",`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
  ...
  <div class="page">
    ...
    <div class="page-body">
      <div class="booster-grid">
        ${fe.map(a=>{const l=r>=a.cost||a.cost===0,s=a.id==="players_std"||a.id==="players_pub";return`<div class="booster-card ${l?"":"disabled"}" data-booster="${a.id}" style="position:relative">
  ...
  `,document.body.appendChild(o);let r=!1;document.getElementById("pack-visual").addEventListener("click",()=>{if(r)return;r=!0;const p=document.getElementById("pack-visual");p.classList.add("shaking"),setTimeout(()=>{p.classList.add("pack-open"),setTimeout(()=>{document.getElementById("pack-phase").style.display="none",a(0)},600)},500)});let n=0;function a(p){n=p;const f=document.getElementById("reveal-phase");f.style.display="flex",l(p)}function l(p){var $;const f=t[p],x=document.getElementById("card-counter"),m=document.getElementById("single-card-slot"),g=document.getElementById("card-tap-hint");x&&(x.textContent=`Carte ${p+1} / ${t.length}`),g&&(g.textContent=p<t.length-1?"Appuie pour continuer →":"Appuie pour voir toutes tes cartes");const u=ue(f),h=f.card_type==="player"&&(($=f.player)==null?void 0:$.rarity)==="legende";m.innerHTML=`
      <div id="current-card-wrap" class="single-card-reveal" style="cursor:pointer;${h?"filter:drop-shadow(0 0 20px #7a28b8)":""}">
        ${u}
      </div>`,h&&c();const b=document.getElementById("current-card-wrap");let v=!1;b.addEventListener("click",()=>{if(v)return;v=!0;const E=p+1;E<t.length?(b.style.transition="all 0.25s ease",b.style.transform="translateX(-120%) rotate(-15deg)",b.style.opacity="0",setTimeout(()=>l(E),250)):s()})}function s(){y(),document.getElementById("reveal-phase").style.display="none";const p=document.getElementById("recap-phase");p.style.display="flex";const f=document.getElementById("recap-grid");f.innerHTML=t.map((x,m)=>`
      <div class="recap-card" style="--i:${m};animation-delay:${m*.07}s">
        ${ue(x)}
      </div>`).join("")}let d=null;function c(){const p=document.getElementById("fireworks-canvas");if(!p)return;p.width=window.innerWidth,p.height=window.innerHeight;const f=p.getContext("2d"),x=[];function m(){const u=Math.random()*p.width,h=Math.random()*p.height*.6,b=["#7a28b8","#ff4081","#D4A017","#00e676","#fff","#e040fb","#40c4ff"],v=b[Math.floor(Math.random()*b.length)];for(let $=0;$<60;$++){const E=Math.PI*2/60*$,w=2+Math.random()*5;x.push({x:u,y:h,vx:Math.cos(E)*w,vy:Math.sin(E)*w,alpha:1,color:v,size:2+Math.random()*3})}}m(),d=setInterval(m,600);function g(){if(document.getElementById("fireworks-canvas")){f.clearRect(0,0,p.width,p.height);for(let u=x.length-1;u>=0;u--){const h=x[u];if(h.x+=h.vx,h.y+=h.vy+.08,h.vy*=.98,h.alpha-=.018,h.alpha<=0){x.splice(u,1);continue}f.globalAlpha=h.alpha,f.fillStyle=h.color,f.beginPath(),f.arc(h.x,h.y,h.size,0,Math.PI*2),f.fill()}f.globalAlpha=1,(d!==null||x.length>0)&&requestAnimationFrame(g)}}g()}function y(){d!==null&&(clearInterval(d),d=null);const p=document.getElementById("fireworks-canvas");p&&p.getContext("2d").clearRect(0,0,p.width,p.height)}document.getElementById("reveal-collection").addEventListener("click",()=>{y(),o.remove(),i("collection")}),document.getElementById("reveal-more").addEventListener("click",()=>{y(),o.remove(),i("boosters")})}function ue(t){var e,i;if(t.card_type==="player"&&t.player){const o=t.player,r=o.job||"ATT",n=Xe[r]||"#1A6B3C",a=Qe[o.rarity]||"#ccc",l=r==="GK"?o.note_g:r==="DEF"?o.note_d:r==="MIL"?o.note_m:o.note_a,s=Je(o),d={MA:"MAROC",FR:"FRANCE",AR:"ARGENTINE",PT:"PORTUGAL",BR:"BRESIL",ES:"ESPAGNE",DE:"ALLEMAGNE",GB:"ANGLETERRE",IT:"ITALIE",CM:"CAMEROUN",SN:"SENEGAL"}[o.country_code]||o.country_code;return`<div style="width:140px;height:200px;background:#f2e8d2;border-radius:12px;border:3px solid ${a};overflow:hidden;display:flex;flex-direction:column">
      <!-- Nom -->
    ...
    </div>`:'<div style="width:140px;height:200px;background:#333;border-radius:12px"></div>'}function rt(){const t=document.createElement("div");t.style.cssText=`position:fixed;inset:0;background:rgba(0,0,0,0.6);display:flex;
  ...
  `,document.body.appendChild(t),t.addEventListener("click",e=>{e.target===t&&t.remove()}),document.getElementById("odds-close").addEventListener("click",()=>t.remove())}function dt(){return new Promise(t=>{const e=document.createElement("div");e.style.cssText="position:fixed;inset:0;background:#000;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:4000;color:#fff;gap:16px";let i=5;e.innerHTML=`<div style="font-size:48px">📺</div>
      ...
      <div style="font-size:36px;font-weight:900" id="ad-cd">5</div>`,document.body.appendChild(e);const o=setInterval(()=>{i--;const r=document.getElementById("ad-cd");r&&(r.textContent=i),i<=0&&(clearInterval(o),e.remove(),t(!0))},1e3)})}const S={"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2}},W={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function Te(t,e,i,o,r){var n;t.innerHTML=`<div class="match-screen" style="display:flex;align-items:center;justify-content:center;min-height:100vh">
    <div style="text-align:center;padding:40px;color:#fff">
      <div style="font-size:48px;margin-bottom:16px">${e}</div>
      <p style="margin-bottom:16px">${i}</p>
      <button class="btn btn-primary" id="msg-btn">${o}</button>
    </div>
  </div>`,(n=document.getElementById("msg-btn"))==null||n.addEventListener("click",r)}function Ae(t){const e=typeof import.meta<"u"?"https://fcnwclxlkytdfjotqkta.supabase.co":"";if(!e||!(t!=null&&t.skin)||!(t!=null&&t.hair))return null;const i=t.hair==="chauve"?`${t.skin}-chauve-rase`:`${t.skin}-${t.hair}-${t.hair_length}`;return`${e}/storage/v1/object/public/assets/tetes/${i}.png`}function ye(t){const e=t.player;return{cardId:t.id,id:e.id,firstname:e.firstname,name:e.surname_encoded,country_code:e.country_code,club_id:e.club_id,job:e.job,job2:e.job2,note_g:Number(e.note_g)||0,note_d:Number(e.note_d)||0,note_m:Number(e.note_m)||0,note_a:Number(e.note_a)||0,rarity:e.rarity,skin:e.skin,hair:e.hair,hair_length:e.hair_length,boost:0,used:!1,_line:null,_col:null}}function ie(t){return t===1?[1]:t===2?[0,2]:t===3?[0,1,2]:t===4?[0,1,1,2]:t===5?[0,1,1,1,2]:[1]}function lt(){const t=Math.random()*100;return t<.1?4:t<5?3:t<20?2:1}function ct(t,e){const i=S[e]||S["4-4-2"],o={GK:[],DEF:[],MIL:[],ATT:[]},r=[...t];for(const n of["GK","DEF","MIL","ATT"]){const a=[];for(let s=0;s<i[n];s++){let d=r.findIndex(c=>c.job===n);if(d===-1&&(d=r.findIndex(c=>c.job2===n)),d===-1&&(d=0),r[d]){const c={...r[d],_line:n};a.push(c),r.splice(d,1)}}const l=ie(a.length);a.forEach((s,d)=>{s._col=l[d]}),o[n]=a}return o}async function pt(t,e){const{data:i}=await _.from("players").select("id,firstname,surname_encoded,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length").eq("is_active",!0).limit(60);if(!i||i.length<11)return ft(t);const o=S[t]||S["4-4-2"],r={GK:[],DEF:[],MIL:[],ATT:[]},n=[...i];for(const a of["GK","DEF","MIL","ATT"]){const l=n.filter(p=>p.job===a),s=n.filter(p=>p.job!==a),d=[...l,...s],c=[];for(let p=0;p<o[a];p++){const f=d[p]||n[p];f&&c.push({cardId:"ai-"+f.id+"-"+p,id:f.id,firstname:f.firstname,name:f.surname_encoded,country_code:f.country_code,club_id:f.club_id,job:f.job,job2:f.job2,note_g:Number(f.note_g)||0,note_d:Number(f.note_d)||0,note_m:Number(f.note_m)||0,note_a:Number(f.note_a)||0,rarity:f.rarity,skin:f.skin,hair:f.hair,hair_length:f.hair_length,boost:0,used:!1,_line:a})}const y=ie(c.length);c.forEach((p,f)=>{p._col=y[f]}),r[a]=c}return r}function ft(t){const e=S[t]||S["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},o=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let r=0;for(const n of["GK","DEF","MIL","ATT"]){const a=[];for(let s=0;s<e[n];s++){const d=3+Math.floor(Math.random()*5);a.push({cardId:"fake-"+r,id:"fake-"+r,firstname:"IA",name:o[r%o.length],country_code:"XX",club_id:null,job:n,job2:null,note_g:n==="GK"?d:2,note_d:n==="DEF"?d:2,note_m:n==="MIL"?d:2,note_a:n==="ATT"?d:2,rarity:"normal",boost:0,used:!1,_line:n}),r++}const l=ie(a.length);a.forEach((s,d)=>{s._col=l[d]}),i[n]=a}return i}async function ut(t,e){var v;const{state:i,navigate:o,toast:r}=e,n=i.params||{};t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const a=n.matchMode||"vs_ai_easy",l=a.replace("vs_ai_",""),s=a;if(!n.deckId)return yt(t,e,a);const d=n.deckId,{data:c}=await _.from("deck_cards").select(`position, is_starter, slot_order,
      card:cards(id, card_type, formation,
        player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
          clubs(encoded_name,logo_url)))`).eq("deck_id",d).order("slot_order"),y=(c||[]).filter($=>{var E;return $.is_starter&&((E=$.card)==null?void 0:E.player)}).map($=>ye($.card)),p=(c||[]).filter($=>{var E;return!$.is_starter&&((E=$.card)==null?void 0:E.player)}).map($=>ye($.card));if(y.length<11){Te(t,"⚠️",`Deck incomplet (${y.length}/11).`,"Compléter",()=>o("decks"));return}const f=(c||[]).find($=>{var E;return((E=$.card)==null?void 0:E.card_type)==="formation"}),x=((v=f==null?void 0:f.card)==null?void 0:v.formation)||"4-4-2",{data:m}=await _.from("cards").select("id,gc_type").eq("owner_id",i.profile.id).eq("card_type","game_changer"),g=ct(y,x),u=await pt(x),{data:h}=await _.from("matches").insert({home_id:i.profile.id,away_id:null,mode:s,home_deck_id:d,status:"in_progress"}).select().single(),b={matchId:h==null?void 0:h.id,mode:s,difficulty:l,formation:x,homeTeam:g,aiTeam:u,homeSubs:p,subsUsed:0,maxSubs:Math.min(p.length,3),homeScore:0,aiScore:0,gcCards:m||[],usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};gt(t,b,e)}async function yt(t,e,i){var a;const{state:o,navigate:r}=e,{data:n}=await _.from("decks").select("id,name,is_active,formation_card_id").eq("owner_id",o.profile.id).order("created_at",{ascending:!1});if(!n||n.length===0){Te(t,"📋","Aucun deck. Crée un deck avant de jouer !","Créer un deck",()=>r("decks"));return}t.innerHTML=`
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${y.map((x,m)=>{const g=Ae(x),u=m<y.length-1?G(x,y[m+1]):null;return`
          <div style="width:52px;height:52px;border-radius:8px;background:${f};position:relative;flex-shrink:0;overflow:hidden;border:2px solid rgba(255,255,255,0.3)">
            ...
            <div style="position:relative;z-index:1;font-size:15px;font-weight:900;color:#fff;text-shadow:0 1px 3px #000">${C(x,"MIL")}</div>
  ...
  <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;gap:20px;padding:20px">
    ...
    <div id="midfield-result" style="opacity:0;text-align:center;transition:opacity 0.5s;color:#fff">
      ...
      `,d&&(e.boostCard={value:x})}e.attacker=d?"home":"ai",e.log.push({text:`Duel milieu : ${e.clubName} ${l} – ${s} IA → ${d?e.clubName:"IA"} attaque en premier`,type:"info"}),setTimeout(()=>{e.phase=e.attacker==="home"?"attack":"ai-attack",D(t,e,i),e.attacker==="ai"&&setTimeout(()=>V(t,e,i),1e3)},2800)},1200)}function Me(t,e,i,o,r=310,n=310){const a=ke[e]||{},l=we[e]||[],s=26,d={},c=["ATT","MIL","DEF","GK"];for(const x of c)(t[x]||[]).forEach((g,u)=>{d[`${x}${u+1}`]=g});function y(x){const m=a[x];return m?{x:m.x*r,y:m.y*n}:null}let p="";for(const[x,m]of l){const g=y(x),u=y(m);if(!g||!u)continue;const h=d[x],b=d[m],v=G(h,b),$=v==="#ff3333"?.25:.9,E=v!=="#ff3333"?`filter="url(#glow${v.replace("#","").slice(0,6)})"`:"";p+=`<line x1="${g.x.toFixed(1)}" y1="${g.y.toFixed(1)}" x2="${u.x.toFixed(1)}" y2="${u.y.toFixed(1)}"
      stroke="${v}" stroke-width="3.5" stroke-linecap="round" opacity="${$}" ${E}/>`}for(const[x,m]of Object.entries(d)){const g=y(x);if(!g)continue;const u=x.replace(/[0-9]/g,""),b={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[u]||"#555",v=i==="attack"&&["MIL","ATT"].includes(u)&&!m.used||i==="defense"&&["GK","DEF","MIL"].includes(u)&&!m.used,$=o.includes(m.cardId);let E;i==="attack"?E=u==="MIL"?Number(m.note_m)||0:Number(m.note_a)||0:i==="defense"?E=u==="GK"?Number(m.note_g)||0:u==="MIL"?Number(m.note_m)||0:Number(m.note_d)||0:E=Number(u==="GK"?m.note_g:u==="DEF"?m.note_d:u==="MIL"?m.note_m:m.note_a)||0,E=E+(m.boost||0);const w=$?"#FFD700":v?"rgba(255,255,255,0.7)":"rgba(255,255,255,0.25)",T=$?3:2,L=m.used?.25:1,I=Ae(m);I&&(p+=`<defs><clipPath id="mc-${x}"><circle cx="${g.x}" cy="${g.y}" r="${s}"/></clipPath></defs>`),p+=`<circle cx="${g.x}" cy="${g.y}" r="${s}" fill="${b}" opacity="${L}"
      stroke="${w}" stroke-width="${T}"/>`,I&&!m.used&&(p+=`<image href="${I}" x="${g.x-s}" y="${g.y-s}" width="${s*2}" height="${s*2}"
        clip-path="url(#mc-${x})" preserveAspectRatio="xMidYMid slice" opacity="0.8"/>`,p+=`<circle cx="${g.x}" cy="${g.y}" r="${s}" fill="${b}" opacity="0.35"
        stroke="${w}" stroke-width="${T}"/>`),m.boost&&(p+=`<rect x="${g.x+s-10}" y="${g.y-s}" width="14" height="10" rx="3" fill="#87CEEB"/>
      ...
      fill="${m.used?"#555":"white"}" font-family="Arial Black,Arial">${m.used?"–":E}</text>
    <text x="${g.x}" y="${g.y+11}" text-anchor="middle" font-size="6" fill="rgba(255,255,255,${m.used?.3:.8})"
      font-family="Arial">${(m.name||"").slice(0,8)}</text>`,v&&(p+=`<circle cx="${g.x}" cy="${g.y}" r="${s}" fill="rgba(255,255,255,0.08)"
        class="match-slot-hit ${$?"selected":""}" data-card-id="${m.cardId}" data-role="${u}"
    ...
    ${Me(t,e,i,o)}
  </div>`}function D(t,e,i){var d,c,y,p;const o={attack:"⚔️ Choisissez vos attaquants",defense:"🛡️ Choisissez vos défenseurs","ai-attack":"🤖 L'IA attaque...","ai-defense":"🤖 L'IA défend...",finished:"🏁 Match terminé"}[e.phase]||"",r=e.selected.map(f=>f.cardId),n=e.usedSubIds||[],a=e.homeSubs.filter(f=>!n.includes(f.cardId)),l=Object.values(e.homeTeam).flat().filter(f=>f.used);t.innerHTML=`
  <div class="match-screen">
    ...
    <div class="match-field" id="match-field" style="position:relative">
      ${mt(e.homeTeam,e.formation,e.phase,r)}
    </div>
    ...
    <div style="padding:6px 12px;display:flex;gap:6px;overflow-x:auto;align-items:center;background:rgba(0,0,0,0.2)">
      ...
      ${e.gcCards.filter(f=>!e.usedGc.includes(f.id)).map(f=>{var x;return`
        <div class="gc-mini" data-gc-id="${f.id}" data-gc-type="${f.gc_type}"
          ...
          <div style="font-size:14px">${((x=Q[f.gc_type])==null?void 0:x.icon)||"⚡"}</div>
    ...
    <div class="match-log" id="match-log">
  ...
  </div>`,(d=document.getElementById("match-quit"))==null||d.addEventListener("click",()=>{confirm("Abandonner le match ?")&&i.navigate("home")}),(c=document.getElementById("view-ai"))==null||c.addEventListener("click",()=>kt(e,i)),vt(t,e,i),t.querySelectorAll(".match-slot-hit").forEach(f=>{f.addEventListener("click",()=>ht(f,e,t,i))}),t.querySelectorAll(".gc-mini").forEach(f=>{f.addEventListener("click",()=>wt(f.dataset.gcId,f.dataset.gcType,t,e,i))}),(y=document.getElementById("boost-card"))==null||y.addEventListener("click",()=>{Et(t,e,i)}),(p=document.getElementById("sub-btn"))==null||p.addEventListener("click",()=>{_t(t,e,i)});const s=document.getElementById("match-log");s&&(s.scrollTop=s.scrollHeight)}function vt(t,e,i){var r,n,a,l;const o=document.getElementById("match-actions");if(o)if(e.phase==="attack"){const s=e.selected.length>0?Z(e.selected.map(d=>({...d,_line:d._role})),e.modifiers.home):null;o.innerHTML=`
      ...
      <button class="btn btn-primary" id="confirm-attack" style="width:100%" ${s?"":"disabled"}>Attaquer →</button>`,(r=document.getElementById("confirm-attack"))==null||r.addEventListener("click",()=>xt(t,e,i))}else if(e.phase==="defense"){const s=e.selected.length>0?ee(e.selected.map(d=>({...d,_line:d._role})),e.modifiers.home):null;o.innerHTML=`
      <div style="text-align:center;color:#fff;margin-bottom:6px;font-size:13px">
      ...
      <button class="btn btn-primary" id="confirm-defense" style="width:100%" ${s?"":"disabled"}>Défendre →</button>`,(a=document.getElementById("confirm-defense"))==null||a.addEventListener("click",()=>bt(t,e,i))}else e.phase==="finished"?(o.innerHTML='<button class="btn btn-primary" id="end-match" style="width:100%">Voir les résultats</button>',(l=document.getElementById("end-match"))==null||l.addEventListener("click",()=>i.navigate("home"))):o.innerHTML=`<div style="text-align:center;color:rgba(255,255,255,.4);padding:8px;font-size:12px">⏳ Tour de l'IA...</div>`}function ht(t,e,i,o){const r=t.dataset.cardId,n=t.dataset.role,a=e.selected.findIndex(l=>l.cardId===r);if(a!==-1)e.selected.splice(a,1);else{if(e.selected.length>=3){o.toast("Maximum 3 joueurs","error");return}const l=(e.homeTeam[n]||[]).find(s=>s.cardId===r);l&&e.selected.push({...l,_role:n,_line:n})}D(i,e,o)}function xt(t,e,i){const o=e.selected.map(n=>({...n,_line:n._role})),r=Z(o,e.modifiers.home);e.pendingAttack={...r,players:[...e.selected],side:"home"},e.selected.forEach(n=>{const a=(e.homeTeam[n._role]||[]).find(l=>l.cardId===n.cardId);a&&(a.used=!0)}),e.log.push({text:`Vous attaquez : ${r.total} (${e.selected.map(n=>n.name).join(", ")})`,type:"info"}),e.selected=[],e.modifiers.home={},e.phase="ai-defense",D(t,e,i),setTimeout(()=>$t(t,e,i),1200)}function bt(t,e,i){const o=e.selected.map(a=>({...a,_line:a._role})),r=ee(o,e.modifiers.home);e.selected.forEach(a=>{const l=(e.homeTeam[a._role]||[]).find(s=>s.cardId===a.cardId);l&&(l.used=!0)});const n=xe(e.pendingAttack.total,r.total,e.modifiers.home);n.shielded?e.log.push({text:"🛡️ Bouclier ! But annulé.",type:"info"}):n.goal?(e.aiScore++,e.log.push({text:`⚽ BUT IA ! (${e.pendingAttack.total} > ${r.total})`,type:"goal"})):e.log.push({text:`🧤 Défense ! (${r.total} ≥ ${e.pendingAttack.total})`,type:"info"}),e.selected=[],e.modifiers.home={},e.pendingAttack=null,Ce(t,e,i,"home-attack")}function V(t,e,i){const o=[...e.aiTeam.MIL||[],...e.aiTeam.ATT||[]],r=be(o,"attack",e.difficulty);if(!r.length){Be(t,e,i);return}const n=Z(r,e.modifiers.ai);e.pendingAttack={...n,players:r,side:"ai"},r.forEach(a=>{a.used=!0}),e.log.push({text:`IA attaque : ${n.total}`,type:"info"}),e.modifiers.ai={},e.phase="defense",D(t,e,i)}function $t(t,e,i){const o=[...e.aiTeam.GK||[],...e.aiTeam.DEF||[],...e.aiTeam.MIL||[]],r=be(o,"defense",e.difficulty),n=r.length>0?ee(r,e.modifiers.ai).total:0;r.forEach(l=>{l.used=!0});const a=xe(e.pendingAttack.total,n,e.modifiers.ai);a.shielded?e.log.push({text:"🛡️ Bouclier IA !",type:"info"}):a.goal?(e.homeScore++,e.log.push({text:`⚽ BUT ! (${e.pendingAttack.total} > ${n})`,type:"goal"})):e.log.push({text:`🧤 IA défend (${n} ≥ ${e.pendingAttack.total})`,type:"info"}),e.modifiers.ai={},e.pendingAttack=null,Ce(t,e,i,"ai-attack")}function Ce(t,e,i,o){if(e.round++,De(e)){Y(t,e,i);return}if(o==="home-attack"){if(![...e.homeTeam.MIL||[],...e.homeTeam.ATT||[]].filter(n=>!n.used).length){if(![...e.homeTeam.GK||[],...e.homeTeam.DEF||[],...e.homeTeam.MIL||[]].filter(a=>!a.used).length){Y(t,e,i);return}e.phase="ai-attack",D(t,e,i),setTimeout(()=>V(t,e,i),800);return}e.phase="attack",D(t,e,i)}else{if(![...e.aiTeam.MIL||[],...e.aiTeam.ATT||[]].filter(n=>!n.used).length){Be(t,e,i);return}e.phase="ai-attack",D(t,e,i),setTimeout(()=>V(t,e,i),800)}}function De(t){const e=["MIL","ATT","GK","DEF"].some(o=>(t.homeTeam[o]||[]).some(r=>!r.used)),i=["MIL","ATT","GK","DEF"].some(o=>(t.aiTeam[o]||[]).some(r=>!r.used));return!e&&!i}function Be(t,e,i){De(e)?Y(t,e,i):(e.phase="attack",D(t,e,i))}function Et(t,e,i){const o=Object.values(e.homeTeam).flat().filter(r=>!r.used);if(!o.length){i.toast("Aucun joueur actif à booster","error");return}i.openModal("⚡ Utiliser le Boost",`<div style="margin-bottom:12px;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border-radius:10px;padding:12px;text-align:center;color:#000">
    ...
    <div style="display:flex;flex-direction:column;gap:6px">
      ${o.map(r=>`
        <div class="player-boost-opt" data-card-id="${r.cardId}"
          ...
          <div style="width:32px;height:32px;background:${W[r.job]||"#888"};border-radius:6px;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:900;font-size:13px">${C(r,r._line||r.job)}</div>
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Annuler</button>`),document.querySelectorAll(".player-boost-opt").forEach(r=>{r.addEventListener("click",()=>{const n=r.dataset.cardId;for(const a of["GK","DEF","MIL","ATT"]){const l=(e.homeTeam[a]||[]).find(s=>s.cardId===n);if(l){l.boost=(l.boost||0)+e.boostCard.value,e.log.push({text:`⚡ Boost +${e.boostCard.value} appliqué à ${l.name}`,type:"info"});break}}e.boostUsed=!0,i.closeModal(),D(t,e,i)})})}function _t(t,e,i){e.usedSubIds||(e.usedSubIds=[]);const o=Object.values(e.homeTeam).flat().filter(s=>s.used),r=e.homeSubs.filter(s=>!e.usedSubIds.includes(s.cardId));if(!o.length){i.toast("Aucun joueur grisé","info");return}if(!r.length){i.toast("Aucun remplaçant disponible","info");return}if(e.subsUsed>=e.maxSubs){i.toast(`Maximum ${e.maxSubs} remplacements`,"error");return}i.openModal("🔄 Remplacement",`<div style="margin-bottom:12px">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Annuler</button>`);let n=null,a=null;document.querySelectorAll(".grayed-opt").forEach(s=>{s.addEventListener("click",()=>{document.querySelectorAll(".grayed-opt").forEach(d=>d.style.borderColor="#eee"),s.style.borderColor="#c0392b",n={cardId:s.dataset.cardId,role:s.dataset.role},l()})}),document.querySelectorAll(".sub-opt").forEach(s=>{s.addEventListener("click",()=>{document.querySelectorAll(".sub-opt").forEach(d=>d.style.borderColor="var(--green)"),s.style.borderColor="#D4A017",a=s.dataset.cardId,l()})});function l(){if(!n||!a)return;const s=n.role,d=e.homeTeam[s]||[],c=d.findIndex(p=>p.cardId===n.cardId),y=e.homeSubs.find(p=>p.cardId===a);c!==-1&&y&&(y._line=s,y._col=d[c]._col,y.used=!1,d.splice(c,1,y),e.usedSubIds=[...e.usedSubIds||[],a],e.subsUsed++,e.log.push({text:`🔄 Remplacement : ${y.firstname} ${y.name} entre`,type:"info"})),i.closeModal(),D(t,e,i)}}function wt(t,e,i,o,r){if(!o.usedGc.includes(t)){switch(o.usedGc.push(t),e){case"Double attaque":o.modifiers.home.doubleAttack=!0,o.log.push({text:"⚡ Double attaque !",type:"info"});break;case"Bouclier":o.modifiers.home.shield=!0,o.log.push({text:"🛡️ Bouclier !",type:"info"});break;case"Ressusciter":{let n=!1;for(const a of["ATT","MIL","DEF","GK"]){const l=(o.homeTeam[a]||[]).find(s=>s.used);if(l){l.used=!1,n=!0;break}}o.log.push({text:n?"💫 Joueur ressuscité !":"💫 Aucun joueur à ressusciter",type:"info"});break}case"Vol de note":o.modifiers.ai.stolenNote=(o.modifiers.ai.stolenNote||0)+1,o.log.push({text:"🎯 -1 à la prochaine IA",type:"info"});break;case"Gel":{const n=[...o.aiTeam.ATT||[],...o.aiTeam.MIL||[]].filter(a=>!a.used);if(n.length){const a=n.sort((l,s)=>C(s,"ATT")-C(l,"ATT"))[0];a.used=!0,o.log.push({text:`❄️ ${a.name} (IA) gelé !`,type:"info"})}break}case"Remplacement+":o.maxSubs++,o.log.push({text:"🔄 +1 remplacement",type:"info"});break}_.from("cards").delete().eq("id",t).then(()=>{}),D(i,o,r)}}async function Y(t,e,i){var c,y;e.phase="finished";const{state:o}=i,r=e.homeScore>e.aiScore,n=e.homeScore===e.aiScore,a=r?"victoire":n?"nul":"defaite",l=Ge(e.mode,a);e.matchId&&await _.from("matches").update({status:"finished",home_score:e.homeScore,away_score:e.aiScore,winner_id:r?o.profile.id:null,home_credits_reward:l,played_at:new Date().toISOString()}).eq("id",e.matchId);const s={credits:(o.profile.credits||0)+l,matches_played:(o.profile.matches_played||0)+1};r?s.wins=(o.profile.wins||0)+1:n?s.draws=(o.profile.draws||0)+1:s.losses=(o.profile.losses||0)+1,await _.from("users").update(s).eq("id",o.profile.id),await i.refreshProfile();const d=document.createElement("div");d.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.85);display:flex;align-items:center;justify-content:center;z-index:2000",d.innerHTML=`
    ...
    </div>`,`<button class="btn btn-primary" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const It={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"};async function Lt(t,e){const{state:i,toast:o}=e;t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement du marché...</div>',await oe(t,e)}async function oe(t,e){const{state:i,toast:o}=e,{data:r}=await _.from("market_listings").select(`id, price, status, listed_at, seller_id,
  ...
  `;function l(s){const d=document.getElementById("mkt-content"),c=s==="buy"?a:n;if(c.length===0){d.innerHTML=`<div style="text-align:center;color:var(--gray-600);padding:40px">
      ...
      ${c.map(y=>{var g,u,h;const p=(g=y.card)==null?void 0:g.player;if(!p)return"";const f=p.job==="GK"?p.note_g:p.job==="DEF"?p.note_d:p.job==="MIL"?p.note_m:p.note_a,x=It[p.rarity],m=(i.profile.credits||0)>=y.price;return`<div class="card-panel" style="display:flex;align-items:center;gap:12px;padding:12px">
          <div style="width:44px;height:44px;border-radius:8px;background:${Mt(p.job)};color:#fff;display:flex;align-items:center;justify-content:center;font-weight:900;font-size:18px;border:2px solid ${x};flex-shrink:0">${f}</div>
          <div style="flex:1;min-width:0">
            ...
            <div style="font-size:11px;color:var(--gray-600)">Vendeur : ${((h=y.seller)==null?void 0:h.pseudo)||"—"}</div>
          </div>
          <div style="text-align:right;flex-shrink:0">
            <div style="font-weight:900;color:var(--yellow);font-size:15px">${y.price.toLocaleString("fr")}</div>
            ${s==="buy"?`<button class="btn btn-primary btn-sm" data-buy="${y.id}" ${m?"":"disabled"} style="margin-top:4px">${m?"Acheter":"Trop cher"}</button>`:`<button class="btn btn-danger btn-sm" data-cancel="${y.id}" style="margin-top:4px">Retirer</button>`}
          </div>
        </div>`}).join("")}
    </div>`,d.querySelectorAll("[data-buy]").forEach(y=>{y.addEventListener("click",()=>Tt(y.dataset.buy,c,t,e))}),d.querySelectorAll("[data-cancel]").forEach(y=>{y.addEventListener("click",()=>At(y.dataset.cancel,t,e))})}l("buy"),t.querySelectorAll(".mkt-tab").forEach(s=>{s.addEventListener("click",()=>{t.querySelectorAll(".mkt-tab").forEach(d=>{const c=d===s;d.style.background=c?"var(--green)":"#fff",d.style.color=c?"#fff":"var(--gray-600)",d.style.borderColor=c?"var(--green)":"var(--gray-200)"}),l(s.dataset.tab)})})}async function Tt(t,e,i,o){const{state:r,toast:n,refreshProfile:a}=o,l=e.find(s=>s.id===t);if(l){if((r.profile.credits||0)<l.price){n("Crédits insuffisants","error");return}if(confirm(`Acheter ${l.card.player.firstname} ${l.card.player.surname_encoded} pour ${l.price.toLocaleString("fr")} crédits ?`))try{const{error:s}=await _.from("cards").update({owner_id:r.profile.id,is_for_sale:!1,sale_price:null}).eq("id",l.card.id);if(s)throw s;await _.from("market_listings").update({status:"sold",buyer_id:r.profile.id,sold_at:new Date().toISOString()}).eq("id",t),await _.from("users").update({credits:(r.profile.credits||0)-l.price}).eq("id",r.profile.id);const{data:d}=await _.from("users").select("credits").eq("id",l.seller_id).single();d&&await _.from("users").update({credits:(d.credits||0)+l.price}).eq("id",l.seller_id),await _.from("notifications").insert({user_id:l.seller_id,type:"card_sold",message:`Ta carte ${l.card.player.surname_encoded} a été vendue pour ${l.price} crédits !`,data:{card_id:l.card.id,price:l.price}}),await a(),n("Carte achetée ! ✅","success"),oe(i,o)}catch(s){n("Erreur : "+s.message,"error")}}}async function At(t,e,i){const{toast:o}=i,{data:r}=await _.from("market_listings").select("card_id").eq("id",t).single();await _.from("market_listings").update({status:"cancelled"}).eq("id",t),r&&await _.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",r.card_id),o("Annonce retirée","success"),oe(e,i)}function Mt(t){return{GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[t]||"#888"}async function Ct(t,{state:e,navigate:i,toast:o}){t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:r}=await _.from("users").select("id,pseudo,club_name,trophies_top1,trophies_top2,trophies_top3,wins,level").order("trophies_top1",{ascending:!1}).limit(100);t.innerHTML=`
  <div class="page">
    <div class="page-header">
  ...
  `}const k={user:null,profile:null,page:"home",params:{}};function R(t,e="info",i=3e3){const o=document.getElementById("toast");o&&(o.textContent=t,o.className=`show ${e}`,clearTimeout(o._t),o._t=setTimeout(()=>{o.className=""},i))}function Dt(t,e,i=""){document.getElementById("modal-title").textContent=t,document.getElementById("modal-body").innerHTML=e,document.getElementById("modal-footer").innerHTML=i,document.getElementById("modal-overlay").classList.remove("hidden")}function J(){document.getElementById("modal-overlay").classList.add("hidden")}async function N(){if(!k.user)return;const{data:t}=await _.from("users").select("*").eq("id",k.user.id).single();t&&(k.profile=t)}const ne="mw_theme";function H(){return localStorage.getItem(ne)||"light"}function Bt(t){var e;localStorage.setItem(ne,t),X(t),(e=k.profile)!=null&&e.id&&_.from("users").update({theme:t}).eq("id",k.profile.id).then(()=>{})}function X(t){document.documentElement.setAttribute("data-theme",t)}function q(t,e={}){k.page=t,k.params=e,je()}async function je(){const t=document.getElementById("page-content");if(!t)return;document.querySelectorAll(".bottom-nav a").forEach(o=>{o.classList.toggle("active",o.dataset.page===k.page)});const e=document.getElementById("nav-credits");e&&k.profile&&(e.textContent=`💰 ${(k.profile.credits||0).toLocaleString("fr")}`);const i={state:k,navigate:q,toast:R,openModal:Dt,closeModal:J,refreshProfile:N};switch(t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',k.page){case"home":await re(t,i);break;case"collection":await Oe(t,i);break;case"decks":await Ie(t,i);break;case"boosters":await Ze(t,i);break;case"match":await ut(t,i);break;case"market":await Lt(t,i);break;case"rankings":await Ct(t,i);break;default:await re(t,i)}}function jt(){const t=document.getElementById("app"),e=k.profile;if(!e)return;const i="/manager-wars/icons/";t.innerHTML=`
    <nav class="top-nav">
      <div class="club-name" id="nav-club">${(e.club_name||"").toUpperCase()}</div>
    ...
    <nav class="bottom-nav">
      <a href="#" data-page="home" class="active">
        <span class="icon"><img src="${i}nav-home.png" alt="" style="height:32px;width:auto;display:block"></span>
        <img class="nav-label" src="${i}nav-home-txt.png" alt="Accueil">
      </a>
      <a href="#" data-page="collection">
        <span class="icon"><img src="${i}nav-collection.png" alt="" style="height:32px;width:auto;display:block"></span>
        <img class="nav-label" src="${i}nav-collection-txt.png" alt="Cartes">
      </a>
      <a href="#" data-page="decks">
        <span class="icon"><img src="${i}nav-decks.png" alt="" style="height:32px;width:auto;display:block"></span>
        <img class="nav-label" src="${i}nav-deck-txt.png" alt="Decks">
      </a>
      <a href="#" data-page="boosters">
        <span class="icon"><img src="${i}nav-boosters.png" alt="" style="height:32px;width:auto;display:block"></span>
        <img class="nav-label" src="${i}nav-boosters-txt.png" alt="Boosters">
      </a>
      <a href="#" data-page="market">
        <span class="icon"><img src="${i}nav-market.png" alt="" style="height:32px;width:auto;display:block"></span>
        <img class="nav-label" src="${i}nav-market-txt.png" alt="Marché">
      </a>
    </nav>
  `,document.querySelectorAll(".bottom-nav a").forEach(o=>{o.addEventListener("click",r=>{r.preventDefault(),q(o.dataset.page)})}),document.getElementById("nav-logo").addEventListener("click",()=>q("home")),document.getElementById("nav-credits").addEventListener("click",()=>q("boosters")),document.getElementById("theme-toggle").addEventListener("click",()=>{const r=H()==="dark"?"light":"dark";Bt(r),ge(r)}),ge(H())}function ge(t){const e=document.getElementById("theme-icon");e&&(e.textContent=t==="dark"?"☀️":"🌙")}async function Ft(){X(H()),document.getElementById("modal-overlay").addEventListener("click",e=>{e.target===e.currentTarget&&J()}),document.getElementById("modal-close").addEventListener("click",J);const{data:{session:t}}=await _.auth.getSession();if(!t){ve(),se(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:R});return}if(k.user=t.user,await N(),ve(),!k.profile){Fe(document.getElementById("app"),{state:k,navigate:async()=>{await N(),me()},toast:R,refreshProfile:N});return}k.profile.theme&&k.profile.theme!==H()&&(localStorage.setItem(ne,k.profile.theme),X(k.profile.theme)),me(),_.auth.onAuthStateChange(async(e,i)=>{e==="SIGNED_OUT"&&(k.user=null,k.profile=null,document.getElementById("app").innerHTML="",se(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:R}))})}function me(){const t=document.getElementById("app");t.style.display="flex",t.style.flexDirection="column",jt(),je()}function ve(){const t=document.getElementById("app-loader");t&&(t.style.opacity="0",t.style.transition="opacity 0.3s",setTimeout(()=>t.style.display="none",300))}Ft();
