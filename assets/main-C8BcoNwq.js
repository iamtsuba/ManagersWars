import{s as L}from"./supabase-B22JUf_T.js";function re(t,{navigate:e,toast:i}){t.innerHTML=`
    ...
    <div class="page-body">
      ...
      <div>
        ...
        <div class="card-panel" style="padding:0">
          ${n.map(l=>{const s=l.winner_id===a.id,d=l.home_score===l.away_score,c=d?"N":s?"V":"D",y=d?"#888":s?"#1A6B3C":"#c0392b",p={vs_ai_easy:"IA Facile",vs_ai_medium:"IA Moyen",vs_ai_hard:"IA Difficile",vs_ai_club:"IA Club",friend_challenge:"Défi ami",championship:"Championnat"}[l.mode]||l.mode,g=new Date(l.created_at).toLocaleDateString("fr",{month:"short",day:"numeric"});return`<div style="display:flex;justify-content:space-between;align-items:center;padding:10px 14px;border-bottom:1px solid var(--gray-200)">
              <div>
  ...
  `,document.body.appendChild(i);const o=()=>i.remove();document.getElementById("diff-cancel").addEventListener("click",o),i.addEventListener("click",a=>{a.target===i&&o()}),i.querySelectorAll("[data-mode]").forEach(a=>{a.addEventListener("click",()=>{o(),t("match",{matchMode:a.dataset.mode})})})}const Q={Ressusciter:{icon:"💫",desc:"Réactive un joueur grisé pour ce match."},"Double attaque":{icon:"⚡",desc:"La note d'attaque compte double."},Bouclier:{icon:"🛡️",desc:"Annule le prochain but adverse."},"Vol de note":{icon:"🎯",desc:"-1 à la note d'un joueur adverse."},Gel:{icon:"❄️",desc:"Bloque le meilleur attaquant IA."},"Remplacement+":{icon:"🔄",desc:"+1 remplacement pour ce match."}};function _(t,e){if(!t)return 0;switch(e){case"GK":return Number(t.note_g)||0;case"DEF":return Number(t.note_d)||0;case"MIL":return Number(t.note_m)||0;case"ATT":return Number(t.note_a)||0;default:return 0}}const de=["ATT","MIL","DEF","GK"];function ve(t){let e=0;const i=t.length;for(let o=0;o<i;o++)for(let a=o+1;a<i;a++){const n=t[o],r=t[a];if(!n||!r)continue;const l=n._col!==void 0&&r._col!==void 0&&n._col===r._col,s=n._col!==void 0&&r._col!==void 0&&Math.abs(n._col-r._col)===1,d=de.indexOf(n._line),c=de.indexOf(r._line),y=Math.abs(d-c)===1;(n._line===r._line&&s||l&&y)&&(n.country_code&&r.country_code&&n.country_code===r.country_code&&e++,n.club_id&&r.club_id&&n.club_id===r.club_id&&e++)}return e}function Z(t,e={}){const i=t.reduce((n,r)=>{const l=r._line||r.job;return n+Number(l==="MIL"?r.note_m:r.note_a)||0},0),o=ve(t);let a=i+o;return e.doubleAttack&&(a*=2),e.stolenNote&&(a-=e.stolenNote),{base:i,links:o,total:Math.max(0,a)}}function ee(t,e={}){const i=t.reduce((n,r)=>{const l=r._line||r.job;let s=0;return l==="GK"?s=Number(r.note_g)||0:l==="MIL"?s=Number(r.note_m)||0:s=Number(r.note_d)||0,n+s},0),o=ve(t);let a=i+o;return e.stolenNote&&(a-=e.stolenNote),{base:i,links:o,total:Math.max(0,a)}}function he(t,e,i={}){return i.shield?{goal:!1,shielded:!0}:{goal:t>e,shielded:!1}}function be(t,e,i="easy"){const o=t.filter(r=>!r.used);if(!o.length)return[];const a=[...o].sort((r,l)=>{const s=e==="attack"?_(r,"ATT"):r._line==="GK"?_(r,"GK"):_(r,"DEF");return(e==="attack"?_(l,"ATT"):l._line==="GK"?_(l,"GK"):_(l,"DEF"))-s});let n=i==="easy"?1+Math.floor(Math.random()*2):i==="medium"?2+Math.floor(Math.random()*2):3;return a.slice(0,Math.min(n,a.length,3))}function Se(t,e){const i={vs_ai_easy:{victoire:500,nul:250,defaite:50},vs_ai_medium:{victoire:1e3,nul:500,defaite:50},vs_ai_hard:{victoire:1500,nul:750,defaite:100},vs_ai_club:{victoire:2500,nul:1250,defaite:100}};return(i[t]||i.vs_ai_easy)[e]||0}const Ee={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"},q={GK:"#111111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},le=["GK","DEF","MIL","ATT"],Ke=["Tous","GK","DEF","MIL","ATT"],Re={normal:1e3,pepite:5e3,papyte:5e3,legende:1e4},Ie={MA:"MAROC",FR:"FRANCE",AR:"ARGENTINE",PT:"PORTUGAL",BR:"BRESIL",ES:"ESPAGNE",DE:"ALLEMAGNE",GB:"ANGLETERRE",IT:"ITALIE",CM:"CAMEROUN",SN:"SENEGAL",NG:"NIGERIA",DK:"DANEMARK",NL:"PAYS-BAS",BE:"BELGIQUE",CI:"CÔTE D'IVOIRE",AL:"ALBANIE",HR:"CROATIE",RS:"SERBIE",TR:"TURQUIE"};function Le(t){const e="https://fcnwclxlkytdfjotqkta.supabase.co";if(!(t!=null&&t.skin)||!(t!=null&&t.hair))return null;const i=t.hair==="chauve"?`${t.skin}-chauve-rase`:`${t.skin}-${t.hair}-${t.hair_length}`;return`${e}/storage/v1/object/public/assets/tetes/${i}.png`}function O(t,e){return t&&Number(e==="GK"?t.note_g:e==="DEF"?t.note_d:e==="MIL"?t.note_m:t.note_a)||0}function Ne(t,e=""){var y,p;const i=t.player;if(!i)return"";const o=i.job||"ATT",a=q[o],n=Ee[i.rarity]||"#ccc",r=O(i,o),l=i.job2?O(i,i.job2):null,s=i.job2?q[i.job2]:null,d=Le(i),c=Ie[i.country_code]||i.country_code||"";return`
  <div style="
  ...
  </div>`}async function qe(t,e){const{state:i,navigate:o,toast:a,openModal:n,closeModal:r}=e;t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:l}=await L.from("cards").select(`id, card_type, current_note, gc_type, formation, is_for_sale, sale_price,
      player:players(id, firstname, surname_encoded, country_code, club_id, job, job2,
        note_g, note_d, note_m, note_a, rarity, note_min, note_max, skin, hair, hair_length, sell_price,
        clubs(encoded_name, logo_url))`).eq("owner_id",i.profile.id),s=(l||[]).filter(u=>u.card_type==="player"&&u.player),d=(l||[]).filter(u=>u.card_type==="game_changer"),c=(l||[]).filter(u=>u.card_type==="formation"),y={};s.forEach(u=>{const m=u.player.id;y[m]=(y[m]||0)+1});let p="Tous",f="";function g(){return[...s].sort((u,m)=>{const b=le.indexOf(u.player.job),h=le.indexOf(m.player.job);return b!==h?b-h:(u.player.surname_encoded||"").localeCompare(m.player.surname_encoded||"")})}function v(){return g().filter(u=>{const m=u.player,b=p==="Tous"||m.job===p,h=!f||`${m.firstname} ${m.surname_encoded}`.toLowerCase().includes(f);return b&&h})}t.innerHTML=`
  <div class="page">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}function Pe(t,e){const i={"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2}},o={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},a=i[t]||i["4-4-2"],n=["ATT","MIL","DEF","GK"];function r(d,c){const g=(d-1)*54,v=(c-g)/2;return Array.from({length:d},(x,u)=>v+u*54)}function l(d){return d===1?[1]:d===2?[0,2]:d===3?[0,1,2]:d===4?[0,1,1,2]:d===5?[0,1,1,1,2]:[1]}function s(){const p=n.length*72+48,f=n.map((u,m)=>24+m*72+72/2),g={};n.forEach(u=>{g[u]=r(a[u],290)});function v(u,m){const b=a[u],h=l(b),E=g[u],I=h.indexOf(m);return I>=0?E[I]:null}let x=`<svg width="290" height="${p}" viewBox="0 0 290 ${p}" xmlns="http://www.w3.org/2000/svg">`;n.forEach((u,m)=>{const b=g[u];for(let h=0;h<b.length-1;h++){const E=b[h]+20,I=b[h+1]-20,T=f[m];x+=`<line x1="${E}" y1="${T}" x2="${I}" y2="${T}"
          stroke="rgba(255,255,255,0.35)" stroke-width="2" stroke-dasharray="4,3"/>`,x+=`<text x="${(E+I)/2}" y="${T-6}" text-anchor="middle"
          font-size="8" fill="rgba(255,255,255,0.45)">↔</text>`}});for(let u=0;u<3;u++)for(let m=0;m<n.length-1;m++){const b=n[m],h=n[m+1],E=v(b,u),I=v(h,u);if(E!==null&&I!==null){const T=(E+I)/2;x+=`<line x1="${E}" y1="${f[m]+20}" x2="${I}" y2="${f[m+1]-20}"
            stroke="rgba(255,255,255,0.35)" stroke-width="2" stroke-dasharray="4,3"/>`,x+=`<text x="${T+6}" y="${(f[m]+f[m+1])/2+3}"
            font-size="8" fill="rgba(255,255,255,0.45)">↕</text>`}}return n.forEach((u,m)=>{const b=a[u],h=g[u],E=l(b),I=o[u],T=f[m],F={};E.forEach(($,D)=>{F[$]||(F[$]={xs:[],indices:[]}),F[$].xs.push(h[D]),F[$].indices.push(D)}),Object.entries(F).forEach(([$,D])=>{const w=D.xs.length;if(w>1){const A=D.xs.reduce((C,U)=>C+U,0)/w;x+=`<circle cx="${A}" cy="${T}" r="20" fill="${I}" stroke="rgba(255,255,255,0.6)" stroke-width="2"/>`,x+=`<text x="${A}" y="${T-4}" text-anchor="middle" font-size="9" font-weight="900" fill="white" font-family="Arial Black,Arial">${u}</text>`,x+=`<text x="${A}" y="${T+9}" text-anchor="middle" font-size="8" font-weight="700" fill="rgba(255,255,255,0.85)">×${w}</text>`}else{const A=D.xs[0],C=D.indices[0]+1;x+=`<circle cx="${A}" cy="${T}" r="20" fill="${I}" stroke="rgba(255,255,255,0.6)" stroke-width="2"/>`,x+=`<text x="${A}" y="${T+4}" text-anchor="middle" font-size="9" font-weight="900" fill="white" font-family="Arial Black,Arial">${u}</text>`,x+=`<text x="${A}" y="${T+30}" text-anchor="middle" font-size="7" fill="rgba(255,255,255,0.4)">${u}${C}</text>`}})}),x+="</svg>",x}e(`Formation ${t}`,`<div style="background:linear-gradient(180deg,#1a6b3c,#0a3d1e);border-radius:12px;padding:16px;margin-bottom:14px;overflow-x:auto;text-align:center">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}function He(t,e,i,o){var I,T,F,$,D,w;const{state:a,toast:n,openModal:r,closeModal:l,navigate:s,refreshProfile:d}=o,c=t.player,y=e.filter(A=>A.player.id===c.id),p=y.length,f=Re[c.rarity]||1e3,g=c.rarity!=="legende",v=Le(c),x=O(c,c.job),u=c.job2?O(c,c.job2):null,m=q[c.job]||"#1A6B3C",b=c.job2?q[c.job2]:null,h=Ee[c.rarity]||"#ccc",E=Ie[c.country_code]||c.country_code||"";r(`${c.firstname} ${c.surname_encoded}`,`<div style="display:flex;gap:16px;flex-wrap:wrap;justify-content:center">
      ...
      <div style="width:140px;border-radius:12px;padding:6px;background:${h};flex-shrink:0">
        <div style="background:#f2e8d2;border-radius:8px;overflow:hidden;display:flex;flex-direction:column">
          ...
          <div style="background:#f2e8d2;padding:3px 6px;display:flex;align-items:center;justify-content:space-between;min-height:24px">
            ...
            ${(I=c.clubs)!=null&&I.logo_url?`<img src="${c.clubs.logo_url}" style="width:22px;height:16px;object-fit:contain">`:`<div style="background:#1a3a7a;color:#fff;border-radius:2px;padding:1px 3px;font-size:6px;font-weight:800">${(((T=c.clubs)==null?void 0:T.encoded_name)||"").slice(0,6)}</div>`}
          </div>
        </div>
      </div>
  ...
  </div>`,document.getElementById("new-deck-btn").addEventListener("click",async()=>{const r=prompt("Nom du deck :",`Deck ${((n==null?void 0:n.length)||0)+1}`);if(!r)return;const{data:l,error:s}=await L.from("decks").insert({owner_id:i.profile.id,name:r,is_active:!(n!=null&&n.length)}).select().single();if(s){a(s.message,"error");return}a("Deck créé !","success"),ce(l.id,t,e)}),t.querySelectorAll("[data-edit]").forEach(r=>{r.addEventListener("click",()=>ce(r.dataset.edit,t,e))}),t.querySelectorAll("[data-activate]").forEach(r=>{r.addEventListener("click",async()=>{await L.from("decks").update({is_active:!1}).eq("owner_id",i.profile.id),await L.from("decks").update({is_active:!0}).eq("id",r.dataset.activate),a("Deck activé !","success"),De(t,e)})})}async function ce(t,e,i){const{state:o,toast:a}=i;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:n}=await L.from("decks").select("*").eq("id",t).single(),{data:r}=await L.from("cards").select(`id, card_type, formation,
      player:players(id, firstname, surname_encoded, country_code, club_id, job, job2,
        note_g, note_d, note_m, note_a, rarity, skin, hair, hair_length,
        clubs(encoded_name, logo_url))`).eq("owner_id",o.profile.id),l=(r||[]).filter(f=>f.card_type==="player"&&f.player),s=(r||[]).filter(f=>f.card_type==="formation"),d=s.map(f=>f.formation).filter(Boolean),{data:c}=await L.from("deck_cards").select("card_id, position, is_starter, slot_order").eq("deck_id",t);let y=n.formation||"4-4-2";d.length>0&&!d.includes(y)&&(y=d[0]);const p={deckId:t,name:n.name,formation:y,formationCardId:n.formation_card_id,slots:{},subs:[],playerCards:l,formationCards:s,availableFormations:d};(c||[]).forEach(f=>{f.is_starter?p.slots[f.position]=f.card_id:p.subs.includes(f.card_id)||p.subs.push(f.card_id)}),j(e,p,i)}function j(t,e,i){var s;const{navigate:o}=i;P[e.formation];const a=pe(e.formation),n=a.filter(d=>e.slots[d]).length,r=e.availableFormations.length>0?e.availableFormations:Object.keys(P),l=e.subs.map(d=>e.playerCards.find(c=>c.id===d)).filter(Boolean);[...Object.values(e.slots),...e.subs],t.innerHTML=`
  <div class="page">
  ...
  </div>`,Ue(t,e,a,i),document.getElementById("builder-back").addEventListener("click",()=>o("decks")),document.getElementById("formation-select").addEventListener("change",d=>{e.formation=d.target.value;const c=pe(e.formation),y={};c.forEach(p=>{e.slots[p]&&(y[p]=e.slots[p])}),e.slots=y,j(t,e,i)}),document.getElementById("save-deck").addEventListener("click",()=>Ye(e,i)),t.querySelectorAll("[data-remove-sub]").forEach(d=>{d.addEventListener("click",()=>{e.subs=e.subs.filter(c=>c!==d.dataset.removeSub),j(t,e,i)})}),(s=document.getElementById("add-sub-btn"))==null||s.addEventListener("click",()=>{Ve(e,t,i)})}function Ue(t,e,i,o){const a=document.getElementById("deck-field");if(!a)return;const n=e.formation,r=Me[n]||{},l=Te[n]||[],s={};i.forEach(b=>{const h=e.slots[b],E=h?e.playerCards.find(I=>I.id===h):null;s[b]=(E==null?void 0:E.player)||null});const d=i.filter(b=>b.startsWith("MIL"));let c=0,y=0;d.forEach(b=>{const h=s[b];h&&(c+=Number(h.note_m)||0)}),l.forEach(([b,h])=>{if(!b.startsWith("MIL")||!h.startsWith("MIL"))return;S(s[b],s[h])!=="#ff3333"&&y++});const p=320,f=320,g=28,v=4;function x(b){const h=r[b];return h?{x:h.x*p,y:h.y*f}:null}let u="";for(const[b,h]of l){const E=x(b),I=x(h);if(!E||!I)continue;const T=s[b],F=s[h],$=S(T,F),D=$==="#ff3333"?.3:.9,w=$!=="#ff3333"?`filter="url(#glow-${$.replace("#","")})"`:"";u+=`<line x1="${E.x}" y1="${E.y}" x2="${I.x}" y2="${I.y}"
      stroke="${$}" stroke-width="${v}" stroke-linecap="round"
      opacity="${D}" ${w}/>`}for(const b of i){const h=x(b);if(!h)continue;const E=s[b],I=b.replace(/\d+/,""),F={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[I]||"#555",$=E?Number(I==="GK"?E.note_g:I==="DEF"?E.note_d:I==="MIL"?E.note_m:E.note_a)||0:null,D=E?(E.surname_encoded||"").slice(0,8).toUpperCase():"";if(E){const w=te(E);w&&(u+=`
          <defs>
            <clipPath id="clip-${b}">
              <circle cx="${h.x}" cy="${h.y}" r="${g}"/>
            </clipPath>
          </defs>
          <image href="${w}" x="${h.x-g}" y="${h.y-g}" width="${g*2}" height="${g*2}"
            clip-path="url(#clip-${b})" preserveAspectRatio="xMidYMid slice" opacity="0.85"/>`),u+=`
        <circle cx="${h.x}" cy="${h.y}" r="${g}" fill="${w?"transparent":F}"
          stroke="${F}" stroke-width="2" />
        <circle cx="${h.x}" cy="${h.y}" r="${g}" fill="${F}" opacity="${w?"0.5":"1"}"
          stroke="rgba(255,255,255,0.6)" stroke-width="2"/>
        ${w?`<image href="${w}" x="${h.x-g}" y="${h.y-g}" width="${g*2}" height="${g*2}"
    ...
    </div>`,'<button class="btn btn-ghost" id="close-selector">Fermer</button>'),(f=document.getElementById("close-selector"))==null||f.addEventListener("click",n),(g=document.getElementById("remove-player"))==null||g.addEventListener("click",()=>{delete e.slots[t],n(),j(i,e,o)}),document.querySelectorAll(".player-option").forEach(v=>{v.addEventListener("click",()=>{e.slots[t]=v.dataset.cardId,n(),j(i,e,o)})})}function Ve(t,e,i){var s;const{openModal:o,closeModal:a}=i,n=new Set;Object.values(t.slots).filter(Boolean).forEach(d=>{var y;const c=t.playerCards.find(p=>p.id===d);(y=c==null?void 0:c.player)!=null&&y.id&&n.add(c.player.id)}),t.subs.forEach(d=>{var y;const c=t.playerCards.find(p=>p.id===d);(y=c==null?void 0:c.player)!=null&&y.id&&n.add(c.player.id)});const r=new Set,l=t.playerCards.filter(d=>{var c,y,p;return n.has((c=d.player)==null?void 0:c.id)||r.has((y=d.player)==null?void 0:y.id)?!1:(r.add((p=d.player)==null?void 0:p.id),!0)});o("Ajouter un remplaçant",`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
  ...
  `,document.body.appendChild(t),t.addEventListener("click",e=>{e.target===t&&t.remove()}),document.getElementById("odds-close").addEventListener("click",()=>t.remove())}function dt(){return new Promise(t=>{const e=document.createElement("div");e.style.cssText="position:fixed;inset:0;background:#000;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:4000;color:#fff;gap:16px";let i=5;e.innerHTML=`<div style="font-size:48px">📺</div>
      ...
      <div style="font-size:36px;font-weight:900" id="ad-cd">5</div>`,document.body.appendChild(e);const o=setInterval(()=>{i--;const a=document.getElementById("ad-cd");a&&(a.textContent=i),i<=0&&(clearInterval(o),e.remove(),t(!0))},1e3)})}const z={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}},W={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function Fe(t,e,i,o,a){var n;t.innerHTML=`<div class="match-screen" style="display:flex;align-items:center;justify-content:center;min-height:100vh">
    <div style="text-align:center;padding:40px;color:#fff">
      <div style="font-size:48px;margin-bottom:16px">${e}</div>
      <p style="margin-bottom:16px">${i}</p>
      <button class="btn btn-primary" id="msg-btn">${o}</button>
    </div>
  </div>`,(n=document.getElementById("msg-btn"))==null||n.addEventListener("click",a)}function Ae(t){const e=typeof import.meta<"u"?"https://fcnwclxlkytdfjotqkta.supabase.co":"";if(!e||!(t!=null&&t.skin)||!(t!=null&&t.hair))return null;const i=t.hair==="chauve"?`${t.skin}-chauve-rase`:`${t.skin}-${t.hair}-${t.hair_length}`;return`${e}/storage/v1/object/public/assets/tetes/${i}.png`}function ye(t){const e=t.player;return{cardId:t.id,id:e.id,firstname:e.firstname,name:e.surname_encoded,country_code:e.country_code,club_id:e.club_id,job:e.job,job2:e.job2,note_g:Number(e.note_g)||0,note_d:Number(e.note_d)||0,note_m:Number(e.note_m)||0,note_a:Number(e.note_a)||0,rarity:e.rarity,skin:e.skin,hair:e.hair,hair_length:e.hair_length,boost:0,used:!1,_line:null,_col:null}}function ie(t){return t===1?[1]:t===2?[0,2]:t===3?[0,1,2]:t===4?[0,1,1,2]:t===5?[0,1,1,1,2]:[1]}function lt(){const t=Math.random()*100;return t<.1?4:t<5?3:t<20?2:1}function ct(t,e){const i=z[e]||z["4-4-2"],o={GK:[],DEF:[],MIL:[],ATT:[]},a=[...t];for(const n of["GK","DEF","MIL","ATT"]){const r=[];for(let s=0;s<i[n];s++){let d=a.findIndex(c=>c.job===n);if(d===-1&&(d=a.findIndex(c=>c.job2===n)),d===-1&&(d=0),a[d]){const c={...a[d],_line:n};r.push(c),a.splice(d,1)}}const l=ie(r.length);r.forEach((s,d)=>{s._col=l[d]}),o[n]=r}return o}async function pt(t,e){const{data:i}=await L.from("players").select("id,firstname,surname_encoded,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length").eq("is_active",!0).limit(60);if(!i||i.length<11)return ft(t);const o=z[t]||z["4-4-2"],a={GK:[],DEF:[],MIL:[],ATT:[]},n=[...i];for(const r of["GK","DEF","MIL","ATT"]){const l=n.filter(p=>p.job===r),s=n.filter(p=>p.job!==r),d=[...l,...s],c=[];for(let p=0;p<o[r];p++){const f=d[p]||n[p];f&&c.push({cardId:"ai-"+f.id+"-"+p,id:f.id,firstname:f.firstname,name:f.surname_encoded,country_code:f.country_code,club_id:f.club_id,job:f.job,job2:f.job2,note_g:Number(f.note_g)||0,note_d:Number(f.note_d)||0,note_m:Number(f.note_m)||0,note_a:Number(f.note_a)||0,rarity:f.rarity,skin:f.skin,hair:f.hair,hair_length:f.hair_length,boost:0,used:!1,_line:r})}const y=ie(c.length);c.forEach((p,f)=>{p._col=y[f]}),a[r]=c}return a}function ft(t){const e=z[t]||z["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},o=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let a=0;for(const n of["GK","DEF","MIL","ATT"]){const r=[];for(let s=0;s<e[n];s++){const d=3+Math.floor(Math.random()*5);r.push({cardId:"fake-"+a,id:"fake-"+a,firstname:"IA",name:o[a%o.length],country_code:"XX",club_id:null,job:n,job2:null,note_g:n==="GK"?d:2,note_d:n==="DEF"?d:2,note_m:n==="MIL"?d:2,note_a:n==="ATT"?d:2,rarity:"normal",boost:0,used:!1,_line:n}),a++}const l=ie(r.length);r.forEach((s,d)=>{s._col=l[d]}),i[n]=r}return i}async function ut(t,e){var h;const{state:i,navigate:o,toast:a}=e,n=i.params||{};t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const r=n.matchMode||"vs_ai_easy",l=r.replace("vs_ai_",""),s=r;if(!n.deckId)return yt(t,e,r);const d=n.deckId,{data:c}=await L.from("deck_cards").select(`position, is_starter, slot_order,
      card:cards(id, card_type, formation,
        player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
          clubs(encoded_name,logo_url)))`).eq("deck_id",d).order("slot_order"),y=(c||[]).filter(E=>{var I;return E.is_starter&&((I=E.card)==null?void 0:I.player)}).map(E=>ye(E.card)),p=(c||[]).filter(E=>{var I;return!E.is_starter&&((I=E.card)==null?void 0:I.player)}).map(E=>ye(E.card));if(y.length<11){Fe(t,"⚠️",`Deck incomplet (${y.length}/11).`,"Compléter",()=>o("decks"));return}const f=(c||[]).find(E=>{var I;return((I=E.card)==null?void 0:I.card_type)==="formation"}),g=((h=f==null?void 0:f.card)==null?void 0:h.formation)||"4-4-2",{data:v}=await L.from("cards").select("id,gc_type").eq("owner_id",i.profile.id).eq("card_type","game_changer"),x=ct(y,g),u=await pt(g),{data:m}=await L.from("matches").insert({home_id:i.profile.id,away_id:null,mode:s,home_deck_id:d,status:"in_progress"}).select().single(),b={matchId:m==null?void 0:m.id,mode:s,difficulty:l,formation:g,homeTeam:x,aiTeam:u,homeSubs:p,subsUsed:0,maxSubs:Math.min(p.length,3),homeScore:0,aiScore:0,gcCards:v||[],usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};xt(t,b,e)}async function yt(t,e,i){var r;const{state:o,navigate:a}=e,{data:n}=await L.from("decks").select("id,name,is_active,formation_card_id").eq("owner_id",o.profile.id).order("created_at",{ascending:!1});if(!n||n.length===0){Fe(t,"📋","Aucun deck. Crée un deck avant de jouer !","Créer un deck",()=>a("decks"));return}t.innerHTML=`
  ...
  <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;gap:20px;padding:20px">
    ...
    <div id="midfield-result" style="opacity:0;text-align:center;transition:opacity 0.5s;color:#fff">
      ...
      `,d&&(e.boostCard={value:g})}e.attacker=d?"home":"ai",e.log.push({text:`Duel milieu : ${e.clubName} ${l} – ${s} IA → ${d?e.clubName:"IA"} attaque en premier`,type:"info"}),setTimeout(()=>{e.phase=e.attacker==="home"?"attack":"ai-attack",k(t,e,i),e.attacker==="ai"&&setTimeout(()=>V(t,e,i),1e3)},2800)},1200)}function we(t,e,i,o,a=310,n=310){const r=Me[e]||{},l=Te[e]||[],s=26,d={},c=["ATT","MIL","DEF","GK"];for(const g of c)(t[g]||[]).forEach((x,u)=>{d[`${g}${u+1}`]=x});function y(g){const v=r[g];return v?{x:v.x*a,y:v.y*n}:null}let p="";for(const[g,v]of l){const x=y(g),u=y(v);if(!x||!u)continue;const m=d[g],b=d[v],h=S(m,b),E=h==="#ff3333"?.25:.9,I=h!=="#ff3333"?`filter="url(#glow${h.replace("#","").slice(0,6)})"`:"";p+=`<line x1="${x.x.toFixed(1)}" y1="${x.y.toFixed(1)}" x2="${u.x.toFixed(1)}" y2="${u.y.toFixed(1)}"
      stroke="${h}" stroke-width="3.5" stroke-linecap="round" opacity="${E}" ${I}/>`}for(const[g,v]of Object.entries(d)){const x=y(g);if(!x)continue;const u=g.replace(/[0-9]/g,""),b={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[u]||"#555",h=i==="attack"&&["MIL","ATT"].includes(u)&&!v.used||i==="defense"&&["GK","DEF","MIL"].includes(u)&&!v.used,E=o.includes(v.cardId);let I;i==="attack"?I=u==="MIL"?Number(v.note_m)||0:Number(v.note_a)||0:i==="defense"?I=u==="GK"?Number(v.note_g)||0:u==="MIL"?Number(v.note_m)||0:Number(v.note_d)||0:I=Number(u==="GK"?v.note_g:u==="DEF"?v.note_d:u==="MIL"?v.note_m:v.note_a)||0,I=I+(v.boost||0);const T=E?"#FFD700":h?"rgba(255,255,255,0.7)":"rgba(255,255,255,0.25)",F=E?3:2,$=v.used?.25:1,D=Ae(v);D&&(p+=`<defs><clipPath id="mc-${g}"><circle cx="${x.x}" cy="${x.y}" r="${s}"/></clipPath></defs>`),p+=`<circle cx="${x.x}" cy="${x.y}" r="${s}" fill="${b}" opacity="${$}"
      stroke="${T}" stroke-width="${F}"/>`,D&&!v.used&&(p+=`<image href="${D}" x="${x.x-s}" y="${x.y-s}" width="${s*2}" height="${s*2}"
        clip-path="url(#mc-${g})" preserveAspectRatio="xMidYMid slice" opacity="0.8"/>`,p+=`<circle cx="${x.x}" cy="${x.y}" r="${s}" fill="${b}" opacity="0.35"
        stroke="${T}" stroke-width="${F}"/>`),v.boost&&(p+=`<rect x="${x.x+s-10}" y="${x.y-s}" width="14" height="10" rx="3" fill="#87CEEB"/>
        <text x="${x.x+s-3}" y="${x.y-s+8}" text-anchor="middle" font-size="7" fill="#000" font-weight="900">+${v.boost}</text>`),p+=`<text x="${x.x}" y="${x.y-1}" text-anchor="middle" font-size="12" font-weight="900"
      fill="${v.used?"#555":"white"}" font-family="Arial Black,Arial">${v.used?"–":I}</text>
    <text x="${x.x}" y="${x.y+11}" text-anchor="middle" font-size="6" fill="rgba(255,255,255,${v.used?.3:.8})"
      font-family="Arial">${(v.name||"").slice(0,8)}</text>`,h&&(p+=`<circle cx="${x.x}" cy="${x.y}" r="${s}" fill="rgba(255,255,255,0.08)"
  ...
  <div class="match-screen">
    ...
    <div class="match-field" id="match-field" style="position:relative">
      ${gt(e.homeTeam,e.formation,e.phase,a)}
    </div>
    ...
    <div class="match-log" id="match-log">
      ...
      <button class="btn btn-primary" id="confirm-defense" style="width:100%" ${s?"":"disabled"}>Défendre →</button>`,(r=document.getElementById("confirm-defense"))==null||r.addEventListener("click",()=>bt(t,e,i))}else e.phase==="finished"?(o.innerHTML='<button class="btn btn-primary" id="end-match" style="width:100%">Voir les résultats</button>',(l=document.getElementById("end-match"))==null||l.addEventListener("click",()=>i.navigate("home"))):o.innerHTML=`<div style="text-align:center;color:rgba(255,255,255,.4);padding:8px;font-size:12px">⏳ Tour de l'IA...</div>`}function vt(t,e,i,o){const a=t.dataset.cardId,n=t.dataset.role,r=e.selected.findIndex(l=>l.cardId===a);if(r!==-1)e.selected.splice(r,1);else{if(e.selected.length>=3){o.toast("Maximum 3 joueurs","error");return}const l=(e.homeTeam[n]||[]).find(s=>s.cardId===a);l&&e.selected.push({...l,_role:n,_line:n})}k(i,e,o)}function ht(t,e,i){const o=e.selected.map(n=>({...n,_line:n._role})),a=Z(o,e.modifiers.home);e.pendingAttack={...a,players:[...e.selected],side:"home"},e.selected.forEach(n=>{const r=(e.homeTeam[n._role]||[]).find(l=>l.cardId===n.cardId);r&&(r.used=!0)}),e.log.push({text:`Vous attaquez : ${a.total} (${e.selected.map(n=>n.name).join(", ")})`,type:"info"}),e.selected=[],e.modifiers.home={},e.phase="ai-defense",k(t,e,i),setTimeout(()=>Et(t,e,i),1200)}function bt(t,e,i){const o=e.selected.map(r=>({...r,_line:r._role})),a=ee(o,e.modifiers.home);e.selected.forEach(r=>{const l=(e.homeTeam[r._role]||[]).find(s=>s.cardId===r.cardId);l&&(l.used=!0)});const n=he(e.pendingAttack.total,a.total,e.modifiers.home);n.shielded?e.log.push({text:"🛡️ Bouclier ! But annulé.",type:"info"}):n.goal?(e.aiScore++,e.log.push({text:`⚽ BUT IA ! (${e.pendingAttack.total} > ${a.total})`,type:"goal"})):e.log.push({text:`🧤 Défense ! (${a.total} ≥ ${e.pendingAttack.total})`,type:"info"}),e.selected=[],e.modifiers.home={},e.pendingAttack=null,_e(t,e,i,"home-attack")}function V(t,e,i){const o=[...e.aiTeam.MIL||[],...e.aiTeam.ATT||[]],a=be(o,"attack",e.difficulty);if(!a.length){Ce(t,e,i);return}const n=Z(a,e.modifiers.ai);e.pendingAttack={...n,players:a,side:"ai"},a.forEach(r=>{r.used=!0}),e.log.push({text:`IA attaque : ${n.total}`,type:"info"}),e.modifiers.ai={},e.phase="defense",k(t,e,i)}function Et(t,e,i){const o=[...e.aiTeam.GK||[],...e.aiTeam.DEF||[],...e.aiTeam.MIL||[]],a=be(o,"defense",e.difficulty),n=a.length>0?ee(a,e.modifiers.ai).total:0;a.forEach(l=>{l.used=!0});const r=he(e.pendingAttack.total,n,e.modifiers.ai);r.shielded?e.log.push({text:"🛡️ Bouclier IA !",type:"info"}):r.goal?(e.homeScore++,e.log.push({text:`⚽ BUT ! (${e.pendingAttack.total} > ${n})`,type:"goal"})):e.log.push({text:`🧤 IA défend (${n} ≥ ${e.pendingAttack.total})`,type:"info"}),e.modifiers.ai={},e.pendingAttack=null,_e(t,e,i,"ai-attack")}function _e(t,e,i,o){if(e.round++,ke(e)){Y(t,e,i);return}if(o==="home-attack"){if(![...e.homeTeam.MIL||[],...e.homeTeam.ATT||[]].filter(n=>!n.used).length){if(![...e.homeTeam.GK||[],...e.homeTeam.DEF||[],...e.homeTeam.MIL||[]].filter(r=>!r.used).length){Y(t,e,i);return}e.phase="ai-attack",k(t,e,i),setTimeout(()=>V(t,e,i),800);return}e.phase="attack",k(t,e,i)}else{if(![...e.aiTeam.MIL||[],...e.aiTeam.ATT||[]].filter(n=>!n.used).length){Ce(t,e,i);return}e.phase="ai-attack",k(t,e,i),setTimeout(()=>V(t,e,i),800)}}function ke(t){const e=["MIL","ATT","GK","DEF"].some(o=>(t.homeTeam[o]||[]).some(a=>!a.used)),i=["MIL","ATT","GK","DEF"].some(o=>(t.aiTeam[o]||[]).some(a=>!a.used));return!e&&!i}function Ce(t,e,i){ke(e)?Y(t,e,i):(e.phase="attack",k(t,e,i))}function It(t,e,i){const o=Object.values(e.homeTeam).flat().filter(a=>!a.used);if(!o.length){i.toast("Aucun joueur actif à booster","error");return}i.openModal("⚡ Utiliser le Boost",`<div style="margin-bottom:12px;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border-radius:10px;padding:12px;text-align:center;color:#000">
    ...
    <div style="display:flex;flex-direction:column;gap:6px">
      ${o.map(a=>`
        <div class="player-boost-opt" data-card-id="${a.cardId}"
          ...
          <div style="width:32px;height:32px;background:${W[a.job]||"#888"};border-radius:6px;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:900;font-size:13px">${_(a,a._line||a.job)}</div>
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Annuler</button>`),document.querySelectorAll(".player-boost-opt").forEach(a=>{a.addEventListener("click",()=>{const n=a.dataset.cardId;for(const r of["GK","DEF","MIL","ATT"]){const l=(e.homeTeam[r]||[]).find(s=>s.cardId===n);if(l){l.boost=(l.boost||0)+e.boostCard.value,e.log.push({text:`⚡ Boost +${e.boostCard.value} appliqué à ${l.name}`,type:"info"});break}}e.boostUsed=!0,i.closeModal(),k(t,e,i)})})}function Lt(t,e,i){e.usedSubIds||(e.usedSubIds=[]);const o=Object.values(e.homeTeam).flat().filter(s=>s.used),a=e.homeSubs.filter(s=>!e.usedSubIds.includes(s.cardId));if(!o.length){i.toast("Aucun joueur grisé","info");return}if(!a.length){i.toast("Aucun remplaçant disponible","info");return}if(e.subsUsed>=e.maxSubs){i.toast(`Maximum ${e.maxSubs} remplacements`,"error");return}i.openModal("🔄 Remplacement",`<div style="margin-bottom:12px">
    ...
    <div style="text-align:center;padding:40px;color:#fff;max-width:360px">
      ...
      ${we(t.aiTeam,t.formation,null,[],300,300)}
    </div>`,`<button class="btn btn-primary" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const Dt={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"};async function $t(t,e){const{state:i,toast:o}=e;t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement du marché...</div>',await oe(t,e)}async function oe(t,e){const{state:i,toast:o}=e,{data:a}=await L.from("market_listings").select(`id, price, status, listed_at, seller_id,
  ...
  `;function l(s){const d=document.getElementById("mkt-content"),c=s==="buy"?r:n;if(c.length===0){d.innerHTML=`<div style="text-align:center;color:var(--gray-600);padding:40px">
      ...
      ${c.map(y=>{var x,u,m;const p=(x=y.card)==null?void 0:x.player;if(!p)return"";const f=p.job==="GK"?p.note_g:p.job==="DEF"?p.note_d:p.job==="MIL"?p.note_m:p.note_a,g=Dt[p.rarity],v=(i.profile.credits||0)>=y.price;return`<div class="card-panel" style="display:flex;align-items:center;gap:12px;padding:12px">
          <div style="width:44px;height:44px;border-radius:8px;background:${wt(p.job)};color:#fff;display:flex;align-items:center;justify-content:center;font-weight:900;font-size:18px;border:2px solid ${g};flex-shrink:0">${f}</div>
          <div style="flex:1;min-width:0">
          ...
          <div style="text-align:right;flex-shrink:0">
            ...
            ${s==="buy"?`<button class="btn btn-primary btn-sm" data-buy="${y.id}" ${v?"":"disabled"} style="margin-top:4px">${v?"Acheter":"Trop cher"}</button>`:`<button class="btn btn-danger btn-sm" data-cancel="${y.id}" style="margin-top:4px">Retirer</button>`}
          </div>
        </div>`}).join("")}
    </div>`,d.querySelectorAll("[data-buy]").forEach(y=>{y.addEventListener("click",()=>Ft(y.dataset.buy,c,t,e))}),d.querySelectorAll("[data-cancel]").forEach(y=>{y.addEventListener("click",()=>At(y.dataset.cancel,t,e))})}l("buy"),t.querySelectorAll(".mkt-tab").forEach(s=>{s.addEventListener("click",()=>{t.querySelectorAll(".mkt-tab").forEach(d=>{const c=d===s;d.style.background=c?"var(--green)":"#fff",d.style.color=c?"#fff":"var(--gray-600)",d.style.borderColor=c?"var(--green)":"var(--gray-200)"}),l(s.dataset.tab)})})}async function Ft(t,e,i,o){const{state:a,toast:n,refreshProfile:r}=o,l=e.find(s=>s.id===t);if(l){if((a.profile.credits||0)<l.price){n("Crédits insuffisants","error");return}if(confirm(`Acheter ${l.card.player.firstname} ${l.card.player.surname_encoded} pour ${l.price.toLocaleString("fr")} crédits ?`))try{const{error:s}=await L.from("cards").update({owner_id:a.profile.id,is_for_sale:!1,sale_price:null}).eq("id",l.card.id);if(s)throw s;await L.from("market_listings").update({status:"sold",buyer_id:a.profile.id,sold_at:new Date().toISOString()}).eq("id",t),await L.from("users").update({credits:(a.profile.credits||0)-l.price}).eq("id",a.profile.id);const{data:d}=await L.from("users").select("credits").eq("id",l.seller_id).single();d&&await L.from("users").update({credits:(d.credits||0)+l.price}).eq("id",l.seller_id),await L.from("notifications").insert({user_id:l.seller_id,type:"card_sold",message:`Ta carte ${l.card.player.surname_encoded} a été vendue pour ${l.price} crédits !`,data:{card_id:l.card.id,price:l.price}}),await r(),n("Carte achetée ! ✅","success"),oe(i,o)}catch(s){n("Erreur : "+s.message,"error")}}}async function At(t,e,i){const{toast:o}=i,{data:a}=await L.from("market_listings").select("card_id").eq("id",t).single();await L.from("market_listings").update({status:"cancelled"}).eq("id",t),a&&await L.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",a.card_id),o("Annonce retirée","success"),oe(e,i)}function wt(t){return{GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[t]||"#888"}async function _t(t,{state:e,navigate:i,toast:o}){t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:a}=await L.from("users").select("id,pseudo,club_name,trophies_top1,trophies_top2,trophies_top3,wins,level").order("trophies_top1",{ascending:!1}).limit(100);t.innerHTML=`
  <div class="page">
    <div class="page-header">
  ...
  `,document.querySelectorAll(".bottom-nav a").forEach(o=>{o.addEventListener("click",a=>{a.preventDefault(),N(o.dataset.page)})}),document.getElementById("nav-logo").addEventListener("click",()=>N("home")),document.getElementById("nav-credits").addEventListener("click",()=>N("boosters")),document.getElementById("theme-toggle").addEventListener("click",()=>{const a=H()==="dark"?"light":"dark";Ct(a),xe(a)}),xe(H())}function xe(t){const e=document.getElementById("theme-icon");e&&(e.textContent=t==="dark"?"☀️":"🌙")}async function Bt(){X(H()),document.getElementById("modal-overlay").addEventListener("click",e=>{e.target===e.currentTarget&&J()}),document.getElementById("modal-close").addEventListener("click",J);const{data:{session:t}}=await L.auth.getSession();if(!t){me(),re(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:K});return}if(M.user=t.user,await R(),me(),!M.profile){Be(document.getElementById("app"),{state:M,navigate:async()=>{await R(),ge()},toast:K,refreshProfile:R});return}M.profile.theme&&M.profile.theme!==H()&&(localStorage.setItem(ne,M.profile.theme),X(M.profile.theme)),ge(),L.auth.onAuthStateChange(async(e,i)=>{e==="SIGNED_OUT"&&(M.user=null,M.profile=null,document.getElementById("app").innerHTML="",re(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:K}))})}function ge(){const t=document.getElementById("app");t.style.display="flex",t.style.flexDirection="column",Gt(),Ge()}function me(){const t=document.getElementById("app-loader");t&&(t.classList.add("zoom-out"),setTimeout(()=>t.style.display="none",500))}Bt();
