import{s as $}from"./supabase-z_u0vv5N.js";function ie(t,{navigate:e,toast:i}){t.innerHTML=`
    ...
    <div class="page-body">
      ...
      <div>
        ...
        <div class="card-panel" style="padding:0">
          ${n.map(s=>{const d=s.winner_id===a.id,c=s.home_score===s.away_score,y=c?"N":d?"V":"D",p=c?"#888":d?"#1A6B3C":"#c0392b",f={vs_ai_easy:"IA Facile",vs_ai_medium:"IA Moyen",vs_ai_hard:"IA Difficile",vs_ai_club:"IA Club",friend_challenge:"Défi ami",championship:"Championnat"}[s.mode]||s.mode,g=new Date(s.created_at).toLocaleDateString("fr",{month:"short",day:"numeric"});return`<div style="display:flex;justify-content:space-between;align-items:center;padding:10px 14px;border-bottom:1px solid var(--gray-200)">
              <div>
  ...
  `,t.querySelectorAll("[data-nav]").forEach(s=>{s.addEventListener("click",d=>{d.preventDefault(),i(s.dataset.nav)})}),t.querySelectorAll("[data-action]").forEach(s=>{s.addEventListener("click",()=>{const d=s.dataset.action;if(d==="championship"){o("Championnats — bientôt disponibles","info");return}if(d==="match-random"){o("Matchmaking aléatoire — bientôt disponible","info");return}if(d==="match-friend"){o("Défi ami — bientôt disponible","info");return}d==="match-ai"&&Fe(i)})}),document.getElementById("logout-btn").addEventListener("click",async()=>{await $.auth.signOut(),window.location.reload()})}function Fe(t){const e=[{mode:"vs_ai_easy",label:"Facile",sub:"Gain 500 cr.",icon:"🟢"},{mode:"vs_ai_medium",label:"Moyen",sub:"Gain 1 000 cr.",icon:"🟡"},{mode:"vs_ai_hard",label:"Difficile",sub:"Gain 1 500 cr.",icon:"🟠"},{mode:"vs_ai_club",label:"Club",sub:"Gain 2 500 cr.",icon:"🔴"}],i=document.createElement("div");i.className="modal-overlay",i.style.zIndex="2000",i.innerHTML=`
  ...
  `,document.body.appendChild(i);const o=()=>i.remove();document.getElementById("diff-cancel").addEventListener("click",o),i.addEventListener("click",a=>{a.target===i&&o()}),i.querySelectorAll("[data-mode]").forEach(a=>{a.addEventListener("click",()=>{o(),t("match",{matchMode:a.dataset.mode})})})}const J={Ressusciter:{icon:"💫",desc:"Réactive un joueur grisé pour ce match."},"Double attaque":{icon:"⚡",desc:"La note d'attaque compte double."},Bouclier:{icon:"🛡️",desc:"Annule le prochain but adverse."},"Vol de note":{icon:"🎯",desc:"-1 à la note d'un joueur adverse."},Gel:{icon:"❄️",desc:"Bloque le meilleur attaquant IA."},"Remplacement+":{icon:"🔄",desc:"+1 remplacement pour ce match."}};function C(t,e){if(!t)return 0;switch(e){case"GK":return Number(t.note_g)||0;case"DEF":return Number(t.note_d)||0;case"MIL":return Number(t.note_m)||0;case"ATT":return Number(t.note_a)||0;default:return 0}}const se=["ATT","MIL","DEF","GK"];function ve(t){let e=0;const i=t.length;for(let o=0;o<i;o++)for(let a=o+1;a<i;a++){const n=t[o],r=t[a];if(!n||!r)continue;const l=n._col!==void 0&&r._col!==void 0&&n._col===r._col,s=n._col!==void 0&&r._col!==void 0&&Math.abs(n._col-r._col)===1,d=se.indexOf(n._line),c=se.indexOf(r._line),y=Math.abs(d-c)===1;(n._line===r._line&&s||l&&y)&&(n.country_code&&r.country_code&&n.country_code===r.country_code&&e++,n.club_id&&r.club_id&&n.club_id===r.club_id&&e++)}return e}function X(t,e={}){const i=t.reduce((n,r)=>{const l=r._line||r.job;return n+Number(l==="MIL"?r.note_m:r.note_a)||0},0),o=ve(t);let a=i+o;return e.doubleAttack&&(a*=2),e.stolenNote&&(a-=e.stolenNote),{base:i,links:o,total:Math.max(0,a)}}function Q(t,e={}){const i=t.reduce((n,r)=>{const l=r._line||r.job;let s=0;return l==="GK"?s=Number(r.note_g)||0:l==="MIL"?s=Number(r.note_m)||0:s=Number(r.note_d)||0,n+s},0),o=ve(t);let a=i+o;return e.stolenNote&&(a-=e.stolenNote),{base:i,links:o,total:Math.max(0,a)}}function ge(t,e,i={}){return i.shield?{goal:!1,shielded:!0}:{goal:t>e,shielded:!1}}function me(t,e,i="easy"){const o=t.filter(r=>!r.used);if(!o.length)return[];const a=[...o].sort((r,l)=>{const s=e==="attack"?C(r,"ATT"):r._line==="GK"?C(r,"GK"):C(r,"DEF");return(e==="attack"?C(l,"ATT"):l._line==="GK"?C(l,"GK"):C(l,"DEF"))-s});let n=i==="easy"?1+Math.floor(Math.random()*2):i==="medium"?2+Math.floor(Math.random()*2):3;return a.slice(0,Math.min(n,a.length,3))}function ze(t,e){const i={vs_ai_easy:{victoire:500,nul:250,defaite:50},vs_ai_medium:{victoire:1e3,nul:500,defaite:50},vs_ai_hard:{victoire:1500,nul:750,defaite:100},vs_ai_club:{victoire:2500,nul:1250,defaite:100}};return(i[t]||i.vs_ai_easy)[e]||0}const xe={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"},O={GK:"#111111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},re=["GK","DEF","MIL","ATT"],Se=["Tous","GK","DEF","MIL","ATT"],Ge={normal:1e3,pepite:5e3,papyte:5e3,legende:1e4},he={MA:"MAROC",FR:"FRANCE",AR:"ARGENTINE",PT:"PORTUGAL",BR:"BRESIL",ES:"ESPAGNE",DE:"ALLEMAGNE",GB:"ANGLETERRE",IT:"ITALIE",CM:"CAMEROUN",SN:"SENEGAL",NG:"NIGERIA",DK:"DANEMARK",NL:"PAYS-BAS",BE:"BELGIQUE",CI:"CÔTE D'IVOIRE",AL:"ALBANIE",HR:"CROATIE",RS:"SERBIE",TR:"TURQUIE"};function be(t){const e="https://fcnwclxlkytdfjotqkta.supabase.co";if(!(t!=null&&t.skin)||!(t!=null&&t.hair))return null;const i=t.hair==="chauve"?`${t.skin}-chauve-rase`:`${t.skin}-${t.hair}-${t.hair_length}`;return`${e}/storage/v1/object/public/assets/tetes/${i}.png`}function P(t,e){return t&&Number(e==="GK"?t.note_g:e==="DEF"?t.note_d:e==="MIL"?t.note_m:t.note_a)||0}function Re(t,e=""){var y,p;const i=t.player;if(!i)return"";const o=i.job||"ATT",a=O[o],n=xe[i.rarity]||"#ccc",r=P(i,o),l=i.job2?P(i,i.job2):null,s=i.job2?O[i.job2]:null,d=be(i),c=he[i.country_code]||i.country_code||"";return`
  <div style="
  ...
  </div>`}async function Ne(t,e){const{state:i,navigate:o,toast:a,openModal:n,closeModal:r}=e;t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:l}=await $.from("cards").select(`id, card_type, current_note, gc_type, formation, is_for_sale, sale_price,
      player:players(id, firstname, surname_encoded, country_code, club_id, job, job2,
        note_g, note_d, note_m, note_a, rarity, note_min, note_max, skin, hair, hair_length, sell_price,
        clubs(encoded_name, logo_url))`).eq("owner_id",i.profile.id),s=(l||[]).filter(u=>u.card_type==="player"&&u.player),d=(l||[]).filter(u=>u.card_type==="game_changer"),c=(l||[]).filter(u=>u.card_type==="formation"),y={};s.forEach(u=>{const x=u.player.id;y[x]=(y[x]||0)+1});let p="Tous",f="";function h(){return[...s].sort((u,x)=>{const b=re.indexOf(u.player.job),m=re.indexOf(x.player.job);return b!==m?b-m:(u.player.surname_encoded||"").localeCompare(x.player.surname_encoded||"")})}function g(){return h().filter(u=>{const x=u.player,b=p==="Tous"||x.job===p,m=!f||`${x.firstname} ${x.surname_encoded}`.toLowerCase().includes(f);return b&&m})}t.innerHTML=`
  <div class="page">
      ...
      <div style="display:flex;gap:8px;overflow-x:auto;padding-bottom:4px">
        ...
        ${d.map(u=>{var x;return`
          <div data-gc-id="${u.id}" data-gc-type="${u.gc_type}" style="
            ...
            <div style="font-size:28px">${((x=J[u.gc_type])==null?void 0:x.icon)||"⚡"}</div>
  ...
  </div>`;function v(){const u=g(),x=document.getElementById("col-grid");if(!x)return;if(!u.length){x.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const b={},m=[];u.forEach(_=>{const E=_.player.id;b[E]||(b[E]=!0,m.push(_))}),x.innerHTML=m.map(_=>{const E=y[_.player.id]||1,w=E>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${E}</div>`:"",I=s.filter(k=>k.player.id===_.player.id&&k.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return Re(_,w+I)}).join(""),x.querySelectorAll("[data-card-id]").forEach(_=>{_.addEventListener("click",()=>{const E=s.find(w=>w.id===_.dataset.cardId);E&&Pe(E,s,y,e)})})}v(),t.querySelectorAll(".filter-btn").forEach(u=>{u.addEventListener("click",()=>{p=u.dataset.job,t.querySelectorAll(".filter-btn").forEach(x=>{const b=x.dataset.job===p;x.style.background=b?"var(--green)":"#fff",x.style.color=b?"#fff":"var(--gray-600)",x.style.borderColor=b?"var(--green)":"var(--gray-200)"}),v()})}),document.getElementById("col-search").addEventListener("input",u=>{f=u.target.value.toLowerCase(),v()}),t.querySelectorAll("[data-gc-id]").forEach(u=>{u.addEventListener("click",()=>qe(u.dataset.gcType,n))}),t.querySelectorAll("[data-form-id]").forEach(u=>{u.addEventListener("click",()=>Oe(u.dataset.formation,n))})}function qe(t,e){const i=J[t]||{icon:"⚡",desc:"Effet spécial."};e("Game Changer",`<div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}function Oe(t,e){const i={"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2}},o={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},a=i[t]||i["4-4-2"],n=["ATT","MIL","DEF","GK"];function r(d,c){const h=(d-1)*54,g=(c-h)/2;return Array.from({length:d},(v,u)=>g+u*54)}function l(d){return d===1?[1]:d===2?[0,2]:d===3?[0,1,2]:d===4?[0,1,1,2]:d===5?[0,1,1,1,2]:[1]}function s(){const p=n.length*72+48,f=n.map((u,x)=>24+x*72+72/2),h={};n.forEach(u=>{h[u]=r(a[u],290)});function g(u,x){const b=a[u],m=l(b),_=h[u],E=m.indexOf(x);return E>=0?_[E]:null}let v=`<svg width="290" height="${p}" viewBox="0 0 290 ${p}" xmlns="http://www.w3.org/2000/svg">`;n.forEach((u,x)=>{const b=h[u];for(let m=0;m<b.length-1;m++){const _=b[m]+20,E=b[m+1]-20,w=f[x];v+=`<line x1="${_}" y1="${w}" x2="${E}" y2="${w}"
          stroke="rgba(255,255,255,0.35)" stroke-width="2" stroke-dasharray="4,3"/>`,v+=`<text x="${(_+E)/2}" y="${w-6}" text-anchor="middle"
          font-size="8" fill="rgba(255,255,255,0.45)">↔</text>`}});for(let u=0;u<3;u++)for(let x=0;x<n.length-1;x++){const b=n[x],m=n[x+1],_=g(b,u),E=g(m,u);if(_!==null&&E!==null){const w=(_+E)/2;v+=`<line x1="${_}" y1="${f[x]+20}" x2="${E}" y2="${f[x+1]-20}"
            stroke="rgba(255,255,255,0.35)" stroke-width="2" stroke-dasharray="4,3"/>`,v+=`<text x="${w+6}" y="${(f[x]+f[x+1])/2+3}"
            font-size="8" fill="rgba(255,255,255,0.45)">↕</text>`}}return n.forEach((u,x)=>{const b=a[u],m=h[u],_=l(b),E=o[u],w=f[x],L={};_.forEach((I,k)=>{L[I]||(L[I]={xs:[],indices:[]}),L[I].xs.push(m[k]),L[I].indices.push(k)}),Object.entries(L).forEach(([I,k])=>{const M=k.xs.length;if(M>1){const T=k.xs.reduce((B,H)=>B+H,0)/M;v+=`<circle cx="${T}" cy="${w}" r="20" fill="${E}" stroke="rgba(255,255,255,0.6)" stroke-width="2"/>`,v+=`<text x="${T}" y="${w-4}" text-anchor="middle" font-size="9" font-weight="900" fill="white" font-family="Arial Black,Arial">${u}</text>`,v+=`<text x="${T}" y="${w+9}" text-anchor="middle" font-size="8" font-weight="700" fill="rgba(255,255,255,0.85)">×${M}</text>`}else{const T=k.xs[0],B=k.indices[0]+1;v+=`<circle cx="${T}" cy="${w}" r="20" fill="${E}" stroke="rgba(255,255,255,0.6)" stroke-width="2"/>`,v+=`<text x="${T}" y="${w+4}" text-anchor="middle" font-size="9" font-weight="900" fill="white" font-family="Arial Black,Arial">${u}</text>`,v+=`<text x="${T}" y="${w+30}" text-anchor="middle" font-size="7" fill="rgba(255,255,255,0.4)">${u}${B}</text>`}})}),v+="</svg>",v}e(`Formation ${t}`,`<div style="background:linear-gradient(180deg,#1a6b3c,#0a3d1e);border-radius:12px;padding:16px;margin-bottom:14px;overflow-x:auto;text-align:center">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}function Pe(t,e,i,o){var E,w,L,I,k,M;const{state:a,toast:n,openModal:r,closeModal:l,navigate:s,refreshProfile:d}=o,c=t.player,y=e.filter(T=>T.player.id===c.id),p=y.length,f=Ge[c.rarity]||1e3,h=c.rarity!=="legende",g=be(c),v=P(c,c.job),u=c.job2?P(c,c.job2):null,x=O[c.job]||"#1A6B3C",b=c.job2?O[c.job2]:null,m=xe[c.rarity]||"#ccc",_=he[c.country_code]||c.country_code||"";r(`${c.firstname} ${c.surname_encoded}`,`<div style="display:flex;gap:16px;flex-wrap:wrap;justify-content:center">
    ...
    </div>`:""}`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(L=document.getElementById("close-detail"))==null||L.addEventListener("click",l),(I=document.getElementById("direct-sell-btn"))==null||I.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte ${c.surname_encoded} pour ${f.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const T=y.find(H=>!H.is_for_sale)||y[0];if(!T){n("Aucune carte à vendre","error");return}const{error:B}=await $.from("cards").delete().eq("id",T.id);if(B){n(B.message,"error");return}await $.from("users").update({credits:(a.profile.credits||0)+f}).eq("id",a.profile.id),await d(),n(`+${f.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),l(),s("collection")}),(k=document.getElementById("market-sell-btn"))==null||k.addEventListener("click",async()=>{const T=parseInt(document.getElementById("sell-price").value);if(!T||T<1){n("Prix invalide","error");return}await $.from("cards").update({is_for_sale:!0,sale_price:T}).eq("id",t.id),await $.from("market_listings").insert({seller_id:a.profile.id,card_id:t.id,price:T}),n("Carte mise en vente sur le marché !","success"),l(),s("collection")}),(M=document.getElementById("cancel-sell-btn"))==null||M.addEventListener("click",async()=>{await $.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",t.id),await $.from("market_listings").update({status:"cancelled"}).eq("card_id",t.id).eq("status","active"),n("Annonce retirée","success"),l(),s("collection")})}const _e={"4-4-2":[["ATT1","ATT2"],["MIL1","MIL2"],["MIL2","MIL3"],["MIL3","MIL4"],["DEF1","DEF2"],["DEF2","DEF3"],["DEF3","DEF4"],["ATT1","MIL1"],["ATT1","MIL2"],["ATT2","MIL3"],["ATT2","MIL4"],["MIL1","DEF1"],["MIL1","DEF2"],["MIL2","DEF2"],["MIL3","DEF3"],["MIL4","DEF3"],["MIL4","DEF4"],["DEF1","GK1"],["DEF2","GK1"],["DEF3","GK1"],["DEF4","GK1"]],"4-3-3":[["ATT1","ATT2"],["ATT2","ATT3"],["MIL1","MIL2"],["MIL2","MIL3"],["DEF1","DEF2"],["DEF2","DEF3"],["DEF3","DEF4"],["ATT1","MIL1"],["ATT2","MIL2"],["ATT3","MIL3"],["MIL1","DEF1"],["MIL1","DEF2"],["MIL2","DEF2"],["MIL2","DEF3"],["MIL3","DEF3"],["MIL3","DEF4"],["DEF1","GK1"],["DEF2","GK1"],["DEF3","GK1"],["DEF4","GK1"]],"3-4-3":[["ATT1","ATT2"],["ATT2","ATT3"],["MIL1","MIL2"],["MIL2","MIL3"],["MIL3","MIL4"],["DEF1","DEF2"],["DEF2","DEF3"],["ATT1","MIL1"],["ATT2","MIL2"],["ATT2","MIL3"],["ATT3","MIL4"],["MIL1","DEF1"],["MIL2","DEF1"],["MIL2","DEF2"],["MIL3","DEF2"],["MIL3","DEF3"],["MIL4","DEF3"],["DEF1","GK1"],["DEF2","GK1"],["DEF3","GK1"]],"3-5-2":[["ATT1","ATT2"],["MIL1","MIL2"],["MIL2","MIL3"],["MIL3","MIL4"],["MIL4","MIL5"],["DEF1","DEF2"],["DEF2","DEF3"],["ATT1","MIL1"],["ATT1","MIL2"],["ATT2","MIL4"],["ATT2","MIL5"],["MIL1","DEF1"],["MIL2","DEF1"],["MIL2","DEF2"],["MIL3","DEF2"],["MIL4","DEF2"],["MIL4","DEF3"],["MIL5","DEF3"],["DEF1","GK1"],["DEF2","GK1"],["DEF3","GK1"]],"5-3-2":[["ATT1","ATT2"],["MIL1","MIL2"],["MIL2","MIL3"],["DEF1","DEF2"],["DEF2","DEF3"],["DEF3","DEF4"],["DEF4","DEF5"],["ATT1","MIL1"],["ATT2","MIL3"],["MIL1","DEF1"],["MIL1","DEF2"],["MIL2","DEF2"],["MIL2","DEF3"],["MIL2","DEF4"],["MIL3","DEF4"],["MIL3","DEF5"],["DEF1","GK1"],["DEF2","GK1"],["DEF3","GK1"],["DEF4","GK1"],["DEF5","GK1"]]};function N(t,e){if(!t||!e)return"#cc2222";const i=t.country_code&&e.country_code&&t.country_code===e.country_code,o=t.club_id&&e.club_id&&t.club_id===e.club_id;return i&&o?"#00ff88":i||o?"#FFD700":"#ff3333"}const $e={"4-4-2":{ATT1:{x:.3,y:.04},ATT2:{x:.7,y:.04},MIL1:{x:.1,y:.3},MIL2:{x:.37,y:.3},MIL3:{x:.63,y:.3},MIL4:{x:.9,y:.3},DEF1:{x:.1,y:.6},DEF2:{x:.37,y:.6},DEF3:{x:.63,y:.6},DEF4:{x:.9,y:.6},GK1:{x:.5,y:.88}},"4-3-3":{ATT1:{x:.2,y:.04},ATT2:{x:.5,y:.04},ATT3:{x:.8,y:.04},MIL1:{x:.2,y:.33},MIL2:{x:.5,y:.33},MIL3:{x:.8,y:.33},DEF1:{x:.1,y:.62},DEF2:{x:.37,y:.62},DEF3:{x:.63,y:.62},DEF4:{x:.9,y:.62},GK1:{x:.5,y:.88}},"3-4-3":{ATT1:{x:.2,y:.04},ATT2:{x:.5,y:.04},ATT3:{x:.8,y:.04},MIL1:{x:.1,y:.33},MIL2:{x:.37,y:.33},MIL3:{x:.63,y:.33},MIL4:{x:.9,y:.33},DEF1:{x:.2,y:.62},DEF2:{x:.5,y:.62},DEF3:{x:.8,y:.62},GK1:{x:.5,y:.88}},"3-5-2":{ATT1:{x:.3,y:.04},ATT2:{x:.7,y:.04},MIL1:{x:.05,y:.33},MIL2:{x:.28,y:.33},MIL3:{x:.5,y:.33},MIL4:{x:.72,y:.33},MIL5:{x:.95,y:.33},DEF1:{x:.2,y:.62},DEF2:{x:.5,y:.62},DEF3:{x:.8,y:.62},GK1:{x:.5,y:.88}},"5-3-2":{ATT1:{x:.3,y:.04},ATT2:{x:.7,y:.04},MIL1:{x:.2,y:.33},MIL2:{x:.5,y:.33},MIL3:{x:.8,y:.33},DEF1:{x:.05,y:.62},DEF2:{x:.28,y:.62},DEF3:{x:.5,y:.62},DEF4:{x:.72,y:.62},DEF5:{x:.95,y:.62},GK1:{x:.5,y:.88}}},K={"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2}},F={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function Z(t){const e=typeof import.meta<"u"?"https://fcnwclxlkytdfjotqkta.supabase.co":"";if(!e||!(t!=null&&t.skin)||!(t!=null&&t.hair))return null;const i=t.hair==="chauve"?`${t.skin}-chauve-rase`:`${t.skin}-${t.hair}-${t.hair_length}`;return`${e}/storage/v1/object/public/assets/tetes/${i}.png`}async function Ee(t,e){const{state:i,navigate:o,toast:a}=e;t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:n}=await $.from("decks").select("id,name,formation_card_id,is_active").eq("owner_id",i.profile.id).order("created_at",{ascending:!1});t.innerHTML=`
  <div class="page">
    <div class="page-header">
      <h2>Mes decks</h2>
  ...
  </div>`,document.getElementById("new-deck-btn").addEventListener("click",async()=>{const r=prompt("Nom du deck :",`Deck ${((n==null?void 0:n.length)||0)+1}`);if(!r)return;const{data:l,error:s}=await $.from("decks").insert({owner_id:i.profile.id,name:r,is_active:!(n!=null&&n.length)}).select().single();if(s){a(s.message,"error");return}a("Deck créé !","success"),ae(l.id,t,e)}),t.querySelectorAll("[data-edit]").forEach(r=>{r.addEventListener("click",()=>ae(r.dataset.edit,t,e))}),t.querySelectorAll("[data-activate]").forEach(r=>{r.addEventListener("click",async()=>{await $.from("decks").update({is_active:!1}).eq("owner_id",i.profile.id),await $.from("decks").update({is_active:!0}).eq("id",r.dataset.activate),a("Deck activé !","success"),Ee(t,e)})})}async function ae(t,e,i){const{state:o,toast:a}=i;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:n}=await $.from("decks").select("*").eq("id",t).single(),{data:r}=await $.from("cards").select(`id, card_type, formation,
      player:players(id, firstname, surname_encoded, country_code, club_id, job, job2,
        note_g, note_d, note_m, note_a, rarity, skin, hair, hair_length,
        clubs(encoded_name, logo_url))`).eq("owner_id",o.profile.id),l=(r||[]).filter(f=>f.card_type==="player"&&f.player),s=(r||[]).filter(f=>f.card_type==="formation"),d=s.map(f=>f.formation).filter(Boolean),{data:c}=await $.from("deck_cards").select("card_id, position, is_starter, slot_order").eq("deck_id",t);let y=n.formation||"4-4-2";d.length>0&&!d.includes(y)&&(y=d[0]);const p={deckId:t,name:n.name,formation:y,formationCardId:n.formation_card_id,slots:{},subs:[],playerCards:l,formationCards:s,availableFormations:d};(c||[]).forEach(f=>{f.is_starter?p.slots[f.position]=f.card_id:p.subs.includes(f.card_id)||p.subs.push(f.card_id)}),z(e,p,i)}function z(t,e,i){var s;const{navigate:o}=i;K[e.formation];const a=de(e.formation),n=a.filter(d=>e.slots[d]).length,r=e.availableFormations.length>0?e.availableFormations:Object.keys(K),l=e.subs.map(d=>e.playerCards.find(c=>c.id===d)).filter(Boolean);[...Object.values(e.slots),...e.subs],t.innerHTML=`
  <div class="page">
  ...
  </div>`,Ke(t,e,a,i),document.getElementById("builder-back").addEventListener("click",()=>o("decks")),document.getElementById("formation-select").addEventListener("change",d=>{e.formation=d.target.value;const c=de(e.formation),y={};c.forEach(p=>{e.slots[p]&&(y[p]=e.slots[p])}),e.slots=y,z(t,e,i)}),document.getElementById("save-deck").addEventListener("click",()=>We(e,i)),t.querySelectorAll("[data-remove-sub]").forEach(d=>{d.addEventListener("click",()=>{e.subs=e.subs.filter(c=>c!==d.dataset.removeSub),z(t,e,i)})}),(s=document.getElementById("add-sub-btn"))==null||s.addEventListener("click",()=>{Ue(e,t,i)})}function Ke(t,e,i,o){const a=document.getElementById("deck-field");if(!a)return;const n=e.formation,r=$e[n]||{},l=_e[n]||[],s={};i.forEach(b=>{const m=e.slots[b],_=m?e.playerCards.find(E=>E.id===m):null;s[b]=(_==null?void 0:_.player)||null});const d=i.filter(b=>b.startsWith("MIL"));let c=0,y=0;d.forEach(b=>{const m=s[b];m&&(c+=Number(m.note_m)||0)}),l.forEach(([b,m])=>{if(!b.startsWith("MIL")||!m.startsWith("MIL"))return;N(s[b],s[m])!=="#ff3333"&&y++});const p=320,f=320,h=28,g=4;function v(b){const m=r[b];return m?{x:m.x*p,y:m.y*f}:null}let u="";for(const[b,m]of l){const _=v(b),E=v(m);if(!_||!E)continue;const w=s[b],L=s[m],I=N(w,L),k=I==="#ff3333"?.3:.9,M=I!=="#ff3333"?`filter="url(#glow-${I.replace("#","")})"`:"";u+=`<line x1="${_.x}" y1="${_.y}" x2="${E.x}" y2="${E.y}"
      stroke="${I}" stroke-width="${g}" stroke-linecap="round"
      opacity="${k}" ${M}/>`}for(const b of i){const m=v(b);if(!m)continue;const _=s[b],E=b.replace(/\d+/,""),L={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[E]||"#555",I=_?Number(E==="GK"?_.note_g:E==="DEF"?_.note_d:E==="MIL"?_.note_m:_.note_a)||0:null,k=_?(_.surname_encoded||"").slice(0,8).toUpperCase():"";if(_){const M=Z(_);M&&(u+=`
          <defs>
            <clipPath id="clip-${b}">
        ...
        <circle cx="${m.x}" cy="${m.y}" r="${h}" fill="${M?"transparent":L}"
          stroke="${L}" stroke-width="2" />
        <circle cx="${m.x}" cy="${m.y}" r="${h}" fill="${L}" opacity="${M?"0.5":"1"}"
        ...
        <text x="${m.x}" y="${m.y-3}" text-anchor="middle" font-size="13" font-weight="900"
          fill="white" font-family="Arial Black,Arial" style="text-shadow:0 1px 2px #000">${I}</text>
        <text x="${m.x}" y="${m.y+11}" text-anchor="middle" font-size="6.5" fill="rgba(255,255,255,0.9)"
          font-family="Arial">${k}</text>
    ...
    <svg viewBox="0 0 ${p} ${f}" width="100%" style="display:block;max-width:380px;margin:0 auto">
      ${x}
      ${u}
    </svg>`,a.querySelectorAll(".deck-slot-hit").forEach(b=>{b.addEventListener("click",()=>He(b.dataset.pos,e,t,o))})}function He(t,e,i,o){var p,f,h;const{openModal:a,closeModal:n}=o,r=t.replace(/\d+/,""),l=e.slots[t],s=l?e.playerCards.find(g=>g.id===l):null;(p=s==null?void 0:s.player)==null||p.id;const d=new Set;Object.entries(e.slots).forEach(([g,v])=>{var x;if(g===t||!v)return;const u=e.playerCards.find(b=>b.id===v);(x=u==null?void 0:u.player)!=null&&x.id&&d.add(u.player.id)}),e.subs.forEach(g=>{var u;const v=e.playerCards.find(x=>x.id===g);(u=v==null?void 0:v.player)!=null&&u.id&&d.add(v.player.id)});const c=new Set,y=e.playerCards.filter(g=>{const v=g.player;return!(v.job===r||v.job2===r)||d.has(v.id)||c.has(v.id)?!1:(c.add(v.id),!0)});y.sort((g,v)=>{const u=r==="GK"?g.player.note_g:r==="DEF"?g.player.note_d:r==="MIL"?g.player.note_m:g.player.note_a;return(r==="GK"?v.player.note_g:r==="DEF"?v.player.note_d:r==="MIL"?v.player.note_m:v.player.note_a)-u}),a(`Choisir ${r} — ${t}`,`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
      ${e.slots[t]?`
        <button class="btn btn-danger btn-sm" id="remove-player" style="width:100%;margin-bottom:4px">
          ✕ Retirer le joueur actuel
        </button>`:""}
      ${y.length>0?y.map(g=>{var m,_;const v=g.player,u=r==="GK"?v.note_g:r==="DEF"?v.note_d:r==="MIL"?v.note_m:v.note_a,x=Z(v),b={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"}[v.rarity];return`<div class="player-option" data-card-id="${g.id}"
          style="display:flex;align-items:center;gap:10px;padding:8px;border:1.5px solid var(--gray-200);border-radius:10px;cursor:pointer">
          <!-- Portrait -->
          <div style="width:44px;height:44px;border-radius:8px;overflow:hidden;flex-shrink:0;background:#dde;border:2px solid ${F[r]}">
            ${x?`<img src="${x}" style="width:100%;height:100%;object-fit:cover">`:`<div style="width:100%;height:100%;background:${F[r]};display:flex;align-items:center;justify-content:center;color:#fff;font-size:10px;font-weight:700">${r}</div>`}
          </div>
          <!-- Infos -->
          <div style="flex:1;min-width:0">
            ...
            <div style="display:flex;align-items:center;gap:6px;margin-top:3px">
              ...
              ${(m=v.clubs)!=null&&m.logo_url?`<img src="${v.clubs.logo_url}" style="width:18px;height:18px;object-fit:contain">`:`<span style="font-size:10px;color:var(--gray-600)">${((_=v.clubs)==null?void 0:_.encoded_name)||"—"}</span>`}
              <span style="font-size:10px;color:var(--gray-600)">${v.country_code}</span>
            </div>
          </div>
          <!-- Note -->
          <div style="width:36px;height:36px;border-radius:8px;background:${F[r]};color:#fff;display:flex;align-items:center;justify-content:center;font-weight:900;font-size:16px;border:2px solid ${b};flex-shrink:0">
            ${u}
          </div>
        </div>`}).join(""):'<div style="text-align:center;color:var(--gray-600);padding:20px">Aucun joueur pour ce poste.<br><small>Ouvre des boosters !</small></div>'}
    </div>`,'<button class="btn btn-ghost" id="close-selector">Fermer</button>'),(f=document.getElementById("close-selector"))==null||f.addEventListener("click",n),(h=document.getElementById("remove-player"))==null||h.addEventListener("click",()=>{delete e.slots[t],n(),z(i,e,o)}),document.querySelectorAll(".player-option").forEach(g=>{g.addEventListener("click",()=>{e.slots[t]=g.dataset.cardId,n(),z(i,e,o)})})}function Ue(t,e,i){var s;const{openModal:o,closeModal:a}=i,n=new Set;Object.values(t.slots).filter(Boolean).forEach(d=>{var y;const c=t.playerCards.find(p=>p.id===d);(y=c==null?void 0:c.player)!=null&&y.id&&n.add(c.player.id)}),t.subs.forEach(d=>{var y;const c=t.playerCards.find(p=>p.id===d);(y=c==null?void 0:c.player)!=null&&y.id&&n.add(c.player.id)});const r=new Set,l=t.playerCards.filter(d=>{var c,y,p;return n.has((c=d.player)==null?void 0:c.id)||r.has((y=d.player)==null?void 0:y.id)?!1:(r.add((p=d.player)==null?void 0:p.id),!0)});o("Ajouter un remplaçant",`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
      ${l.length>0?l.map(d=>{var f;const c=d.player,y=Z(c),p=c.job==="GK"?c.note_g:c.job==="DEF"?c.note_d:c.job==="MIL"?c.note_m:c.note_a;return`<div class="player-option" data-card-id="${d.id}"
          style="display:flex;align-items:center;gap:10px;padding:8px;border:1.5px solid var(--gray-200);border-radius:10px;cursor:pointer">
    ...
    </div>`,'<button class="btn btn-ghost" id="close-sub-selector">Fermer</button>'),(s=document.getElementById("close-sub-selector"))==null||s.addEventListener("click",a),document.querySelectorAll(".player-option").forEach(d=>{d.addEventListener("click",()=>{t.subs.push(d.dataset.cardId),a(),z(e,t,i)})})}async function We(t,e){const{state:i,toast:o,navigate:a}=e,n=t.formationCards.find(s=>s.formation===t.formation),r=(n==null?void 0:n.id)||t.formationCardId;await $.from("decks").update({formation:t.formation,formation_card_id:r||null}).eq("id",t.deckId),await $.from("deck_cards").delete().eq("deck_id",t.deckId);const l=[];if(Object.entries(t.slots).forEach(([s,d],c)=>{l.push({deck_id:t.deckId,card_id:d,position:s,is_starter:!0,slot_order:c})}),t.subs.forEach((s,d)=>{l.push({deck_id:t.deckId,card_id:s,position:`SUB${d+1}`,is_starter:!1,slot_order:100+d})}),l.length>0){const{error:s}=await $.from("deck_cards").insert(l);if(s){o(s.message,"error");return}}o("Deck enregistré ✅","success"),a("decks")}function de(t){const e=K[t]||K["4-4-2"],i=["GK1"];for(let o=1;o<=e.DEF;o++)i.push(`DEF${o}`);for(let o=1;o<=e.MIL;o++)i.push(`MIL${o}`);for(let o=1;o<=e.ATT;o++)i.push(`ATT${o}`);return i}const le=[{id:"players_std",icon:"⚽",name:"Players",sub:"5 cartes joueurs",cost:5e3,costLabel:"5 000 crédits",cardCount:5,type:"player"},{id:"players_pub",icon:"📺",name:"Players (pub)",sub:"3 cartes joueurs",cost:0,costLabel:"1 pub",cardCount:3,type:"player"},{id:"game_changer",icon:"⚡",name:"Game Changer",sub:"3 cartes spéciales",cost:1e4,costLabel:"10 000 crédits",cardCount:3,type:"game_changer"},{id:"formation",icon:"🏟️",name:"Formation",sub:"1 carte formation",cost:1e4,costLabel:"10 000 crédits",cardCount:1,type:"formation"}],we={Ressusciter:{icon:"💫",desc:"Réactive un joueur grisé."},"Double attaque":{icon:"⚡",desc:"La prochaine attaque compte double."},Bouclier:{icon:"🛡️",desc:"Annule le prochain but adverse."},"Vol de note":{icon:"🎯",desc:"-1 à la prochaine action IA."},Gel:{icon:"❄️",desc:"Bloque le meilleur attaquant IA."},"Remplacement+":{icon:"🔄",desc:"+1 remplacement pour ce match."}};function Ve(t){const e="https://fcnwclxlkytdfjotqkta.supabase.co";if(!(t!=null&&t.skin)||!(t!=null&&t.hair))return null;const i=t.hair==="chauve"?`${t.skin}-chauve-rase`:`${t.skin}-${t.hair}-${t.hair_length}`;return`${e}/storage/v1/object/public/assets/tetes/${i}.png`}const Ye={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},Je={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"};async function Xe(t,{state:e,navigate:i,toast:o}){var n;const a=((n=e.profile)==null?void 0:n.credits)||0;t.innerHTML=`
  <div class="page">
    <div class="page-header">
      <h2>📦 Boosters</h2>
    ...
    <div class="page-body">
      <div class="booster-grid">
        ${le.map(r=>{const l=a>=r.cost||r.cost===0,s=r.id==="players_std"||r.id==="players_pub";return`<div class="booster-card ${l?"":"disabled"}" data-booster="${r.id}" style="position:relative">
  ...
  </div>`,t.querySelectorAll(".booster-card:not(.disabled)").forEach(r=>{r.addEventListener("click",async()=>{const l=le.find(s=>s.id===r.dataset.booster);if(l){r.style.opacity="0.5",r.style.pointerEvents="none";try{await Qe(l,{state:e,toast:o,navigate:i,container:t})}catch(s){o(s.message,"error"),r.style.opacity="",r.style.pointerEvents=""}}})}),t.querySelectorAll(".booster-info-btn").forEach(r=>{r.addEventListener("click",l=>{l.stopPropagation(),st()})})}async function Qe(t,{state:e,toast:i,navigate:o,container:a}){if(t.cost>0&&e.profile.credits<t.cost){i("Crédits insuffisants","error");return}t.id==="players_pub"&&await rt();let n=[];t.type==="player"?n=await tt(e.profile,t.cardCount,t.cost):t.type==="game_changer"?n=await it(e.profile,t.cardCount,t.cost):t.type==="formation"&&(n=await ot(e.profile,t.cost));const{data:r}=await $.from("users").select("*").eq("id",e.profile.id).single();r&&(e.profile=r),nt(n,t,o)}function Ze(){const t=Math.random()*100;return t<.5?"legende":t<2?"special":t<10?"normal_high":"normal_low"}function j(t){return Math.max(Number(t.note_g)||0,Number(t.note_d)||0,Number(t.note_m)||0,Number(t.note_a)||0)}function et(t,e){let i;switch(e){case"legende":i=t.filter(o=>o.rarity==="legende"),i.length||(i=t.filter(o=>o.rarity==="pepite"||o.rarity==="papyte")),i.length||(i=t.filter(o=>j(o)>=6));break;case"special":i=t.filter(o=>o.rarity==="pepite"||o.rarity==="papyte"),i.length||(i=t.filter(o=>j(o)>=6));break;case"normal_high":i=t.filter(o=>o.rarity==="normal"&&j(o)>=6),i.length||(i=t.filter(o=>j(o)>=6));break;default:i=t.filter(o=>o.rarity==="normal"&&j(o)>=1&&j(o)<=5),i.length||(i=t.filter(o=>o.rarity==="normal"));break}return i.length||(i=t),i[Math.floor(Math.random()*i.length)]}async function tt(t,e,i){if(i>0){const{error:d}=await $.from("users").update({credits:t.credits-i}).eq("id",t.id);if(d)throw d}const{data:o}=await $.from("players").select("id,job,firstname,surname_encoded,country_code,club_id,rarity,note_g,note_d,note_m,note_a,note_min,note_max,skin,hair,hair_length,sell_price,clubs(encoded_name,logo_url)").eq("is_active",!0);if(!(o!=null&&o.length))throw new Error("Pas de joueurs en BDD — ajoutes-en via le panel admin !");const a=o.filter(d=>d.job==="GK"),n=o.filter(d=>d.job!=="GK"),r=!t.first_booster_opened&&a.length>0,l=[];for(let d=0;d<e;d++){const c=d===0&&r?a:d===0?n:o,y=Ze(),p=et(c,y);p&&l.push(p)}r&&await $.from("users").update({first_booster_opened:!0}).eq("id",t.id);const{data:s}=await $.from("cards").insert(l.map(d=>({owner_id:t.id,player_id:d.id,card_type:"player"}))).select();return l.map((d,c)=>({...s[c],player:d}))}async function it(t,e,i){const{error:o}=await $.from("users").update({credits:t.credits-i}).eq("id",t.id);if(o)throw o;const a=Object.keys(we),n=Array.from({length:e},()=>a[Math.floor(Math.random()*a.length)]),{data:r}=await $.from("cards").insert(n.map(l=>({owner_id:t.id,card_type:"game_changer",gc_type:l}))).select();return r}async function ot(t,e){const{error:i}=await $.from("users").update({credits:t.credits-e}).eq("id",t.id);if(i)throw i;const o=["4-4-2","4-3-3","3-4-3","3-5-2","5-3-2"],a=o[Math.floor(Math.random()*o.length)],{data:n}=await $.from("cards").insert({owner_id:t.id,card_type:"formation",formation:a}).select();return n}function nt(t,e,i){const o=document.createElement("div");o.id="booster-anim-overlay",o.innerHTML=`
    <style>
  ...
  `,document.body.appendChild(o);let a=!1;document.getElementById("pack-visual").addEventListener("click",()=>{if(a)return;a=!0;const p=document.getElementById("pack-visual");p.classList.add("shaking"),setTimeout(()=>{p.classList.add("pack-open"),setTimeout(()=>{document.getElementById("pack-phase").style.display="none",r(0)},600)},500)});let n=0;function r(p){n=p;const f=document.getElementById("reveal-phase");f.style.display="flex",l(p)}function l(p){var _;const f=t[p],h=document.getElementById("card-counter"),g=document.getElementById("single-card-slot"),v=document.getElementById("card-tap-hint");h&&(h.textContent=`Carte ${p+1} / ${t.length}`),v&&(v.textContent=p<t.length-1?"Appuie pour continuer →":"Appuie pour voir toutes tes cartes");const u=ce(f),x=f.card_type==="player"&&((_=f.player)==null?void 0:_.rarity)==="legende";g.innerHTML=`
    ...
    </div>`}if(t.card_type==="game_changer"){const o=we[t.gc_type]||{icon:"⚡",desc:""};return`<div style="width:140px;height:200px;background:linear-gradient(135deg,#3d0a7a,#7a28b8);border-radius:12px;border:3px solid #9b59b6;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:16px">
  ...
  `,document.body.appendChild(t),t.addEventListener("click",e=>{e.target===t&&t.remove()}),document.getElementById("odds-close").addEventListener("click",()=>t.remove())}function rt(){return new Promise(t=>{const e=document.createElement("div");e.style.cssText="position:fixed;inset:0;background:#000;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:4000;color:#fff;gap:16px";let i=5;e.innerHTML=`<div style="font-size:48px">📺</div>
      <div style="font-size:18px;font-weight:700">Publicité</div>
      <div style="font-size:36px;font-weight:900" id="ad-cd">5</div>`,document.body.appendChild(e);const o=setInterval(()=>{i--;const a=document.getElementById("ad-cd");a&&(a.textContent=i),i<=0&&(clearInterval(o),e.remove(),t(!0))},1e3)})}const S={"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2}},U={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function ke(t,e,i,o,a){var n;t.innerHTML=`<div class="match-screen" style="display:flex;align-items:center;justify-content:center;min-height:100vh">
    <div style="text-align:center;padding:40px;color:#fff">
      <div style="font-size:48px;margin-bottom:16px">${e}</div>
      <p style="margin-bottom:16px">${i}</p>
      <button class="btn btn-primary" id="msg-btn">${o}</button>
    </div>
  </div>`,(n=document.getElementById("msg-btn"))==null||n.addEventListener("click",a)}function Ie(t){const e=typeof import.meta<"u"?"https://fcnwclxlkytdfjotqkta.supabase.co":"";if(!e||!(t!=null&&t.skin)||!(t!=null&&t.hair))return null;const i=t.hair==="chauve"?`${t.skin}-chauve-rase`:`${t.skin}-${t.hair}-${t.hair_length}`;return`${e}/storage/v1/object/public/assets/tetes/${i}.png`}function pe(t){const e=t.player;return{cardId:t.id,id:e.id,firstname:e.firstname,name:e.surname_encoded,country_code:e.country_code,club_id:e.club_id,job:e.job,job2:e.job2,note_g:Number(e.note_g)||0,note_d:Number(e.note_d)||0,note_m:Number(e.note_m)||0,note_a:Number(e.note_a)||0,rarity:e.rarity,skin:e.skin,hair:e.hair,hair_length:e.hair_length,boost:0,used:!1,_line:null,_col:null}}function ee(t){return t===1?[1]:t===2?[0,2]:t===3?[0,1,2]:t===4?[0,1,1,2]:t===5?[0,1,1,1,2]:[1]}function at(){const t=Math.random()*100;return t<.1?4:t<5?3:t<20?2:1}function dt(t,e){const i=S[e]||S["4-4-2"],o={GK:[],DEF:[],MIL:[],ATT:[]},a=[...t];for(const n of["GK","DEF","MIL","ATT"]){const r=[];for(let s=0;s<i[n];s++){let d=a.findIndex(c=>c.job===n);if(d===-1&&(d=a.findIndex(c=>c.job2===n)),d===-1&&(d=0),a[d]){const c={...a[d],_line:n};r.push(c),a.splice(d,1)}}const l=ee(r.length);r.forEach((s,d)=>{s._col=l[d]}),o[n]=r}return o}async function lt(t,e){const{data:i}=await $.from("players").select("id,firstname,surname_encoded,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length").eq("is_active",!0).limit(60);if(!i||i.length<11)return ct(t);const o=S[t]||S["4-4-2"],a={GK:[],DEF:[],MIL:[],ATT:[]},n=[...i];for(const r of["GK","DEF","MIL","ATT"]){const l=n.filter(p=>p.job===r),s=n.filter(p=>p.job!==r),d=[...l,...s],c=[];for(let p=0;p<o[r];p++){const f=d[p]||n[p];f&&c.push({cardId:"ai-"+f.id+"-"+p,id:f.id,firstname:f.firstname,name:f.surname_encoded,country_code:f.country_code,club_id:f.club_id,job:f.job,job2:f.job2,note_g:Number(f.note_g)||0,note_d:Number(f.note_d)||0,note_m:Number(f.note_m)||0,note_a:Number(f.note_a)||0,rarity:f.rarity,skin:f.skin,hair:f.hair,hair_length:f.hair_length,boost:0,used:!1,_line:r})}const y=ee(c.length);c.forEach((p,f)=>{p._col=y[f]}),a[r]=c}return a}function ct(t){const e=S[t]||S["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},o=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let a=0;for(const n of["GK","DEF","MIL","ATT"]){const r=[];for(let s=0;s<e[n];s++){const d=3+Math.floor(Math.random()*5);r.push({cardId:"fake-"+a,id:"fake-"+a,firstname:"IA",name:o[a%o.length],country_code:"XX",club_id:null,job:n,job2:null,note_g:n==="GK"?d:2,note_d:n==="DEF"?d:2,note_m:n==="MIL"?d:2,note_a:n==="ATT"?d:2,rarity:"normal",boost:0,used:!1,_line:n}),a++}const l=ee(r.length);r.forEach((s,d)=>{s._col=l[d]}),i[n]=r}return i}async function pt(t,e){var m;const{state:i,navigate:o,toast:a}=e,n=i.params||{};t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const r=n.matchMode||"vs_ai_easy",l=r.replace("vs_ai_",""),s=r;if(!n.deckId)return ft(t,e,r);const d=n.deckId,{data:c}=await $.from("deck_cards").select(`position, is_starter, slot_order,
      card:cards(id, card_type, formation,
        player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
          clubs(encoded_name,logo_url)))`).eq("deck_id",d).order("slot_order"),y=(c||[]).filter(_=>{var E;return _.is_starter&&((E=_.card)==null?void 0:E.player)}).map(_=>pe(_.card)),p=(c||[]).filter(_=>{var E;return!_.is_starter&&((E=_.card)==null?void 0:E.player)}).map(_=>pe(_.card));if(y.length<11){ke(t,"⚠️",`Deck incomplet (${y.length}/11).`,"Compléter",()=>o("decks"));return}const f=(c||[]).find(_=>{var E;return((E=_.card)==null?void 0:E.card_type)==="formation"}),h=((m=f==null?void 0:f.card)==null?void 0:m.formation)||"4-4-2",{data:g}=await $.from("cards").select("id,gc_type").eq("owner_id",i.profile.id).eq("card_type","game_changer"),v=dt(y,h),u=await lt(h),{data:x}=await $.from("matches").insert({home_id:i.profile.id,away_id:null,mode:s,home_deck_id:d,status:"in_progress"}).select().single(),b={matchId:x==null?void 0:x.id,mode:s,difficulty:l,formation:h,homeTeam:v,aiTeam:u,homeSubs:p,subsUsed:0,maxSubs:Math.min(p.length,3),homeScore:0,aiScore:0,gcCards:g||[],usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};ut(t,b,e)}async function ft(t,e,i){var r;const{state:o,navigate:a}=e,{data:n}=await $.from("decks").select("id,name,is_active,formation_card_id").eq("owner_id",o.profile.id).order("created_at",{ascending:!1});if(!n||n.length===0){ke(t,"📋","Aucun deck. Crée un deck avant de jouer !","Créer un deck",()=>a("decks"));return}t.innerHTML=`
  ...
  <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;gap:20px;padding:20px">
    ...
    <div id="midfield-result" style="opacity:0;text-align:center;transition:opacity 0.5s;color:#fff">
      ...
      `,d&&(e.boostCard={value:h})}e.attacker=d?"home":"ai",e.log.push({text:`Duel milieu : ${e.clubName} ${l} – ${s} IA → ${d?e.clubName:"IA"} attaque en premier`,type:"info"}),setTimeout(()=>{e.phase=e.attacker==="home"?"attack":"ai-attack",D(t,e,i),e.attacker==="ai"&&setTimeout(()=>W(t,e,i),1e3)},2800)},1200)}function Le(t,e,i,o,a=310,n=310){const r=$e[e]||{},l=_e[e]||[],s=26,d={},c=["ATT","MIL","DEF","GK"];for(const h of c)(t[h]||[]).forEach((v,u)=>{d[`${h}${u+1}`]=v});function y(h){const g=r[h];return g?{x:g.x*a,y:g.y*n}:null}let p="";for(const[h,g]of l){const v=y(h),u=y(g);if(!v||!u)continue;const x=d[h],b=d[g],m=N(x,b),_=m==="#ff3333"?.25:.9,E=m!=="#ff3333"?`filter="url(#glow${m.replace("#","").slice(0,6)})"`:"";p+=`<line x1="${v.x.toFixed(1)}" y1="${v.y.toFixed(1)}" x2="${u.x.toFixed(1)}" y2="${u.y.toFixed(1)}"
      stroke="${m}" stroke-width="3.5" stroke-linecap="round" opacity="${_}" ${E}/>`}for(const[h,g]of Object.entries(d)){const v=y(h);if(!v)continue;const u=h.replace(/[0-9]/g,""),b={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[u]||"#555",m=i==="attack"&&["MIL","ATT"].includes(u)&&!g.used||i==="defense"&&["GK","DEF","MIL"].includes(u)&&!g.used,_=o.includes(g.cardId);let E;i==="attack"?E=u==="MIL"?Number(g.note_m)||0:Number(g.note_a)||0:i==="defense"?E=u==="GK"?Number(g.note_g)||0:u==="MIL"?Number(g.note_m)||0:Number(g.note_d)||0:E=Number(u==="GK"?g.note_g:u==="DEF"?g.note_d:u==="MIL"?g.note_m:g.note_a)||0,E=E+(g.boost||0);const w=_?"#FFD700":m?"rgba(255,255,255,0.7)":"rgba(255,255,255,0.25)",L=_?3:2,I=g.used?.25:1,k=Ie(g);k&&(p+=`<defs><clipPath id="mc-${h}"><circle cx="${v.x}" cy="${v.y}" r="${s}"/></clipPath></defs>`),p+=`<circle cx="${v.x}" cy="${v.y}" r="${s}" fill="${b}" opacity="${I}"
      stroke="${w}" stroke-width="${L}"/>`,k&&!g.used&&(p+=`<image href="${k}" x="${v.x-s}" y="${v.y-s}" width="${s*2}" height="${s*2}"
        clip-path="url(#mc-${h})" preserveAspectRatio="xMidYMid slice" opacity="0.8"/>`,p+=`<circle cx="${v.x}" cy="${v.y}" r="${s}" fill="${b}" opacity="0.35"
        stroke="${w}" stroke-width="${L}"/>`),g.boost&&(p+=`<rect x="${v.x+s-10}" y="${v.y-s}" width="14" height="10" rx="3" fill="#87CEEB"/>
        <text x="${v.x+s-3}" y="${v.y-s+8}" text-anchor="middle" font-size="7" fill="#000" font-weight="900">+${g.boost}</text>`),p+=`<text x="${v.x}" y="${v.y-1}" text-anchor="middle" font-size="12" font-weight="900"
      fill="${g.used?"#555":"white"}" font-family="Arial Black,Arial">${g.used?"–":E}</text>
    <text x="${v.x}" y="${v.y+11}" text-anchor="middle" font-size="6" fill="rgba(255,255,255,${g.used?.3:.8})"
      font-family="Arial">${(g.name||"").slice(0,8)}</text>`,m&&(p+=`<circle cx="${v.x}" cy="${v.y}" r="${s}" fill="rgba(255,255,255,0.08)"
        class="match-slot-hit ${_?"selected":""}" data-card-id="${g.cardId}" data-role="${u}"
  ...
  </svg>`}function yt(t,e,i,o){return`<div id="match-terrain-wrap" style="position:relative;padding:0 4px">
    ${Le(t,e,i,o)}
  ...
  <div class="match-screen">
    ...
    <div class="match-field" id="match-field" style="position:relative">
      ${yt(e.homeTeam,e.formation,e.phase,a)}
    </div>
    ...
    <div style="padding:6px 12px;display:flex;gap:6px;overflow-x:auto;align-items:center;background:rgba(0,0,0,0.2)">
      ...
      ${e.gcCards.filter(f=>!e.usedGc.includes(f.id)).map(f=>{var h;return`
        <div class="gc-mini" data-gc-id="${f.id}" data-gc-type="${f.gc_type}"
          ...
          <div style="font-size:14px">${((h=J[f.gc_type])==null?void 0:h.icon)||"⚡"}</div>
    ...
    <div class="match-log" id="match-log">
  ...
  </div>`,(d=document.getElementById("match-quit"))==null||d.addEventListener("click",()=>{confirm("Abandonner le match ?")&&i.navigate("home")}),(c=document.getElementById("view-ai"))==null||c.addEventListener("click",()=>Et(e,i)),vt(t,e,i),t.querySelectorAll(".match-slot-hit").forEach(f=>{f.addEventListener("click",()=>gt(f,e,t,i))}),t.querySelectorAll(".gc-mini").forEach(f=>{f.addEventListener("click",()=>$t(f.dataset.gcId,f.dataset.gcType,t,e,i))}),(y=document.getElementById("boost-card"))==null||y.addEventListener("click",()=>{bt(t,e,i)}),(p=document.getElementById("sub-btn"))==null||p.addEventListener("click",()=>{_t(t,e,i)});const s=document.getElementById("match-log");s&&(s.scrollTop=s.scrollHeight)}function vt(t,e,i){var a,n,r,l;const o=document.getElementById("match-actions");if(o)if(e.phase==="attack"){const s=e.selected.length>0?X(e.selected.map(d=>({...d,_line:d._role})),e.modifiers.home):null;o.innerHTML=`
      ...
      <button class="btn btn-primary" id="confirm-attack" style="width:100%" ${s?"":"disabled"}>Attaquer →</button>`,(a=document.getElementById("confirm-attack"))==null||a.addEventListener("click",()=>mt(t,e,i))}else if(e.phase==="defense"){const s=e.selected.length>0?Q(e.selected.map(d=>({...d,_line:d._role})),e.modifiers.home):null;o.innerHTML=`
      <div style="text-align:center;color:#fff;margin-bottom:6px;font-size:13px">
      ...
      <button class="btn btn-primary" id="confirm-defense" style="width:100%" ${s?"":"disabled"}>Défendre →</button>`,(r=document.getElementById("confirm-defense"))==null||r.addEventListener("click",()=>xt(t,e,i))}else e.phase==="finished"?(o.innerHTML='<button class="btn btn-primary" id="end-match" style="width:100%">Voir les résultats</button>',(l=document.getElementById("end-match"))==null||l.addEventListener("click",()=>i.navigate("home"))):o.innerHTML=`<div style="text-align:center;color:rgba(255,255,255,.4);padding:8px;font-size:12px">⏳ Tour de l'IA...</div>`}function gt(t,e,i,o){const a=t.dataset.cardId,n=t.dataset.role,r=e.selected.findIndex(l=>l.cardId===a);if(r!==-1)e.selected.splice(r,1);else{if(e.selected.length>=3){o.toast("Maximum 3 joueurs","error");return}const l=(e.homeTeam[n]||[]).find(s=>s.cardId===a);l&&e.selected.push({...l,_role:n,_line:n})}D(i,e,o)}function mt(t,e,i){const o=e.selected.map(n=>({...n,_line:n._role})),a=X(o,e.modifiers.home);e.pendingAttack={...a,players:[...e.selected],side:"home"},e.selected.forEach(n=>{const r=(e.homeTeam[n._role]||[]).find(l=>l.cardId===n.cardId);r&&(r.used=!0)}),e.log.push({text:`Vous attaquez : ${a.total} (${e.selected.map(n=>n.name).join(", ")})`,type:"info"}),e.selected=[],e.modifiers.home={},e.phase="ai-defense",D(t,e,i),setTimeout(()=>ht(t,e,i),1200)}function xt(t,e,i){const o=e.selected.map(r=>({...r,_line:r._role})),a=Q(o,e.modifiers.home);e.selected.forEach(r=>{const l=(e.homeTeam[r._role]||[]).find(s=>s.cardId===r.cardId);l&&(l.used=!0)});const n=ge(e.pendingAttack.total,a.total,e.modifiers.home);n.shielded?e.log.push({text:"🛡️ Bouclier ! But annulé.",type:"info"}):n.goal?(e.aiScore++,e.log.push({text:`⚽ BUT IA ! (${e.pendingAttack.total} > ${a.total})`,type:"goal"})):e.log.push({text:`🧤 Défense ! (${a.total} ≥ ${e.pendingAttack.total})`,type:"info"}),e.selected=[],e.modifiers.home={},e.pendingAttack=null,Ae(t,e,i,"home-attack")}function W(t,e,i){const o=[...e.aiTeam.MIL||[],...e.aiTeam.ATT||[]],a=me(o,"attack",e.difficulty);if(!a.length){Me(t,e,i);return}const n=X(a,e.modifiers.ai);e.pendingAttack={...n,players:a,side:"ai"},a.forEach(r=>{r.used=!0}),e.log.push({text:`IA attaque : ${n.total}`,type:"info"}),e.modifiers.ai={},e.phase="defense",D(t,e,i)}function ht(t,e,i){const o=[...e.aiTeam.GK||[],...e.aiTeam.DEF||[],...e.aiTeam.MIL||[]],a=me(o,"defense",e.difficulty),n=a.length>0?Q(a,e.modifiers.ai).total:0;a.forEach(l=>{l.used=!0});const r=ge(e.pendingAttack.total,n,e.modifiers.ai);r.shielded?e.log.push({text:"🛡️ Bouclier IA !",type:"info"}):r.goal?(e.homeScore++,e.log.push({text:`⚽ BUT ! (${e.pendingAttack.total} > ${n})`,type:"goal"})):e.log.push({text:`🧤 IA défend (${n} ≥ ${e.pendingAttack.total})`,type:"info"}),e.modifiers.ai={},e.pendingAttack=null,Ae(t,e,i,"ai-attack")}function Ae(t,e,i,o){if(e.round++,Te(e)){V(t,e,i);return}if(o==="home-attack"){if(![...e.homeTeam.MIL||[],...e.homeTeam.ATT||[]].filter(n=>!n.used).length){if(![...e.homeTeam.GK||[],...e.homeTeam.DEF||[],...e.homeTeam.MIL||[]].filter(r=>!r.used).length){V(t,e,i);return}e.phase="ai-attack",D(t,e,i),setTimeout(()=>W(t,e,i),800);return}e.phase="attack",D(t,e,i)}else{if(![...e.aiTeam.MIL||[],...e.aiTeam.ATT||[]].filter(n=>!n.used).length){Me(t,e,i);return}e.phase="ai-attack",D(t,e,i),setTimeout(()=>W(t,e,i),800)}}function Te(t){const e=["MIL","ATT","GK","DEF"].some(o=>(t.homeTeam[o]||[]).some(a=>!a.used)),i=["MIL","ATT","GK","DEF"].some(o=>(t.aiTeam[o]||[]).some(a=>!a.used));return!e&&!i}function Me(t,e,i){Te(e)?V(t,e,i):(e.phase="attack",D(t,e,i))}function bt(t,e,i){const o=Object.values(e.homeTeam).flat().filter(a=>!a.used);if(!o.length){i.toast("Aucun joueur actif à booster","error");return}i.openModal("⚡ Utiliser le Boost",`<div style="margin-bottom:12px;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border-radius:10px;padding:12px;text-align:center;color:#000">
    ...
    <div style="display:flex;flex-direction:column;gap:6px">
      ${o.map(a=>`
        <div class="player-boost-opt" data-card-id="${a.cardId}"
          ...
          <div style="width:32px;height:32px;background:${U[a.job]||"#888"};border-radius:6px;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:900;font-size:13px">${C(a,a._line||a.job)}</div>
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Annuler</button>`),document.querySelectorAll(".player-boost-opt").forEach(a=>{a.addEventListener("click",()=>{const n=a.dataset.cardId;for(const r of["GK","DEF","MIL","ATT"]){const l=(e.homeTeam[r]||[]).find(s=>s.cardId===n);if(l){l.boost=(l.boost||0)+e.boostCard.value,e.log.push({text:`⚡ Boost +${e.boostCard.value} appliqué à ${l.name}`,type:"info"});break}}e.boostUsed=!0,i.closeModal(),D(t,e,i)})})}function _t(t,e,i){e.usedSubIds||(e.usedSubIds=[]);const o=Object.values(e.homeTeam).flat().filter(s=>s.used),a=e.homeSubs.filter(s=>!e.usedSubIds.includes(s.cardId));if(!o.length){i.toast("Aucun joueur grisé","info");return}if(!a.length){i.toast("Aucun remplaçant disponible","info");return}if(e.subsUsed>=e.maxSubs){i.toast(`Maximum ${e.maxSubs} remplacements`,"error");return}i.openModal("🔄 Remplacement",`<div style="margin-bottom:12px">
      ...
      ${o.map(s=>`
        <div class="grayed-opt" data-card-id="${s.cardId}" data-role="${s._line}"
          ...
          <div style="width:28px;height:28px;background:${U[s.job]||"#888"};border-radius:5px;display:flex;align-items:center;justify-content:center;color:#fff;font-size:10px;font-weight:900">${s._line}</div>
    ...
    <div>
      ...
      ${a.map(s=>`
        <div class="sub-opt" data-card-id="${s.cardId}"
          ...
          <div style="width:28px;height:28px;background:${U[s.job]||"#888"};border-radius:5px;display:flex;align-items:center;justify-content:center;color:#fff;font-size:10px;font-weight:900">${s.job}</div>
          <div><b>${s.firstname} ${s.name}</b></div>
        </div>`).join("")}
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Annuler</button>`);let n=null,r=null;document.querySelectorAll(".grayed-opt").forEach(s=>{s.addEventListener("click",()=>{document.querySelectorAll(".grayed-opt").forEach(d=>d.style.borderColor="#eee"),s.style.borderColor="#c0392b",n={cardId:s.dataset.cardId,role:s.dataset.role},l()})}),document.querySelectorAll(".sub-opt").forEach(s=>{s.addEventListener("click",()=>{document.querySelectorAll(".sub-opt").forEach(d=>d.style.borderColor="var(--green)"),s.style.borderColor="#D4A017",r=s.dataset.cardId,l()})});function l(){if(!n||!r)return;const s=n.role,d=e.homeTeam[s]||[],c=d.findIndex(p=>p.cardId===n.cardId),y=e.homeSubs.find(p=>p.cardId===r);c!==-1&&y&&(y._line=s,y._col=d[c]._col,y.used=!1,d.splice(c,1,y),e.usedSubIds=[...e.usedSubIds||[],r],e.subsUsed++,e.log.push({text:`🔄 Remplacement : ${y.firstname} ${y.name} entre`,type:"info"})),i.closeModal(),D(t,e,i)}}function $t(t,e,i,o,a){if(!o.usedGc.includes(t)){switch(o.usedGc.push(t),e){case"Double attaque":o.modifiers.home.doubleAttack=!0,o.log.push({text:"⚡ Double attaque !",type:"info"});break;case"Bouclier":o.modifiers.home.shield=!0,o.log.push({text:"🛡️ Bouclier !",type:"info"});break;case"Ressusciter":{let n=!1;for(const r of["ATT","MIL","DEF","GK"]){const l=(o.homeTeam[r]||[]).find(s=>s.used);if(l){l.used=!1,n=!0;break}}o.log.push({text:n?"💫 Joueur ressuscité !":"💫 Aucun joueur à ressusciter",type:"info"});break}case"Vol de note":o.modifiers.ai.stolenNote=(o.modifiers.ai.stolenNote||0)+1,o.log.push({text:"🎯 -1 à la prochaine IA",type:"info"});break;case"Gel":{const n=[...o.aiTeam.ATT||[],...o.aiTeam.MIL||[]].filter(r=>!r.used);if(n.length){const r=n.sort((l,s)=>C(s,"ATT")-C(l,"ATT"))[0];r.used=!0,o.log.push({text:`❄️ ${r.name} (IA) gelé !`,type:"info"})}break}case"Remplacement+":o.maxSubs++,o.log.push({text:"🔄 +1 remplacement",type:"info"});break}$.from("cards").delete().eq("id",t).then(()=>{}),D(i,o,a)}}async function V(t,e,i){var c,y;e.phase="finished";const{state:o}=i,a=e.homeScore>e.aiScore,n=e.homeScore===e.aiScore,r=a?"victoire":n?"nul":"defaite",l=ze(e.mode,r);e.matchId&&await $.from("matches").update({status:"finished",home_score:e.homeScore,away_score:e.aiScore,winner_id:a?o.profile.id:null,home_credits_reward:l,played_at:new Date().toISOString()}).eq("id",e.matchId);const s={credits:(o.profile.credits||0)+l,matches_played:(o.profile.matches_played||0)+1};a?s.wins=(o.profile.wins||0)+1:n?s.draws=(o.profile.draws||0)+1:s.losses=(o.profile.losses||0)+1,await $.from("users").update(s).eq("id",o.profile.id),await i.refreshProfile();const d=document.createElement("div");d.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.85);display:flex;align-items:center;justify-content:center;z-index:2000",d.innerHTML=`
    <div style="text-align:center;padding:40px;color:#fff;max-width:360px">
      ...
      ${Le(t.aiTeam,t.formation,null,[],300,300)}
    </div>`,`<button class="btn btn-primary" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const wt={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"};async function kt(t,e){const{state:i,toast:o}=e;t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement du marché...</div>',await te(t,e)}async function te(t,e){const{state:i,toast:o}=e,{data:a}=await $.from("market_listings").select(`id, price, status, listed_at, seller_id,
  ...
  `;function l(s){const d=document.getElementById("mkt-content"),c=s==="buy"?r:n;if(c.length===0){d.innerHTML=`<div style="text-align:center;color:var(--gray-600);padding:40px">
      ...
      ${c.map(y=>{var v,u,x;const p=(v=y.card)==null?void 0:v.player;if(!p)return"";const f=p.job==="GK"?p.note_g:p.job==="DEF"?p.note_d:p.job==="MIL"?p.note_m:p.note_a,h=wt[p.rarity],g=(i.profile.credits||0)>=y.price;return`<div class="card-panel" style="display:flex;align-items:center;gap:12px;padding:12px">
          <div style="width:44px;height:44px;border-radius:8px;background:${At(p.job)};color:#fff;display:flex;align-items:center;justify-content:center;font-weight:900;font-size:18px;border:2px solid ${h};flex-shrink:0">${f}</div>
          <div style="flex:1;min-width:0">
          ...
          <div style="text-align:right;flex-shrink:0">
            ...
            ${s==="buy"?`<button class="btn btn-primary btn-sm" data-buy="${y.id}" ${g?"":"disabled"} style="margin-top:4px">${g?"Acheter":"Trop cher"}</button>`:`<button class="btn btn-danger btn-sm" data-cancel="${y.id}" style="margin-top:4px">Retirer</button>`}
          </div>
        </div>`}).join("")}
    </div>`,d.querySelectorAll("[data-buy]").forEach(y=>{y.addEventListener("click",()=>It(y.dataset.buy,c,t,e))}),d.querySelectorAll("[data-cancel]").forEach(y=>{y.addEventListener("click",()=>Lt(y.dataset.cancel,t,e))})}l("buy"),t.querySelectorAll(".mkt-tab").forEach(s=>{s.addEventListener("click",()=>{t.querySelectorAll(".mkt-tab").forEach(d=>{const c=d===s;d.style.background=c?"var(--green)":"#fff",d.style.color=c?"#fff":"var(--gray-600)",d.style.borderColor=c?"var(--green)":"var(--gray-200)"}),l(s.dataset.tab)})})}async function It(t,e,i,o){const{state:a,toast:n,refreshProfile:r}=o,l=e.find(s=>s.id===t);if(l){if((a.profile.credits||0)<l.price){n("Crédits insuffisants","error");return}if(confirm(`Acheter ${l.card.player.firstname} ${l.card.player.surname_encoded} pour ${l.price.toLocaleString("fr")} crédits ?`))try{const{error:s}=await $.from("cards").update({owner_id:a.profile.id,is_for_sale:!1,sale_price:null}).eq("id",l.card.id);if(s)throw s;await $.from("market_listings").update({status:"sold",buyer_id:a.profile.id,sold_at:new Date().toISOString()}).eq("id",t),await $.from("users").update({credits:(a.profile.credits||0)-l.price}).eq("id",a.profile.id);const{data:d}=await $.from("users").select("credits").eq("id",l.seller_id).single();d&&await $.from("users").update({credits:(d.credits||0)+l.price}).eq("id",l.seller_id),await $.from("notifications").insert({user_id:l.seller_id,type:"card_sold",message:`Ta carte ${l.card.player.surname_encoded} a été vendue pour ${l.price} crédits !`,data:{card_id:l.card.id,price:l.price}}),await r(),n("Carte achetée ! ✅","success"),te(i,o)}catch(s){n("Erreur : "+s.message,"error")}}}async function Lt(t,e,i){const{toast:o}=i,{data:a}=await $.from("market_listings").select("card_id").eq("id",t).single();await $.from("market_listings").update({status:"cancelled"}).eq("id",t),a&&await $.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",a.card_id),o("Annonce retirée","success"),te(e,i)}function At(t){return{GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[t]||"#888"}async function Tt(t,{state:e,navigate:i,toast:o}){t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:a}=await $.from("users").select("id,pseudo,club_name,trophies_top1,trophies_top2,trophies_top3,wins,level").order("trophies_top1",{ascending:!1}).limit(100);t.innerHTML=`
  <div class="page">
    <div class="page-header">
  ...
  `}const A={user:null,profile:null,page:"home",params:{}};function G(t,e="info",i=3e3){const o=document.getElementById("toast");o&&(o.textContent=t,o.className=`show ${e}`,clearTimeout(o._t),o._t=setTimeout(()=>{o.className=""},i))}function Mt(t,e,i=""){document.getElementById("modal-title").textContent=t,document.getElementById("modal-body").innerHTML=e,document.getElementById("modal-footer").innerHTML=i,document.getElementById("modal-overlay").classList.remove("hidden")}function Y(){document.getElementById("modal-overlay").classList.add("hidden")}async function R(){if(!A.user)return;const{data:t}=await $.from("users").select("*").eq("id",A.user.id).single();t&&(A.profile=t)}function q(t,e={}){A.page=t,A.params=e,Ce()}async function Ce(){const t=document.getElementById("page-content");if(!t)return;document.querySelectorAll(".bottom-nav a").forEach(o=>{o.classList.toggle("active",o.dataset.page===A.page)});const e=document.getElementById("nav-credits");e&&A.profile&&(e.textContent=`💰 ${(A.profile.credits||0).toLocaleString("fr")}`);const i={state:A,navigate:q,toast:G,openModal:Mt,closeModal:Y,refreshProfile:R};switch(t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',A.page){case"home":await ne(t,i);break;case"collection":await Ne(t,i);break;case"decks":await Ee(t,i);break;case"boosters":await Xe(t,i);break;case"match":await pt(t,i);break;case"market":await kt(t,i);break;case"rankings":await Tt(t,i);break;default:await ne(t,i)}}function Ct(){const t=document.getElementById("app"),e=A.profile,i=(e.club_name||"MW").split(" ").filter(Boolean);i.length>=2?(i[0][0]+i[1][0]).toUpperCase():(e.club_name||"MW").slice(0,2).toUpperCase(),t.innerHTML=`
    <nav class="top-nav">
  ...
  `,document.querySelectorAll(".bottom-nav a").forEach(o=>{o.addEventListener("click",a=>{a.preventDefault(),q(o.dataset.page)})}),document.getElementById("nav-logo").addEventListener("click",()=>q("home")),document.getElementById("nav-credits").addEventListener("click",()=>q("boosters"))}async function Dt(){document.getElementById("modal-overlay").addEventListener("click",e=>{e.target===e.currentTarget&&Y()}),document.getElementById("modal-close").addEventListener("click",Y);const{data:{session:t}}=await $.auth.getSession();if(!t){ye(),ie(document.getElementById("app"),{navigate:fe,toast:G});return}if(A.user=t.user,await R(),ye(),!A.profile){Be(document.getElementById("app"),{state:A,navigate:Bt,toast:G,refreshProfile:R});return}A.profile.first_booster_opened||(await jt(A.user.id),await R()),De(),$.auth.onAuthStateChange(async(e,i)=>{e==="SIGNED_OUT"&&(A.user=null,A.profile=null,document.getElementById("app").innerHTML="",ie(document.getElementById("app"),{navigate:fe,toast:G}))})}function De(){document.getElementById("app").style.cssText="display:flex;flex-direction:column",Ct(),Ce()}function fe(){window.location.reload()}async function Bt(){await R(),De()}async function jt(t){const{data:e}=await $.from("cards").select("id").eq("owner_id",t).limit(1);if(e&&e.length>0)return;const{data:i}=await $.from("players").select("id,job").eq("is_active",!0);if(!i||i.length===0)return;const o=i.filter(l=>l.job==="GK"),a=i.filter(l=>l.job!=="GK"),n=[];for(let l=0;l<5;l++){let s=[];l===0&&o.length>0?(s.push(o[Math.floor(Math.random()*o.length)]),s.push(...ue([...a]).slice(0,3))):s=ue([...i]).slice(0,4),s.forEach(d=>n.push({owner_id:t,player_id:d.id,card_type:"player"}))}["Ressusciter","Double attaque","Bouclier"].forEach(l=>{n.push({owner_id:t,card_type:"game_changer",gc_type:l})});const r=["4-4-2","4-3-3","3-4-3","3-5-2","5-3-2"];n.push({owner_id:t,card_type:"formation",formation:r[Math.floor(Math.random()*r.length)]}),await $.from("cards").insert(n),await $.from("users").update({first_booster_opened:!0}).eq("id",t),G("🎁 Tes récompenses de démarrage ont été ajoutées !","success",5e3)}function ue(t){for(let e=t.length-1;e>0;e--){const i=Math.floor(Math.random()*(e+1));[t[e],t[i]]=[t[i],t[e]]}return t}function ye(){const t=document.getElementById("app-loader");t&&(t.style.opacity="0",t.style.transition="opacity 0.3s",setTimeout(()=>t.style.display="none",300)),document.getElementById("app").style.display="flex"}Dt();
