import{s as h,F as re,b as fe,l as Y,c as Ve}from"./formation-links-CJ_BhI3P.js";function be(t,{navigate:e,toast:i}){t.innerHTML=`
  ...
  `,document.body.appendChild(i);const o=()=>i.remove();document.getElementById("diff-cancel").addEventListener("click",o),i.addEventListener("click",a=>{a.target===i&&o()}),i.querySelectorAll("[data-mode]").forEach(a=>{a.addEventListener("click",()=>{o(),t("match",{matchMode:a.dataset.mode})})})}const te={Ressusciter:{icon:"💫",desc:"Réactive un joueur grisé pour ce match."},"Double attaque":{icon:"⚡",desc:"La note d'attaque compte double."},Bouclier:{icon:"🛡️",desc:"Annule le prochain but adverse."},"Vol de note":{icon:"🎯",desc:"-1 à la note d'un joueur adverse."},Gel:{icon:"❄️",desc:"Bloque le meilleur attaquant IA."},"Remplacement+":{icon:"🔄",desc:"+1 remplacement pour ce match."}};function G(t,e){if(!t)return 0;switch(e){case"GK":return Number(t.note_g)||0;case"DEF":return Number(t.note_d)||0;case"MIL":return Number(t.note_m)||0;case"ATT":return Number(t.note_a)||0;default:return 0}}const _e=["ATT","MIL","DEF","GK"];function ze(t){let e=0;const i=t.length;for(let o=0;o<i;o++)for(let a=o+1;a<i;a++){const n=t[o],r=t[a];if(!n||!r)continue;const l=n._col!==void 0&&r._col!==void 0&&n._col===r._col,s=n._col!==void 0&&r._col!==void 0&&Math.abs(n._col-r._col)===1,d=_e.indexOf(n._line),c=_e.indexOf(r._line),u=Math.abs(d-c)===1;(n._line===r._line&&s||l&&u)&&(n.country_code&&r.country_code&&n.country_code===r.country_code&&e++,n.club_id&&r.club_id&&n.club_id===r.club_id&&e++)}return e}function ue(t,e={}){const i=t.reduce((n,r)=>{const l=r._line||r.job;return n+Number(l==="MIL"?r.note_m:r.note_a)||0},0),o=ze(t);let a=i+o;return e.doubleAttack&&(a*=2),e.stolenNote&&(a-=e.stolenNote),{base:i,links:o,total:Math.max(0,a)}}function ge(t,e={}){const i=t.reduce((n,r)=>{const l=r._line||r.job;let s=0;return l==="GK"?s=Number(r.note_g)||0:l==="MIL"?s=Number(r.note_m)||0:s=Number(r.note_d)||0,n+s},0),o=ze(t);let a=i+o;return e.stolenNote&&(a-=e.stolenNote),{base:i,links:o,total:Math.max(0,a)}}function je(t,e,i={}){return i.shield?{goal:!1,shielded:!0}:{goal:t>e,shielded:!1}}function Se(t,e,i="easy"){const o=t.filter(r=>!r.used);if(!o.length)return[];const a=[...o].sort((r,l)=>{const s=e==="attack"?G(r,"ATT"):r._line==="GK"?G(r,"GK"):G(r,"DEF");return(e==="attack"?G(l,"ATT"):l._line==="GK"?G(l,"GK"):G(l,"DEF"))-s});let n=i==="easy"?1+Math.floor(Math.random()*2):i==="medium"?2+Math.floor(Math.random()*2):3;return a.slice(0,Math.min(n,a.length,3))}function Xe(t,e){const i={vs_ai_easy:{victoire:500,nul:250,defaite:50},vs_ai_medium:{victoire:1e3,nul:500,defaite:50},vs_ai_hard:{victoire:1500,nul:750,defaite:100},vs_ai_club:{victoire:2500,nul:1250,defaite:100}};return(i[t]||i.vs_ai_easy)[e]||0}const De={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"},ie={GK:"#111111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},X=["GK","DEF","MIL","ATT"],Qe=["Tous","GK","DEF","MIL","ATT"],Ze={normal:1e3,pepite:5e3,papyte:5e3,legende:1e4},ye={MA:"MAROC",FR:"FRANCE",AR:"ARGENTINE",PT:"PORTUGAL",BR:"BRESIL",ES:"ESPAGNE",DE:"ALLEMAGNE",GB:"ANGLETERRE",IT:"ITALIE",CM:"CAMEROUN",SN:"SENEGAL",NG:"NIGERIA",DK:"DANEMARK",NL:"PAYS-BAS",BE:"BELGIQUE",CI:"CÔTE D'IVOIRE",AL:"ALBANIE",HR:"CROATIE",RS:"SERBIE",TR:"TURQUIE"};function Ge(t){const e="https://fcnwclxlkytdfjotqkta.supabase.co";if(!(t!=null&&t.skin)||!(t!=null&&t.hair))return null;const i=t.hair==="chauve"?`${t.skin}-chauve-rase`:`${t.skin}-${t.hair}-${t.hair_length}`;return`${e}/storage/v1/object/public/assets/tetes/${i}.png`}function J(t,e){return t&&Number(e==="GK"?t.note_g:e==="DEF"?t.note_d:e==="MIL"?t.note_m:t.note_a)||0}function ke(t,e=""){var u,p;const i=t.player;if(!i)return"";const o=i.job||"ATT",a=ie[o],n=De[i.rarity]||"#ccc",r=J(i,o),l=i.job2?J(i,i.job2):null,s=i.job2?ie[i.job2]:null,d=Ge(i),c=ye[i.country_code]||i.country_code||"";return`
  <div style="
  ...
  </div>`}function et(t){const e=t.job||"ATT",i=J(t,e),o=ye[t.country_code]||t.country_code||"";return`
  <div style="
    width:140px;border-radius:12px;padding:6px;
  ...
  ">
    <div style="background:#e8e8e8;border-radius:8px;overflow:hidden;display:flex;flex-direction:column">
  ...
  </div>`}async function tt(t,e){const{state:i,navigate:o,toast:a,openModal:n,closeModal:r}=e;t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:l}=await h.from("cards").select(`id, card_type, current_note, gc_type, formation, is_for_sale, sale_price,
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),d=(l||[]).filter(_=>_.card_type==="player"&&_.player),c=(l||[]).filter(_=>_.card_type==="game_changer"),u=(l||[]).filter(_=>_.card_type==="formation"),p=Object.keys(re),f=Object.keys(te),y={};d.forEach(_=>{const k=_.player.id;y[k]=(y[k]||0)+1});const m=new Set(Object.keys(y).map(_=>String(_))),g=new Set(u.map(_=>_.formation)),$=new Set(c.map(_=>_.gc_type));let b="player",w="Tous",v="",x=!1;function I(){return[...d].sort((_,k)=>{const E=X.indexOf(_.player.job),z=X.indexOf(k.player.job);return E!==z?E-z:(_.player.surname_encoded||"").localeCompare(k.player.surname_encoded||"")})}function j(){return[...s||[]].sort((_,k)=>{const E=X.indexOf(_.job),z=X.indexOf(k.job);return E!==z?E-z:(_.surname_encoded||"").localeCompare(k.surname_encoded||"")})}function C(){return I().filter(_=>{const k=_.player,E=w==="Tous"||k.job===w,z=!v||`${k.firstname} ${k.surname_encoded}`.toLowerCase().includes(v);return E&&z})}function L(){return j().filter(_=>{const k=w==="Tous"||_.job===w,E=!v||`${_.firstname} ${_.surname_encoded}`.toLowerCase().includes(v);return k&&E})}t.innerHTML=`
  <div class="page">
    ...
    <div class="page-body">
      <div style="display:flex;flex-wrap:wrap;gap:10px;justify-content:flex-start" id="col-grid"></div>
        ...
        </div>`,document.getElementById("col-search").addEventListener("input",k=>{v=k.target.value.toLowerCase(),T()}),t.querySelectorAll(".filter-btn").forEach(k=>{k.addEventListener("click",()=>{w=k.dataset.job,A(),T()})}),document.getElementById("show-all-btn").addEventListener("click",()=>{x=!x,A(),T()})):(_.innerHTML=`
        <div style="display:flex;justify-content:flex-end">
        ...
        </div>`,document.getElementById("show-all-btn").addEventListener("click",()=>{x=!x,A(),T()})))}function T(){const _=document.getElementById("col-grid");_&&(b==="player"?B(_):b==="formation"?W(_):ae(_))}function B(_){if(x){const k=L();if(!k.length){_.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucun joueur.</div>';return}_.innerHTML=k.map(E=>{if(m.has(String(E.id))){const S=d.find(O=>O.player.id===E.id),D=y[E.id]||1,R=D>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${D}</div>`:"",N=d.filter(O=>O.player.id===E.id&&O.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return ke(S,R+N)}return et(E)}).join("")}else{const k=C();if(!k.length){_.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const E={},z=[];k.forEach(S=>{const D=S.player.id;E[D]||(E[D]=!0,z.push(S))}),_.innerHTML=z.map(S=>{const D=y[S.player.id]||1,R=D>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${D}</div>`:"",N=d.filter(O=>O.player.id===S.player.id&&O.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return ke(S,R+N)}).join("")}_.querySelectorAll("[data-card-id]").forEach(k=>{k.addEventListener("click",()=>{const E=d.find(z=>z.id===k.dataset.cardId);E&&nt(E,d,y,e)})})}function W(_){const k=x?p:[...g];if(!k.length){_.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Formation.<br><small>Ouvre un booster Formation !</small></div>';return}_.innerHTML=k.map(E=>{if(g.has(E)){const S=u.find(q=>q.formation===E),D=u.filter(q=>q.formation===E).length,R=D>1?`<div style="position:absolute;top:4px;right:4px;background:#0a3d1e;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${D}</div>`:"";return`
          <div data-form-id="${S.id}" style="
            ...
            <div style="font-weight:900;font-size:18px">${E}</div>
          </div>`}return`
        <div style="
          ...
          <div style="font-weight:900;font-size:18px">${E}</div>
        </div>`}).join(""),_.querySelectorAll("[data-form-id]").forEach(E=>{E.addEventListener("click",()=>{const z=u.find(S=>S.id===E.dataset.formId);z&&ot(z,u,e,n)})})}function ae(_){const k=x?f:[...$];if(!k.length){_.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Game Changer.<br><small>Ouvre un booster Game Changer !</small></div>';return}_.innerHTML=k.map(E=>{const z=$.has(E),S=te[E]||{icon:"⚡"};if(z){const D=c.find(N=>N.gc_type===E),R=c.filter(N=>N.gc_type===E).length,q=R>1?`<div style="position:absolute;top:4px;right:4px;background:#3d0a7a;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${R}</div>`:"";return`
          <div data-gc-id="${D.id}" data-gc-type="${E}" style="
            ...
            <div style="font-weight:700;font-size:13px">${E}</div>
          </div>`}return`
        <div style="
          background:#ccc;border:2px solid #bbb;border-radius:12px;padding:12px;color:#888;
          ...
          <div style="font-weight:700;font-size:13px">${E}</div>
        </div>`}).join(""),_.querySelectorAll("[data-gc-id]").forEach(E=>{E.addEventListener("click",()=>it(E.dataset.gcType,n))})}t.querySelectorAll(".col-tab-btn").forEach(_=>{_.addEventListener("click",()=>{b=_.dataset.tab,w="Tous",v="",x=!1,t.querySelectorAll(".col-tab-btn").forEach(k=>{const E=k.dataset.tab===b;k.style.borderBottomColor=E?"var(--green)":"transparent",k.style.color=E?"var(--green)":"var(--gray-600)"}),A(),T()})}),A(),T()}function it(t,e){const i=te[t]||{icon:"⚡",desc:"Effet spécial."};e("Game Changer",`<div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const V=1e3;function ot(t,e,i,o){var m,g,$;const{state:a,toast:n,closeModal:r,navigate:l,refreshProfile:s}=i,d=t.formation,c={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function u(){const b=fe[d]||{},w=re[d]||[],v=290,x=360,I=20;function j(L){const A=b[L];return A?{x:A.x*v,y:A.y*x}:null}let C=`<svg width="${v}" height="${x}" viewBox="0 0 ${v} ${x}" xmlns="http://www.w3.org/2000/svg">`;for(const[L,A]of w){const T=j(L),B=j(A);!T||!B||(C+=`<line x1="${T.x}" y1="${T.y}" x2="${B.x}" y2="${B.y}"
        stroke="#FFD700" stroke-width="2.5" stroke-dasharray="4,3" opacity="0.85"/>`)}for(const L of Object.keys(b)){const A=j(L);if(!A)continue;const T=L.replace(/\d+/,""),B=c[T]||"#555";C+=`<circle cx="${A.x}" cy="${A.y}" r="${I}" fill="${B}" stroke="rgba(255,255,255,0.6)" stroke-width="2"/>`,C+=`<text x="${A.x}" y="${A.y+4}" text-anchor="middle" font-size="9" font-weight="900" fill="white" font-family="Arial Black,Arial">${T}</text>`}return C+="</svg>",C}const p=e.filter(b=>b.formation===d),f=p.length,y=!t.is_for_sale;o(`Formation ${d}`,`<div style="background:linear-gradient(180deg,#1a6b3c,#0a3d1e);border-radius:12px;padding:16px;margin-bottom:14px;overflow-x:auto;text-align:center">
      ...
      <div style="width:140px;border-radius:12px;padding:6px;background:${v};flex-shrink:0">
        <div style="background:#f2e8d2;border-radius:8px;overflow:hidden;display:flex;flex-direction:column">
          ...
          <div style="background:#f2e8d2;padding:3px 6px;display:flex;align-items:center;justify-content:space-between;min-height:24px">
            ...
            ${(I=c.clubs)!=null&&I.logo_url?`<img src="${c.clubs.logo_url}" style="width:22px;height:16px;object-fit:contain">`:`<div style="background:#1a3a7a;color:#fff;border-radius:2px;padding:1px 3px;font-size:6px;font-weight:800">${(((j=c.clubs)==null?void 0:j.encoded_name)||"").slice(0,6)}</div>`}
          </div>
        </div>
      </div>
    ...
    </div>`:""}`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(C=document.getElementById("close-detail"))==null||C.addEventListener("click",l),(L=document.getElementById("direct-sell-btn"))==null||L.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte ${c.surname_encoded} pour ${f.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const B=u.find(ae=>!ae.is_for_sale)||u[0];if(!B){n("Aucune carte à vendre","error");return}const{error:W}=await h.from("cards").delete().eq("id",B.id);if(W){n(W.message,"error");return}await h.from("users").update({credits:(a.profile.credits||0)+f}).eq("id",a.profile.id),await d(),n(`+${f.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),l(),s("collection")}),(A=document.getElementById("market-sell-btn"))==null||A.addEventListener("click",async()=>{const B=parseInt(document.getElementById("sell-price").value);if(!B||B<1){n("Prix invalide","error");return}await h.from("cards").update({is_for_sale:!0,sale_price:B}).eq("id",t.id),await h.from("market_listings").insert({seller_id:a.profile.id,card_id:t.id,price:B}),n("Carte mise en vente sur le marché !","success"),l(),s("collection")}),(T=document.getElementById("cancel-sell-btn"))==null||T.addEventListener("click",async()=>{await h.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",t.id),await h.from("market_listings").update({status:"cancelled"}).eq("card_id",t.id).eq("status","active"),n("Annonce retirée","success"),l(),s("collection")})}const oe={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}},P={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function me(t){const e=typeof import.meta<"u"?"https://fcnwclxlkytdfjotqkta.supabase.co":"";if(!e||!(t!=null&&t.skin)||!(t!=null&&t.hair))return null;const i=t.hair==="chauve"?`${t.skin}-chauve-rase`:`${t.skin}-${t.hair}-${t.hair_length}`;return`${e}/storage/v1/object/public/assets/tetes/${i}.png`}async function Fe(t,e){const{state:i,navigate:o,toast:a}=e;t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:n}=await h.from("decks").select("id,name,formation_card_id,is_active").eq("owner_id",i.profile.id).order("created_at",{ascending:!1});t.innerHTML=`
  <div class="page">
    <div class="page-header">
      <h2>Mes decks</h2>
  ...
  <div class="page">
  ...
  </div>`,rt(t,e,a,i),document.getElementById("builder-back").addEventListener("click",()=>o("decks")),document.getElementById("formation-select").addEventListener("change",d=>{e.formation=d.target.value;const c=Ie(e.formation),u={};c.forEach(p=>{e.slots[p]&&(u[p]=e.slots[p])}),e.slots=u,H(t,e,i)}),document.getElementById("save-deck").addEventListener("click",()=>dt(e,i)),t.querySelectorAll("[data-remove-sub]").forEach(d=>{d.addEventListener("click",()=>{e.subs=e.subs.filter(c=>c!==d.dataset.removeSub),H(t,e,i)})}),(s=document.getElementById("add-sub-btn"))==null||s.addEventListener("click",()=>{st(e,t,i)})}function rt(t,e,i,o){const a=document.getElementById("deck-field");if(!a)return;const n=e.formation,r=fe[n]||{},l=re[n]||[],s={};i.forEach(w=>{const v=e.slots[w],x=v?e.playerCards.find(I=>I.id===v):null;s[w]=(x==null?void 0:x.player)||null});const d=i.filter(w=>w.startsWith("MIL"));let c=0,u=0;d.forEach(w=>{const v=s[w];v&&(c+=Number(v.note_m)||0)}),l.forEach(([w,v])=>{if(!w.startsWith("MIL")||!v.startsWith("MIL"))return;Y(s[w],s[v])!=="#ff3333"&&u++});const p=320,f=320,y=28,m=4;function g(w){const v=r[w];return v?{x:v.x*p,y:v.y*f}:null}let $="";for(const[w,v]of l){const x=g(w),I=g(v);if(!x||!I)continue;const j=s[w],C=s[v],L=Y(j,C),A=L==="#ff3333"||L==="#cc2222"?.3:.9,B=L==="#00ff88"||L==="#FFD700"?`filter="url(#glow-${L.replace("#","")})"`:"";$+=`<line x1="${x.x}" y1="${x.y}" x2="${I.x}" y2="${I.y}"
      stroke="${L}" stroke-width="${m}" stroke-linecap="round"
      opacity="${A}" ${B}/>`}for(const w of i){const v=g(w);if(!v)continue;const x=s[w],I=w.replace(/\d+/,""),C={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[I]||"#555",L=x?Number(I==="GK"?x.note_g:I==="DEF"?x.note_d:I==="MIL"?x.note_m:x.note_a)||0:null,A=x?(x.surname_encoded||"").slice(0,8).toUpperCase():"";if(x){const T=me(x);T&&($+=`
          <defs>
            <clipPath id="clip-${w}">
          ...
          <image href="${T}" x="${v.x-y}" y="${v.y-y}" width="${y*2}" height="${y*2}"
            clip-path="url(#clip-${w})" preserveAspectRatio="xMidYMid slice" opacity="0.85"/>`),$+=`
        ...
        <rect x="${v.x-y}" y="${v.y-y}" width="${y*2}" height="${y*2}"
          fill="transparent" class="deck-slot-hit" data-pos="${w}" style="cursor:pointer"/>`}else $+=`
        ...
        <rect x="${v.x-y}" y="${v.y-y}" width="${y*2}" height="${y*2}"
          fill="transparent" class="deck-slot-hit" data-pos="${w}" style="cursor:pointer"/>`}const b=`
    <defs>
    ...
    <svg viewBox="0 0 ${p} ${f}" width="100%" style="display:block;max-width:380px;margin:0 auto">
      ${b}
      ${$}
    </svg>`,a.querySelectorAll(".deck-slot-hit").forEach(w=>{w.addEventListener("click",()=>at(w.dataset.pos,e,t,o))})}function at(t,e,i,o){var p,f,y;const{openModal:a,closeModal:n}=o,r=t.replace(/\d+/,""),l=e.slots[t],s=l?e.playerCards.find(m=>m.id===l):null;(p=s==null?void 0:s.player)==null||p.id;const d=new Set;Object.entries(e.slots).forEach(([m,g])=>{var b;if(m===t||!g)return;const $=e.playerCards.find(w=>w.id===g);(b=$==null?void 0:$.player)!=null&&b.id&&d.add($.player.id)}),e.subs.forEach(m=>{var $;const g=e.playerCards.find(b=>b.id===m);($=g==null?void 0:g.player)!=null&&$.id&&d.add(g.player.id)});const c=new Set,u=e.playerCards.filter(m=>{const g=m.player;return!(g.job===r||g.job2===r)||d.has(g.id)||c.has(g.id)?!1:(c.add(g.id),!0)});u.sort((m,g)=>{const $=r==="GK"?m.player.note_g:r==="DEF"?m.player.note_d:r==="MIL"?m.player.note_m:m.player.note_a;return(r==="GK"?g.player.note_g:r==="DEF"?g.player.note_d:r==="MIL"?g.player.note_m:g.player.note_a)-$}),a(`Choisir ${r} — ${t}`,`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
      ${e.slots[t]?`
        <button class="btn btn-danger btn-sm" id="remove-player" style="width:100%;margin-bottom:4px">
          ✕ Retirer le joueur actuel
        </button>`:""}
      ${u.length>0?u.map(m=>{var v,x;const g=m.player,$=r==="GK"?g.note_g:r==="DEF"?g.note_d:r==="MIL"?g.note_m:g.note_a,b=me(g),w={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"}[g.rarity];return`<div class="player-option" data-card-id="${m.id}"
    ...
    </div>`,'<button class="btn btn-ghost" id="close-sub-selector">Fermer</button>'),(s=document.getElementById("close-sub-selector"))==null||s.addEventListener("click",a),document.querySelectorAll(".player-option").forEach(d=>{d.addEventListener("click",()=>{t.subs.push(d.dataset.cardId),a(),H(e,t,i)})})}async function dt(t,e){const{state:i,toast:o,navigate:a}=e,n=t.formationCards.find(s=>s.formation===t.formation),r=(n==null?void 0:n.id)||t.formationCardId;await h.from("decks").update({formation:t.formation,formation_card_id:r||null}).eq("id",t.deckId),await h.from("deck_cards").delete().eq("deck_id",t.deckId);const l=[];if(Object.entries(t.slots).forEach(([s,d],c)=>{l.push({deck_id:t.deckId,card_id:d,position:s,is_starter:!0,slot_order:c})}),t.subs.forEach((s,d)=>{l.push({deck_id:t.deckId,card_id:s,position:`SUB${d+1}`,is_starter:!1,slot_order:100+d})}),l.length>0){const{error:s}=await h.from("deck_cards").insert(l);if(s){o(s.message,"error");return}}o("Deck enregistré ✅","success"),a("decks")}function Ie(t){const e=oe[t]||oe["4-4-2"],i=["GK1"];for(let o=1;o<=e.DEF;o++)i.push(`DEF${o}`);for(let o=1;o<=e.MIL;o++)i.push(`MIL${o}`);for(let o=1;o<=e.ATT;o++)i.push(`ATT${o}`);return i}const Ae=[{id:"players_std",img:"/manager-wars/icons/booster-players.png",name:"Players",sub:"5 cartes joueurs",cost:5e3,costLabel:"5 000 crédits",cardCount:5,type:"player"},{id:"players_pub",img:"/manager-wars/icons/booster-silver.png",name:"Players (pub)",sub:"3 cartes joueurs",cost:0,costLabel:"1 pub",cardCount:3,type:"player"},{id:"game_changer",img:"/manager-wars/icons/booster-gamechanger.png",name:"Game Changer",sub:"3 cartes spéciales",cost:1e4,costLabel:"10 000 crédits",cardCount:3,type:"game_changer"},{id:"formation",img:"/manager-wars/icons/booster-formation.png",name:"Formation",sub:"1 carte formation",cost:1e4,costLabel:"10 000 crédits",cardCount:1,type:"formation"}],Re={Ressusciter:{icon:"💫",desc:"Réactive un joueur grisé."},"Double attaque":{icon:"⚡",desc:"La prochaine attaque compte double."},Bouclier:{icon:"🛡️",desc:"Annule le prochain but adverse."},"Vol de note":{icon:"🎯",desc:"-1 à la prochaine action IA."},Gel:{icon:"❄️",desc:"Bloque le meilleur attaquant IA."},"Remplacement+":{icon:"🔄",desc:"+1 remplacement pour ce match."}};function lt(t){const e="https://fcnwclxlkytdfjotqkta.supabase.co";if(!(t!=null&&t.skin)||!(t!=null&&t.hair))return null;const i=t.hair==="chauve"?`${t.skin}-chauve-rase`:`${t.skin}-${t.hair}-${t.hair_length}`;return`${e}/storage/v1/object/public/assets/tetes/${i}.png`}const ct={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},pt={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"};async function ft(t,{state:e,navigate:i,toast:o}){var n;const a=((n=e.profile)==null?void 0:n.credits)||0;t.innerHTML=`
  <div class="page">
    <div class="page-header">
      <h2>📦 Boosters</h2>
    ...
    <div class="page-body">
      <div class="booster-grid">
        ${Ae.map(r=>{const l=a>=r.cost||r.cost===0,s=r.id==="players_std"||r.id==="players_pub";return`<div class="booster-card ${l?"":"disabled"}" data-booster="${r.id}" style="position:relative">
  ...
  </div>`,t.querySelectorAll(".booster-card:not(.disabled)").forEach(r=>{r.addEventListener("click",async()=>{const l=Ae.find(s=>s.id===r.dataset.booster);if(l){r.style.opacity="0.5",r.style.pointerEvents="none";try{await ut(l,{state:e,toast:o,navigate:i,container:t})}catch(s){o(s.message,"error"),r.style.opacity="",r.style.pointerEvents=""}}})}),t.querySelectorAll(".booster-info-btn").forEach(r=>{r.addEventListener("click",l=>{l.stopPropagation(),bt()})})}async function ut(t,{state:e,toast:i,navigate:o,container:a}){if(t.cost>0&&e.profile.credits<t.cost){i("Crédits insuffisants","error");return}t.id==="players_pub"&&await wt();const{data:n}=await h.from("cards").select("card_type, player_id, formation").eq("owner_id",e.profile.id),r=new Set((n||[]).filter(c=>c.card_type==="player").map(c=>c.player_id)),l=new Set((n||[]).filter(c=>c.card_type==="formation").map(c=>c.formation));let s=[];t.type==="player"?s=await mt(e.profile,t.cardCount,t.cost):t.type==="game_changer"?s=await vt(e.profile,t.cardCount,t.cost):t.type==="formation"&&(s=await xt(e.profile,t.cost)),s.forEach(c=>{c.card_type==="player"&&c.player?c.isDuplicate=r.has(c.player.id):c.card_type==="formation"&&(c.isDuplicate=l.has(c.formation))});const{data:d}=await h.from("users").select("*").eq("id",e.profile.id).single();d&&(e.profile=d),ht(s,t,o)}function gt(){const t=Math.random()*100;return t<.5?"legende":t<2?"special":t<10?"normal_high":"normal_low"}function K(t){return Math.max(Number(t.note_g)||0,Number(t.note_d)||0,Number(t.note_m)||0,Number(t.note_a)||0)}function yt(t,e){let i;switch(e){case"legende":i=t.filter(o=>o.rarity==="legende"),i.length||(i=t.filter(o=>o.rarity==="pepite"||o.rarity==="papyte")),i.length||(i=t.filter(o=>K(o)>=6));break;case"special":i=t.filter(o=>o.rarity==="pepite"||o.rarity==="papyte"),i.length||(i=t.filter(o=>K(o)>=6));break;case"normal_high":i=t.filter(o=>o.rarity==="normal"&&K(o)>=6),i.length||(i=t.filter(o=>K(o)>=6));break;default:i=t.filter(o=>o.rarity==="normal"&&K(o)>=1&&K(o)<=5),i.length||(i=t.filter(o=>o.rarity==="normal"));break}return i.length||(i=t),i[Math.floor(Math.random()*i.length)]}async function mt(t,e,i){if(i>0){const{error:d}=await h.from("users").update({credits:t.credits-i}).eq("id",t.id);if(d)throw d}const{data:o}=await h.from("players").select("id,job,firstname,surname_encoded,country_code,club_id,rarity,note_g,note_d,note_m,note_a,note_min,note_max,skin,hair,hair_length,sell_price,clubs(encoded_name,logo_url)").eq("is_active",!0);if(!(o!=null&&o.length))throw new Error("Pas de joueurs en BDD — ajoutes-en via le panel admin !");const a=o.filter(d=>d.job==="GK"),n=o.filter(d=>d.job!=="GK"),r=!t.first_booster_opened&&a.length>0,l=[];for(let d=0;d<e;d++){const c=d===0&&r?a:d===0?n:o,u=gt(),p=yt(c,u);p&&l.push(p)}r&&await h.from("users").update({first_booster_opened:!0}).eq("id",t.id);const{data:s}=await h.from("cards").insert(l.map(d=>({owner_id:t.id,player_id:d.id,card_type:"player"}))).select();return l.map((d,c)=>({...s[c],player:d}))}async function vt(t,e,i){const{error:o}=await h.from("users").update({credits:t.credits-i}).eq("id",t.id);if(o)throw o;const a=Object.keys(Re),n=Array.from({length:e},()=>a[Math.floor(Math.random()*a.length)]),{data:r}=await h.from("cards").insert(n.map(l=>({owner_id:t.id,card_type:"game_changer",gc_type:l}))).select();return r}async function xt(t,e){const{error:i}=await h.from("users").update({credits:t.credits-e}).eq("id",t.id);if(i)throw i;const o=["4-4-2","4-3-3","3-4-3","3-5-2","5-3-2"],a=o[Math.floor(Math.random()*o.length)],{data:n}=await h.from("cards").insert({owner_id:t.id,card_type:"formation",formation:a}).select();return n}function ht(t,e,i){const o=document.createElement("div");o.id="booster-anim-overlay",o.innerHTML=`
    <style>
  ...
  `,document.body.appendChild(o);let a=!1;document.getElementById("pack-visual").addEventListener("click",()=>{if(a)return;a=!0;const p=document.getElementById("pack-visual");p.classList.add("shaking"),setTimeout(()=>{p.classList.add("pack-open"),setTimeout(()=>{document.getElementById("pack-phase").style.display="none",r(0)},600)},500)});let n=0;function r(p){n=p;const f=document.getElementById("reveal-phase");f.style.display="flex",l(p)}function l(p){var x;const f=t[p],y=document.getElementById("card-counter"),m=document.getElementById("single-card-slot"),g=document.getElementById("card-tap-hint");y&&(y.textContent=`Carte ${p+1} / ${t.length}`),g&&(g.textContent=p<t.length-1?"Appuie pour continuer →":"Appuie pour voir toutes tes cartes");const $=Te(f),b=f.card_type==="player"&&((x=f.player)==null?void 0:x.rarity)==="legende";m.innerHTML=`
      ...
      </div>`,b&&c();const w=document.getElementById("current-card-wrap");let v=!1;w.addEventListener("click",()=>{if(v)return;v=!0;const I=p+1;I<t.length?(w.style.transition="all 0.25s ease",w.style.transform="translateX(-120%) rotate(-15deg)",w.style.opacity="0",setTimeout(()=>l(I),250)):s()})}function s(){u(),document.getElementById("reveal-phase").style.display="none";const p=document.getElementById("recap-phase");p.style.display="flex";const f=document.getElementById("recap-grid");f.innerHTML=t.map((y,m)=>`
    ...
    </div>`}if(t.card_type==="game_changer"){const o=Re[t.gc_type]||{icon:"⚡",desc:""};return`<div style="width:140px;height:200px;background:linear-gradient(135deg,#3d0a7a,#7a28b8);border-radius:12px;border:3px solid #9b59b6;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:16px">
    ...
    </div>`:'<div style="width:140px;height:200px;background:#333;border-radius:12px"></div>'}function bt(){const t=document.createElement("div");t.style.cssText=`position:fixed;inset:0;background:rgba(0,0,0,0.6);display:flex;
  ...
  `,document.body.appendChild(t),t.addEventListener("click",e=>{e.target===t&&t.remove()}),document.getElementById("odds-close").addEventListener("click",()=>t.remove())}function wt(){return new Promise(t=>{const e=document.createElement("div");e.style.cssText="position:fixed;inset:0;background:#000;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:4000;color:#fff;gap:16px";let i=5;e.innerHTML=`<div style="font-size:48px">📺</div>
      <div style="font-size:18px;font-weight:700">Publicité</div>
      <div style="font-size:36px;font-weight:900" id="ad-cd">5</div>`,document.body.appendChild(e);const o=setInterval(()=>{i--;const a=document.getElementById("ad-cd");a&&(a.textContent=i),i<=0&&(clearInterval(o),e.remove(),t(!0))},1e3)})}const U={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}},se={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function qe(t,e,i,o,a){var n;t.innerHTML=`<div class="match-screen" style="display:flex;align-items:center;justify-content:center;min-height:100vh">
    <div style="text-align:center;padding:40px;color:#fff">
      <div style="font-size:48px;margin-bottom:16px">${e}</div>
      <p style="margin-bottom:16px">${i}</p>
      <button class="btn btn-primary" id="msg-btn">${o}</button>
    </div>
  </div>`,(n=document.getElementById("msg-btn"))==null||n.addEventListener("click",a)}function Ne(t){const e=typeof import.meta<"u"?"https://fcnwclxlkytdfjotqkta.supabase.co":"";if(!e||!(t!=null&&t.skin)||!(t!=null&&t.hair))return null;const i=t.hair==="chauve"?`${t.skin}-chauve-rase`:`${t.skin}-${t.hair}-${t.hair_length}`;return`${e}/storage/v1/object/public/assets/tetes/${i}.png`}function Le(t){const e=t.player;return{cardId:t.id,id:e.id,firstname:e.firstname,name:e.surname_encoded,country_code:e.country_code,club_id:e.club_id,job:e.job,job2:e.job2,note_g:Number(e.note_g)||0,note_d:Number(e.note_d)||0,note_m:Number(e.note_m)||0,note_a:Number(e.note_a)||0,rarity:e.rarity,skin:e.skin,hair:e.hair,hair_length:e.hair_length,boost:0,used:!1,_line:null,_col:null}}function ve(t){return t===1?[1]:t===2?[0,2]:t===3?[0,1,2]:t===4?[0,1,1,2]:t===5?[0,1,1,1,2]:[1]}function $t(){const t=Math.random()*100;return t<.1?4:t<5?3:t<20?2:1}function _t(t,e){const i=U[e]||U["4-4-2"],o={GK:[],DEF:[],MIL:[],ATT:[]},a=[...t];for(const n of["GK","DEF","MIL","ATT"]){const r=[];for(let s=0;s<i[n];s++){let d=a.findIndex(c=>c.job===n);if(d===-1&&(d=a.findIndex(c=>c.job2===n)),d===-1&&(d=0),a[d]){const c={...a[d],_line:n};r.push(c),a.splice(d,1)}}const l=ve(r.length);r.forEach((s,d)=>{s._col=l[d]}),o[n]=r}return o}async function kt(t,e){const{data:i}=await h.from("players").select("id,firstname,surname_encoded,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length").eq("is_active",!0).limit(60);if(!i||i.length<11)return Et(t);const o=U[t]||U["4-4-2"],a={GK:[],DEF:[],MIL:[],ATT:[]},n=[...i];for(const r of["GK","DEF","MIL","ATT"]){const l=n.filter(p=>p.job===r),s=n.filter(p=>p.job!==r),d=[...l,...s],c=[];for(let p=0;p<o[r];p++){const f=d[p]||n[p];f&&c.push({cardId:"ai-"+f.id+"-"+p,id:f.id,firstname:f.firstname,name:f.surname_encoded,country_code:f.country_code,club_id:f.club_id,job:f.job,job2:f.job2,note_g:Number(f.note_g)||0,note_d:Number(f.note_d)||0,note_m:Number(f.note_m)||0,note_a:Number(f.note_a)||0,rarity:f.rarity,skin:f.skin,hair:f.hair,hair_length:f.hair_length,boost:0,used:!1,_line:r})}const u=ve(c.length);c.forEach((p,f)=>{p._col=u[f]}),a[r]=c}return a}function Et(t){const e=U[t]||U["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},o=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let a=0;for(const n of["GK","DEF","MIL","ATT"]){const r=[];for(let s=0;s<e[n];s++){const d=3+Math.floor(Math.random()*5);r.push({cardId:"fake-"+a,id:"fake-"+a,firstname:"IA",name:o[a%o.length],country_code:"XX",club_id:null,job:n,job2:null,note_g:n==="GK"?d:2,note_d:n==="DEF"?d:2,note_m:n==="MIL"?d:2,note_a:n==="ATT"?d:2,rarity:"normal",boost:0,used:!1,_line:n}),a++}const l=ve(r.length);r.forEach((s,d)=>{s._col=l[d]}),i[n]=r}return i}async function It(t,e){var v;const{state:i,navigate:o,toast:a}=e,n=i.params||{};t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const r=n.matchMode||"vs_ai_easy",l=r.replace("vs_ai_",""),s=r;if(!n.deckId)return At(t,e,r);const d=n.deckId,{data:c}=await h.from("deck_cards").select(`position, is_starter, slot_order,
      card:cards(id, card_type, formation,
        player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
          clubs(encoded_name,logo_url)))`).eq("deck_id",d).order("slot_order"),u=(c||[]).filter(x=>{var I;return x.is_starter&&((I=x.card)==null?void 0:I.player)}).map(x=>Le(x.card)),p=(c||[]).filter(x=>{var I;return!x.is_starter&&((I=x.card)==null?void 0:I.player)}).map(x=>Le(x.card));if(u.length<11){qe(t,"⚠️",`Deck incomplet (${u.length}/11).`,"Compléter",()=>o("decks"));return}const f=(c||[]).find(x=>{var I;return((I=x.card)==null?void 0:I.card_type)==="formation"}),y=((v=f==null?void 0:f.card)==null?void 0:v.formation)||"4-4-2",{data:m}=await h.from("cards").select("id,gc_type").eq("owner_id",i.profile.id).eq("card_type","game_changer"),g=_t(u,y),$=await kt(y),{data:b}=await h.from("matches").insert({home_id:i.profile.id,away_id:null,mode:s,home_deck_id:d,status:"in_progress"}).select().single(),w={matchId:b==null?void 0:b.id,mode:s,difficulty:l,formation:y,homeTeam:g,aiTeam:$,homeSubs:p,subsUsed:0,maxSubs:Math.min(p.length,3),homeScore:0,aiScore:0,gcCards:m||[],usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};Tt(t,w,e)}async function At(t,e,i){var r;const{state:o,navigate:a}=e,{data:n}=await h.from("decks").select("id,name,is_active,formation_card_id").eq("owner_id",o.profile.id).order("created_at",{ascending:!1});if(!n||n.length===0){qe(t,"📋","Aucun deck. Crée un deck avant de jouer !","Créer un deck",()=>a("decks"));return}t.innerHTML=`
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${u.map((y,m)=>{const g=Ne(y),$=m<u.length-1?Y(y,u[m+1]):null;return`
          <div style="width:52px;height:52px;border-radius:8px;background:${f};position:relative;flex-shrink:0;overflow:hidden;border:2px solid rgba(255,255,255,0.3)">
            ...
            <div style="position:relative;z-index:1;font-size:15px;font-weight:900;color:#fff;text-shadow:0 1px 3px #000">${G(y,"MIL")}</div>
          ...
          ${$?`<div style="width:12px;height:4px;border-radius:2px;background:${$};flex-shrink:0;opacity:${$==="#333"?.3:.9}"></div>`:""}
          `}).join("")}
      </div>
    </div>`}t.innerHTML=`
  <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;gap:20px;padding:20px">
    ...
    <div id="midfield-result" style="opacity:0;text-align:center;transition:opacity 0.5s;color:#fff">
  ...
  </div>`,setTimeout(()=>{const u=document.getElementById("score-home"),p=document.getElementById("score-ai"),f=document.getElementById("midfield-result");if(u&&p&&(d?(u.style.fontSize="72px",u.style.color="#fff",p.style.opacity="0.3"):(p.style.fontSize="72px",p.style.color="#fff",u.style.opacity="0.3")),f){const y=$t();f.style.opacity="1";const m=d?e.clubName:"IA";f.innerHTML=`
      ...
      `,d&&(e.boostCard={value:y})}e.attacker=d?"home":"ai",e.log.push({text:`Duel milieu : ${e.clubName} ${l} – ${s} IA → ${d?e.clubName:"IA"} attaque en premier`,type:"info"}),setTimeout(()=>{e.phase=e.attacker==="home"?"attack":"ai-attack",F(t,e,i),e.attacker==="ai"&&setTimeout(()=>de(t,e,i),1e3)},2800)},1200)}function Oe(t,e,i,o,a=310,n=310){const r=fe[e]||{},l=re[e]||[],s=26,d={},c=["ATT","MIL","DEF","GK"];for(const y of c)(t[y]||[]).forEach((g,$)=>{d[`${y}${$+1}`]=g});function u(y){const m=r[y];return m?{x:m.x*a,y:m.y*n}:null}let p="";for(const[y,m]of l){const g=u(y),$=u(m);if(!g||!$)continue;const b=d[y],w=d[m],v=Y(b,w),x=v==="#ff3333"?.25:.9,I=v!=="#ff3333"?`filter="url(#glow${v.replace("#","").slice(0,6)})"`:"";p+=`<line x1="${g.x.toFixed(1)}" y1="${g.y.toFixed(1)}" x2="${$.x.toFixed(1)}" y2="${$.y.toFixed(1)}"
      stroke="${v}" stroke-width="3.5" stroke-linecap="round" opacity="${x}" ${I}/>`}for(const[y,m]of Object.entries(d)){const g=u(y);if(!g)continue;const $=y.replace(/[0-9]/g,""),w={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[$]||"#555",v=i==="attack"&&["MIL","ATT"].includes($)&&!m.used||i==="defense"&&["GK","DEF","MIL"].includes($)&&!m.used,x=o.includes(m.cardId);let I;i==="attack"?I=$==="MIL"?Number(m.note_m)||0:Number(m.note_a)||0:i==="defense"?I=$==="GK"?Number(m.note_g)||0:$==="MIL"?Number(m.note_m)||0:Number(m.note_d)||0:I=Number($==="GK"?m.note_g:$==="DEF"?m.note_d:$==="MIL"?m.note_m:m.note_a)||0,I=I+(m.boost||0);const j=x?"#FFD700":v?"rgba(255,255,255,0.7)":"rgba(255,255,255,0.25)",C=x?3:2,L=m.used?.25:1,A=Ne(m);A&&(p+=`<defs><clipPath id="mc-${y}"><circle cx="${g.x}" cy="${g.y}" r="${s}"/></clipPath></defs>`),p+=`<circle cx="${g.x}" cy="${g.y}" r="${s}" fill="${w}" opacity="${L}"
      stroke="${j}" stroke-width="${C}"/>`,A&&!m.used&&(p+=`<image href="${A}" x="${g.x-s}" y="${g.y-s}" width="${s*2}" height="${s*2}"
        clip-path="url(#mc-${y})" preserveAspectRatio="xMidYMid slice" opacity="0.8"/>`,p+=`<circle cx="${g.x}" cy="${g.y}" r="${s}" fill="${w}" opacity="0.35"
        stroke="${j}" stroke-width="${C}"/>`),m.boost&&(p+=`<rect x="${g.x+s-10}" y="${g.y-s}" width="14" height="10" rx="3" fill="#87CEEB"/>
      ...
      fill="${m.used?"#555":"white"}" font-family="Arial Black,Arial">${m.used?"–":I}</text>
    <text x="${g.x}" y="${g.y+11}" text-anchor="middle" font-size="6" fill="rgba(255,255,255,${m.used?.3:.8})"
      font-family="Arial">${(m.name||"").slice(0,8)}</text>`,v&&(p+=`<circle cx="${g.x}" cy="${g.y}" r="${s}" fill="rgba(255,255,255,0.08)"
        class="match-slot-hit ${x?"selected":""}" data-card-id="${m.cardId}" data-role="${$}"
  ...
  <div class="match-screen">
    ...
    <div class="match-field" id="match-field" style="position:relative">
      ${Lt(e.homeTeam,e.formation,e.phase,a)}
    </div>
    ...
    <div style="padding:6px 12px;display:flex;gap:6px;overflow-x:auto;align-items:center;background:rgba(0,0,0,0.2)">
      ...
      ${e.gcCards.filter(f=>!e.usedGc.includes(f.id)).map(f=>{var y;return`
        <div class="gc-mini" data-gc-id="${f.id}" data-gc-type="${f.gc_type}"
          ...
          <div style="font-size:14px">${((y=te[f.gc_type])==null?void 0:y.icon)||"⚡"}</div>
    ...
    <div class="match-log" id="match-log">
  ...
  </div>`,(d=document.getElementById("match-quit"))==null||d.addEventListener("click",()=>{confirm("Abandonner le match ?")&&i.navigate("home")}),(c=document.getElementById("view-ai"))==null||c.addEventListener("click",()=>Ft(e,i)),Mt(t,e,i),t.querySelectorAll(".match-slot-hit").forEach(f=>{f.addEventListener("click",()=>Ct(f,e,t,i))}),t.querySelectorAll(".gc-mini").forEach(f=>{f.addEventListener("click",()=>Gt(f.dataset.gcId,f.dataset.gcType,t,e,i))}),(u=document.getElementById("boost-card"))==null||u.addEventListener("click",()=>{St(t,e,i)}),(p=document.getElementById("sub-btn"))==null||p.addEventListener("click",()=>{Dt(t,e,i)});const s=document.getElementById("match-log");s&&(s.scrollTop=s.scrollHeight)}function Mt(t,e,i){var a,n,r,l;const o=document.getElementById("match-actions");if(o)if(e.phase==="attack"){const s=e.selected.length>0?ue(e.selected.map(d=>({...d,_line:d._role})),e.modifiers.home):null;o.innerHTML=`
      ...
      <button class="btn btn-primary" id="confirm-attack" style="width:100%" ${s?"":"disabled"}>Attaquer →</button>`,(a=document.getElementById("confirm-attack"))==null||a.addEventListener("click",()=>Bt(t,e,i))}else if(e.phase==="defense"){const s=e.selected.length>0?ge(e.selected.map(d=>({...d,_line:d._role})),e.modifiers.home):null;o.innerHTML=`
      <div style="text-align:center;color:#fff;margin-bottom:6px;font-size:13px">
      ...
      <button class="btn btn-primary" id="confirm-defense" style="width:100%" ${s?"":"disabled"}>Défendre →</button>`,(r=document.getElementById("confirm-defense"))==null||r.addEventListener("click",()=>zt(t,e,i))}else e.phase==="finished"?(o.innerHTML='<button class="btn btn-primary" id="end-match" style="width:100%">Voir les résultats</button>',(l=document.getElementById("end-match"))==null||l.addEventListener("click",()=>i.navigate("home"))):o.innerHTML=`<div style="text-align:center;color:rgba(255,255,255,.4);padding:8px;font-size:12px">⏳ Tour de l'IA...</div>`}function Ct(t,e,i,o){const a=t.dataset.cardId,n=t.dataset.role,r=e.selected.findIndex(l=>l.cardId===a);if(r!==-1)e.selected.splice(r,1);else{if(e.selected.length>=3){o.toast("Maximum 3 joueurs","error");return}const l=(e.homeTeam[n]||[]).find(s=>s.cardId===a);l&&e.selected.push({...l,_role:n,_line:n})}F(i,e,o)}function Bt(t,e,i){const o=e.selected.map(n=>({...n,_line:n._role})),a=ue(o,e.modifiers.home);e.pendingAttack={...a,players:[...e.selected],side:"home"},e.selected.forEach(n=>{const r=(e.homeTeam[n._role]||[]).find(l=>l.cardId===n.cardId);r&&(r.used=!0)}),e.log.push({text:`Vous attaquez : ${a.total} (${e.selected.map(n=>n.name).join(", ")})`,type:"info"}),e.selected=[],e.modifiers.home={},e.phase="ai-defense",F(t,e,i),setTimeout(()=>jt(t,e,i),1200)}function zt(t,e,i){const o=e.selected.map(r=>({...r,_line:r._role})),a=ge(o,e.modifiers.home);e.selected.forEach(r=>{const l=(e.homeTeam[r._role]||[]).find(s=>s.cardId===r.cardId);l&&(l.used=!0)});const n=je(e.pendingAttack.total,a.total,e.modifiers.home);n.shielded?e.log.push({text:"🛡️ Bouclier ! But annulé.",type:"info"}):n.goal?(e.aiScore++,e.log.push({text:`⚽ BUT IA ! (${e.pendingAttack.total} > ${a.total})`,type:"goal"})):e.log.push({text:`🧤 Défense ! (${a.total} ≥ ${e.pendingAttack.total})`,type:"info"}),e.selected=[],e.modifiers.home={},e.pendingAttack=null,Ke(t,e,i,"home-attack")}function de(t,e,i){const o=[...e.aiTeam.MIL||[],...e.aiTeam.ATT||[]],a=Se(o,"attack",e.difficulty);if(!a.length){He(t,e,i);return}const n=ue(a,e.modifiers.ai);e.pendingAttack={...n,players:a,side:"ai"},a.forEach(r=>{r.used=!0}),e.log.push({text:`IA attaque : ${n.total}`,type:"info"}),e.modifiers.ai={},e.phase="defense",F(t,e,i)}function jt(t,e,i){const o=[...e.aiTeam.GK||[],...e.aiTeam.DEF||[],...e.aiTeam.MIL||[]],a=Se(o,"defense",e.difficulty),n=a.length>0?ge(a,e.modifiers.ai).total:0;a.forEach(l=>{l.used=!0});const r=je(e.pendingAttack.total,n,e.modifiers.ai);r.shielded?e.log.push({text:"🛡️ Bouclier IA !",type:"info"}):r.goal?(e.homeScore++,e.log.push({text:`⚽ BUT ! (${e.pendingAttack.total} > ${n})`,type:"goal"})):e.log.push({text:`🧤 IA défend (${n} ≥ ${e.pendingAttack.total})`,type:"info"}),e.modifiers.ai={},e.pendingAttack=null,Ke(t,e,i,"ai-attack")}function Ke(t,e,i,o){if(e.round++,Pe(e)){le(t,e,i);return}if(o==="home-attack"){if(![...e.homeTeam.MIL||[],...e.homeTeam.ATT||[]].filter(n=>!n.used).length){if(![...e.homeTeam.GK||[],...e.homeTeam.DEF||[],...e.homeTeam.MIL||[]].filter(r=>!r.used).length){le(t,e,i);return}e.phase="ai-attack",F(t,e,i),setTimeout(()=>de(t,e,i),800);return}e.phase="attack",F(t,e,i)}else{if(![...e.aiTeam.MIL||[],...e.aiTeam.ATT||[]].filter(n=>!n.used).length){He(t,e,i);return}e.phase="ai-attack",F(t,e,i),setTimeout(()=>de(t,e,i),800)}}function Pe(t){const e=["MIL","ATT","GK","DEF"].some(o=>(t.homeTeam[o]||[]).some(a=>!a.used)),i=["MIL","ATT","GK","DEF"].some(o=>(t.aiTeam[o]||[]).some(a=>!a.used));return!e&&!i}function He(t,e,i){Pe(e)?le(t,e,i):(e.phase="attack",F(t,e,i))}function St(t,e,i){const o=Object.values(e.homeTeam).flat().filter(a=>!a.used);if(!o.length){i.toast("Aucun joueur actif à booster","error");return}i.openModal("⚡ Utiliser le Boost",`<div style="margin-bottom:12px;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border-radius:10px;padding:12px;text-align:center;color:#000">
    ...
    <div style="display:flex;flex-direction:column;gap:6px">
      ${o.map(a=>`
        <div class="player-boost-opt" data-card-id="${a.cardId}"
          ...
          <div style="width:32px;height:32px;background:${se[a.job]||"#888"};border-radius:6px;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:900;font-size:13px">${G(a,a._line||a.job)}</div>
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Annuler</button>`),document.querySelectorAll(".player-boost-opt").forEach(a=>{a.addEventListener("click",()=>{const n=a.dataset.cardId;for(const r of["GK","DEF","MIL","ATT"]){const l=(e.homeTeam[r]||[]).find(s=>s.cardId===n);if(l){l.boost=(l.boost||0)+e.boostCard.value,e.log.push({text:`⚡ Boost +${e.boostCard.value} appliqué à ${l.name}`,type:"info"});break}}e.boostUsed=!0,i.closeModal(),F(t,e,i)})})}function Dt(t,e,i){e.usedSubIds||(e.usedSubIds=[]);const o=Object.values(e.homeTeam).flat().filter(s=>s.used),a=e.homeSubs.filter(s=>!e.usedSubIds.includes(s.cardId));if(!o.length){i.toast("Aucun joueur grisé","info");return}if(!a.length){i.toast("Aucun remplaçant disponible","info");return}if(e.subsUsed>=e.maxSubs){i.toast(`Maximum ${e.maxSubs} remplacements`,"error");return}i.openModal("🔄 Remplacement",`<div style="margin-bottom:12px">
  ...
  `;function l(s){const d=document.getElementById("mkt-content"),c=s==="buy"?r:n;if(c.length===0){d.innerHTML=`<div style="text-align:center;color:var(--gray-600);padding:40px">
      ...
      ${c.map(u=>{var g,$,b;const p=(g=u.card)==null?void 0:g.player;if(!p)return"";const f=p.job==="GK"?p.note_g:p.job==="DEF"?p.note_d:p.job==="MIL"?p.note_m:p.note_a,y=Rt[p.rarity],m=(i.profile.credits||0)>=u.price;return`<div class="card-panel" style="display:flex;align-items:center;gap:12px;padding:12px">
          <div style="width:44px;height:44px;border-radius:8px;background:${Kt(p.job)};color:#fff;display:flex;align-items:center;justify-content:center;font-weight:900;font-size:18px;border:2px solid ${y};flex-shrink:0">${f}</div>
          <div style="flex:1;min-width:0">
            <div style="font-weight:700;font-size:14px">${p.firstname} ${p.surname_encoded}</div>
            <div style="font-size:11px;color:var(--gray-600)">${p.country_code} · ${(($=p.clubs)==null?void 0:$.encoded_name)||"—"} · ${p.rarity} · ${p.job}</div>
  ...
  `}const M={user:null,profile:null,page:"home",params:{}};function Q(t,e="info",i=3e3){const o=document.getElementById("toast");o&&(o.textContent=t,o.className=`show ${e}`,clearTimeout(o._t),o._t=setTimeout(()=>{o.className=""},i))}function Ht(t,e,i=""){document.getElementById("modal-title").textContent=t,document.getElementById("modal-body").innerHTML=e,document.getElementById("modal-footer").innerHTML=i,document.getElementById("modal-overlay").classList.remove("hidden")}function ce(){document.getElementById("modal-overlay").classList.add("hidden")}async function Z(){if(!M.user)return;const{data:t}=await h.from("users").select("*").eq("id",M.user.id).single();t&&(M.profile=t)}const he="mw_theme";function ne(){return localStorage.getItem(he)||"light"}function Ut(t){var e;localStorage.setItem(he,t),pe(t),(e=M.profile)!=null&&e.id&&h.from("users").update({theme:t}).eq("id",M.profile.id).then(()=>{})}function pe(t){document.documentElement.setAttribute("data-theme",t)}function ee(t,e={}){M.page=t,M.params=e,Ue()}async function Ue(){const t=document.getElementById("page-content");if(!t)return;document.querySelectorAll(".bottom-nav a").forEach(o=>{o.classList.toggle("active",o.dataset.page===M.page)});const e=document.getElementById("nav-credits");e&&M.profile&&(e.textContent=`💰 ${(M.profile.credits||0).toLocaleString("fr")}`);const i={state:M,navigate:ee,toast:Q,openModal:Ht,closeModal:ce,refreshProfile:Z};switch(t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',M.page){case"home":await $e(t,i);break;case"collection":await tt(t,i);break;case"decks":await Fe(t,i);break;case"boosters":await ft(t,i);break;case"match":await It(t,i);break;case"market":await qt(t,i);break;case"rankings":await Pt(t,i);break;default:await $e(t,i)}}function Vt(){const t=document.getElementById("app"),e=M.profile;if(!e)return;const i="/manager-wars/icons/";t.innerHTML=`
    <nav class="top-nav">
  ...
  `,document.querySelectorAll(".bottom-nav a").forEach(o=>{o.addEventListener("click",a=>{a.preventDefault(),ee(o.dataset.page)})}),document.getElementById("nav-logo").addEventListener("click",()=>ee("home")),document.getElementById("nav-credits").addEventListener("click",()=>ee("boosters")),document.getElementById("theme-toggle").addEventListener("click",()=>{const a=ne()==="dark"?"light":"dark";Ut(a),Me(a)}),Me(ne())}function Me(t){const e=document.getElementById("theme-icon");e&&(e.textContent=t==="dark"?"☀️":"🌙")}async function Yt(){pe(ne()),document.getElementById("modal-overlay").addEventListener("click",e=>{e.target===e.currentTarget&&ce()}),document.getElementById("modal-close").addEventListener("click",ce);const{data:{session:t}}=await h.auth.getSession();if(!t){Be(),be(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:Q});return}M.user=t.user,await Z(),Be();try{const{data:e}=await h.from("formation_links_overrides").select("formation, links"),i={};(e||[]).forEach(o=>{i[o.formation]=o.links}),Ve(i)}catch(e){console.warn("Impossible de charger les overrides de formation:",e)}if(!M.profile){Ye(document.getElementById("app"),{state:M,navigate:async()=>{await Z(),Ce()},toast:Q,refreshProfile:Z});return}M.profile.theme&&M.profile.theme!==ne()&&(localStorage.setItem(he,M.profile.theme),pe(M.profile.theme)),Ce(),h.auth.onAuthStateChange(async(e,i)=>{e==="SIGNED_OUT"&&(M.user=null,M.profile=null,document.getElementById("app").innerHTML="",be(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:Q}))})}function Ce(){const t=document.getElementById("app");t.style.display="flex",t.style.flexDirection="column",Vt(),Ue()}function Be(){const t=document.getElementById("app-loader"),e=document.getElementById("app");e&&(e.style.display=""),t&&(t.classList.add("zoom-out"),setTimeout(()=>t.style.display="none",500))}Yt();
