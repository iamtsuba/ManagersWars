import{s as p,g as V}from"./supabase-3x2kAdST.js";async function K(e){const[{count:n},{count:t},{count:a},{count:d},{count:r}]=await Promise.all([p.from("players").select("*",{count:"exact",head:!0}),p.from("clubs").select("*",{count:"exact",head:!0}),p.from("users").select("*",{count:"exact",head:!0}),p.from("cards").select("*",{count:"exact",head:!0}),p.from("matches").select("*",{count:"exact",head:!0})]);e.innerHTML=`
